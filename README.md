...
This is a WIP decompilation of The Legend of Zelda: Ocarina of Time. **It is not a PC port.** It has never been a PC port. There will never be a PC port in this repository. Please do not claim that this project is a PC port. Anything claiming this is a PC port is misinformed. For more information you can get in touch with the team on our [Discord server](https://discord.zelda64.dev).
