...
SceneCmd entra_n_room_0Commands[] = {
    ...
    SCENE_CMD_MESH(&entra_n_room_0MeshHeader1Single_000070),
    SCENE_CMD_OBJECT_LIST(2, entra_n_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, entra_n_room_0ActorList_000044),
    SCENE_CMD_END(),
};
...
ActorEntry entra_n_room_0ActorList_000044[] = {
...
MeshHeader1Single entra_n_room_0MeshHeader1Single_000070 = { 
    { 1, 1, &entra_n_room_0PolygonDlist_000090, }, 
...
PolygonDlist entra_n_room_0PolygonDlist_000090 = { 
