...
RomFile market_alley_sceneRoomList0x0000E0[] = {
    { _market_alley_room_0SegmentRomStart, _market_alley_room_0SegmentRomEnd },
};

EntranceEntry market_alley_sceneEntranceList0x0000E8[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
    { 0x02, 0x00 },
    { 0x03, 0x00 },
...
LightSettings market_alley_sceneLightSettings0x000100[] = {
...
CamData market_alley_sceneCollisionHeader_001218CamDataList[] = {
...
SurfaceType market_alley_sceneCollisionHeader_001218SurfaceType[] = {
    ...
    { 0x00000303, 0x00000802 },
    { 0x00000403, 0x00000802 },
    { 0x00000503, 0x00000802 },
    { 0x00000003, 0x0000080A },
};
...
CollisionHeader market_alley_sceneCollisionHeader_001218 = { 
    { -800, 0, 200 },
    { 800, 400, 1400 },
    168, market_alley_sceneCollisionHeader_001218Vertices,
    198, market_alley_sceneCollisionHeader_001218Polygons,
