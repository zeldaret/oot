...
RomFile zoora_sceneRoomList0x000060[] = {
    { _zoora_room_0SegmentRomStart, _zoora_room_0SegmentRomEnd },
};

EntranceEntry zoora_sceneEntranceList0x000068[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
LightSettings zoora_sceneLightSettings0x000070[] = {
...
CamData zoora_sceneCollisionHeader_000360CamDataList[] = {
...
CollisionHeader zoora_sceneCollisionHeader_000360 = { 
    { -200, -1, -250 },
    { 200, 120, 80 },
    38, zoora_sceneCollisionHeader_000360Vertices,
    26, zoora_sceneCollisionHeader_000360Polygons,
