...
SceneCmd testroom_room_4Commands[] = {
    ...
    SCENE_CMD_MESH(&testroom_room_4PolygonType0_000050),
...
PolygonType0 testroom_room_4PolygonType0_000050 = { 
    0, 1,
    testroom_room_4PolygonDlist_00005C,
    testroom_room_4PolygonDlist_00005C + ARRAY_COUNTU(testroom_room_4PolygonDlist_00005C)
};

PolygonDlist testroom_room_4PolygonDlist_00005C[1] = {
