...
PolygonType0 spot10_room_4PolygonType0_000090 = { 
    0, 1,
    spot10_room_4PolygonDlist_00009C,
    spot10_room_4PolygonDlist_00009C + ARRAY_COUNTU(spot10_room_4PolygonDlist_00009C)
};

PolygonDlist spot10_room_4PolygonDlist_00009C[1] = {
...
SceneCmd spot10_room_4Set_0000B0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, spot10_room_4ActorList_000108),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_4ActorList_000108[] = {
    { ACTOR_EN_RIVER_SOUND, {   1594,      0,  -1880 }, {      0,      0,      0 }, 0x000C },
    { ACTOR_OBJECT_KANKYO,  {   1588,      0,  -1581 }, {      0,      0,      0 }, 0x0000 },
};
