...
SceneCmd ice_doukutu_room_5Commands[] = {
    ...
    SCENE_CMD_ACTOR_LIST(31, ice_doukutu_room_5ActorList_000074),
    SCENE_CMD_END(),
};
...
ActorEntry ice_doukutu_room_5ActorList_000074[] = {
    ...
    { ACTOR_BG_ICE_SHELTER,   {  -1438,    120,   -129 }, {      0,      0,      0 }, 0x002D },
    { ACTOR_BG_ICE_SHELTER,   {  -1386,    120,   -133 }, {      0,      0,      0 }, 0x002E },
    { ACTOR_BG_ICE_SHELTER,   {  -1335,    120,   -137 }, {      0,      0,      0 }, 0x002F },
    { ACTOR_BG_ICE_TURARA,    {   -763,    174,   -896 }, {      0,      0,      0 }, 0x0002 },
    { ACTOR_EN_ITEM00,        {  -1699,    225,   -697 }, {      0,      0,      0 }, 0x2E02 },
    { ACTOR_EN_ITEM00,        {  -1648,    226,   -715 }, {      0,      0,      0 }, 0x2F02 },
    { ACTOR_EN_ITEM00,        {  -1648,    225,   -677 }, {      0,      0,      0 }, 0x3002 },
    { ACTOR_EN_FIREFLY,       {  -1367,      0,  -1017 }, {      0,      0,      0 }, 0x0004 },
    { ACTOR_EN_FIREFLY,       {  -1359,      0,   -749 }, {      0, 0XFBBC,      0 }, 0x0004 },
    { ACTOR_EN_FIREFLY,       {  -1208,      0,   -490 }, {      0,      0,      0 }, 0x0004 },
    { ACTOR_EN_SW,            {   -761,    185,   -525 }, {      0, 0XA889,      0 }, 0x8A04 },
    { ACTOR_OBJ_TIMEBLOCK,    {  -1681,    120,   -695 }, {      0,      0,    0X3 }, 0x383A },
    { ACTOR_OBJ_TIMEBLOCK,    {  -1820,    122,   -695 }, {      0,      0,    0X3 }, 0x3938 },
    { ACTOR_OBJ_TIMEBLOCK,    {  -1760,    122,   -695 }, {      0,      0,    0X3 }, 0x3939 },
    { ACTOR_EN_G_SWITCH,      {  -1676,    112,   -552 }, {      0,      0,      0 }, 0x1FC9 },
    { ACTOR_EN_G_SWITCH,      {  -1558,     41,   -951 }, {      0,      0,      0 }, 0x1FC9 },
    { ACTOR_EN_G_SWITCH,      {  -1294,    113,   -899 }, {      0,      0,      0 }, 0x1FC9 },
    { ACTOR_EN_G_SWITCH,      {  -1120,    119,  -1577 }, {      0,      0,      0 }, 0x1FC9 },
    { ACTOR_EN_G_SWITCH,      {  -1040,    112,   -485 }, {      0,      0,      0 }, 0x1FC9 },
    { ACTOR_EN_G_SWITCH,      {  -1387,      0,   -334 }, {      0,      0,      0 }, 0x0149 },
    { ACTOR_BG_ICE_SHUTTER,   {  -1388,    120,   -164 }, {      0, 0X8000,      0 }, 0x0901 },
    { ACTOR_BG_ICE_OBJECTS,   {  -1060,      0,   -900 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_BG_ICE_SHELTER,   {  -1126,    119,  -1577 }, {      0, 0XF555,      0 }, 0x0010 },
};
