...
u64 gFileSelConnectorTex[TEX_LEN(u64, gFileSelConnectorTex_WIDTH, gFileSelConnectorTex_HEIGHT, 8)] = {
...
#include "assets/textures/title_static/title_static_options_tex.inc.c"
...
u64 gFileSelNameBoxTex[TEX_LEN(u64, gFileSelNameBoxTex_WIDTH, gFileSelNameBoxTex_HEIGHT, 16)] = {
...
u64 gFileSelBrightnessCheckTex[TEX_LEN(u64, gFileSelBrightnessCheckTex_WIDTH, gFileSelBrightnessCheckTex_HEIGHT, 4)] = {
...
u64 gFileSelNoEmptyFileENGTex[TEX_LEN(u64, gFileSelNoEmptyFileENGTex_WIDTH, gFileSelNoEmptyFileENGTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoEmptyFileENGTex.ia8.inc.c"
};

u64 gFileSelFileEmptyENGTex[TEX_LEN(u64, gFileSelFileEmptyENGTex_WIDTH, gFileSelFileEmptyENGTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelFileEmptyENGTex.ia8.inc.c"
};

u64 gFileSelFileInUseENGTex[TEX_LEN(u64, gFileSelFileInUseENGTex_WIDTH, gFileSelFileInUseENGTex_HEIGHT, 8)] = {
...
u64 gFileSelFile1ButtonENGTex[TEX_LEN(u64, gFileSelFile1ButtonENGTex_WIDTH, gFileSelFile1ButtonENGTex_HEIGHT, 16)] = {
#include "assets/textures/title_static/gFileSelFile1ButtonENGTex.ia16.inc.c"
};

u64 gFileSelFile2ButtonENGTex[TEX_LEN(u64, gFileSelFile2ButtonENGTex_WIDTH, gFileSelFile2ButtonENGTex_HEIGHT, 16)] = {
#include "assets/textures/title_static/gFileSelFile2ButtonENGTex.ia16.inc.c"
};

u64 gFileSelFile3ButtonENGTex[TEX_LEN(u64, gFileSelFile3ButtonENGTex_WIDTH, gFileSelFile3ButtonENGTex_HEIGHT, 16)] = {
...
u64 gFileSelNoFileToCopyGERTex[TEX_LEN(u64, gFileSelNoFileToCopyGERTex_WIDTH, gFileSelNoFileToCopyGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoFileToCopyGERTex.ia8.inc.c"
};

u64 gFileSelNoFileToEraseGERTex[TEX_LEN(u64, gFileSelNoFileToEraseGERTex_WIDTH, gFileSelNoFileToEraseGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoFileToEraseGERTex.ia8.inc.c"
};

u64 gFileSelNoEmptyFileGERTex[TEX_LEN(u64, gFileSelNoEmptyFileGERTex_WIDTH, gFileSelNoEmptyFileGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoEmptyFileGERTex.ia8.inc.c"
};

u64 gFileSelFileEmptyGERTex[TEX_LEN(u64, gFileSelFileEmptyGERTex_WIDTH, gFileSelFileEmptyGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelFileEmptyGERTex.ia8.inc.c"
};

u64 gFileSelFileInUseGERTex[TEX_LEN(u64, gFileSelFileInUseGERTex_WIDTH, gFileSelFileInUseGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelFileInUseGERTex.ia8.inc.c"
};

u64 gFileSelCopyWhichFileGERTex[TEX_LEN(u64, gFileSelCopyWhichFileGERTex_WIDTH, gFileSelCopyWhichFileGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelCopyWhichFileGERTex.ia8.inc.c"
};

u64 gFileSelCopyToWhichFileGERTex[TEX_LEN(u64, gFileSelCopyToWhichFileGERTex_WIDTH, gFileSelCopyToWhichFileGERTex_HEIGHT, 8)] = {
...
u64 gFileSelPleaseSelectAFileGERTex[TEX_LEN(u64, gFileSelPleaseSelectAFileGERTex_WIDTH, gFileSelPleaseSelectAFileGERTex_HEIGHT, 8)] = {
...
u64 gFileSelEraseWhichFileGERTex[TEX_LEN(u64, gFileSelEraseWhichFileGERTex_WIDTH, gFileSelEraseWhichFileGERTex_HEIGHT, 8)] = {
...
u64 gFileSelFile1ButtonGERTex[TEX_LEN(u64, gFileSelFile1ButtonGERTex_WIDTH, gFileSelFile1ButtonGERTex_HEIGHT, 16)] = {
#include "assets/textures/title_static/gFileSelFile1ButtonGERTex.ia16.inc.c"
};

u64 gFileSelFile2ButtonGERTex[TEX_LEN(u64, gFileSelFile2ButtonGERTex_WIDTH, gFileSelFile2ButtonGERTex_HEIGHT, 16)] = {
#include "assets/textures/title_static/gFileSelFile2ButtonGERTex.ia16.inc.c"
};

u64 gFileSelFile3ButtonGERTex[TEX_LEN(u64, gFileSelFile3ButtonGERTex_WIDTH, gFileSelFile3ButtonGERTex_HEIGHT, 16)] = {
...
u64 gFileSelNoFileToCopyFRATex[TEX_LEN(u64, gFileSelNoFileToCopyFRATex_WIDTH, gFileSelNoFileToCopyFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoFileToCopyFRATex.ia8.inc.c"
};

u64 gFileSelNoFileToEraseFRATex[TEX_LEN(u64, gFileSelNoFileToEraseFRATex_WIDTH, gFileSelNoFileToEraseFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoFileToEraseFRATex.ia8.inc.c"
};

u64 gFileSelNoEmptyFileFRATex[TEX_LEN(u64, gFileSelNoEmptyFileFRATex_WIDTH, gFileSelNoEmptyFileFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelNoEmptyFileFRATex.ia8.inc.c"
};

u64 gFileSelFileEmptyFRATex[TEX_LEN(u64, gFileSelFileEmptyFRATex_WIDTH, gFileSelFileEmptyFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelFileEmptyFRATex.ia8.inc.c"
};

u64 gFileSelFileInUseFRATex[TEX_LEN(u64, gFileSelFileInUseFRATex_WIDTH, gFileSelFileInUseFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelFileInUseFRATex.ia8.inc.c"
};

u64 gFileSelCopyWhichFileFRATex[TEX_LEN(u64, gFileSelCopyWhichFileFRATex_WIDTH, gFileSelCopyWhichFileFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelCopyWhichFileFRATex.ia8.inc.c"
};

u64 gFileSelCopyToWhichFileFRATex[TEX_LEN(u64, gFileSelCopyToWhichFileFRATex_WIDTH, gFileSelCopyToWhichFileFRATex_HEIGHT, 8)] = {
...
u64 gFileSelPleaseSelectAFileFRATex[TEX_LEN(u64, gFileSelPleaseSelectAFileFRATex_WIDTH, gFileSelPleaseSelectAFileFRATex_HEIGHT, 8)] = {
...
u64 gFileSelFile1ButtonFRATex[TEX_LEN(u64, gFileSelFile1ButtonFRATex_WIDTH, gFileSelFile1ButtonFRATex_HEIGHT, 16)] = {
#include "assets/textures/title_static/gFileSelFile1ButtonFRATex.ia16.inc.c"
};

u64 gFileSelFile2ButtonFRATex[TEX_LEN(u64, gFileSelFile2ButtonFRATex_WIDTH, gFileSelFile2ButtonFRATex_HEIGHT, 16)] = {
...
u64 gFileSelInitialLanguageChoiceENGTex[TEX_LEN(u64, gFileSelInitialLanguageChoiceENGTex_WIDTH, gFileSelInitialLanguageChoiceENGTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelInitialLanguageChoiceENGTex.ia8.inc.c"
};

u64 gFileSelInitialLanguageChoiceGERTex[TEX_LEN(u64, gFileSelInitialLanguageChoiceGERTex_WIDTH, gFileSelInitialLanguageChoiceGERTex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelInitialLanguageChoiceGERTex.ia8.inc.c"
};

u64 gFileSelInitialLanguageChoiceFRATex[TEX_LEN(u64, gFileSelInitialLanguageChoiceFRATex_WIDTH, gFileSelInitialLanguageChoiceFRATex_HEIGHT, 8)] = {
#include "assets/textures/title_static/gFileSelInitialLanguageChoiceFRATex.ia8.inc.c"
};

u64 gFileSelSelectYourLanguageTex[TEX_LEN(u64, gFileSelSelectYourLanguageTex_WIDTH, gFileSelSelectYourLanguageTex_HEIGHT, 8)] = {
...
u64 gFileSelInitialLanguageCursorTex[TEX_LEN(u64, gFileSelInitialLanguageCursorTex_WIDTH, gFileSelInitialLanguageCursorTex_HEIGHT, 4)] = {
