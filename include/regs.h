...
#define R_MESSAGE_TEXTBOX_X_TARGET  XREG(72)
#define R_MESSAGE_TEXTBOX_Y_TARGET  XREG(73)

#define R_MESSAGE_TEXTBOX_TEXWIDTH  YREG(16)
#define R_MESSAGE_TEXTBOX_TEXHEIGHT YREG(17)

#define R_MESSAGE_TEXTBOX_WIDTH     YREG(22)
#define R_MESSAGE_TEXTBOX_HEIGHT    YREG(23)

#define R_MESSAGE_DEBUGGER_SELECT   YREG(78)
#define R_MESSAGE_DEBUGGER_TEXTID   YREG(79)

#define R_MESSAGE_LINE_SPACING      XREG(56)
#define R_MESSAGE_CHAR_SCALE        XREG(57)

#define R_MESSAGE_ITEM_ICON_XPOS    YREG(71)
#define R_MESSAGE_ITEM_ICON_YPOS    YREG(72)
#define R_MESSAGE_ITEM_ICON_DIM     YREG(75)

#define R_MESSAGE_TEXTBOX_X         VREG(0)
#define R_MESSAGE_TEXTBOX_Y         VREG(1)
