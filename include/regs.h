...
#define R_PITCH_FLOOR_CHECK_NEAR_DIST_FAC        OREG(17)
#define R_PITCH_FLOOR_CHECK_FAR_DIST_FAC         OREG(18)
#define R_PITCH_FLOOR_CHECK_OFFSET_Y_FAC         OREG(19)
#define R_PITCH_FLOOR_CHECK_NEAR_WEIGHT          OREG(20)
