...
typedef struct Player {
    ...
    /* 0x08A4 */ f32        unk_8A4;
    /* 0x08A8 */ f32        unk_8A8;
    /* 0x08AC */ f32        pushedSpeed; // Pushing player, examples include water currents, floor converyors, climbing sloped surfaces
    /* 0x08B0 */ s16        pushedDirection; // Yaw direction of player being pushed
