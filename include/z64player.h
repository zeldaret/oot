...
#define PLAYER_STATE2_FREEZE_WITH_GRAVITY (1 << 15) // Replaces a large block in the middle of Player_UpdateCommon with only gravity and bgCheck updating (only used by Twinrova's freezing effects)
...
#define PLAYER_STATE2_DRAW_REFLECTION (1 << 26) // Draw a water reflection under Player (only used by EnBlkobj_Wait())
