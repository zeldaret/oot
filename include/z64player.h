...
typedef struct Player {
    ...
    /* 0x08A4 */ f32        unk_8A4;
    /* 0x08A8 */ f32        unk_8A8;
    /* 0x08AC */ f32        pushedSpeed; // Pushing Player, examples include water currents, wind streams, climbing sloped surfaces
    /* 0x08B0 */ s16        pushedYaw; // Direction Player is being pushed
