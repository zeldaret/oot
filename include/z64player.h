...
#define PLAYER_STATE_FLAG_1_0 (1 << 0)
#define PLAYER_STATE_FLAG_1_1 (1 << 1)
#define PLAYER_STATE_FLAG_1_2 (1 << 2)
#define PLAYER_STATE_FLAG_1_3 (1 << 3)
#define PLAYER_STATE_FLAG_1_4 (1 << 4)
#define PLAYER_STATE_FLAG_1_5 (1 << 5)
#define PLAYER_STATE_FLAG_1_6 (1 << 6)
#define PLAYER_STATE_FLAG_1_7 (1 << 7)
#define PLAYER_STATE_FLAG_1_8 (1 << 8)
#define PLAYER_STATE_FLAG_1_9 (1 << 9)
#define PLAYER_STATE_FLAG_1_10 (1 << 10)
#define PLAYER_STATE_FLAG_1_11 (1 << 11)
#define PLAYER_STATE_FLAG_1_12 (1 << 12)
#define PLAYER_STATE_FLAG_1_13 (1 << 13)
#define PLAYER_STATE_FLAG_1_14 (1 << 14)
#define PLAYER_STATE_FLAG_1_15 (1 << 15)
#define PLAYER_STATE_FLAG_1_16 (1 << 16)
#define PLAYER_STATE_FLAG_1_17 (1 << 17)
#define PLAYER_STATE_FLAG_1_18 (1 << 18)
#define PLAYER_STATE_FLAG_1_19 (1 << 19)
#define PLAYER_STATE_FLAG_1_20 (1 << 20)
#define PLAYER_STATE_FLAG_1_21 (1 << 21)
#define PLAYER_STATE_FLAG_1_22 (1 << 22)
#define PLAYER_STATE_FLAG_1_23 (1 << 23)
#define PLAYER_STATE_FLAG_1_24 (1 << 24)
#define PLAYER_STATE_FLAG_1_25 (1 << 25)
#define PLAYER_STATE_FLAG_1_26 (1 << 26)
#define PLAYER_STATE_FLAG_1_27 (1 << 27)
#define PLAYER_STATE_FLAG_1_28 (1 << 28)
#define PLAYER_STATE_FLAG_1_29 (1 << 29)
#define PLAYER_STATE_FLAG_1_30 (1 << 30)
#define PLAYER_STATE_FLAG_1_31 (1 << 31)

#define PLAYER_STATE_FLAG_2_0 (1 << 0)
#define PLAYER_STATE_FLAG_2_1 (1 << 1)
#define PLAYER_STATE_FLAG_2_2 (1 << 2)
#define PLAYER_STATE_FLAG_2_3 (1 << 3)
#define PLAYER_STATE_FLAG_2_4 (1 << 4)
#define PLAYER_STATE_FLAG_2_5 (1 << 5)
#define PLAYER_STATE_FLAG_2_6 (1 << 6)
#define PLAYER_STATE_FLAG_2_7 (1 << 7)
#define PLAYER_STATE_FLAG_2_8 (1 << 8)
#define PLAYER_STATE_FLAG_2_9 (1 << 9)
#define PLAYER_STATE_FLAG_2_10 (1 << 10)
#define PLAYER_STATE_FLAG_2_11 (1 << 11)
#define PLAYER_STATE_FLAG_2_12 (1 << 12)
#define PLAYER_STATE_FLAG_2_13 (1 << 13)
#define PLAYER_STATE_FLAG_2_14 (1 << 14)
#define PLAYER_STATE_FLAG_2_15 (1 << 15)
#define PLAYER_STATE_FLAG_2_16 (1 << 16)
#define PLAYER_STATE_FLAG_2_17 (1 << 17)
#define PLAYER_STATE_FLAG_2_18 (1 << 18)
#define PLAYER_STATE_FLAG_2_19 (1 << 19)
#define PLAYER_STATE_FLAG_2_20 (1 << 20)
#define PLAYER_STATE_FLAG_2_21 (1 << 21)
#define PLAYER_STATE_FLAG_2_22 (1 << 22)
#define PLAYER_STATE_FLAG_2_23 (1 << 23)
#define PLAYER_STATE_FLAG_2_24 (1 << 24)
#define PLAYER_STATE_FLAG_2_25 (1 << 25)
#define PLAYER_STATE_FLAG_2_26 (1 << 26)
#define PLAYER_STATE_FLAG_2_27 (1 << 27)
#define PLAYER_STATE_FLAG_2_28 (1 << 28)
#define PLAYER_STATE_FLAG_2_29 (1 << 29)
#define PLAYER_STATE_FLAG_2_30 (1 << 30)
#define PLAYER_STATE_FLAG_2_31 (1 << 31)

#define PLAYER_STATE_FLAG_3_0 (1 << 0)
#define PLAYER_STATE_FLAG_3_1 (1 << 1)
#define PLAYER_STATE_FLAG_3_2 (1 << 2)
#define PLAYER_STATE_FLAG_3_3 (1 << 3)
#define PLAYER_STATE_FLAG_3_4 (1 << 4)
#define PLAYER_STATE_FLAG_3_5 (1 << 5)
#define PLAYER_STATE_FLAG_3_6 (1 << 6)
#define PLAYER_STATE_FLAG_3_7 (1 << 7)
