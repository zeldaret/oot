...
typedef struct Player {
    ...
    /* 0x01F8 */ Vec3s      jointTbl[PLAYER_LIMB_BUF_COUNT];
    /* 0x0288 */ Vec3s      morphTbl[PLAYER_LIMB_BUF_COUNT];
    ...
    /* 0x070C */ Vec3s      jointTbl2[PLAYER_LIMB_BUF_COUNT];
    /* 0x079C */ Vec3s      morphTbl2[PLAYER_LIMB_BUF_COUNT];
