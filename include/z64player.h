...
#define PLAYER_STATE1_FRIENDLY_ACTOR_FOCUS (1 << 16) // Current focus actor is friendly. Includes friendly lock-on, talking, and more. Does not include hostile actor lock-on, see `PLAYER_STATE1_HOSTILE_LOCK_ON`.
