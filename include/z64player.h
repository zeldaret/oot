...
typedef enum {
    /*  0 */ PMWA_FORWARD_SLASH_1H,
    /*  1 */ PMWA_FORWARD_SLASH_2H,
    /*  2 */ PMWA_FORWARD_COMBO_1H,
    /*  3 */ PMWA_FORWARD_COMBO_2H,
    /*  4 */ PMWA_RIGHT_SLASH_1H,
    /*  5 */ PMWA_RIGHT_SLASH_2H,
    /*  6 */ PMWA_RIGHT_COMBO_1H,
    /*  7 */ PMWA_RIGHT_COMBO_2H,
    /*  8 */ PMWA_LEFT_SLASH_1H,
    /*  9 */ PMWA_LEFT_SLASH_2H,
    /* 10 */ PMWA_LEFT_COMBO_1H,
    /* 11 */ PMWA_LEFT_COMBO_2H,
    /* 12 */ PMWA_STAB_1H,
    /* 13 */ PMWA_STAB_2H,
    /* 14 */ PMWA_STAB_COMBO_1H,
    /* 15 */ PMWA_STAB_COMBO_2H,
    /* 16 */ PMWA_FLIPSLASH_START,
    /* 17 */ PMWA_JUMPSLASH_START,
    /* 18 */ PMWA_FLIPSLASH_FINISH,
    /* 19 */ PMWA_JUMPSLASH_FINISH,
    /* 20 */ PMWA_BACKSLASH_RIGHT,
    /* 21 */ PMWA_BACKSLASH_LEFT,
    /* 22 */ PMWA_HAMMER_FORWARD,
    /* 23 */ PMWA_HAMMER_SIDE,
