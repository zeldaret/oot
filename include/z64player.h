...
typedef enum {
    ...
    /* 0x02 */ PLAYER_MODELGROUP_SWORD_AND_SHIELD, // kokiri/master sword and possibly shield
    ...
    /* 0x0F */ PLAYER_MODELGROUP_SWORD, // kokiri/master sword in hand without shield
