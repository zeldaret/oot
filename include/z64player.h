...
typedef struct Player {
    ...
    /* 0x08A4 */ f32        unk_8A4;
    /* 0x08A8 */ f32        unk_8A8;
    /* 0x08AC */ f32        pushSpeed; // speed player is pushed at, examples include water currents, floor conveyors, climbing sloped surfaces
    /* 0x08B0 */ s16        pushYaw; // direction player will be pushed
