...
typedef struct {
    ...
    /* 0x0226 */ s16    unk_226; // Used only in uncalled functions
    /* 0x0228 */ s16    unk_228; // Used only in uncalled functions
    /* 0x022A */ s16    beatingHeartOscillator;
    /* 0x022C */ s16    beatingHeartOscillatorDirection; // 1 for decreasing, 0 for increasing 
    /* 0x022E */ s16    unk_22E;
    /* 0x0230 */ s16    unk_230;
