...
typedef struct {
    ...
    /* 0x0120 */ s32    dirtyFlags;
    /* 0x0124 */ s32    unk_124;
} View; // size = 0x128

#define VIEW_VIEWING 0x1
#define VIEW_VIEWPORT 0x2
#define VIEW_PROJECTION_PERSPECTIVE 0x4
#define VIEW_PROJECTION_ORTHO 0x8
#define VIEW_ALL 0xF

#define VIEW_FORCE_VIEWING 0x10
#define VIEW_FORCE_VIEWPORT 0x20
#define VIEW_FORCE_PROJECTION_PERSPECTIVE 0x40
#define VIEW_FORCE_PROJECTION_ORTHO 0x80
#define VIEW_FORCE_ALL 0xF0
