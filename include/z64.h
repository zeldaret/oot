...
#define ENTRANCE_INFO_END_TRANSITION_TYPE_SHIFT 7
#define ENTRANCE_INFO_END_TRANSITION_TYPE(field)          \
    (((field) >> ENTRANCE_INFO_END_TRANSITION_TYPE_SHIFT) \
     & (ENTRANCE_INFO_END_TRANSITION_TYPE_MASK >> ENTRANCE_INFO_END_TRANSITION_TYPE_SHIFT))
#define ENTRANCE_INFO_START_TRANSITION_TYPE_MASK 0x7F
#define ENTRANCE_INFO_START_TRANSITION_TYPE_SHIFT 0
#define ENTRANCE_INFO_START_TRANSITION_TYPE(field)          \
    (((field) >> ENTRANCE_INFO_START_TRANSITION_TYPE_SHIFT) \
     & (ENTRANCE_INFO_START_TRANSITION_TYPE_MASK >> ENTRANCE_INFO_START_TRANSITION_TYPE_SHIFT))
