...
typedef struct {
    ...
    /* 0x01FE */ s16    unk_1FE;
    /* 0x0200 */ s16    unk_200;
    /* 0x0202 */ s16    beatingHeartColor[3]; // prim color for the beating heart
    /* 0x0208 */ s16    beatingHeartBgColor[3]; // env color for the beating heart
    /* 0x020E */ s16    heartColorR[2]; // prim color for hearts
    /* 0x0212 */ s16    heartColorG[2];
    /* 0x0216 */ s16    heartColorB[2];
    /* 0x021A */ s16    heartBgColorR[2]; // env color for hearts
    /* 0x021E */ s16    heartBgColorG[2];
    /* 0x0222 */ s16    heartBgColorB[2];
    /* 0x0226 */ s16    unk_226;
    /* 0x0228 */ s16    unk_228; // a timer
    /* 0x022A */ s16    unk_22A;
    /* 0x022C */ s16    unk_22C;
    /* 0x022E */ s16    unk_22E;
    /* 0x0230 */ s16    unk_230;
    ...
    /* 0x0258 */ s16    overworldMapNum;
    /* 0x025A */ s16    dungeonMapNum;
