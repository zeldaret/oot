...
#define ENTRANCE_INFO_FIELD_CONTINUE_BGM_FLAG (1 << 15)
#define ENTRANCE_INFO_FIELD_DISPLAY_TITLE_CARD_FLAG (1 << 14)
#define ENTRANCE_INFO_FIELD_DEFAULT_END_TRANSITION_TYPE_MASK 0x3F80
#define ENTRANCE_INFO_FIELD_DEFAULT_END_TRANSITION_TYPE_SHIFT 7
#define ENTRANCE_INFO_FIELD_DEFAULT_END_TRANSITION_TYPE(field)          \
    (((field) >> ENTRANCE_INFO_FIELD_DEFAULT_END_TRANSITION_TYPE_SHIFT) \
     & (ENTRANCE_INFO_FIELD_DEFAULT_END_TRANSITION_TYPE_MASK >> ENTRANCE_INFO_FIELD_DEFAULT_END_TRANSITION_TYPE_SHIFT))
#define ENTRANCE_INFO_FIELD_DEFAULT_START_TRANSITION_TYPE_MASK 0x7F
#define ENTRANCE_INFO_FIELD_DEFAULT_START_TRANSITION_TYPE_SHIFT 0
#define ENTRANCE_INFO_FIELD_DEFAULT_START_TRANSITION_TYPE(field)          \
    (((field) >> ENTRANCE_INFO_FIELD_DEFAULT_START_TRANSITION_TYPE_SHIFT) \
     & (ENTRANCE_INFO_FIELD_DEFAULT_START_TRANSITION_TYPE_MASK >> ENTRANCE_INFO_FIELD_DEFAULT_START_TRANSITION_TYPE_SHIFT))
