...
#define MAGIC_DEFAULT    0
#define MAGIC_RED        1
#define MAGIC_ADJUSTABLE 2
#define MAGIC_BLUE       3
#define MAGIC_LIGHTBLUE  4
#define MAGIC_PURPLE     5
