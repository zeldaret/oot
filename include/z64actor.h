...
typedef enum {
    NAVI_ENEMY_GOHMA = 1,
    NAVI_ENEMY_ENGOMA_EGG = 2,
    NAVI_ENEMY_ENGOMA = 3,
    NAVI_ENEMY_SKULLTULA_NORMAL = 4,
    NAVI_ENEMY_SKULLTULA_BIG = 5,
    NAVI_ENEMY_TAILPASARAN = 6,
    NAVI_ENEMY_DEKU_BABA = 7,
    NAVI_ENEMY_DEKU_BABA_BIG = 8,
    NAVI_ENEMY_DEKU_WITHERED = 9,
    NAVI_ENEMY_DEKU_SCRUB = 10,
    NAVI_ENEMY_DODONGO = 12,
    NAVI_ENEMY_DODONGO2 = 13,
    NAVI_ENEMY_DODONGO_JR = 14,
    NAVI_ENEMY_LIZALFOS = 15,
    NAVI_ENEMY_DINOLFOS = 16,
    NAVI_ENEMY_FIRE_KEESE = 17,
    NAVI_ENEMY_KEESE = 18,
    NAVI_ENEMY_ARMOS = 19,
    NAVI_ENEMY_BARINADE = 20,
    NAVI_ENEMY_TENTACLE = 21,
    NAVI_ENEMY_BUBBLE = 22,
    NAVI_ENEMY_BIRI = 23,
    NAVI_ENEMY_BARI = 24,
    NAVI_ENEMY_EIYER = 25, // Stinger?
    NAVI_ENEMY_GANON_PHANTOM = 26,
    NAVI_ENEMY_STALFOS = 27,
    NAVI_ENEMY_BUBBLE_BLUE = 28,
    NAVI_ENEMY_BUBBLE_WHITE = 29,
    NAVI_ENEMY_BUBBLE_GREEN = 30,
    NAVI_ENEMY_UNK31 = 31,
    NAVI_ENEMY_UNK32 = 32,
    NAVI_ENEMY_VOLVAGIA = 33,
    NAVI_ENEMY_FLARE_DANCER = 34,
    NAVI_ENEMY_SLUG = 35,
    NAVI_ENEMY_BUBBLE_RED = 36,
    NAVI_ENEMY_MORPHA = 37,
    NAVI_ENEMY_DARK_LINK = 38,
    NAVI_ENEMY_SHELLBLADE = 39,
    NAVI_ENEMY_UNK40 = 40,
    NAVI_ENEMY_BONGO_BONGO = 41,
    NAVI_ENEMY_UNK42 = 42,
    NAVI_ENEMY_GANONDORF = 43,
    NAVI_ENEMY_UNK45 = 45,
    NAVI_ENEMY_DEADHANDS_HAND = 46,
    NAVI_ENEMY_DEADHAND = 47,
    NAVI_ENEMY_WALLMASTER = 48,
    NAVI_ENEMY_FLOORMASTER = 49,
    NAVI_ENEMY_KOUME = 50,
    NAVI_ENEMY_KOTAKE = 51,
    NAVI_ENEMY_IRON_KNUCKLE_1 = 52,
    NAVI_ENEMY_IRON_KNUCKLE_2 = 53,
    NAVI_ENEMY_SKULL_KID_ADULT = 54,
    NAVI_ENEMY_REACH_REACH = 55,
    NAVI_ENEMY_BEAMOS = 57,
    NAVI_ENEMY_ANUBIS = 58,
    NAVI_ENEMY_FREEZARD = 59,
    NAVI_ENEMY_GANON = 61,
    NAVI_ENEMY_GANON2 = 62,
    NAVI_ENEMY_UNK63 = 63,
    NAVI_ENEMY_SKULL_KID_NO_MASK = 64,
    NAVI_ENEMY_SKULL_KID_WITH_MASK = 65,
    NAVI_ENEMY_OKUTA = 66,
    NAVI_ENEMY_UNK67 = 67,
    NAVI_ENEMY_UNK68 = 68,
    NAVI_ENEMY_TEKTITE = 69,
    NAVI_ENEMY_LEEVER = 71,
    NAVI_ENEMY_UNK72 = 72,
    NAVI_ENEMY_LARVA = 73,
    NAVI_ENEMY_MOBLIN = 74,
    NAVI_ENEMY_MOBLIN_CLUB = 75,
    NAVI_ENEMY_WOLFOS = 76,
    NAVI_ENEMY_DEKU_MAD = 77,
    NAVI_ENEMY_DEKU_SALESMAN = 78,
    NAVI_ENEMY_DAMPES_GHOST = 79,
    NAVI_ENEMY_GERUDO_FIGHTER = 84,
    NAVI_ENEMY_POE_1 = 80,
    NAVI_ENEMY_POE_2 = 81,
    NAVI_ENEMY_POE_3 = 82,
    NAVI_ENEMY_POE_4 = 83,
    NAVI_ENEMY_STALCHILD = 85,
    NAVI_ENEMY_ICE_KEESE = 86,
    NAVI_ENEMY_WHITE_WOLFOS = 87,
    NAVI_ENEMY_CROW = 88,
    NAVI_ENEMY_BIGOKUTA = 89,
    NAVI_ENEMY_UNK90 = 90,
    NAVI_ENEMY_TWINROVA = 91,
    NAVI_ENEMY_POE = 92,
