...
typedef struct Actor {
    ...
    /* 0x01E */ s8 objectLoadEntryIndex; // Object load entry index corresponding to the actor's object; original name: "bank"
...
typedef struct {
    /* 0x00 */ MtxF* matrices;
    /* 0x04 */ s16* objectLoadEntryIndices;
    /* 0x08 */ s16 count;
    /* 0x0C */ Gfx** dLists;
...
#define BODYBREAK_OBJECT_LOAD_ENTRY_DEFAULT -1 // use the same object as the actor
