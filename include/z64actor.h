...
typedef struct Actor {
    ...
    /* 0x01E */ s8 objectEntry; // Object entry (in ObjectContext) corresponding to the actor's object; original name: "bank"
...
#define BODYBREAK_OBJECT_ENTRY_DEFAULT -1 // use the same object as the actor
