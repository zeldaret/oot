...
// `EquipInv*` enums are for Inventory#equipment (for example `CHECK_OWNED_EQUIP` macro)
...
// `EquipValue*` enums are for ItemEquips#equipment (for example `CUR_EQUIP_VALUE` macro)
