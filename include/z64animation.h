...
typedef void (*PostLimbUpdate)(struct GlobalContext* globalCtx, s32 limbIndex, Gfx** dList,
...
typedef void (*PostLimbUpdate2)(struct GlobalContext* globalCtx, s32 limbIndex, Gfx** dList,
