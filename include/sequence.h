...
#define NATURE_IO_CRITTER_0_REVERB(reverb)    NATURE_CHANNEL_CRITTER_0, CHANNEL_IO_PORT_5, reverb
...
#define NATURE_IO_CRITTER_1_REVERB(reverb)    NATURE_CHANNEL_CRITTER_1, CHANNEL_IO_PORT_5, reverb
...
#define NATURE_IO_CRITTER_2_REVERB(reverb)    NATURE_CHANNEL_CRITTER_2, CHANNEL_IO_PORT_5, reverb
...
#define NATURE_IO_CRITTER_3_REVERB(reverb)    NATURE_CHANNEL_CRITTER_3, CHANNEL_IO_PORT_5, reverb
...
#define NATURE_IO_CRITTER_4_REVERB(reverb)    NATURE_CHANNEL_CRITTER_4, CHANNEL_IO_PORT_5, reverb
...
#define NATURE_IO_CRITTER_5_REVERB(reverb)    NATURE_CHANNEL_CRITTER_5, CHANNEL_IO_PORT_5, reverb
...
#define NATURE_IO_CRITTER_6_REVERB(reverb)    NATURE_CHANNEL_CRITTER_6, CHANNEL_IO_PORT_5, reverb
