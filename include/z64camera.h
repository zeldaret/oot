...
typedef struct {
    ...
    /* 0x78 */ s16 unk_78;
    /* 0x7A */ s16 unk_7A;
    /* 0x7C */ DebugCameraSub sub;
} DebugCamera; // size = 0x10CC
...
typedef struct {
    ...
    /* 0x28 */ f32 roll;
    /* 0x2C */ f32 fov;
} DebugCameraAnim; // size = 0x30

typedef enum {
    /* 0 */ DBG_CAM_TEXT_YELLOW,
    /* 1 */ DBG_CAM_TEXT_PEACH,
    /* 2 */ DBG_CAM_TEXT_BROWN,
    /* 3 */ DBG_CAM_TEXT_ORANGE,
    /* 4 */ DBG_CAM_TEXT_GOLD,
    /* 5 */ DBG_CAM_TEXT_WHITE,
    /* 6 */ DBG_CAM_TEXT_BLUE,
    /* 7 */ DBG_CAM_TEXT_GREEN
} DebugCameraTextColor;
