...
#if DEBUG_FEATURES
#define PRINTF_COLOR_BLACK()    osSyncPrintf(VT_FGCOL(BLACK))
#define PRINTF_COLOR_RED()      osSyncPrintf(VT_FGCOL(RED))
#define PRINTF_COLOR_GREEN()    osSyncPrintf(VT_FGCOL(GREEN))
#define PRINTF_COLOR_YELLOW()   osSyncPrintf(VT_FGCOL(YELLOW))
#define PRINTF_COLOR_BLUE()     osSyncPrintf(VT_FGCOL(BLUE))
#define PRINTF_COLOR_MAGENTA()  osSyncPrintf(VT_FGCOL(MAGENTA))
#define PRINTF_COLOR_CYAN()     osSyncPrintf(VT_FGCOL(CYAN))
#define PRINTF_COLOR_WHITE()    osSyncPrintf(VT_FGCOL(WHITE))
#define PRINTF_COLOR_WARNING()  osSyncPrintf(VT_COL(YELLOW, BLACK))
#define PRINTF_COLOR_ERROR()    osSyncPrintf(VT_COL(RED, WHITE))
#define PRINTF_RST              osSyncPrintf(VT_RST)
#else
