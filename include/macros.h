 ...
 * `crnx` red component of colour vertex, or x component of normal vertex
 * `cgny` green component of colour vertex, or y component of normal vertex
 * `cbnz` blue component of colour vertex, or z component of normal vertex
 * `a` alpha
 */
