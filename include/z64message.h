...
typedef enum FaceReactionSet {
    /* 0x00 */ FACE_REACTION_SET_CARPENTER_BOSS,
    /* 0x01 */ FACE_REACTION_SET_CARPENTER_1,
    /* 0x02 */ FACE_REACTION_SET_CARPENTER_2,
    /* 0x03 */ FACE_REACTION_SET_CARPENTER_3,
    /* 0x04 */ FACE_REACTION_SET_CARPENTER_4,
    /* 0x05 */ FACE_REACTION_SET_HYRULIAN_GUARD,
    /* 0x06 */ FACE_REACTION_SET_HEISHI4_1,
    /* 0x07 */ FACE_REACTION_SET_HEISHI4_2,
    /* 0x08 */ FACE_REACTION_SET_CUCCO_LADY,
    /* 0x09 */ FACE_REACTION_SET_CARPENTERS_SON,
    /* 0x0A */ FACE_REACTION_SET_KAKARIKO_ROOF_MAN,
    /* 0x0B */ FACE_REACTION_SET_WINDMILL_MAN,
    /* 0x0C */ FACE_REACTION_SET_12, // Unused
    /* 0x0D */ FACE_REACTION_SET_CURSED_SKULLTULA_MAN,
    /* 0x0E */ FACE_REACTION_SET_DAMPE,
    /* 0x0F */ FACE_REACTION_SET_GRAVEYARD_KID,
    /* 0x10 */ FACE_REACTION_SET_SARIA,
    /* 0x11 */ FACE_REACTION_SET_MIDO,
    /* 0x12 */ FACE_REACTION_SET_FADO,
    /* 0x13 */ FACE_REACTION_SET_KOKIRI_CHILD_1,
    /* 0x14 */ FACE_REACTION_SET_KOKIRI_CHILD_2,
    /* 0x15 */ FACE_REACTION_SET_SKULL_KID,
    /* 0x16 */ FACE_REACTION_SET_CHILD_ZELDA,
    /* 0x17 */ FACE_REACTION_SET_MALON,
    /* 0x18 */ FACE_REACTION_SET_TALON,
    /* 0x19 */ FACE_REACTION_SET_INGO,
    /* 0x1A */ FACE_REACTION_SET_LAKESIDE_PROFESSOR,
    /* 0x1B */ FACE_REACTION_SET_MAGIC_BEAN_SALESMAN,
    /* 0x1C */ FACE_REACTION_SET_RUNNING_MAN,
    /* 0x1D */ FACE_REACTION_SET_ZORA,
    /* 0x1E */ FACE_REACTION_SET_KING_ZORA,
    /* 0x1F */ FACE_REACTION_SET_RUTO,
    /* 0x20 */ FACE_REACTION_SET_GORON,
    /* 0x21 */ FACE_REACTION_SET_DARUNIA,
    /* 0x22 */ FACE_REACTION_SET_GERUDO_WHITE,
    /* 0x23 */ FACE_REACTION_SET_NABOORU,
    /* 0x24 */ FACE_REACTION_SET_DANCING_COUPLE,
    /* 0x25 */ FACE_REACTION_SET_37, // ENHY_TYPE_AOB
    /* 0x26 */ FACE_REACTION_SET_38, // ENHY_TYPE_COB
    /* 0x27 */ FACE_REACTION_SET_39, // ENHY_TYPE_AHG_2
    /* 0x28 */ FACE_REACTION_SET_40, // ENHY_TYPE_BOJ_3
    /* 0x29 */ FACE_REACTION_SET_41, // ENHY_TYPE_AHG_4
    /* 0x2A */ FACE_REACTION_SET_42, // ENHY_TYPE_BOJ_5
    /* 0x2B */ FACE_REACTION_SET_43, // ENHY_TYPE_BBA
    /* 0x2C */ FACE_REACTION_SET_44, // ENHY_TYPE_BJI_7
    /* 0x2D */ FACE_REACTION_SET_45, // ENHY_TYPE_CNE_8
    /* 0x2E */ FACE_REACTION_SET_46, // ENHY_TYPE_BOJ_9
    /* 0x2F */ FACE_REACTION_SET_47, // ENHY_TYPE_BOJ_10
    /* 0x30 */ FACE_REACTION_SET_48, // ENHY_TYPE_CNE_11
    /* 0x31 */ FACE_REACTION_SET_49, // ENHY_TYPE_BOJ_12
    /* 0x32 */ FACE_REACTION_SET_50, // ENHY_TYPE_AHG_13
    /* 0x33 */ FACE_REACTION_SET_51, // ENHY_TYPE_BOJ_14
    /* 0x34 */ FACE_REACTION_SET_52, // ENHY_TYPE_BJI_15
    /* 0x35 */ FACE_REACTION_SET_53, // ENHY_TYPE_BOJ_16
    /* 0x36 */ FACE_REACTION_SET_54, // ENHY_TYPE_AHG_17
    /* 0x37 */ FACE_REACTION_SET_55, // ENHY_TYPE_BOB_18
    /* 0x38 */ FACE_REACTION_SET_56, // ENHY_TYPE_BJI_19
    /* 0x39 */ FACE_REACTION_SET_57, // ENHY_TYPE_AHG_20
    /* 0x3A */ FACE_REACTION_SET_HAGGLING_TOWNSPEOPLE_1,
    /* 0x3B */ FACE_REACTION_SET_HAGGLING_TOWNSPEOPLE_2,
    /* 0x3C */ FACE_REACTION_SET_MAX
} FaceReactionSet;
