...
void func_800430A0(CollisionContext* colCtx, s32 index, Vec3f* arg2);
// ? func_800432A0(?);
// ? func_80043334(?);
// ? func_800433A4(?);
...
void CollisionCheck_ShieldParticlesWood(GlobalContext* globalCtx, Vec3f* arg1, Vec3f* arg2);
