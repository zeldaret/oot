...
s16 OnePointCs_Init(GlobalContext* globalCtx, s16 csId, s16 timer, Actor* actor, s16 camIdx);
...
void OnePointCs_EnableAttention(void);
void OnePointCs_DisableAttention(void);
s32 OnePointCs_CheckForCategory(GlobalContext* globalCtx, s32 actorCategory);
