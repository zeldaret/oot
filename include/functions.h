...
s32 CollisionCheck_SetAT_SAC(GlobalContext* globalCtx, CollisionCheckContext* collisionCheckCtx, Collider* collider, s32 index);
s32 CollisionCheck_SetAC(GlobalContext* globalCtx, CollisionCheckContext* collisionCheckCtx, Collider* collider);
s32 CollisionCheck_SetAC_SAC(GlobalContext* globalCtx, CollisionCheckContext* collisionCheckCtx, Collider* collider, s32 index);
s32 CollisionCheck_SetOC(GlobalContext* globalCtx, CollisionCheckContext* collisionCheckCtx, Collider* collider);
s32 CollisionCheck_SetOC_SAC(GlobalContext* globalCtx, CollisionCheckContext* collisionCheckCtx, Collider* collider, s32 index);
...
// ? func_80061F64(?);
// ? func_800622E4(?);
s32 CollisionCheck_GeneralLineOcCheck(GlobalContext* globalCtx, CollisionCheckContext* collisionCheckCtx, Vec3f* camera_3C, Vec3f* arg3, Actor** arg4, s32 arg5);
// ? func_800626B0(?);
