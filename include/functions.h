...
void FBDemo_InitGraphics(TransitionStruct*);
void FBDemo_InitData(TransitionStruct*);
void FBDemo_Destroy(TransitionStruct*);
TransitionStruct* FBDemo_Init(TransitionStruct* trans, s32 row, s32 col);
void FBDemo_Update(TransitionStruct*);
void FBDemo_Draw(TransitionStruct*, Gfx**);
void func_800B23E8(TransitionStruct*);
void TransitionTriforce_Start(UNK_ARGS);
...
void TransitionWipe1_Start(UNK_ARGS);
TransitionWipe1* TransitionWipe1_Init(TransitionWipe1* wipe);
void TransitionWipe1_Destroy(UNK_ARGS);
void TransitionWipe1_Move(UNK_ARGS);
void TransitionWipe1_Draw(UNK_ARGS);
s32 TransitionWipe1_IsDone(UNK_ARGS);
void TransitionWipe1_SetType(UNK_ARGS);
void TransitionWipe1_SetColor(UNK_ARGS);
...
void TransitionCircle_SetEnvColor(TransitionCircle* circle, u32 color);
