...
void Kankyo_Init(GlobalContext*, EnvironmentContext*, UNK_TYPE);
...
// ? Kankyo_Update(?);
// ? Kankyo_DrawSunAndMoon(?);
void Kankyo_DrawSunLensFlare(GlobalContext*, EnvironmentContext*, View*, GraphicsContext*, Vec3f, s32);
void Kankyo_DrawLensFlare(GlobalContext* globalCtx, EnvironmentContext* envCtx, View* view, GraphicsContext* gfxCtx, Vec3f pos, UNK_TYPE, s16, f32, s16, u8);
f32 func_800746DC();
// ? Kankyo_DrawRain(?);
...
// ? Kankyo_DrawLightning(?);
void func_800758AC(GlobalContext* globalCtx);
// ? func_80075B44(?);
// ? Kankyo_DrawCustomLensFlare(?);
// ? func_80075F14(?);
// ? func_800760F4(?);
// ? func_800763A8(?);
// ? func_800766C4(?);
...
// ? func_800F50CC(?);
// ? func_800F510C(?);
void func_800F5510(u8 seqIndex);
void func_800F5550(u16 seqIndex);
// ? func_800F56A8(?);
