...
void* AudioHeap_SearchRegularCaches(s32 tableType, s32 arg1, s32 id);
...
void Audio_AsyncLoadSeq(s32 seqId, s32 arg1, s32 retData, OSMesgQueue* retQueue);
void Audio_AsyncLoadSampleBank(s32 sampleBankId, s32 arg1, s32 retData, OSMesgQueue* retQueue);
void Audio_AsyncLoadBank(s32 bankId, s32 arg1, s32 retData, OSMesgQueue* retQueue);
...
void Audio_InitSlowLoads(void);
s32 Audio_SlowLoadSample(s32 arg0, s32 arg1, s8* arg2);
s32 Audio_SlowLoadSeq(s32 playerIdx, u8* ramAddr, s8* arg2);
void Audio_InitAsyncLoads(void);
void Audio_LoadPermanentSamples(void);
void Audio_ScriptLoad(s32 tableType, s32 arg1, s8* arg2);
void Audio_ProcessScriptLoads(void);
void Audio_InitScriptLoads(void);
...
Note* AudioHeap_AllocNoteFromDisabled(NotePool* pool, SequenceChannelLayer* seqLayer);
Note* AudioHeap_AllocNoteFromDecaying(NotePool* pool, SequenceChannelLayer* seqLayer);
Note* AudioHeap_AllocNoteFromActive(NotePool* pool, SequenceChannelLayer* seqLayer);
Note* AudioHeap_AllocNote(SequenceChannelLayer* seqLayer);
...
void Audio_SetUnusedBankLerp(u8 bankId, u8, u16);
