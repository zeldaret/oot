...
s32 DmaMgr_SendRequestImpl(DmaRequest* req, void* ram, uintptr_t vrom, u32 size, UNUSED u32 unk, OSMesgQueue* queue, OSMesg msg);
...
void Environment_DrawLensFlare(PlayState* play, EnvironmentContext* envCtx, View* view,
                               GraphicsContext* gfxCtx, Vec3f pos, UNUSED s32 arg5, s16 scale, f32 colorIntensity,
...
void func_800A9F30(PadMgr*, UNUSED s32);
...
void UCodeDisas_Destroy(UNUSED UCodeDisas*);
