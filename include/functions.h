...
// ? func_80026C1C(?);
// ? func_80026C2C(?);
void Effect_Add(GlobalContext* gctx, s32* a, s32 b, u8 c, u8 d, void* d2);
// ? func_80026E74(?);
// ? func_80026F70(?);
// ? func_8002709C(?);
// ? func_800271A8(?);
...
s32 Collider_DestroyCollider(GlobalContext* globalCtx, Collider* collision);
s32 Collider_SetCollider_Actor(GlobalContext* globalCtx, Collider* collider, ColliderInit_Actor* src);
s32 Collider_SetCollider_Set3(GlobalContext* globalCtx, Collider* collision, Actor* actor, ColliderInit_set3* src);
...
s32 Collider_InitJntSph(GlobalContext* globalCtx, ColliderJntSph* collision);
...
s32 Collider_SetCylinder_Actor(GlobalContext* globalCtx, ColliderCylinder* collision, ColliderCylinderInit_Actor* arg2);
s32 Collider_SetCylinder_Set3(GlobalContext* globalCtx, ColliderCylinder* collision, Actor* actor, ColliderCylinderInit_set3* src);
s32 Collider_SetCylinder(GlobalContext* globalCtx, ColliderCylinder* collision, Actor* actor, ColliderCylinderInit* src);
...
s32 Collider_SetQuad_Set3(GlobalContext* globalCtx, ColliderQuad* collision, Actor* actor, ColliderQuadInit_set3* src);
s32 Collider_SetQuad(GlobalContext* globalCtx, ColliderQuad* collision, Actor* actor, ColliderQuadInit* src);
...
s32 CollisionCheck_SetAT(GlobalContext* globalCtx, CollisionCheckContext* check, Collider* collision);
s32 CollisionCheck_SetAT_SAC(GlobalContext* globalCtx, CollisionCheckContext* check, Collider* collider, s32 index);
s32 CollisionCheck_SetAC(GlobalContext* globalCtx, CollisionCheckContext* check, Collider* collision);
s32 CollisionCheck_SetAC_SAC(GlobalContext* globalCtx, CollisionCheckContext* check, Collider* collider, s32 index);
s32 CollisionCheck_SetOC(GlobalContext* globalCtx, CollisionCheckContext* check, Collider* collision);
...
// ? func_80061E48(?);
// ? func_80061E8C(?);
void func_80061ED4(SubActorStruct98* sub98, ActorDamageChart* damageTable, SubActor98Init* subActor98Init);
...
// ? func_800626B0(?);
void Collider_CylinderUpdate(Actor* actor, ColliderCylinder* collision);
// ? func_80062734(?);
...
s32 func_800CFCAC(PosRadius* a, PosRadius* b, f32* surfaceDist, f32* centerDist);
s32 func_800CFD84(PosRadius* sph, ColliderCylinderDim* cyl, f32* surfaceDist);
s32 func_800CFDA4(PosRadius* a, ColliderCylinderDim* b, f32* unk, f32* dist);
s32 func_800CFF14(ColliderCylinderDim* arg0, ColliderCylinderDim* arg1, f32* arg2);
s32 func_800CFF34(ColliderCylinderDim* arg0, ColliderCylinderDim* arg1, f32* arg2, f32* arg3);
s32 func_800D0104(ColliderTrisItemDim* a, ColliderTrisItemDim* b, Vec3f* result);
// ? func_800D0480(?);
// ? func_800D04F0(?);
// ? func_800D0560(?);
void func_800D05D0(GlobalContext* gctx, PosRadius* sph);
void func_800D05DC(GlobalContext* gctx, ColliderCylinderDim* cyl);
// ? func_800D05F0(?);
