...
void Lights_InitDirectionalLight(LightInfo* info, s8 dirX, s8 dirY, s8 dirZ, u8 red, u8 green, u8 blue);
void Lights_ResetCollection(LightCollection* collection, u8 red, u8 green, u8 blue);
