...
void Actor_SetFeetPos(Actor* actor, s32 limbIndex, s32 leftFootIndex, Vec3f* leftFootPos, s32 rightFootIndex,
                      Vec3f* rightFootPos);
void Matrix_GetProjectionPos(GlobalContext* globalCtx, Vec3f* arg1, Vec3f* arg2, f32* arg3);
...
s32 Player_IsWithinActorTargetRange(Actor* actor, Player* player, s32 arg2);
