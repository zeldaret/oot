...
s32 Collider_InitJntSph_Set3(GlobalContext* globalCtx, ColliderJntSph* dest, Actor* actor, ColliderJntSphInit_set3* src);
s32 Collider_InitJntSph_Set5(GlobalContext* globalCtx, ColliderJntSph* dest, Actor* actor, ColliderJntSphInit* src);
s32 Collider_InitJntSph(GlobalContext* globalCtx, ColliderJntSph* dest, Actor* actor, ColliderJntSphInit* src, ColliderJntSphItem* list);
// ? func_8005C2BC(?);
...
s32 Collider_InitCylinder_Actor(GlobalContext* globalCtx, ColliderCylinder* collision, ColliderCylinderInit_Actor* arg2);
s32 Collider_InitCylinder_Set3(GlobalContext* globalCtx, ColliderCylinder* collision, Actor* actor, ColliderCylinderInit_set3* src);
s32 Collider_InitCylinder(GlobalContext* globalCtx, ColliderCylinder* collision, Actor* actor, ColliderCylinderInit* src);
// ? func_8005C5B0(?);
...
s32 Collider_InitQuad_Set3(GlobalContext* globalCtx, ColliderQuad* collision, Actor* actor, ColliderQuadInit_set3* src);
