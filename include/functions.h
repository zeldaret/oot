...
void SoundSource_PlaySfxAtStationaryPosition(GlobalContext* globalCtx, Vec3f* pos, s32 duration, u16 sfxId);
...
u16 Audio_GetActiveSequence(u8 a0);
s32 Audio_IsSeqCmdNotQueued(u32 arg0, u32 arg1);
void Audio_ResetSequenceRequests(u8);
void Audio_DisableSeqCmdSetupOp(u8, u8);
