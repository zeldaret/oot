...
void Player_SetMovementBehaviorInfo(GlobalContext* globalCtx, Player* player);
...
s32 Player_OverrideLimbDrawImpl(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* data);
