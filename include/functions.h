...
void Sram_VerifyAndLoadAllSaves(FileChooseContext* fileChoose, Sram* sramCtx);
void Sram_InitSave(FileChooseContext* fileChoose, Sram* sramCtx);
void Sram_EraseSave(FileChooseContext* fileChoose, Sram* sramCtx);
void Sram_CopySave(FileChooseContext* fileChoose, Sram* sramCtx);
