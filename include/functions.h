...
void Matrix_ToMtx(Mtx* dest, char* file, s32 line);
void Matrix_NewMtx(GraphicsContext* gfxCtx, char* file, s32 line);
void Matrix_MtxFToNewMtx(MtxF* src, GraphicsContext* gfxCtx);
