...
s16 OnePointDemo_Init(GlobalContext* globalCtx, s16 csID, s16 timer, Actor* actor, s16 camIdx);
s16 OnePointDemo_EndDemo(GlobalContext* globalCtx, s16 camId);
...
void OnePointDemo_EnableLookAtActor(void);
void OnePointDemo_DisableLookAtActor(void);
