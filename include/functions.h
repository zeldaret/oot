...
void Play_SetIndoorBgCamDataIndex(PlayState* play, s16 point);
s32 Play_IsCurIndoorBgCamDataIndex(PlayState* play, s16 arg1);
void Play_SetShopBgCamDataIndex(PlayState* play);
