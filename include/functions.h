...
Vec3s* SurfaceType_GetBgCamData(CollisionContext* colCtx, s32 camId, s32 bgId);
Vec3s* SurfaceType_GetBgCamDataSetup(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
