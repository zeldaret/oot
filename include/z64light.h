...
#define LIGHTCTX_FOGNEAR_MAX 996
#define LIGHTCTX_ZFAR_MAX 12800

typedef struct {
    /* 0x0 */ LightNode* listHead;
    /* 0x4 */ u8 ambientColor[3];
    /* 0x7 */ u8 fogColor[3];
    /* 0xA */ s16 fogNear; // how close until fog starts taking effect. range 0 - LIGHTCTX_FOGNEAR_MAX
    /* 0xC */ s16 zFar; // draw distance. range 0 - LIGHTCTX_ZFAR_MAX
