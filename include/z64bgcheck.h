...
#define SURFACETYPE0_BG_CAM_INDEX_SHIFT 0
#define SURFACETYPE0_BG_CAM_INDEX_MASK 0x000000FF
#define SURFACETYPE0_BG_CAM_INDEX(data0) \
    (((data0) >> SURFACETYPE0_BG_CAM_INDEX_SHIFT) & (SURFACETYPE0_BG_CAM_INDEX_MASK >> SURFACETYPE0_BG_CAM_INDEX_SHIFT))

#define SURFACETYPE0_EXIT_INDEX_SHIFT 8
#define SURFACETYPE0_EXIT_INDEX_MASK 0x00001F00
#define SURFACETYPE0_EXIT_INDEX(data0) \
    (((data0) >> SURFACETYPE0_EXIT_INDEX_SHIFT) & (SURFACETYPE0_EXIT_INDEX_MASK >> SURFACETYPE0_EXIT_INDEX_SHIFT))

#define SURFACETYPE0_FLOOR_TYPE_SHIFT 13
#define SURFACETYPE0_FLOOR_TYPE_MASK 0x0003E000
#define SURFACETYPE0_FLOOR_TYPE(data0) \
    (((data0) >> SURFACETYPE0_FLOOR_TYPE_SHIFT) & (SURFACETYPE0_FLOOR_TYPE_MASK >> SURFACETYPE0_FLOOR_TYPE_SHIFT))

typedef enum {
    /*  0 */ SURFACETYPE_FLOOR_TYPE_0,
    /*  1 */ SURFACETYPE_FLOOR_TYPE_1,
    /*  2 */ SURFACETYPE_FLOOR_TYPE_2,
    /*  3 */ SURFACETYPE_FLOOR_TYPE_3,
    /*  4 */ SURFACETYPE_FLOOR_TYPE_4,
    /*  5 */ SURFACETYPE_FLOOR_TYPE_5,
    /*  6 */ SURFACETYPE_FLOOR_TYPE_6,
    /*  7 */ SURFACETYPE_FLOOR_TYPE_7,
    /*  8 */ SURFACETYPE_FLOOR_TYPE_8,
    /*  9 */ SURFACETYPE_FLOOR_TYPE_9,
    /* 10 */ SURFACETYPE_FLOOR_TYPE_10,
    /* 11 */ SURFACETYPE_FLOOR_TYPE_11,
    /* 12 */ SURFACETYPE_FLOOR_TYPE_12
...
#define SURFACETYPE0_WALL_TYPE_SHIFT 21
#define SURFACETYPE0_WALL_TYPE_MASK 0x03E00000
#define SURFACETYPE0_WALL_TYPE(data0) \
    (((data0) >> SURFACETYPE0_WALL_TYPE_SHIFT) & (SURFACETYPE0_WALL_TYPE_MASK >> SURFACETYPE0_WALL_TYPE_SHIFT))

typedef enum {
    /*  0 */ SURFACETYPE_WALL_TYPE_0,
    /*  1 */ SURFACETYPE_WALL_TYPE_1,
    /*  2 */ SURFACETYPE_WALL_TYPE_2,
    /*  3 */ SURFACETYPE_WALL_TYPE_3,
    /*  4 */ SURFACETYPE_WALL_TYPE_4,
    /*  5 */ SURFACETYPE_WALL_TYPE_5,
    /*  6 */ SURFACETYPE_WALL_TYPE_6,
    /*  7 */ SURFACETYPE_WALL_TYPE_7,
    /*  8 */ SURFACETYPE_WALL_TYPE_8,
    /*  9 */ SURFACETYPE_WALL_TYPE_9,
    /* 10 */ SURFACETYPE_WALL_TYPE_10,
    /* 11 */ SURFACETYPE_WALL_TYPE_11,
    /* 12 */ SURFACETYPE_WALL_TYPE_12,
    /* 32 */ SURFACETYPE_WALL_TYPE_MAX = 32
} SurfaceTypeWallType;

#define SURFACETYPE_WALL_FLAG_0 (1 << 0)
#define SURFACETYPE_WALL_FLAG_1 (1 << 1)
#define SURFACETYPE_WALL_FLAG_2 (1 << 2)
#define SURFACETYPE_WALL_FLAG_3 (1 << 3)
#define SURFACETYPE_WALL_FLAG_4 (1 << 4)
#define SURFACETYPE_WALL_FLAG_5 (1 << 5)
#define SURFACETYPE_WALL_FLAG_6 (1 << 6)

#define SURFACETYPE0_FLOOR_PROPERTY_SHIFT 26
#define SURFACETYPE0_FLOOR_PROPERTY_MASK 0x3C000000
#define SURFACETYPE0_FLOOR_PROPERTY(data0)            \
    (((data0) >> SURFACETYPE0_FLOOR_PROPERTY_SHIFT) & \
     (SURFACETYPE0_FLOOR_PROPERTY_MASK >> SURFACETYPE0_FLOOR_PROPERTY_SHIFT))

typedef enum {
    /*  0 */ SURFACETYPE_FLOOR_PROPERTY_0,
    /*  5 */ SURFACETYPE_FLOOR_PROPERTY_5 = 5,
    /*  6 */ SURFACETYPE_FLOOR_PROPERTY_6,
    /*  7 */ SURFACETYPE_FLOOR_PROPERTY_7,
    /*  8 */ SURFACETYPE_FLOOR_PROPERTY_8,
    /*  9 */ SURFACETYPE_FLOOR_PROPERTY_9,
    /* 11 */ SURFACETYPE_FLOOR_PROPERTY_11 = 11,
    /* 12 */ SURFACETYPE_FLOOR_PROPERTY_12
...
#define SURFACETYPE0_IS_HORSE_BLOCKED_SHIFT 31
#define SURFACETYPE0_IS_HORSE_BLOCKED_MASK 0x80000000
#define SURFACETYPE0_IS_HORSE_BLOCKED(data0)            \
    (((data0) >> SURFACETYPE0_IS_HORSE_BLOCKED_SHIFT) & \
     (SURFACETYPE0_IS_HORSE_BLOCKED_MASK >> SURFACETYPE0_IS_HORSE_BLOCKED_SHIFT))

// SurfaceType.data[1]

#define SURFACETYPE1_SFX_TYPE_SHIFT 0
#define SURFACETYPE1_SFX_TYPE_MASK 0x0000000F
#define SURFACETYPE1_SFX_TYPE(data1) \
    (((data1) >> SURFACETYPE1_SFX_TYPE_SHIFT) & (SURFACETYPE1_SFX_TYPE_MASK >> SURFACETYPE1_SFX_TYPE_SHIFT))

typedef enum {
    /*  0 */ SURFACETYPE_SFX_TYPE_0,
    /*  1 */ SURFACETYPE_SFX_TYPE_1,
    /*  2 */ SURFACETYPE_SFX_TYPE_2,
    /*  3 */ SURFACETYPE_SFX_TYPE_3,
    /*  4 */ SURFACETYPE_SFX_TYPE_4,
    /*  5 */ SURFACETYPE_SFX_TYPE_5,
    /*  6 */ SURFACETYPE_SFX_TYPE_6,
    /*  7 */ SURFACETYPE_SFX_TYPE_7,
    /*  8 */ SURFACETYPE_SFX_TYPE_8,
    /*  9 */ SURFACETYPE_SFX_TYPE_9,
    /* 10 */ SURFACETYPE_SFX_TYPE_10,
    /* 11 */ SURFACETYPE_SFX_TYPE_11,
    /* 12 */ SURFACETYPE_SFX_TYPE_12,
    /* 13 */ SURFACETYPE_SFX_TYPE_13,
    /* 14 */ SURFACETYPE_SFX_TYPE_MAX
} SurfaceTypeSfxType;

#define SURFACETYPE1_FLOOR_EFFECT_SHIFT 4
#define SURFACETYPE1_FLOOR_EFFECT_MASK 0x00000030
#define SURFACETYPE1_FLOOR_EFFECT(data1) \
    (((data1) >> SURFACETYPE1_FLOOR_EFFECT_SHIFT) & (SURFACETYPE1_FLOOR_EFFECT_MASK >> SURFACETYPE1_FLOOR_EFFECT_SHIFT))
...
#define SURFACETYPE1_LIGHT_SETTING_SHIFT 6
#define SURFACETYPE1_LIGHT_SETTING_MASK 0x000007C0
#define SURFACETYPE1_LIGHT_SETTING(data1)            \
    (((data1) >> SURFACETYPE1_LIGHT_SETTING_SHIFT) & \
     (SURFACETYPE1_LIGHT_SETTING_MASK >> SURFACETYPE1_LIGHT_SETTING_SHIFT))
...
#define SURFACETYPE1_CAN_HOOKSHOT_SHIFT 17
#define SURFACETYPE1_CAN_HOOKSHOT_MASK 0x00020000
#define SURFACETYPE1_CAN_HOOKSHOT(data1) \
    (((data1) >> SURFACETYPE1_CAN_HOOKSHOT_SHIFT) & (SURFACETYPE1_CAN_HOOKSHOT_MASK >> SURFACETYPE1_CAN_HOOKSHOT_SHIFT))

#define SURFACETYPE1_CONVEYOR_SPEED_SHIFT 18
#define SURFACETYPE1_CONVEYOR_SPEED_MASK 0x001C0000
#define SURFACETYPE1_CONVEYOR_SPEED(data1)            \
    (((data1) >> SURFACETYPE1_CONVEYOR_SPEED_SHIFT) & \
     (SURFACETYPE1_CONVEYOR_SPEED_MASK >> SURFACETYPE1_CONVEYOR_SPEED_SHIFT))

typedef enum {
    /*  0 */ SURFACETYPE_CONVEYOR_SPEED_DISABLED,
    /*  1 */ SURFACETYPE_CONVEYOR_SPEED_SLOW,
    /*  2 */ SURFACETYPE_CONVEYOR_SPEED_MEDIUM,
    /*  3 */ SURFACETYPE_CONVEYOR_SPEED_FAST,
    /*  4 */ SURFACETYPE_CONVEYOR_SPEED_MAX
} SurfaceTypeConveyorSpeed;

#define SURFACETYPE1_CONVEYOR_DIRECTION_SHIFT 21
#define SURFACETYPE1_CONVEYOR_DIRECTION_MASK 0x07E00000
#define SURFACETYPE1_CONVEYOR_DIRECTION(data1)            \
    (((data1) >> SURFACETYPE1_CONVEYOR_DIRECTION_SHIFT) & \
     (SURFACETYPE1_CONVEYOR_DIRECTION_MASK >> SURFACETYPE1_CONVEYOR_DIRECTION_SHIFT))

#define SURFACETYPE_CONVEYOR_DIRECTION_TO_BINANG(conveyorDirection) ((conveyorDirection) * (0x10000 / 64))
