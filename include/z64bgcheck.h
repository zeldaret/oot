...
typedef enum {
    ...
    /*  9 */ SURFACE_MATERIAL_CARPET,
    /* 10 */ SURFACE_MATERIAL_WOOD,
    /* 11 */ SURFACE_MATERIAL_BRIDGE, // WOOD_PLANK?
    /* 12 */ SURFACE_MATERIAL_VINE,
    /* 13 */ SURFACE_MATERIAL_IRON_BOOTS,
    /* 14 */ SURFACE_MATERIAL_UNUSED,
    /* 15 */ SURFACE_MATERIAL_ICE
} SurfaceMaterial;

typedef enum {
    /*  0 */ SURFACE_MATERIAL_SCENE_DIRT,
    /*  1 */ SURFACE_MATERIAL_SCENE_SAND,
    /*  2 */ SURFACE_MATERIAL_SCENE_STONE,
    /*  3 */ SURFACE_MATERIAL_SCENE_JABU,
    /*  4 */ SURFACE_MATERIAL_SCENE_WATER_SHALLOW,
    /*  5 */ SURFACE_MATERIAL_SCENE_WATER_DEEP,
    /*  6 */ SURFACE_MATERIAL_SCENE_TALL_GRASS,
    /*  7 */ SURFACE_MATERIAL_SCENE_LAVA, // MAGMA?
    /*  8 */ SURFACE_MATERIAL_SCENE_GRASS,
    /*  9 */ SURFACE_MATERIAL_SCENE_BRIDGE, // WOOD_PLANK?
    /* 10 */ SURFACE_MATERIAL_SCENE_WOOD,
    /* 11 */ SURFACE_MATERIAL_SCENE_DIRT_SOFT,
    /* 12 */ SURFACE_MATERIAL_SCENE_ICE,
    /* 13 */ SURFACE_MATERIAL_SCENE_CARPET,
    /* 14 */ SURFACE_MATERIAL_SCENE_MAX
} SurfaceMaterialScene;
