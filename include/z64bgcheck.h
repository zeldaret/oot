...
typedef enum {
    /*  0 */ SURFACETYPE_CONVEYORSPEED_DISABLED,
    /*  1 */ SURFACETYPE_CONVEYORSPEED_SLOW,
    /*  2 */ SURFACETYPE_CONVEYORSPEED_MEDIUM,
    /*  3 */ SURFACETYPE_CONVEYORSPEED_FAST,
    /*  4 */ SURFACETYPE_CONVEYORSPEED_MAX
...
#define SURFACETYPE_CONVEYORDIRECTION_TO_BINANG(conveyorDirection) ((conveyorDirection) * (0x10000 / 64))
