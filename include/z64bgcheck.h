...
#define SURFACETYPE0_SCENEEXITINDEX_SHIFT 8
#define SURFACETYPE0_SCENEEXITINDEX_MASK 0x00001F00
#define SURFACETYPE0_SCENEEXITINDEX(data0)            \
    (((data0) >> SURFACETYPE0_SCENEEXITINDEX_SHIFT) & \
     (SURFACETYPE0_SCENEEXITINDEX_MASK >> SURFACETYPE0_SCENEEXITINDEX_SHIFT))

#define SURFACETYPE0_13_SHIFT 13
#define SURFACETYPE0_13_MASK 0x0003E000
#define SURFACETYPE0_13(data0) (((data0) >> SURFACETYPE0_13_SHIFT) & (SURFACETYPE0_13_MASK >> SURFACETYPE0_13_SHIFT))
...
#define SURFACETYPE0_21_SHIFT 21
#define SURFACETYPE0_21_MASK 0x03E00000
#define SURFACETYPE0_21(data0) (((data0) >> SURFACETYPE0_21_SHIFT) & (SURFACETYPE0_21_MASK >> SURFACETYPE0_21_SHIFT))
...
#define SURFACETYPE0_30_SHIFT 30
#define SURFACETYPE0_30_MASK 0x40000000
#define SURFACETYPE0_30(data0) (((data0) >> SURFACETYPE0_30_SHIFT) & (SURFACETYPE0_30_MASK >> SURFACETYPE0_30_SHIFT))
...
#define SURFACETYPE1_0_SHIFT 0
#define SURFACETYPE1_0_MASK 0x0000000F
#define SURFACETYPE1_0(data1) (((data1) >> SURFACETYPE1_0_SHIFT) & (SURFACETYPE1_0_MASK >> SURFACETYPE1_0_SHIFT))

#define SURFACETYPE1_SLOPE_SHIFT 4
#define SURFACETYPE1_SLOPE_MASK 0x00000030
#define SURFACETYPE1_SLOPE(data1) \
    (((data1) >> SURFACETYPE1_SLOPE_SHIFT) & (SURFACETYPE1_SLOPE_MASK >> SURFACETYPE1_SLOPE_SHIFT))

#define SURFACETYPE1_LIGHTSETTINGINDEX_SHIFT 6
#define SURFACETYPE1_LIGHTSETTINGINDEX_MASK 0x000007C0
#define SURFACETYPE1_LIGHTSETTINGINDEX(data1)            \
    (((data1) >> SURFACETYPE1_LIGHTSETTINGINDEX_SHIFT) & \
     (SURFACETYPE1_LIGHTSETTINGINDEX_MASK >> SURFACETYPE1_LIGHTSETTINGINDEX_SHIFT))
...
#define SURFACETYPE1_ISHOOKSHOTSURFACE_SHIFT 17
#define SURFACETYPE1_ISHOOKSHOTSURFACE_MASK 0x00020000
#define SURFACETYPE1_ISHOOKSHOTSURFACE(data1)            \
    (((data1) >> SURFACETYPE1_ISHOOKSHOTSURFACE_SHIFT) & \
     (SURFACETYPE1_ISHOOKSHOTSURFACE_MASK >> SURFACETYPE1_ISHOOKSHOTSURFACE_SHIFT))
...
#define SURFACETYPE1_WALLDAMAGE_SHIFT 27
#define SURFACETYPE1_WALLDAMAGE_FLAG (1 << SURFACETYPE1_WALLDAMAGE_SHIFT)
#define SURFACETYPE1_WALLDAMAGE(data1) ((data1) & SURFACETYPE1_WALLDAMAGE_FLAG ? true : false)
