...
} CutsceneDestinationOld;

typedef enum {
    /* 0x00 */ CS_DEST_UNIMPLEMENTED_0,
    /* 0x01 */ CS_DEST_CUTSCENE_MAP_GANON_HORSE,
    /* 0x02 */ CS_DEST_CUTSCENE_MAP_THREE_GODESSES_POST_DEKU_TREE,
    /* 0x03 */ CS_DEST_GERUDO_VALLEY_DIN,
    ...
    /* 0x08 */ CS_DEST_TEMPLE_OF_TIME_AFTER_USE_MS,
    /* 0x09 */ CS_DEST_GERUDO_VALLEY_DIN_2,
    /* 0x0A */ CS_DEST_LINKS_HOUSE_INTRO,
    /* 0x0B */ CS_DEST_KOKIRI_FOREST_INTRO,
    /* 0x0C */ CS_DEST_DEATH_MOUNTAIN_TRAIL_AFTER_GORON_RUBY,
    /* 0x0D */ CS_DEST_ZORAS_FOUNTAIN_AFTER_ZORAS_SAPPHIRE,
    /* 0x0E */ CS_DEST_KOKIRI_FOREST_AFTER_KOKIRI_EMERALD,
    /* 0x0F */ CS_DEST_TEMPLE_OF_TIME_KOKIRI_EMERALD, //unused
    /* 0x10 */ CS_DEST_TEMPLE_OF_TIME_GORON_RUBY, //unused
    /* 0x11 */ CS_DEST_TEMPLE_OF_TIME_ZORAS_SAPPHIRE, //unused
    /* 0x12 */ CS_DEST_TEMPLE_OF_TIME_AFTER_USE_MS_FIRST,
    /* 0x13 */ CS_DEST_DEATH_MOUNTAIN_TRAIL_AFTER_INTRO,
    /* 0x14 */ CS_DEST_UNIMPLEMENTED_14,
    /* 0x15 */ CS_DEST_LAKE_HYLIA_WATER_RISES,
    /* 0x16 */ CS_DEST_DESERT_COLOSSUS_REQUIEM,
    /* 0x17 */ CS_DEST_CUTSCENE_MAP_CURSE_YOU,
    /* 0x18 */ CS_DEST_JABU_JABU_INTRO,
    /* 0x19 */ CS_DEST_CHAMBER_OF_SAGES_LIGHT_MEDALLION,
    /* 0x1A */ CS_DEST_TEMPLE_OF_TIME_KOKIRI_EMERALD_2, //duplicate of 0x000F
    /* 0x1B */ CS_DEST_TEMPLE_OF_TIME_GORON_RUBY_2, //duplicate of 0x0010
    /* 0x1C */ CS_DEST_TEMPLE_OF_TIME_ZORAS_SAPPHIRE_2, //duplicate of 0x0011
    ...
    /* 0x20 */ CS_DEST_HYRULE_FIELD_FLASHBACK, //lacs part 4
    /* 0x21 */ CS_DEST_HYRULE_FIELD_AFTER_LAKE_HYLIA_OWL,
    /* 0x22 */ CS_DEST_CUTSCENE_MAP_GANON_AFTER_USE_MS,
    /* 0x23 */ CS_DEST_HYRULE_FIELD_INTRO_ZELDA_ESCAPE,
    /* 0x24 */ CS_DEST_UNIMPLEMENTED_24,
    /* 0x25 */ CS_DEST_UNIMPLEMENTED_25,
    /* 0x26 */ CS_DEST_CUTSCENE_MAP_SHEIKAH_LEGEND, //lacs part 2
    /* 0x27 */ CS_DEST_TEMPLE_OF_TIME_ZELDA_REVEAL, //lacs part 3
    /* 0x28 */ CS_DEST_TEMPLE_OF_TIME_GET_LIGHT_ARROWS, //lacs part 5
    /* 0x29 */ CS_DEST_LAKE_HYLIA_AFTER_BLUE_WARP,
    /* 0x2A */ CS_DEST_KAKARIKO_VILLAGE_DRAIN_WELL,
    /* 0x2B */ CS_DEST_WINDMILL_AFTER_DRAIN_WELL,
    /* 0x2C */ CS_DEST_TEMPLE_OF_TIME_AFTER_DOOR_OF_TIME_OPENS,
    /* 0x2D */ CS_DEST_UNIMPLEMENTED_2D,
    /* 0x2E */ CS_DEST_TEMPLE_OF_TIME_AFTER_USE_MS_FIRST_2, // duplicate of 0x0012
    /* 0x2F */ CS_DEST_KAKARIKO_VILLAGE_NOCTURNE_PART_2,
    /* 0x30 */ CS_DEST_DESERT_COLOSSUS_AFTER_REQUIEM,
    /* 0x31 */ CS_DEST_TEMPLE_OF_TIME_AFTER_LIGHT_ARROWS,
    /* 0x32 */ CS_DEST_KAKARIKO_VILLAGE_AFTER_NOCTURNE,
    /* 0x33 */ CS_DEST_HYRULE_FIELD_IMPA_ESCORT_CS,
    /* 0x34 */ CS_DEST_TEMPLE_OF_TIME_SONG_OF_TIME,
    /* 0x35 */ CS_DEST_HYRULE_FIELD_AFTER_SONG_OF_TIME,
    /* 0x36 */ CS_DEST_GERUDO_VALLEY_CREDITS,
    /* 0x37 */ CS_DEST_GERUDO_FORTRESS_CREDITS,
    /* 0x38 */ CS_DEST_KAKARIKO_VILLAGE_CREDITS,
    /* 0x39 */ CS_DEST_DEATH_MOUNTAIN_TRAIL_CREDITS_1,
    /* 0x3A */ CS_DEST_GORON_CITY_CREDITS, // unused?
    /* 0x3B */ CS_DEST_LAKE_HYLIA_CREDITS,
    /* 0x3C */ CS_DEST_ZORAS_FOUNTAIN_CREDITS, // unused
    /* 0x3D */ CS_DEST_ZORAS_DOMAIN_CREDITS,
    /* 0x3E */ CS_DEST_KOKIRI_FOREST_CREDITS_1,
    /* 0x3F */ CS_DEST_KOKIRI_FOREST_CREDITS_2,
    /* 0x40 */ CS_DEST_HYRULE_FIELD_CREDITS,
    /* 0x41 */ CS_DEST_LON_LON_RANCH_CREDITS_1,
    /* 0x42 */ CS_DEST_KAKARIKO_VILLAGE_AFTER_TRAIL_OWL,
    /* 0x43 */ CS_DEST_HTRULE_FIELD_UNUSED_ENTRANCE,
    /* 0x44 */ CS_DEST_CUTSCENE_MAP_WALL_OF_FIRE,
    /* 0x45 */ CS_DEST_KOKIRI_FOREST_POST_FOREST_MEDALLION,
    /* 0x46 */ CS_DEST_DEATH_MOUNTAIN_TRAIL_CREDITS_2,
    /* 0x47 */ CS_DEST_TEMPLE_OF_TIME_CREDITS,
    /* 0x48 */ CS_DEST_ZELDAS_COURTYARD_CREDITS,
    /* 0x49 */ CS_DEST_LON_LON_RANCH_CREDITS_1_2, // duplicate of 0x0041
    /* 0x4A */ CS_DEST_LON_LON_RANCH_CREDITS_2,
    /* 0x4B */ CS_DEST_LON_LON_RANCH_CREDITS_3,
    /* 0x4C */ CS_DEST_LON_LON_RANCH_CREDITS_4,
    /* 0x4D */ CS_DEST_LON_LON_RANCH_CREDITS_5,
    /* 0x4E */ CS_DEST_LON_LON_RANCH_CREDITS_6,
    /* 0x4F */ CS_DEST_LON_LON_RANCH_NO_CS_1,
    /* 0x50 */ CS_DEST_LON_LON_RANCH_NO_CS_2,
    /* 0x51 */ CS_DEST_LON_LON_RANCH_NO_CS_3,
    /* 0x52 */ CS_DEST_LON_LON_RANCH_NO_CS_4,
    /* 0x53 */ CS_DEST_LON_LON_RANCH_NO_CS_5,
    /* 0x54 */ CS_DEST_LON_LON_RANCH_NO_CS_6,
    /* 0x55 */ CS_DEST_LON_LON_RANCH_NO_CS_7,
    /* 0x56 */ CS_DEST_LON_LON_RANCH_NO_CS_8,
    /* 0x57 */ CS_DEST_LON_LON_RANCH_NO_CS_9,
    /* 0x58 */ CS_DEST_LON_LON_RANCH_NO_CS_10,
    /* 0x59 */ CS_DEST_LON_LON_RANCH_NO_CS_11,
    /* 0x5A */ CS_DEST_LON_LON_RANCH_NO_CS_12,
    /* 0x5B */ CS_DEST_LON_LON_RANCH_NO_CS_13,
    /* 0x5C */ CS_DEST_LON_LON_RANCH_NO_CS_14,
    /* 0x5D */ CS_DEST_LON_LON_RANCH_NO_CS_15,
    /* 0x5E */ CS_DEST_LON_LON_RANCH_NO_CS_EPONAS_SONG,
    /* 0x5F */ CS_DEST_CONDITIONAL_DESTINATION, // TODO more descriptive name?
    /* 0x60 */ CS_DEST_DESERT_COLOSSUS_SPIRIT_BLUE_WARP,
    /* 0x61 */ CS_DEST_GRAVEYARD_AFTER_SHADOW_BLUE_WARP,
    /* 0x62 */ CS_DEST_DEATH_MOUNTAIN_CRATER_AFTER_FIRE_BLUE_WARP,
    /* 0x63 */ CS_DEST_SACRED_FOREST_MEADOW_AFTER_FOREST_BLUE_WARP,
    /* 0x64 */ CS_DEST_KOKIRI_FOREST_AFTER_FOREST_BLUE_WARP,
    /* 0x65 */ CS_DEST_DESERT_COLOSSUS_AFTER_SILVER_GAUNTLETS,
    /* 0x66 */ CS_DEST_TEMPLE_OF_TIME_FRONT_OF_PEDESTAL,
    /* 0x67 */ CS_DEST_HYRULE_FIELD_TITLE_SCREEN,
    /* 0x68 */ CS_DEST_SPIRIT_TEMPLE_BOSS_TITLE_SCREEN,
    /* 0x69 */ CS_DEST_GRAVEYARD_SUNS_SONG,
    /* 0x6A */ CS_DEST_ROYAL_FAMILYS_TOMB_SUNS_SONG,
    /* 0x6B */ CS_DEST_GANONS_CASTLE_AFTER_FOREST_TRIAL,
    /* 0x6C */ CS_DEST_GANONS_CASTLE_AFTER_WATER_TRIAL,
    /* 0x6D */ CS_DEST_GANONS_CASTLE_AFTER_SHADOW_TRIAL,
    /* 0x6E */ CS_DEST_GANONS_CASTLE_AFTER_FIRE_TRIAL,
    /* 0x6F */ CS_DEST_GANONS_CASTLE_AFTER_LIGHT_TRIAL,
    /* 0x70 */ CS_DEST_GANONS_CASTLE_AFTER_SPIRIT_TRIAL,
    /* 0x71 */ CS_DEST_GANONS_CASTLE_DISPEL_BARRIER_IF_CONDITIONS,
    /* 0x72 */ CS_DEST_HYRULE_FIELD_INTRO,
    /* 0x73 */ CS_DEST_HYRULE_FIELD_AFTER_IMPA_ESCORT,
    /* 0x74 */ CS_DEST_DESERT_COLOSSUS_SPIRIT_BLUE_WARP_2,
    /* 0x75 */ CS_DEST_HYRULE_FIELD_SKY,
