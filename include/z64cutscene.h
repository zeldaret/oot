...
typedef enum {
    ...
    /* 0x0D */ SONG_OF_STORMS,
    /* 0x0E */ UNK_E,
    /* 0x0F */ MINUET_PLAYBACK,
    /* 0x10 */ BOLERO_PLAYBACK,
    /* 0x11 */ SERENADE_PLAYBACK,
    /* 0x12 */ REQUIEM_PLAYBACK,
    /* 0013 */ NOCTURNE_PLAYBACK,
    /* 0x14 */ PRELUDE_PLAYBACK,
    /* 0x15 */ SARIAS_SONG_PLAYBACK,
    /* 0x16 */ EPONAS_SONG_PLAYBACK,
    /* 0x17 */ ZELDAS_LULLABY_PLAYBACK,
    /* 0x18 */ SUNS_SONG_PLAYBACK,
    /* 0x19 */ SONG_OF_TIME_PLAYBACK,
    /* 0x1A */ SONG_OF_STORMS_PLAYBACK
...
typedef enum {
    ...
    /* 0x27 */ TEMPPLE_OF_TIME_ZELDA_REVEAL, //lacs part 3
