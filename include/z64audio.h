...
typedef struct {
    /* 0x00 */ u8 priority;
    /* 0x01 */ u8 waveId;
    /* 0x02 */ u8 logHarmonic; // the log of the harmonic for the synthetic wave generated by gWaveSamples
    /* 0x03 */ u8 fontId;
    /* 0x04 */ u8 unk_04;
...
typedef struct {
    ...
    /* 0x05 */ u8 reverbVol;
    /* 0x06 */ u8 logHarmonicCurAndPrev; // upper 2 bits store curLogHarmonic, lower 2 bits store prevLogHarmonic
    /* 0x07 */ u8 unk_07;
