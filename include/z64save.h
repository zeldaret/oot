...
#define INFTABLE_SPOKE_TO_DODONGOS_CAVERN_ENTRANCE_GORON 0xE0
#define INFTABLE_SPOKE_TO_GC_STAIRWELL_GORON 0xE3
#define INFTABLE_SPOKE_TO_LOST_WOODS_SHORTCUT_GORON 0xE6
#define INFTABLE_SPOKE_TO_DMT_BOMB_FLOWER_GORON 0xEB
#define INFTABLE_SPOKE_TO_GC_ENTRANCE_GORON 0xF0
#define INFTABLE_SPOKE_TO_GC_ISLAND_GORON 0xF4
#define INFTABLE_SPOKE_TO_DARUNIA_DOOR_GORON 0xF8
...
#define INFTABLE_ACQUIRED_BOMB_BAG_UPGRADE_FROM_HOT_RODDER_GORON 0x11E
