...
typedef struct {
    ...
    /* 0x13F6 */ s16 magicFillTarget; // target used to fill magic. Target can either be capacity for Magic_Fill and upgrades, or previous magic from a save and quit during a load from file-select
