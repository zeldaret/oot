...
/* 01278 80A965C8 3C0E80A9 */  lui     $t6, %hi(EnKarebaba_DeadItemDrop)    ## $t6 = 80A90000
/* 0127C 80A965CC 25CE6048 */  addiu   $t6, $t6, %lo(EnKarebaba_DeadItemDrop) ## $t6 = 80A96048
...
.L80A96658:
/* 01308 80A96658 3C0B80A9 */  lui     $t3, %hi(EnKarebaba_Wait)    ## $t3 = 80A90000
...
/* 01360 80A966B0 3C0C80A9 */  lui     $t4, %hi(EnKarebaba_Regrow)    ## $t4 = 80A90000
/* 01364 80A966B4 258C61DC */  addiu   $t4, $t4, %lo(EnKarebaba_Regrow) ## $t4 = 80A961DC
/* 01368 80A966B8 11820004 */  beq     $t4, $v0, .L80A966CC
/* 0136C 80A966BC 3C0D80A9 */  lui     $t5, %hi(EnKarebaba_Grow)    ## $t5 = 80A90000
/* 01370 80A966C0 25AD5940 */  addiu   $t5, $t5, %lo(EnKarebaba_Grow) ## $t5 = 80A95940
...
/* 013D4 80A96724 3C0380A9 */  lui     $v1, %hi(EnKarebaba_Dying)    ## $v1 = 80A90000
/* 013D8 80A96728 24635D90 */  addiu   $v1, $v1, %lo(EnKarebaba_Dying) ## $v1 = 80A95D90
...
/* 013F8 80A96748 3C0980A9 */  lui     $t1, %hi(DisplayLists)       ## $t1 = 80A90000
/* 013FC 80A9674C 25316A6C */  addiu   $s1, $t1, %lo(DisplayLists)  ## $s1 = 80A96A6C
...
/* 01464 80A967B4 3C1980A9 */  lui     $t9, %hi(DisplayLists)       ## $t9 = 80A90000
...
/* 01478 80A967C8 27396A6C */  addiu   $t9, $t9, %lo(DisplayLists)  ## $t9 = 80A96A6C
...
/* 01650 80A969A0 0C2A5913 */  jal     EnKarebaba_DrawCenterShadow
