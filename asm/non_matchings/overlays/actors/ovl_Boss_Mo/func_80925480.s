...
/* 09A10 80925510 3C120402 */  lui     $s2, %hi(gEffectWaterRippleDL)                ## $s2 = 04020000
...
/* 09A20 80925520 265254B0 */  addiu   $s2, $s2, %lo(gEffectWaterRippleDL)           ## $s2 = 040254B0
...
/* 09B1C 8092561C 3C120402 */  lui     $s2, %hi(gEffectShockwaveDL)                ## $s2 = 04020000
...
/* 09B2C 8092562C 2652A0B0 */  addiu   $s2, $s2, %lo(gEffectShockwaveDL)           ## $s2 = 0401A0B0
...
/* 09C58 80925758 3C020405 */  lui     $v0, %hi(gDustTex1)                ## $v0 = 04050000
/* 09C5C 8092575C 24421DB0 */  addiu   $v0, $v0, %lo(gDustTex1)           ## $v0 = 04051DB0
...
/* 09E18 80925918 3C020405 */  lui     $v0, %hi(gDustTex1)                ## $v0 = 04050000
/* 09E1C 8092591C 24421DB0 */  addiu   $v0, $v0, %lo(gDustTex1)           ## $v0 = 04051DB0
