...
/* 00DC8 80950088 3C0D8096 */  lui     $t5, %hi(sDamageTable)       ## $t5 = 80960000
...
/* 00E60 80950120 3C018096 */  lui     $at, %hi(sDoorState)       ## $at = 80960000
/* 00E64 80950124 A42C6934 */  sh      $t4, %lo(sDoorState)($at)
...
.L80950138:
/* 00E78 80950138 25ADC200 */  addiu   $t5, $t5, %lo(sDamageTable)  ## $t5 = FFFFC200
...
/* 00EA8 80950168 3C018096 */  lui     $at, %hi(sDoorState)       ## $at = 80960000
/* 00EAC 8095016C 24090064 */  addiu   $t1, $zero, 0x0064         ## $t1 = 00000064
/* 00EB0 80950170 A4296934 */  sh      $t1, %lo(sDoorState)($at)
...
/* 00EF4 809501B4 3C108096 */  lui     $s0, %hi(sCsCamera)       ## $s0 = 80960000
/* 00EF8 809501B8 2610C23C */  addiu   $s0, $s0, %lo(sCsCamera)  ## $s0 = 8095C23C
...
/* 00F30 809501F0 3C078096 */  lui     $a3, %hi(sCameraEye)       ## $a3 = 80960000
/* 00F34 809501F4 3C01C1A0 */  lui     $at, 0xC1A0                ## $at = C1A00000
/* 00F38 809501F8 44815000 */  mtc1    $at, $f10                  ## $f10 = -20.00
/* 00F3C 809501FC 24E768D8 */  addiu   $a3, $a3, %lo(sCameraEye)  ## $a3 = 809668D8
...
/* 00F4C 8095020C 3C068096 */  lui     $a2, %hi(sCameraAt)       ## $a2 = 80960000
...
/* 00F5C 8095021C 24C668E8 */  addiu   $a2, $a2, %lo(sCameraAt)  ## $a2 = 809668E8
/* 00F60 80950220 E4EA0008 */  swc1    $f10, 0x0008($a3)          ## 809668E0
/* 00F64 80950224 3C038096 */  lui     $v1, %hi(sCameraNextEye)       ## $v1 = 80960000
...
/* 00F7C 8095023C 246368F8 */  addiu   $v1, $v1, %lo(sCameraNextEye)  ## $v1 = 809668F8
/* 00F80 80950240 3C088096 */  lui     $t0, %hi(sCameraNextAt)       ## $t0 = 80960000
...
/* 00FA8 80950268 25086908 */  addiu   $t0, $t0, %lo(sCameraNextAt)  ## $t0 = 80966908
...
/* 00FC8 80950288 3C108096 */  lui     $s0, %hi(sInitPos+180)       ## $s0 = 80960000
/* 00FCC 8095028C 3C118096 */  lui     $s1, %hi(sInitRot+90)       ## $s1 = 80960000
/* 00FD0 80950290 AE6C0198 */  sw      $t4, 0x0198($s3)           ## 00000198
/* 00FD4 80950294 2631C1D6 */  addiu   $s1, $s1, %lo(sInitRot+90)  ## $s1 = 8095C1D6
/* 00FD8 80950298 2610C0F8 */  addiu   $s0, $s0, %lo(sInitPos+180)  ## $s0 = 8095C0F8
...
/* 0106C 8095032C 3C0D8096 */  lui     $t5, %hi(sZeroVec)       ## $t5 = 80960000
/* 01070 80950330 25ADC220 */  addiu   $t5, $t5, %lo(sZeroVec)  ## $t5 = 8095C220
/* 01074 80950334 8DAF0000 */  lw      $t7, 0x0000($t5)           ## 8095C220
/* 01078 80950338 27A2005C */  addiu   $v0, $sp, 0x005C           ## $v0 = FFFFFFE4
/* 0107C 8095033C 3C188096 */  lui     $t8, %hi(sCameraEyeMaxVel)       ## $t8 = 80960000
...
/* 0108C 8095034C 27186918 */  addiu   $t8, $t8, %lo(sCameraEyeMaxVel)  ## $t8 = 80966918
/* 01090 80950350 AC4E0004 */  sw      $t6, 0x0004($v0)           ## FFFFFFE8
/* 01094 80950354 8DAF0008 */  lw      $t7, 0x0008($t5)           ## 8095C228
/* 01098 80950358 3C0A8096 */  lui     $t2, %hi(sCameraAtMaxVel)       ## $t2 = 80960000
/* 0109C 8095035C 254A6928 */  addiu   $t2, $t2, %lo(sCameraAtMaxVel)  ## $t2 = 80966928
...
/* 010D8 80950398 3C018096 */  lui     $at, %hi(sCsState)       ## $at = 80960000
/* 010DC 8095039C A02D68D2 */  sb      $t5, %lo(sCsState)($at)
/* 010E0 809503A0 3C018096 */  lui     $at, %hi(sDoorState)       ## $at = 80960000
/* 010E4 809503A4 240E0005 */  addiu   $t6, $zero, 0x0005         ## $t6 = 00000005
/* 010E8 809503A8 A42E6934 */  sh      $t6, %lo(sDoorState)($at)
.L809503AC:
...
/* 01108 809503C8 3C078096 */  lui     $a3, %hi(sCylinderInit)       ## $a3 = 80960000
/* 0110C 809503CC 24E7BF60 */  addiu   $a3, $a3, %lo(sCylinderInit)  ## $a3 = 8095BF60
/* 01110 809503D0 02802025 */  or      $a0, $s4, $zero            ## $a0 = 00000000
/* 01114 809503D4 02002825 */  or      $a1, $s0, $zero            ## $a1 = 0000028C
/* 01118 809503D8 0C01712B */  jal     Collider_SetCylinder

/* 0111C 809503DC 02603025 */  or      $a2, $s3, $zero            ## $a2 = 00000000
/* 01120 809503E0 3C108096 */  lui     $s0, %hi(sInitPos+60)       ## $s0 = 80960000
/* 01124 809503E4 3C118096 */  lui     $s1, %hi(sInitRot+30)       ## $s1 = 80960000
/* 01128 809503E8 2631C19A */  addiu   $s1, $s1, %lo(sInitRot+30)  ## $s1 = 8095C19A
/* 0112C 809503EC 2610C080 */  addiu   $s0, $s0, %lo(sInitPos+60)  ## $s0 = 8095C080
...
/* 011BC 8095047C 3C048096 */  lui     $a0, %hi(sEffects)       ## $a0 = 80960000
/* 011C0 80950480 2484DF50 */  addiu   $a0, $a0, %lo(sEffects)  ## $a0 = 8095DF50
...
/* 011D0 80950490 3C0F8096 */  lui     $t7, %hi(sCsState)       ## $t7 = 80960000
/* 011D4 80950494 81EF68D2 */  lb      $t7, %lo(sCsState)($t7)
/* 011D8 80950498 29E1000D */  slti    $at, $t7, 0x000D
/* 011DC 8095049C 10200005 */  beq     $at, $zero, .L809504B4
/* 011E0 809504A0 00000000 */  nop
/* 011E4 809504A4 0C2541BC */  jal     BossVa_SetupIntro
...
.L809504B4:
/* 011F4 809504B4 0C2545E8 */  jal     BossVa_SetupBodyPhase1
...
/* 0120C 809504CC 0C016EFE */  jal     Collider_InitJntSph
/* 01210 809504D0 02802025 */  or      $a0, $s4, $zero            ## $a0 = 00000000
/* 01214 809504D4 3C078096 */  lui     $a3, %hi(sJntSphInit1)       ## $a3 = 80960000
/* 01218 809504D8 267802F8 */  addiu   $t8, $s3, 0x02F8           ## $t8 = 000002F8
/* 0121C 809504DC AFB80010 */  sw      $t8, 0x0010($sp)
/* 01220 809504E0 24E7BFB0 */  addiu   $a3, $a3, %lo(sJntSphInit1)  ## $a3 = 8095BFB0
/* 01224 809504E4 02802025 */  or      $a0, $s4, $zero            ## $a0 = 00000000
/* 01228 809504E8 02002825 */  or      $a1, $s0, $zero            ## $a1 = 000002D8
/* 0122C 809504EC 0C017014 */  jal     Collider_SetJntSph
/* 01230 809504F0 02603025 */  or      $a2, $s3, $zero            ## $a2 = 00000000
/* 01234 809504F4 3C198096 */  lui     $t9, %hi(sCsState)       ## $t9 = 80960000
/* 01238 809504F8 833968D2 */  lb      $t9, %lo(sCsState)($t9)
...
/* 01250 80950510 0C254FD3 */  jal     BossVa_SetupSupportIntro
...
.L80950520:
/* 01260 80950520 0C255039 */  jal     BossVa_SetupSupportPhase1
...
/* 01288 80950548 3C078096 */  lui     $a3, %hi(sQuadInit)       ## $a3 = 80960000
/* 0128C 8095054C 24E7BFF4 */  addiu   $a3, $a3, %lo(sQuadInit)  ## $a3 = 8095BFF4
/* 01290 80950550 02802025 */  or      $a0, $s4, $zero            ## $a0 = 00000000
/* 01294 80950554 02002825 */  or      $a1, $s0, $zero            ## $a1 = 00000338
/* 01298 80950558 0C017441 */  jal     Collider_SetQuad
/* 0129C 8095055C 02603025 */  or      $a2, $s3, $zero            ## $a2 = 00000000
/* 012A0 80950560 3C0B8096 */  lui     $t3, %hi(sCsState)       ## $t3 = 80960000
/* 012A4 80950564 816B68D2 */  lb      $t3, %lo(sCsState)($t3)
...
/* 012BC 8095057C 0C25528F */  jal     BossVa_SetupZapperIntro
...
.L8095058C:
/* 012CC 8095058C 0C2552E3 */  jal     BossVa_SetupZapperAttack
...
/* 012E0 809505A0 0C255249 */  jal     BossVa_SetupStump
...
/* 012F4 809505B4 0C255F27 */  jal     BossVa_SetupDoor
...
/* 01344 80950604 3C078096 */  lui     $a3, %hi(sQuadInit)       ## $a3 = 80960000
/* 01348 80950608 24E7BFF4 */  addiu   $a3, $a3, %lo(sQuadInit)  ## $a3 = 8095BFF4
/* 0134C 8095060C 02802025 */  or      $a0, $s4, $zero            ## $a0 = 00000000
/* 01350 80950610 02002825 */  or      $a1, $s0, $zero            ## $a1 = 00000338
/* 01354 80950614 0C017441 */  jal     Collider_SetQuad
...
/* 01364 80950624 3C0D8096 */  lui     $t5, %hi(sCsState)       ## $t5 = 80960000
...
/* 01374 80950634 81AD68D2 */  lb      $t5, %lo(sCsState)($t5)
/* 01378 80950638 3C0E8096 */  lui     $t6, %hi(sFightProgress)       ## $t6 = 80960000
/* 0137C 8095063C 29A1000D */  slti    $at, $t5, 0x000D
/* 01380 80950640 10200005 */  beq     $at, $zero, .L80950658
/* 01384 80950644 00000000 */  nop
/* 01388 80950648 0C2559F4 */  jal     BossVa_SetupBariIntro
...
.L80950658:
/* 01398 80950658 91CE68D1 */  lbu     $t6, %lo(sFightProgress)($t6)
