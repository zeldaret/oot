...
/* 06FA0 808391B0 3C198016 */  lui     $t9, %hi(gSaveContext+0x1394)
/* 06FA4 808391B4 3C018016 */  lui     $at, %hi(gSaveContext+0x1364)
/* 06FA8 808391B8 AC2FF9C4 */  sw      $t7, %lo(gSaveContext+0x1364)($at)
/* 06FAC 808391BC 8739F9F4 */  lh      $t9, %lo(gSaveContext+0x1394)($t9)
...
/* 06FCC 808391DC 3C018016 */  lui     $at, %hi(gSaveContext+0x141d)
/* 06FD0 808391E0 1000002A */  beq     $zero, $zero, .L8083928C   
/* 06FD4 808391E4 A022FA7D */  sb      $v0, %lo(gSaveContext+0x141d)($at)
.L808391E8:
...
/* 07048 80839258 3C018016 */  lui     $at, %hi(gSaveContext+0x1378)
/* 0704C 8083925C 8FA40040 */  lw      $a0, 0x0040($sp)           
/* 07050 80839260 0C0302D8 */  jal     Gameplay_TriggerVoidOut              
/* 07054 80839264 A42CF9D8 */  sh      $t4, %lo(gSaveContext+0x1378)($at)
/* 07058 80839268 240EFFFE */  addiu   $t6, $zero, 0xFFFE         ## $t6 = FFFFFFFE
/* 0705C 8083926C 3C018016 */  lui     $at, %hi(gSaveContext+0x1364)
/* 07060 80839270 AC2EF9C4 */  sw      $t6, %lo(gSaveContext+0x1364)($at)
.L80839274:
/* 07064 80839274 240F0001 */  addiu   $t7, $zero, 0x0001         ## $t7 = 00000001
/* 07068 80839278 3C018016 */  lui     $at, %hi(gSaveContext+0x13c3)
/* 0706C 8083927C A02FFA23 */  sb      $t7, %lo(gSaveContext+0x13c3)($at)
...
/* 07110 80839320 3C038016 */  lui     $v1, %hi(gSaveContext)
/* 07114 80839324 2463E660 */  addiu   $v1, %lo(gSaveContext)
...
/* 07130 80839340 3C198016 */  lui     $t9, %hi(gGameInfo)
...
.L80839370:
/* 07160 80839370 8F39FA90 */  lw      $t9, %lo(gGameInfo)($t9)
...
/* 0718C 8083939C 3C018016 */  lui     $at, %hi(gSaveContext+0x13bc)
/* 07190 808393A0 10000003 */  beq     $zero, $zero, .L808393B0   
/* 07194 808393A4 E422FA1C */  swc1    $f2, %lo(gSaveContext+0x13bc)($at)
.L808393A8:
/* 07198 808393A8 3C018016 */  lui     $at, %hi(gSaveContext+0x13bc)
/* 0719C 808393AC E420FA1C */  swc1    $f0, %lo(gSaveContext+0x13bc)($at)
.L808393B0:
