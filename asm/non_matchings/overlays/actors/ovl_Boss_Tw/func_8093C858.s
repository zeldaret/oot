glabel BossTw_TwinrovaWaitForMerge
...
/* 03BA4 8093C874 3C038095 */  lui     $v1, %hi(koumePtr)       ## $v1 = 80950000
/* 03BA8 8093C878 8C63C848 */  lw      $v1, %lo(koumePtr)($v1)  
...
/* 03BB8 8093C888 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 03BBC 8093C88C 544F0016 */  bnel    $v0, $t7, .L8093C8E8       
/* 03BC0 8093C890 8FBF0014 */  lw      $ra, 0x0014($sp)           
/* 03BC4 8093C894 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)  
...
/* 03BF4 8093C8C4 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 03BF8 8093C8C8 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)  
/* 03BFC 8093C8CC 0C24F1E7 */  jal     func_8093C79C              
/* 03C00 8093C8D0 8FA5001C */  lw      $a1, 0x001C($sp)           
/* 03C04 8093C8D4 3C048095 */  lui     $a0, %hi(koumePtr)       ## $a0 = 80950000
/* 03C08 8093C8D8 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)  
