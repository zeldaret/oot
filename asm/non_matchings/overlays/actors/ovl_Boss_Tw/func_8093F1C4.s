...
/* 06564 8093F234 3C028095 */  lui     $v0, %hi(kotakePtr)       ## $v0 = 80950000
/* 06568 8093F238 2442C844 */  addiu   $v0, $v0, %lo(kotakePtr)  ## $v0 = 8094C844
...
/* 065C4 8093F294 3C028095 */  lui     $v0, %hi(koumePtr)       ## $v0 = 80950000
/* 065C8 8093F298 2442C848 */  addiu   $v0, $v0, %lo(koumePtr)  ## $v0 = 8094C848
...
/* 06620 8093F2F0 3C0A8095 */  lui     $t2, %hi(kotakePtr)       ## $t2 = 80950000
/* 06624 8093F2F4 8D4AC844 */  lw      $t2, %lo(kotakePtr)($t2)
...
/* 06638 8093F308 3C0B8095 */  lui     $t3, %hi(kotakePtr)       ## $t3 = 80950000
/* 0663C 8093F30C A5400164 */  sh      $zero, 0x0164($t2)         ## 80950164
/* 06640 8093F310 8D6BC844 */  lw      $t3, %lo(kotakePtr)($t3)
/* 06644 8093F314 3C0D8095 */  lui     $t5, %hi(koumePtr)       ## $t5 = 80950000
/* 06648 8093F318 8DADC848 */  lw      $t5, %lo(koumePtr)($t5)
/* 0664C 8093F31C 856C0164 */  lh      $t4, 0x0164($t3)           ## 80950164
/* 06650 8093F320 3C0E8095 */  lui     $t6, %hi(kotakePtr)       ## $t6 = 80950000
/* 06654 8093F324 44804000 */  mtc1    $zero, $f8                 ## $f8 = 0.00
/* 06658 8093F328 A5AC0164 */  sh      $t4, 0x0164($t5)           ## 80950164
/* 0665C 8093F32C 8DCEC844 */  lw      $t6, %lo(kotakePtr)($t6)
/* 06660 8093F330 3C0F8095 */  lui     $t7, %hi(kotakePtr)       ## $t7 = 80950000
/* 06664 8093F334 3C188095 */  lui     $t8, %hi(koumePtr)       ## $t8 = 80950000
/* 06668 8093F338 E5C804C8 */  swc1    $f8, 0x04C8($t6)           ## 809504C8
/* 0666C 8093F33C 8DEFC844 */  lw      $t7, %lo(kotakePtr)($t7)
/* 06670 8093F340 8F18C848 */  lw      $t8, %lo(koumePtr)($t8)
...
/* 06718 8093F3E8 3C188095 */  lui     $t8, %hi(kotakePtr)       ## $t8 = 80950000
/* 0671C 8093F3EC 8F18C844 */  lw      $t8, %lo(kotakePtr)($t8)
...
/* 06754 8093F424 3C0B8095 */  lui     $t3, %hi(koumePtr)       ## $t3 = 80950000
/* 06758 8093F428 8D6BC848 */  lw      $t3, %lo(koumePtr)($t3)
...
/* 06838 8093F508 3C048095 */  lui     $a0, %hi(koumePtr)       ## $a0 = 80950000
/* 0683C 8093F50C 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
/* 0684C 8093F51C 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 06850 8093F520 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
...
.L8093F5F4:
/* 06924 8093F5F4 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
...
.L8093F614:
/* 06944 8093F614 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
...
.L8093F634:
/* 06964 8093F634 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
...
.L8093F6A8:
/* 069D8 8093F6A8 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
.L8093F6C8:
/* 069F8 8093F6C8 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
.L8093F6E8:
/* 06A18 8093F6E8 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
/* 06A54 8093F724 0C01E107 */  jal     Math_ApproachF
...
/* 06AA8 8093F778 3C048095 */  lui     $a0, %hi(koumePtr)       ## $a0 = 80950000
/* 06AAC 8093F77C 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
/* 06ACC 8093F79C 0C01E107 */  jal     Math_ApproachF
...
/* 06B20 8093F7F0 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 06B24 8093F7F4 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
...
/* 06B44 8093F814 0C01E107 */  jal     Math_ApproachF
...
/* 06B64 8093F834 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 06B68 8093F838 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
/* 06B6C 8093F83C 8E070068 */  lw      $a3, 0x0068($s0)           ## 00000068
/* 06B70 8093F840 0C01E107 */  jal     Math_ApproachF

/* 06B74 8093F844 24840028 */  addiu   $a0, $a0, 0x0028           ## $a0 = 80950028
/* 06B78 8093F848 3C048095 */  lui     $a0, %hi(koumePtr)       ## $a0 = 80950000
/* 06B7C 8093F84C 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
/* 06B8C 8093F85C 0C01E107 */  jal     Math_ApproachF
...
/* 06BA0 8093F870 0C01E107 */  jal     Math_ApproachF
...
/* 06BCC 8093F89C 0C01E107 */  jal     Math_ApproachF
...
/* 06BE0 8093F8B0 0C01E107 */  jal     Math_ApproachF
...
/* 06C44 8093F914 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 06C48 8093F918 8C84C844 */  lw      $a0, %lo(kotakePtr)($a0)
...
/* 06C68 8093F938 0C01E107 */  jal     Math_ApproachF
...
/* 06CBC 8093F98C 3C048095 */  lui     $a0, %hi(koumePtr)       ## $a0 = 80950000
/* 06CC0 8093F990 8C84C848 */  lw      $a0, %lo(koumePtr)($a0)
...
/* 06CE0 8093F9B0 0C01E107 */  jal     Math_ApproachF
...
/* 06CF8 8093F9C8 0C01E107 */  jal     Math_ApproachF
