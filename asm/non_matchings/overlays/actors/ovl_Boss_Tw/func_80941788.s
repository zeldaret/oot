...
/* 08C3C 8094190C 3C048095 */  lui     $a0, %hi(D_8094A95C)       ## $a0 = 80950000
/* 08C40 80941910 2484A968 */  addiu   $a0, $a0, %lo(D_8094A95C+0xC)  ## $a0 = 8094A968
/* 08C44 80941914 0C0346BD */  jal     Matrix_MultVec3f              
/* 08C48 80941918 2625045C */  addiu   $a1, $s1, 0x045C           ## $a1 = 0000045C
/* 08C4C 8094191C 3C048095 */  lui     $a0, %hi(D_8094A95C)       ## $a0 = 80950000
/* 08C50 80941920 2484A974 */  addiu   $a0, $a0, %lo(D_8094A95C+0x18)  ## $a0 = 8094A974
/* 08C54 80941924 0C0346BD */  jal     Matrix_MultVec3f              
/* 08C58 80941928 26250468 */  addiu   $a1, $s1, 0x0468           ## $a1 = 00000468
/* 08C5C 8094192C 3C048095 */  lui     $a0, %hi(D_8094A95C)       ## $a0 = 80950000
/* 08C60 80941930 2484A980 */  addiu   $a0, $a0, %lo(D_8094A95C+0x24)  ## $a0 = 8094A980
/* 08C64 80941934 0C0346BD */  jal     Matrix_MultVec3f              
/* 08C68 80941938 26250474 */  addiu   $a1, $s1, 0x0474           ## $a1 = 00000474
/* 08C6C 8094193C 3C048095 */  lui     $a0, %hi(D_8094A95C)       ## $a0 = 80950000
/* 08C70 80941940 2484A98C */  addiu   $a0, $a0, %lo(D_8094A95C+0x30)  ## $a0 = 8094A98C
