...
/* 00A5C 8093972C 3C0F8094 */  lui     $t7, %hi(BossTw_BlastUpdate)    ## $t7 = 80940000
/* 00A60 80939730 3C188094 */  lui     $t8, %hi(BossTw_BlastDraw)    ## $t8 = 80940000
/* 00A64 80939734 2401FFFE */  addiu   $at, $zero, 0xFFFE         ## $at = FFFFFFFE
/* 00A68 80939738 25EF6B00 */  addiu   $t7, $t7, %lo(BossTw_BlastUpdate) ## $t7 = 80946B00
/* 00A6C 8093973C 27186C7C */  addiu   $t8, $t8, %lo(BossTw_BlastDraw) ## $t8 = 80946C7C
...
/* 00A90 80939760 3C078095 */  lui     $a3, %hi(sCylinderInitBlasts)       ## $a3 = 80950000
/* 00A94 80939764 8FA50044 */  lw      $a1, 0x0044($sp)
/* 00A98 80939768 24E7A7E8 */  addiu   $a3, $a3, %lo(sCylinderInitBlasts)  ## $a3 = 8094A7E8
...
/* 00B2C 809397FC 3C198095 */  lui     $t9, %hi(twinrovaPtr)       ## $t9 = 80950000
/* 00B30 80939800 8F39C84C */  lw      $t9, %lo(twinrovaPtr)($t9)
...
.L80939814:
/* 00B44 80939814 3C188095 */  lui     $t8, %hi(twinrovaPtr)       ## $t8 = 80950000
/* 00B48 80939818 8F18C84C */  lw      $t8, %lo(twinrovaPtr)($t8)
...
/* 00B88 80939858 3C198095 */  lui     $t9, %hi(twInitalized)       ## $t9 = 80950000
/* 00B8C 8093985C 9339A89C */  lbu     $t9, %lo(twInitalized)($t9)
...
/* 00BA4 80939874 3C018095 */  lui     $at, %hi(twInitalized)       ## $at = 80950000
/* 00BA8 80939878 A02EA89C */  sb      $t6, %lo(twInitalized)($at)
...
/* 00BE4 809398B4 3C098095 */  lui     $t1, %hi(sEnvType)       ## $t1 = 80950000
/* 00BE8 809398B8 00310821 */  addu    $at, $at, $s1
/* 00BEC 809398BC 2529C840 */  addiu   $t1, $t1, %lo(sEnvType)  ## $t1 = 8094C840
...
/* 00BFC 809398CC 3C0A8095 */  lui     $t2, %hi(sBeamDivertTimer)       ## $t2 = 80950000
/* 00C00 809398D0 3C0B8095 */  lui     $t3, %hi(D_8094C872)       ## $t3 = 80950000
/* 00C04 809398D4 256BC872 */  addiu   $t3, $t3, %lo(D_8094C872)  ## $t3 = 8094C872
/* 00C08 809398D8 254AC86E */  addiu   $t2, $t2, %lo(sBeamDivertTimer)  ## $t2 = 8094C86E
...
/* 00DB8 80939A88 3C078095 */  lui     $a3, %hi(sCylinderInitKoumeKotake)       ## $a3 = 80950000
/* 00DBC 80939A8C 0C01712B */  jal     Collider_SetCylinder

/* 00DC0 80939A90 24E7A814 */  addiu   $a3, $a3, %lo(sCylinderInitKoumeKotake)  ## $a3 = 8094A814
...
.L80939B1C:
/* 00E4C 80939B1C 0C24F553 */  jal     BossTw_SetupCSWait
...
/* 00E7C 80939B4C 3C078095 */  lui     $a3, %hi(sCylinderInitKoumeKotake)       ## $a3 = 80950000
/* 00E80 80939B50 24E7A814 */  addiu   $a3, $a3, %lo(sCylinderInitKoumeKotake)  ## $a3 = 8094A814
...
.L80939BDC:
/* 00F0C 80939BDC 0C24F553 */  jal     BossTw_SetupCSWait
...
.L80939C04:
/* 00F34 80939C04 3C078095 */  lui     $a3, %hi(sCylinderInitTwinrova)       ## $a3 = 80950000
/* 00F38 80939C08 24E7A840 */  addiu   $a3, $a3, %lo(sCylinderInitTwinrova)  ## $a3 = 8094A840
...
/* 00FC8 80939C98 0C24F209 */  jal     BossTw_TwinrovaSetupWaitForMerge
...
/* 01004 80939CD4 3C018095 */  lui     $at, %hi(twinrovaPtr)       ## $at = 80950000
/* 01008 80939CD8 3C050001 */  lui     $a1, 0x0001                ## $a1 = 00010000
/* 0100C 80939CDC AC30C84C */  sw      $s0, %lo(twinrovaPtr)($at)
...
/* 010FC 80939DCC 3C018095 */  lui     $at, %hi(kotakePtr)       ## $at = 80950000
/* 01100 80939DD0 AC22C844 */  sw      $v0, %lo(kotakePtr)($at)
...
/* 01144 80939E14 3C048095 */  lui     $a0, %hi(kotakePtr)       ## $a0 = 80950000
/* 01148 80939E18 2484C844 */  addiu   $a0, $a0, %lo(kotakePtr)  ## $a0 = 8094C844
/* 0114C 80939E1C 8C980000 */  lw      $t8, 0x0000($a0)           ## 8094C844
/* 01150 80939E20 3C038095 */  lui     $v1, %hi(koumePtr)       ## $v1 = 80950000
/* 01154 80939E24 2463C848 */  addiu   $v1, $v1, %lo(koumePtr)  ## $v1 = 8094C848
