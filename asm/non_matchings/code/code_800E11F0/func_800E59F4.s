...
/* B5CBA0 800E5A00 3C0E8017 */  lui   $t6, %hi(gAudioContext)
/* B5CBA4 800E5A04 3C0F8017 */  lui   $t7, %hi(gAudioContext) # $t7, 0x8017
/* B5CBA8 800E5A08 3C188017 */  lui   $t8, %hi(gAudioContext) # $t8, 0x8017
/* B5CBAC 800E5A0C AFBF0014 */  sw    $ra, 0x14($sp)
/* B5CBB0 800E5A10 25C44D70 */  addiu $a0, $t6, %lo(gAudioContext+0x5BF0)
/* B5CBB4 800E5A14 25EF4D88 */  addiu $t7, %lo(gAudioContext+0x5C08) # addiu $t7, $t7, 0x4d88
/* B5CBB8 800E5A18 27184DA0 */  addiu $t8, %lo(gAudioContext+0x5C20) # addiu $t8, $t8, 0x4da0
/* B5CBBC 800E5A1C 3C058017 */  lui   $a1, %hi(gAudioContext) # $a1, 0x8017
...
/* B5CBD8 800E5A38 24A54DB8 */  addiu $a1, %lo(gAudioContext+0x5C38) # addiu $a1, $a1, 0x4db8
...
/* B5CBEC 800E5A4C 3C058017 */  lui   $a1, %hi(gAudioContext) # $a1, 0x8017
/* B5CBF0 800E5A50 24A54DC0 */  addiu $a1, %lo(gAudioContext+0x5C40) # addiu $a1, $a1, 0x4dc0
...
/* B5CC08 800E5A68 3C058017 */  lui   $a1, %hi(gAudioContext) # $a1, 0x8017
/* B5CC0C 800E5A6C 24A54DBC */  addiu $a1, %lo(gAudioContext+0x5C3C) # addiu $a1, $a1, 0x4dbc
