...
/* AEFC8C 80078AEC 3C0D8012 */  lui   $t5, %hi(sHealthPrimColors) # $t5, 0x8012
/* AEFC90 80078AF0 85ADFF10 */  lh    $t5, %lo(sHealthPrimColors)($t5)
/* AEFC94 80078AF4 3C0E8012 */  lui   $t6, %hi(sHealthPrimColors+2) # $t6, 0x8012
/* AEFC98 80078AF8 3C0F8012 */  lui   $t7, %hi(sHealthPrimColors+4) # $t7, 0x8012
/* AEFC9C 80078AFC A44D0210 */  sh    $t5, 0x210($v0)
/* AEFCA0 80078B00 85CEFF12 */  lh    $t6, %lo(sHealthPrimColors+2)($t6)
/* AEFCA4 80078B04 3C188012 */  lui   $t8, %hi(sHealthEnvColors) # $t8, 0x8012
/* AEFCA8 80078B08 3C198012 */  lui   $t9, %hi(sHealthEnvColors+2) # $t9, 0x8012
/* AEFCAC 80078B0C A44E0214 */  sh    $t6, 0x214($v0)
/* AEFCB0 80078B10 85EFFF14 */  lh    $t7, %lo(sHealthPrimColors+4)($t7)
/* AEFCB4 80078B14 3C0B8012 */  lui   $t3, %hi(sHealthEnvColors+4) # $t3, 0x8012
/* AEFCB8 80078B18 3C078012 */  lui   $a3, %hi(sHealthPrimFactors) # $a3, 0x8012
/* AEFCBC 80078B1C A44F0218 */  sh    $t7, 0x218($v0)
/* AEFCC0 80078B20 8718FF24 */  lh    $t8, %lo(sHealthEnvColors)($t8)
/* AEFCC4 80078B24 24E7FF38 */  addiu $a3, %lo(sHealthPrimFactors) # addiu $a3, $a3, -0xc8
/* AEFCC8 80078B28 3C088012 */  lui   $t0, %hi(sHealthEnvFactors) # $t0, 0x8012
/* AEFCCC 80078B2C A458021C */  sh    $t8, 0x21c($v0)
/* AEFCD0 80078B30 8739FF26 */  lh    $t9, %lo(sHealthEnvColors+2)($t9)
/* AEFCD4 80078B34 2508FF4C */  addiu $t0, %lo(sHealthEnvFactors) # addiu $t0, $t0, -0xb4
/* AEFCD8 80078B38 3C018016 */  lui   $at, %hi(sDDBeatingHeartPrim+6) # $at, 0x8016
/* AEFCDC 80078B3C A4590220 */  sh    $t9, 0x220($v0)
/* AEFCE0 80078B40 856BFF28 */  lh    $t3, %lo(sHealthEnvColors+4)($t3)
/* AEFCE4 80078B44 3C098016 */  lui   $t1, %hi(sHealthDDPrim) # $t1, 0x8016
/* AEFCE8 80078B48 2529FDC0 */  addiu $t1, %lo(sHealthDDPrim) # addiu $t1, $t1, -0x240
...
/* AEFD04 80078B64 3C078016 */  lui   $a3, %hi(sDDBeatingHeartPrim) # $a3, 0x8016
/* AEFD08 80078B68 46805420 */  cvt.s.w $f16, $f10
/* AEFD0C 80078B6C 24E7FDD0 */  addiu $a3, %lo(sDDBeatingHeartPrim) # addiu $a3, $a3, -0x230
/* AEFD10 80078B70 3C0A8016 */  lui   $t2, %hi(sHealthDDEnv)
/* AEFD14 80078B74 254AFDC8 */  addiu $t2, %lo(sHealthDDEnv) # addiu $t2, $t2, -0x238
...
/* AEFDA0 80078C00 3C088016 */  lui   $t0, %hi(sDDBeatingHeartEnv) # $t0, 0x8016
/* AEFDA4 80078C04 46805420 */  cvt.s.w $f16, $f10
/* AEFDA8 80078C08 2508FDE0 */  addiu $t0, %lo(sDDBeatingHeartEnv) # addiu $t0, $t0, -0x220
/* AEFDAC 80078C0C 3C0F8012 */  lui   $t7, %hi(sHealthDDPrimColors) # $t7, 0x8012
/* AEFDB0 80078C10 3C0B8012 */  lui   $t3, %hi(sHealthDDEnvColors)
...
/* AEFE18 80078C78 3C188012 */  lui   $t8, %hi(sHealthDDPrimColors+2) # $t8, 0x8012
...
/* AEFE48 80078CA8 3C0E8012 */  lui   $t6, %hi(sHealthDDPrimFactors) # $t6, 0x8012
/* AEFE4C 80078CAC 85CEFF88 */  lh    $t6, %lo(sHealthDDPrimFactors)($t6)
/* AEFE50 80078CB0 85EFFF60 */  lh    $t7, %lo(sHealthDDPrimColors)($t7)
/* AEFE54 80078CB4 8718FF62 */  lh    $t8, %lo(sHealthDDPrimColors+2)($t8)
/* AEFE58 80078CB8 448E5000 */  mtc1  $t6, $f10
/* AEFE5C 80078CBC 3C198012 */  lui   $t9, %hi(sHealthDDPrimColors+4) # $t9, 0x8012
/* AEFE60 80078CC0 8739FF64 */  lh    $t9, %lo(sHealthDDPrimColors+4)($t9)
/* AEFE64 80078CC4 46805420 */  cvt.s.w $f16, $f10
/* AEFE68 80078CC8 A42FFDD6 */  sh    $t7, %lo(sDDBeatingHeartPrim+6)($at)
/* AEFE6C 80078CCC 3C018016 */  lui   $at, %hi(sDDBeatingHeartPrim+8) # $at, 0x8016
/* AEFE70 80078CD0 856BFF74 */  lh    $t3, %lo(sHealthDDEnvColors)($t3)
/* AEFE74 80078CD4 A438FDD8 */  sh    $t8, %lo(sDDBeatingHeartPrim+8)($at)
/* AEFE78 80078CD8 3C188012 */  lui   $t8, %hi(sHealthDDPrimFactors+2) # $t8, 0x8012
/* AEFE7C 80078CDC 46008482 */  mul.s $f18, $f16, $f0
/* AEFE80 80078CE0 A439FDDA */  sh    $t9, %lo(sDDBeatingHeartPrim+0xa)($at)
/* AEFE84 80078CE4 8718FF8A */  lh    $t8, %lo(sHealthDDPrimFactors+2)($t8)
/* AEFE88 80078CE8 3C018016 */  lui   $at, %hi(sDDBeatingHeartEnv+6) # $at, 0x8016
/* AEFE8C 80078CEC A42BFDE6 */  sh    $t3, %lo(sDDBeatingHeartEnv+6)($at)
/* AEFE90 80078CF0 3C0B8012 */  lui   $t3, %hi(sHealthDDPrimFactors+4)
/* AEFE94 80078CF4 856BFF8C */  lh    $t3, %lo(sHealthDDPrimFactors+4)($t3)
/* AEFE98 80078CF8 44983000 */  mtc1  $t8, $f6
/* AEFE9C 80078CFC 4600910D */  trunc.w.s $f4, $f18
/* AEFEA0 80078D00 448B9000 */  mtc1  $t3, $f18
/* AEFEA4 80078D04 3C0D8012 */  lui   $t5, %hi(sHealthDDEnvColors+4) # $t5, 0x8012
/* AEFEA8 80078D08 46803220 */  cvt.s.w $f8, $f6
/* AEFEAC 80078D0C 44032000 */  mfc1  $v1, $f4
/* AEFEB0 80078D10 85ADFF78 */  lh    $t5, %lo(sHealthDDEnvColors+4)($t5)
/* AEFEB4 80078D14 3C0C8012 */  lui   $t4, %hi(sHealthDDEnvColors+2) # $t4, 0x8012
/* AEFEB8 80078D18 858CFF76 */  lh    $t4, %lo(sHealthDDEnvColors+2)($t4)
/* AEFEBC 80078D1C 46809120 */  cvt.s.w $f4, $f18
/* AEFEC0 80078D20 46004282 */  mul.s $f10, $f8, $f0
/* AEFEC4 80078D24 00031C00 */  sll   $v1, $v1, 0x10
/* AEFEC8 80078D28 3C018016 */  lui   $at, %hi(sDDBeatingHeartEnv+8) # $at, 0x8016
/* AEFECC 80078D2C 00031C03 */  sra   $v1, $v1, 0x10
/* AEFED0 80078D30 246E00FF */  addiu $t6, $v1, 0xff
/* AEFED4 80078D34 46002182 */  mul.s $f6, $f4, $f0
/* AEFED8 80078D38 A42DFDEA */  sh    $t5, %lo(sDDBeatingHeartEnv+0xa)($at)
/* AEFEDC 80078D3C 31CF00FF */  andi  $t7, $t6, 0xff
/* AEFEE0 80078D40 A42CFDE8 */  sh    $t4, %lo(sDDBeatingHeartEnv+8)($at)
/* AEFEE4 80078D44 A52F0000 */  sh    $t7, ($t1)
/* AEFEE8 80078D48 3C0F8012 */  lui   $t7, %hi(sHealthDDEnvFactors) # $t7, 0x8012
/* AEFEEC 80078D4C 4600540D */  trunc.w.s $f16, $f10
/* AEFEF0 80078D50 3C0C8012 */  lui   $t4, %hi(sHealthDDEnvFactors+4) # $t4, 0x8012
...
/* AEFF28 80078D88 85EFFF9C */  lh    $t7, %lo(sHealthDDEnvFactors)($t7)
/* AEFF2C 80078D8C 3C198012 */  lui   $t9, %hi(sHealthDDEnvFactors+2)
/* AEFF30 80078D90 8739FF9E */  lh    $t9, %lo(sHealthDDEnvFactors+2)($t9)
/* AEFF34 80078D94 448F5000 */  mtc1  $t7, $f10
/* AEFF38 80078D98 858CFFA0 */  lh    $t4, %lo(sHealthDDEnvFactors+4)($t4)
