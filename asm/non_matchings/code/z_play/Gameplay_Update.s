...
/* B34668 800BD4C8 3C028016 */  lui   $v0, %hi(trnsnUnkState) # $v0, 0x8016
...
.L800BD4EC:
/* B3468C 800BD4EC 8C421490 */  lw    $v0, %lo(trnsnUnkState)($v0)
...
/* B346A0 800BD500 3C048016 */   lui   $a0, %hi(trnsnUnk)
/* B346A4 800BD504 24010003 */  li    $at, 3
/* B346A8 800BD508 1041001A */  beq   $v0, $at, .L800BD574
/* B346AC 800BD50C 3C048016 */   lui   $a0, %hi(trnsnUnk) # $a0, 0x8016
/* B346B0 800BD510 1000001B */  b     .L800BD580
/* B346B4 800BD514 9224241B */   lbu   $a0, 0x241b($s1)
.L800BD518:
/* B346B8 800BD518 248413B0 */  addiu $a0, %lo(trnsnUnk) # addiu $a0, $a0, 0x13b0
...
/* B346DC 800BD53C 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B346E0 800BD540 1000000E */  b     .L800BD57C
/* B346E4 800BD544 AC201490 */   sw    $zero, %lo(trnsnUnkState)($at)
.L800BD548:
/* B346E8 800BD548 258C59C0 */  addiu $t4, %lo(D_801759C0) # addiu $t4, $t4, 0x59c0
/* B346EC 800BD54C 3C018016 */  lui   $at, %hi(trnsnUnk+0xdc) # $at, 0x8016
/* B346F0 800BD550 AC2C148C */  sw    $t4, %lo(trnsnUnk+0xdc)($at)
/* B346F4 800BD554 3C0F8016 */  lui   $t7, %hi(gGameInfo) # $t7, 0x8016
/* B346F8 800BD558 8DEFFA90 */  lw    $t7, %lo(gGameInfo)($t7)
/* B346FC 800BD55C 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B34700 800BD560 240D0003 */  li    $t5, 3
/* B34704 800BD564 AC2D1490 */  sw    $t5, %lo(trnsnUnkState)($at)
...
/* B34718 800BD578 248413B0 */   addiu $a0, $a0, %lo(trnsnUnk)
.L800BD57C:
...
/* B34BE0 800BDA40 3C0E8016 */  lui   $t6, %hi(trnsnUnkState) # $t6, 0x8016
/* B34BE4 800BDA44 8DCE1490 */  lw    $t6, %lo(trnsnUnkState)($t6)
/* B34BE8 800BDA48 24010003 */  li    $at, 3
/* B34BEC 800BDA4C 3C048016 */  lui   $a0, %hi(trnsnUnk) # $a0, 0x8016
...
/* B34BFC 800BDA5C 248413B0 */   addiu $a0, %lo(trnsnUnk) # addiu $a0, $a0, 0x13b0
/* B34C00 800BDA60 3C188016 */  lui   $t8, %hi(gGameInfo) # $t8, 0x8016
/* B34C04 800BDA64 8F18FA90 */  lw    $t8, %lo(gGameInfo)($t8)
/* B34C08 800BDA68 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B34C0C 800BDA6C AC201490 */  sw    $zero, %lo(trnsnUnkState)($at)
...
/* B34EBC 800BDD1C 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B34EC0 800BDD20 AC201490 */  sw    $zero, %lo(trnsnUnkState)($at)
...
/* B34FC8 800BDE28 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B34FCC 800BDE2C AC201490 */  sw    $zero, %lo(trnsnUnkState)($at)
...
/* B350D8 800BDF38 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B350DC 800BDF3C AC201490 */  sw    $zero, %lo(trnsnUnkState)($at)
...
/* B35214 800BE074 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
...
/* B35228 800BE088 AC201490 */  sw    $zero, %lo(trnsnUnkState)($at)
...
/* B352C4 800BE124 3C018016 */  lui   $at, %hi(trnsnUnkState) # $at, 0x8016
/* B352C8 800BE128 AC201490 */  sw    $zero, %lo(trnsnUnkState)($at)
...
.L800BE188:
/* B35328 800BE188 3C028016 */  lui   $v0, %hi(trnsnUnkState) # $v0, 0x8016
/* B3532C 800BE18C 8C421490 */  lw    $v0, %lo(trnsnUnkState)($v0)
...
/* B35CC8 800BEB28 0C02CD5A */  jal   TransitionFade_Move
