...
/* B2C068 800B4EC8 3C0B8016 */  lui   $t3, %hi(globalCtx) # $t3, 0x8016
...
/* B2C09C 800B4EFC 8D6B1100 */  lw    $t3, %lo(globalCtx)($t3)
...
/* B2C0F0 800B4F50 3C018016 */  lui   $at, %hi(dbCamAnim+0xA) # $at, 0x8016
...
/* B2C0FC 800B4F5C A420111A */  sh    $zero, %lo(dbCamAnim+0xA)($at)
...
/* B2C3F4 800B5254 3C198016 */  lui   $t9, %hi(globalCtx) # $t9, 0x8016
/* B2C3F8 800B5258 2401BFDF */  li    $at, -16417
/* B2C3FC 800B525C AEB8003C */  sw    $t8, 0x3c($s5)
/* B2C400 800B5260 8F391100 */  lw    $t9, %lo(globalCtx)($t9)
...
.L800B549C:
/* B2C63C 800B549C 3C0F8016 */  lui   $t7, %hi(globalCtx) # $t7, 0x8016
/* B2C640 800B54A0 8DEF1100 */  lw    $t7, %lo(globalCtx)($t7)
...
.L800B5B24:
/* B2CCC4 800B5B24 3C038016 */  lui   $v1, %hi(globalCtx)
/* B2CCC8 800B5B28 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2D1FC 800B605C 3C0A8016 */   lui   $t2, %hi(globalCtx) # $t2, 0x8016
/* B2D200 800B6060 8D4A1100 */  lw    $t2, %lo(globalCtx)($t2)
...
/* B2D2B4 800B6114 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2D2B8 800B6118 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2D39C 800B61FC 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2D3A0 800B6200 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2D3EC 800B624C 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
...
/* B2D400 800B6260 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
.L800B62D4:
/* B2D474 800B62D4 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2D478 800B62D8 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2D518 800B6378 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2D51C 800B637C E6A80048 */  swc1  $f8, 0x48($s5)
/* B2D520 800B6380 E6AA0050 */  swc1  $f10, 0x50($s5)
/* B2D524 800B6384 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2D558 800B63B8 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
...
/* B2D580 800B63E0 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2DBF0 800B6A50 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DBF4 800B6A54 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2DC48 800B6AA8 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DC4C 800B6AAC 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2DC60 800B6AC0 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DC64 800B6AC4 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2DCBC 800B6B1C 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DCC0 800B6B20 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2DCD4 800B6B34 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DCD8 800B6B38 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
...
/* B2DD40 800B6BA0 3C038016 */   lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DD44 800B6BA4 1000008D */  b     .L800B6DDC
/* B2DD48 800B6BA8 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B6BAC:
/* B2DD4C 800B6BAC 3C0C8016 */  lui   $t4, %hi(globalCtx) # $t4, 0x8016
/* B2DD50 800B6BB0 8D8C1100 */  lw    $t4, %lo(globalCtx)($t4)
...
.L800B6BFC:
/* B2DD9C 800B6BFC 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DDA0 800B6C00 10000076 */  b     .L800B6DDC
/* B2DDA4 800B6C04 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B6C08:
...
.L800B6D24:
/* B2DEC4 800B6D24 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DEC8 800B6D28 1000002C */  b     .L800B6DDC
/* B2DECC 800B6D2C 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B6D30:
/* B2DED0 800B6D30 AEA00088 */  sw    $zero, 0x88($s5)
/* B2DED4 800B6D34 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DED8 800B6D38 10000028 */  b     .L800B6DDC
/* B2DEDC 800B6D3C 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B6D40:
/* B2DEE0 800B6D40 3C0F8016 */  lui   $t7, %hi(globalCtx) # $t7, 0x8016
/* B2DEE4 800B6D44 8DEF1100 */  lw    $t7, %lo(globalCtx)($t7)
...
/* B2DFE4 800B6E44 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2DFE8 800B6E48 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
.L800B6E4C:
...
.L800B6EE8:
/* B2E088 800B6EE8 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2E08C 800B6EEC 10000039 */  b     .L800B6FD4
/* B2E090 800B6EF0 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
...
.L800B6FCC:
/* B2E16C 800B6FCC 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2E170 800B6FD0 8C631100 */  lw    $v1, %lo(globalCtx)($v1)
.L800B6FD4:
...
/* B2E1D4 800B7034 3C038016 */   lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2E1D8 800B7038 10000085 */  b     .L800B7250
/* B2E1DC 800B703C 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B7040:
/* B2E1E0 800B7040 3C0E8016 */  lui   $t6, %hi(globalCtx) # $t6, 0x8016
/* B2E1E4 800B7044 8DCE1100 */  lw    $t6, %lo(globalCtx)($t6)
...
.L800B7090:
/* B2E230 800B7090 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2E234 800B7094 1000006E */  b     .L800B7250
/* B2E238 800B7098 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B709C:
...
/* B2E348 800B71A8 3C038016 */  lui   $v1, %hi(globalCtx) # $v1, 0x8016
/* B2E34C 800B71AC 10000028 */  b     .L800B7250
/* B2E350 800B71B0 8C631100 */   lw    $v1, %lo(globalCtx)($v1)
.L800B71B4:
/* B2E354 800B71B4 3C098016 */  lui   $t1, %hi(globalCtx) # $t1, 0x8016
/* B2E358 800B71B8 8D291100 */  lw    $t1, %lo(globalCtx)($t1)
...
.L800B72D0:
/* B2E470 800B72D0 3C098016 */  lui   $t1, %hi(globalCtx) # $t1, 0x8016
/* B2E474 800B72D4 8D291100 */  lw    $t1, %lo(globalCtx)($t1)
...
.L800B734C:
/* B2E4EC 800B734C 3C098016 */  lui   $t1, %hi(globalCtx) # $t1, 0x8016
/* B2E4F0 800B7350 8D291100 */  lw    $t1, %lo(globalCtx)($t1)
...
/* B2F134 800B7F94 3C0F8016 */  lui   $t7, %hi(globalCtx) # $t7, 0x8016
...
/* B2F14C 800B7FAC 8DEF1100 */  lw    $t7, %lo(globalCtx)($t7)
