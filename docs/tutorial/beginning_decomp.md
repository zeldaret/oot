...
```
$ ./tools/ichaindis.py baseroms/gc-eu-mq-dbg/baserom_uncompressed.z64 80A88CE0
...
```
$ ./tools/ichaindis.py --names baseroms/gc-eu-mq-dbg/baserom_uncompressed.z64 80A88CE0
static InitChainEntry sInitChain[] = {
