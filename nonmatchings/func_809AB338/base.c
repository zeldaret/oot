...
void EffectSs_DrawGEffect(GlobalContext* globalCtx, EffectSs* this, void* segment);
...
s32 func_800803F0(GlobalContext* globalCtx, s16 arg1);
...
u32 EffectSsLightning_Init(GlobalContext* globalCtx, u32 index, EffectSs* this, void* initParamsx) {
    ...
    this->displayList = (void*)(((u32)(gSegments[(((unsigned int)(D_0402CF30) << 4) >> 28)]) + 0x80000000) + ((unsigned int)(D_0402CF30) & 0x00ffffff));
...
void func_809AB338(GlobalContext *globalCtx, u32 index, EffectSs *this) {
    ...
    if ((this->regs[SS_LIGHTNING_8] != 0) && ((this->life + 1) == this->regs[SS_LIGHTNING_LIFE])) {
        ...
        sp3E = (sp3E + 3640);
        sp3E = ( sp3E * phi_v1) + this->regs[SS_LIGHTNING_A];
        ...
        newEffPos.x = this->pos.x - Math_Coss(func_8005A948(globalCtx->cameraPtrs[globalCtx->activeCamera])) * scale;
        newEffPos.z = (Math_Sins(func_8005A948(globalCtx->cameraPtrs[globalCtx->activeCamera])) * scale) + this->pos.z;
        func_809AAFD4(globalCtx, &newEffPos, sp3E, this);
        if (Math_Rand_ZeroOne() < 0.1f) {
            temp = ((this->regs[SS_LIGHTNING_A] * 2) - sp3E);
