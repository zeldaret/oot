...
ASSET_FILES_OUT := $(foreach f,$(ASSET_BIN_DIRS_EXTRACTED:.bin=.bin.inc.c),$(f:$(EXTRACTED_DIR)/%=$(BUILD_DIR)/%)) \
                   $(foreach f,$(ASSET_BIN_DIRS_COMMITTED:.bin=.bin.inc.c),$(BUILD_DIR)/$f) \
