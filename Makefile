...
ifeq ($(PLATFORM),N64)
  ...
  LIBULTRA_MAJOR_VERSION := I
  LIBULTRA_MINOR_VERSION := 1
else
  BUILD_CREATOR := zelda@srd022j
  LIBULTRA_MAJOR_VERSION := L
  LIBULTRA_MINOR_VERSION := 0
endif
...
CPP_DEFINES += -DLIBULTRA_MAJOR_VERSION=LIBULTRA_VERSION_$(LIBULTRA_MAJOR_VERSION)
CPP_DEFINES += -DLIBULTRA_MINOR_VERSION=$(LIBULTRA_MINOR_VERSION)
CPP_DEFINES += -DLIBULTRA_VERSION_ID=$(LIBULTRA_MAJOR_VERSION)
