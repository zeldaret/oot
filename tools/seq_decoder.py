...
commands['seq'] = join(control_flow_commands, {
    ...
    0xd1: ['setshortnotegatetimetable', 'addr'],
...
commands['chan'] = join(control_flow_commands, {
    ...
    0xbc: ['addlarge', 'u16'],
    0xbb: ['unk_bb', 'u8', 'u16'],
    0xba: ['setgatetimerandomvariance', 'u8'],
...
commands_layer_base = join(control_flow_commands, {
    ...
    0xc2: ['transpose', 's8'],
    0xc3: ['setshortnotedefaultdelay', 'var'],
    0xc4: ['enablelegato'],
    0xc5: ['disablelegato'],
    0xc6: ['setinstr', 'u8'],
    0xc7: ['portamento', 'hex8', 'u8', 'u8'],
    0xc8: ['disableportamento'],
    0xc9: ['setshortnotegatetime', 'u8'],
    0xca: ['setpan', 'u8'],
    ...
    0xe0: ['setshortnotegatetimefromtable', 'bits:4'],
})
