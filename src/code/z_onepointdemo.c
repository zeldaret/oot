...
s32 func_8007C850(GlobalContext* globalCtx, s16 arg1, s16 arg2, Actor* actor, s16 timer) {
    ...
    temp_s0 = globalCtx->cameraPtrs[globalCtx->cameraPtrs[arg1]->childCamIdx];

    spDC = globalCtx->cameraPtrs[0];

    player = spDC->player;
    sp84 = globalCtx->cameraPtrs[arg1];
    ...
    switch (arg2) {
        case 0x3FC:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_801208EC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
        ...
        case 0x406:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80120964;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
        ...
        case 0x1388:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_801209B4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x1392:
            ...
            break;
        case 0x251C:
            ONEPOINTDEMO(sp84)->keyFrames = D_80120A54;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x8D4:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80120ACC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;

            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x8DE:
            
            ONEPOINTDEMO(sp84)->keyFrames = D_80120B94;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 11;
            
            phi_s1 = 0;
            do {
                if (D_80120B94[phi_s1].actionFlags != 0x8F) {
                    D_80120B94[phi_s1].atTargetInit.x = Rand_ZeroOne() * 5.0f;
                    D_80120B94[phi_s1].atTargetInit.z = (Rand_ZeroOne() * 30.0f) + 10.0f;
                    D_80120B94[phi_s1].eyeTargetInit.x = (Rand_ZeroOne() * 100.0f) + 20.0f;
                    D_80120B94[phi_s1].eyeTargetInit.z = (Rand_ZeroOne() * 80.0f) + 50.0f;
                }
                phi_s1++;
            } while(phi_s1 < temp->keyFrameCnt - 3);
            

            D_80120B94[arg1 - 1].eyeTargetInit.y = ((spDC->globalCtx->state.frames & 1) ? 3.0f : -3.0f) + Rand_ZeroOne();
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 5);
            Quake_SetSpeed(phi_s1, 0x190);
            Quake_SetQuakeValues(phi_s1, 4, 5, 0x28, 0x3C);
            Quake_SetCountdown(phi_s1, 0x640);
            break;
        case 0x8E8:
            // temp = sp84;
            // temp->keyFrames = D_80120D4C;
            // temp->keyFrameCnt = 7;

            // ONEPOINTDEMO(sp84)->keyFrames = D_80120D4C;
            // ONEPOINTDEMO(sp84)->keyFrameCnt = 7;

            // for(phi_s1 = 0; (phi_s1 < temp->keyFrameCnt - 3); phi_s1++) {
            //     if (D_80120D4C[phi_s1].actionFlags != 0x8F) {
            //         D_80120D4C[phi_s1].atTargetInit.x = Rand_ZeroOne() * 20.0f;
            //         D_80120D4C[phi_s1].atTargetInit.z = (Rand_ZeroOne() * 40.0f) + 10.0f;
            //         D_80120D4C[phi_s1].eyeTargetInit.x = (Rand_ZeroOne() * 40.0f) + 60.0f;
            //         D_80120D4C[phi_s1].eyeTargetInit.z = (Rand_ZeroOne() * 40.0f) + 80.0f;
            //     }
            // }
            ...
            phi_s1 = Quake_Add(sp84, 5);
            Quake_SetSpeed(phi_s1, 0x190);
            Quake_SetQuakeValues(phi_s1, 2, 3, 0xC8, 0x32);
            Quake_SetCountdown(phi_s1, 0x270F);
            break;
        case 0x8AC:
            ONEPOINTDEMO(sp84)->keyFrames = D_80120E64;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 8;

            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 5);
            Quake_SetSpeed(phi_s1, 0x190);
            Quake_SetQuakeValues(phi_s1, 2, 2, 0x32, 0);
            Quake_SetCountdown(phi_s1, 0x118);
            break;
        case 0x8B6:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80120FA4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 6;

            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x924:
            ONEPOINTDEMO(sp84)->keyFrames = D_80121094;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            ...
            Quake_SetSpeed(phi_s1, 0x190);
            Quake_SetQuakeValues(phi_s1, 2, 2, 0x32, 0);
            Quake_SetCountdown(phi_s1, 0x3C);
            break;
        case 0x92E:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012110C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
        ...
        case 0x898:
            ...
            if ((sp82 > 0) && (sp82 < 0x140) && (sp7E > 0) && (sp7E < 0xF0) && (sp80 > 0) && (sp80 < 0x140) &&
                ...
                ONEPOINTDEMO(sp84)->keyFrames = D_80121184;
                ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            } else {
                ...
                ONEPOINTDEMO(sp84)->keyFrames = D_801211D4;
                ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            }
            ...
            break;
        case 0x8F2:
            temp_s0_17 = player->rideActor;
            func_8002DF54(globalCtx, NULL, 8);
            if (temp_s0_17 != NULL) {
                temp_s0_17->freezeTimer = 180;
            }

            ONEPOINTDEMO(sp84)->keyFrames = D_80121224;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 6;
        ...
        case 0x1400:
            func_8002DF54(globalCtx, NULL, 8);
            ONEPOINTDEMO(sp84)->keyFrames = D_80121314;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 1;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x119E:
            ...
            func_8002DF54(globalCtx, NULL, 8);
            ONEPOINTDEMO(sp84)->keyFrames = D_8012133C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x1194:
            ...
            sp84->roll = 0;
            sp84->fov = 50.0f;
            if (sp84->childCamIdx != 0) {
                func_800803F0(globalCtx, sp84->childCamIdx);
            }
            break;
        case 0x8A2:
            ...
            func_8002DF54(globalCtx, NULL, 8);
            ONEPOINTDEMO(sp84)->keyFrames = D_801213B4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x3F2:
        ...
        case 0x2581:
            ...
            func_8007C820(sp84, D_80120430 | 0x1000, D_8012042C, D_80120308, D_80120398);
            break;
        case 0x2582:
            Gameplay_CameraChangeSetting(globalCtx, arg1, 0x2A);
            Gameplay_CameraChangeSetting(globalCtx, 0, spDC->prevSetting);
            func_8007C820(sp84, D_80120430 | 0x1000, D_8012042C, D_80120308, D_80120434);
            break;
        case 75 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012147C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 80 + 0x1004:
        ...
        case 30 + 0xBC2:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_8012151C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 10 + 0xBC2:
            ...
            temp_f2_2 = Rand_ZeroOne() * 15.0f;
            D_8012156C[0].eyeTargetInit.x += temp_f2_2;
            D_8012156C[1].eyeTargetInit.x += temp_f2_2;
            ONEPOINTDEMO(sp84)->keyFrames = D_8012156C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            func_8002DF54(globalCtx, NULL, 8);
            break;
        case 0 + 0xBC2:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_801215BC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 1;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 60 + 0xBC2:
            ONEPOINTDEMO(sp84)->keyFrames = D_801215E4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 10;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 3);
            Quake_SetSpeed(phi_s1, 0x55F0);
            Quake_SetQuakeValues(phi_s1, 2, 0, 0xC8, 0);
            Quake_SetCountdown(phi_s1, 0xA);
            break;
        case 70 + 0xBC2:
            ONEPOINTDEMO(sp84)->keyFrames = D_80121774;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 80 + 0xBC2:
            func_8002DF54(globalCtx, NULL, 8);
            ONEPOINTDEMO(sp84)->keyFrames = D_80121814;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 90 + 0xBC2:
        ...
        case 90 + 0xCDA:
        case 55 + 0xBC2:
            ONEPOINTDEMO(sp84)->keyFrames = D_801218B4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 1);
            Quake_SetSpeed(phi_s1, 0x5DC0);
            Quake_SetQuakeValues(phi_s1, 2, 0, 0, 0);
            Quake_SetCountdown(phi_s1, 0xA0);
            break;
        case 50 + 0xBC2:
            ONEPOINTDEMO(sp84)->keyFrames = D_80121904;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 40 + 0xBC2:
            ...
            func_8007C820(sp84, D_80120304 | 0x2000, D_80120300, D_8012013C, D_8012021C);
            ...
            phi_s1 = Quake_Add(spDC, 3);
            Quake_SetSpeed(phi_s1, 0x7530);
            Quake_SetQuakeValues(phi_s1, 2, 1, 1, 0);
            Quake_SetCountdown(phi_s1, 0xC8);
            break;
        case 110 + 0xBC2:
            ONEPOINTDEMO(sp84)->keyFrames = D_80121954[-(timer + 101)];
            sp84->timer = 100;
            sp84->unk_14C |= 2;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_8002DF54(globalCtx, NULL, 8);
            ...
            break;
        case 120 + 0xBC2:
            ONEPOINTDEMO(sp84)->keyFrames = D_80121A44;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 12;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            sp84->unk_14C |= 2;
            break;
        case 130 + 0xBC2:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80121C24;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 7;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 140 + 0xBC2:
        ...
        case 10 + 0xC94:
            ...
            phi_s1 = Quake_Add(sp84, 3);
            Quake_SetSpeed(phi_s1, 0x55F0);
            Quake_SetQuakeValues(phi_s1, 1, 0, 0, 0);
            Quake_SetCountdown(phi_s1, 0x5A);
            break;
        case 0x177A:
            Actor_GetWorld(&spA0, actor);
            spC0 = spA0.pos;
        ...
        case 20 + 0xC94:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80121D3C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x1771:
            ...
            if (spA0.pos.z > -750.0f) {
                func_8007C820(sp84, D_801208E8, D_801208E4, D_801206A0, D_80120820);
            } else {
                func_8007C820(sp84, D_801208E8, D_801208E4, D_801206A0, D_80120760);
            }
            phi_s1 = Quake_Add(sp84, 1);
            Quake_SetSpeed(phi_s1, 0x7D00);
            Quake_SetQuakeValues(phi_s1, 0, 0, 0x14, 0);
            Quake_SetCountdown(phi_s1, D_801208E4 - 10);
            break;
        case 110 + 0xCDA:
            Gameplay_CameraChangeSetting(globalCtx, arg1, 0x2A);
            func_8002DF38(globalCtx, player, 8);
            func_8007C820(sp84, D_8012069C | 0x2000, D_80120698, D_801204D4, D_801205B4);
            func_8007C76C(&spDC->eye, &D_801205B4[D_80120694 - 2].pos);
            func_8007C76C(&spDC->at, &D_801204D4[D_80120694 - 2].pos);
            phi_s1 = Quake_Add(sp84, 1);
            Quake_SetSpeed(phi_s1, 0x4E20);
            Quake_SetQuakeValues(phi_s1, 1, 0, 0x32, 0);
            Quake_SetCountdown(phi_s1, D_80120698 - 20);
            break;
        case 100 + 0xCDA:
            player->actor.shape.rot.y = player->actor.world.rot.y = player->currentYaw = -0x3FD9;

            ONEPOINTDEMO(sp84)->keyFrames = D_80121DB4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 9;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 20 + 0xCDA:
            ...
            Quake_SetSpeed(phi_s1, 0x7D00);
            Quake_SetQuakeValues(phi_s1, 2, 0, 0, 0);
            Quake_SetCountdown(phi_s1, timer);
            break;
        case 0 + 0xCDA:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80121F1C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 3);
            Quake_SetSpeed(phi_s1, 0x2EE0);
            Quake_SetQuakeValues(phi_s1, 0, 0, 0x3E8, 0);
            Quake_SetCountdown(phi_s1, 5);
            break;
        case 50 + 0xCDA:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80121FBC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 3);
            ...
            break;
        case 70 + 0xCDA:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012205C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_8002DF38(globalCtx, player, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 60 + 0xCDA:
            ...
            func_8002DF54(globalCtx, NULL, 8);
            ONEPOINTDEMO(sp84)->keyFrames = D_801220D4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 40 + 0xCDA:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012219C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 7;
            func_8002DF38(globalCtx, player, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 120 + 0xCDA:
            ONEPOINTDEMO(sp84)->keyFrames = D_801222B4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 1);
            Quake_SetSpeed(phi_s1, 0x7D00);
            Quake_SetQuakeValues(phi_s1, 4, 0, 0, 0);
            Quake_SetCountdown(phi_s1, 0x14);
            break;
        case 160 + 0xCDA:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012237C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_8002DF38(globalCtx, player, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 1);
            ...
            break;
        case 150 + 0xCDA:
            ONEPOINTDEMO(sp84)->keyFrames = D_801223CC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 6;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            ...
            break;
        case 140 + 0xCDA:
            ONEPOINTDEMO(sp84)->keyFrames = D_801224BC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 7;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 1);
            Quake_SetSpeed(phi_s1, 0x7D00);
            Quake_SetQuakeValues(phi_s1, 1, 0, 0xA, 0);
            Quake_SetCountdown(phi_s1, 0x14);
            break;
        case 0 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_801225D4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            ...
            break;
        case 10 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012269C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_8002DF38(globalCtx, player, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 20 + 0x1004:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80122714;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 40 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_801227B4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 6;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            Camera_ChangeMode(spDC, 0);
            break;
        case 50 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_801228A4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_8002DF54(globalCtx, NULL, 8);
            Camera_ChangeMode(spDC, 0);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 60 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012296C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_8002DF54(globalCtx, NULL, 8);
            Camera_ChangeMode(spDC, 0);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 70 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_80122A0C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_8002DF54(globalCtx, NULL, 8);
            Camera_ChangeMode(spDC, 0);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 90 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_80122A5C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 8;
            func_8002DF38(globalCtx, player, 8);
            Camera_ChangeMode(spDC, 0);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 100 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_80122B9C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_8002DF38(globalCtx, player, 8);
            Camera_ChangeMode(spDC, 0);
            func_800C0808(globalCtx, arg1, player, 0x3C);
        ...
        case 110 + 0x1004:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80122C14;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 1;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            phi_s1 = Quake_Add(sp84, 3);
            Quake_SetSpeed(phi_s1, 0x2EE0);
            Quake_SetQuakeValues(phi_s1, 0, 1, 0x64, 0);
            Quake_SetCountdown(phi_s1, timer - 0x50);
            break;
        case 120 + 0x1004:
            if (player->actor.world.pos.z < -15.0f) {
                ONEPOINTDEMO(sp84)->keyFrames = D_80122C3C;
            } else {
                ONEPOINTDEMO(sp84)->keyFrames = D_80122C64;
            }
            ONEPOINTDEMO(sp84)->keyFrameCnt = 1;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            ...
            phi_s1 = Quake_Add(sp84, 3);
            Quake_SetSpeed(phi_s1, 0x2EE0);
            Quake_SetQuakeValues(phi_s1, 0, 1, 0xA, 0);
            Quake_SetCountdown(phi_s1, timer - 0xA);
            break;
        case 121 + 0x1004:
            ONEPOINTDEMO(sp84)->keyFrames = D_80122C8C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 1;
            func_8002DF54(globalCtx, NULL, 8);
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 40 + 0xC94:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80122CB4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 41 + 0xC94:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80122D04;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x1F4A:
            ONEPOINTDEMO(sp84)->keyFrames = D_80122D54;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x1F42:
            ONEPOINTDEMO(sp84)->keyFrames = D_80122DCC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x21FC:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80122E44[timer & 1];
            ONEPOINTDEMO(sp84)->keyFrameCnt = 7;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x44C:
            temp_v0_21 = globalCtx->state.frames - D_80120138;
            if (((temp_v0_21) > 3600) || (temp_v0_21 < -3600)) {
                ONEPOINTDEMO(sp84)->keyFrames = D_80123074;
                ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            } else {
                ...
                ONEPOINTDEMO(sp84)->keyFrames = D_8012313C;
                ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            }
            func_800C0808(globalCtx, arg1, player, 0x3C);
        ...
        case 0x26B4:
            if (func_800C0CB8(globalCtx) != 0) {
                ...
                ONEPOINTDEMO(sp84)->keyFrames = D_801231B4;
                ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
                func_800C0808(globalCtx, arg1, player, 0x3C);
            } else {
                ...
                ONEPOINTDEMO(sp84)->keyFrames = D_80123254;
                ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
                func_800C0808(globalCtx, arg1, player, 0x3C);
            }
            break;
        case 0x3E8:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_801232A4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 1;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x219B:
            ONEPOINTDEMO(sp84)->keyFrames = D_801232CC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x219C:
            ONEPOINTDEMO(sp84)->keyFrames = D_80123394;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0 + 0xFA0:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012345C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 10 + 0xFA0:
            ONEPOINTDEMO(sp84)->keyFrames = D_801234FC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 11 + 0xFA0:
            ONEPOINTDEMO(sp84)->keyFrames = D_801235C4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 20 + 0xFA0:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012368C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 21 + 0xFA0:
            ONEPOINTDEMO(sp84)->keyFrames = D_8012372C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 4;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 22 + 0xFA0:
            sp84->timer = D_801237CC[0].timerInit + D_801237CC[3].timerInit + D_801237CC[1].timerInit +
                          D_801237CC[2].timerInit + D_801237CC[4].timerInit;
            ONEPOINTDEMO(sp84)->keyFrames = D_801237CC;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 5;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x25E7:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_80123894;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x25E8:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_8012390C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 2;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x25E9:
            ...
            ONEPOINTDEMO(sp84)->keyFrames = D_8012395C;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
            func_800C0808(globalCtx, arg1, player, 0x3C);
            break;
        case 0x13F6:
            D_801239D4[1].timerInit = 10;
            ONEPOINTDEMO(sp84)->keyFrames = D_801239D4;
            ONEPOINTDEMO(sp84)->keyFrameCnt = 3;
