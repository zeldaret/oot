 ...
 * successful collision. To collide, an AT collider must share a type (GET_PLAYER(globalCtx), ENEMY, or BOMB) with the
 * AC collider and the toucher and bumper elements that overlapped must share a dmgFlag.
 */
