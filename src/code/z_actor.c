...
void func_8002DE74(GlobalContext* globalCtx, Player* player) {
    if ((globalCtx->roomCtx.curRoom.behaviorType1 != 4) && func_800C0CB8(globalCtx)) {
...
void Actor_DrawLensActors(GlobalContext* globalCtx, s32 numInvisibleActors, Actor** invisibleActors) {
    ...
    if (globalCtx->roomCtx.curRoom.lensActorsMode == LENS_ACTORS_MODE_SEETHROUGH) {
            ...
            if ((HREG(64) != 1) || ((HREG(65) != -1) && (HREG(65) != HREG(66))) || (HREG(71) == 0)) {
                if ((actor->init == NULL) && (actor->draw != NULL) && (actor->flags & (ACTOR_FLAG_5 | ACTOR_FLAG_6))) {
                    if ((actor->flags & ACTOR_FLAG_7) &&
                        ((globalCtx->roomCtx.curRoom.lensActorsMode == LENS_ACTORS_MODE_SEETHROUGH) ||
