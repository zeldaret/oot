...
void func_8002C124(TargetContext* targetCtx, GlobalContext* globalCtx) {
    ...
    if (targetCtx->unk_48 != 0) {
        ...
        if ((!(player->stateFlags1 & PLAYER_STATE_FLAG_1_6)) || (actor != player->unk_664)) {
...
f32 Player_GetHeight(Player* player) {
    f32 offset = (player->stateFlags1 & PLAYER_STATE_FLAG_1_23) ? 32.0f : 0.0f;
...
f32 func_8002DCE4(Player* player) {
    if (player->stateFlags1 & PLAYER_STATE_FLAG_1_23) {
        return 8.0f;
    } else if (player->stateFlags1 & PLAYER_STATE_FLAG_1_27) {
...
s32 func_8002DD6C(Player* player) {
    return player->stateFlags1 & PLAYER_STATE_FLAG_1_3;
}
...
s32 func_8002DDA8(GlobalContext* globalCtx) {
    ...
    return (player->stateFlags1 & PLAYER_STATE_FLAG_1_11) || func_8002DD78(player);
}

s32 func_8002DDE4(GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);

    return player->stateFlags2 & PLAYER_STATE_FLAG_2_3;
}

s32 func_8002DDF4(GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);

    return player->stateFlags2 & PLAYER_STATE_FLAG_2_12;
}
...
void Actor_MountHorse(GlobalContext* globalCtx, Player* player, Actor* horse) {
    ...
    player->stateFlags1 |= PLAYER_STATE_FLAG_1_23;
    horse->child = &player->actor;
}

s32 func_8002DEEC(Player* player) {
    return (player->stateFlags1 & (PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_29)) || (player->csMode != 0);
}
...
u32 D_80116068[] = {
    PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_28,
    PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_28,
    0,
    PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_10 | PLAYER_STATE_FLAG_1_28,
    PLAYER_STATE_FLAG_1_7,
    PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_28 | PLAYER_STATE_FLAG_1_29,
    PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_28,
    0,
    PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_28 | PLAYER_STATE_FLAG_1_29,
    PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_10 | PLAYER_STATE_FLAG_1_28,
    0,
...
void Actor_UpdateAll(GlobalContext* globalCtx, ActorContext* actorCtx) {
    ...
    if (player->stateFlags2 & PLAYER_STATE_FLAG_2_27) {
        unkFlag = ACTOR_FLAG_25;
    }

    if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_6) && ((player->actor.textId & 0xFF00) != 0x600)) {
...
s32 Actor_IsTargeted(GlobalContext* globalCtx, Actor* actor) {
    ...
    if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_4) && actor->isTargeted) {
        return true;
    } else {
        return false;
    }
