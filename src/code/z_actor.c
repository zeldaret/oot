...
void func_8002CDE4(GlobalContext* globalCtx, TitleCardContext* titleCtx) {
    titleCtx->timer1 = titleCtx->timer2 = titleCtx->color = titleCtx->alpha = 0;
}
...
void TitleCard_InitPlaceName(GlobalContext* globalCtx, TitleCardContext* titleCtx, void* texture, s32 arg3, s32 arg4,
    ...
    titleCtx->height = arg6;
    titleCtx->timer1 = 80;
    titleCtx->timer2 = arg7;
}

void TitleCard_Update(GlobalContext* globalCtx, TitleCardContext* titleCtx) {
    if (DECR(titleCtx->timer2) == 0) {
        if (DECR(titleCtx->timer1) == 0) {
            Math_StepToS(&titleCtx->alpha, 0, 30);
            Math_StepToS(&titleCtx->color, 0, 70);
        } else {
            Math_StepToS(&titleCtx->alpha, 255, 10);
            Math_StepToS(&titleCtx->color, 255, 20);
        }
    }
}
...
void TitleCard_Draw(GlobalContext* globalCtx, TitleCardContext* titleCtx) {
    ...
    if (titleCtx->alpha != 0) {
        ...
        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, (u8)titleCtx->color, (u8)titleCtx->color, (u8)titleCtx->color,
                        (u8)titleCtx->alpha);
...
s32 func_8002D53C(GlobalContext* globalCtx, TitleCardContext* titleCtx) {
    if ((globalCtx->actorCtx.titleCtx.timer2 != 0) || (globalCtx->actorCtx.titleCtx.alpha != 0)) {
        titleCtx->timer1 = 0;
        titleCtx->timer2 = 0;
        return 0;
    }
