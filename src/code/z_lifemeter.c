...
s32 func_80078E18(GlobalContext* globalCtx) {
    gSaveContext.save.info.playerData.health = globalCtx->interfaceCtx.unk_226;
    return 1;
}
...
s32 func_80078E84(GlobalContext* globalCtx) {
    ...
    if (interfaceCtx->unk_228 != 0) {
        ...
        if (interfaceCtx->unk_226 <= 0) {
            ...
            globalCtx->damagePlayer(globalCtx, -(gSaveContext.save.info.playerData.health + 1));
            return 1;
        }
    }
...
u32 Health_IsCritical(void) {
    ...
    if ((var >= gSaveContext.save.info.playerData.health) && (gSaveContext.save.info.playerData.health > 0)) {
        return 1;
    } else {
        return 0;
    }
