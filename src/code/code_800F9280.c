...
ReverbSettings D_80133420[] = {
    ...
    /* 0x0A */ { 1, 0x50, 0x5000, 0, 0, 0x7FFF, 0x1000, 0x1000, 0xFF, 0x3000, 0x7, 0x7 },
    /* 0x0B */ { 0 },
    ...
    /* 0x19 */ { 2, 0x50, 0x5000, 0, 0, 0x7FFF, 0xD000, 0x3000, 0xFF, 0x3000, 0x0, 0x0 },
    /* 0x1A */ { 0 },
    /* 0x1B */ { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    /* 0x1C */ { 1, 0x20, 0x0000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x0000, 0x0, 0x0 },
    /* 0x1D */ { 0 },
    /* 0x1E */ { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    /* 0x1F */ { 1, 0x30, 0x1800, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x0000, 0xB, 0xB },
    /* 0x20 */ { 0 },
    /* 0x21 */ { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    /* 0x22 */ { 0 },
    /* 0x23 */ { 0 },
    /* 0x24 */ { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    /* 0x25 */ { 1, 0x40, 0x5000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    /* 0x26 */ { 0 },
};

AudioSpec gAudioSpecs[18] = {
    /* 0x0  */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[0],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x4000,  0x2880, 0, 0, 0 },
    /* 0x1  */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[3],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x2  */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[6],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x3  */ { 32000, 1, 23, 4, 0, 0, 2, &D_80133420[12], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x4  */ { 32000, 1, 23, 4, 0, 0, 2, &D_80133420[15], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x5  */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[18], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x6  */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[21], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x7  */ { 32000, 1, 23, 4, 0, 0, 2, &D_80133420[24], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x8  */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[27], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0x9  */ { 32000, 1, 23, 4, 0, 0, 2, &D_80133420[24], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x3800,  0x2880, 0, 0, 0 },
    /* 0xA  */ { 32000, 1, 28, 3, 0, 0, 2, &D_80133420[30], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00, 0, 0x2800,  0x2880, 0, 0, 0 },
    /* 0xB  */ { 32000, 1, 28, 3, 0, 0, 1, &D_80133420[33], 0x300, 0x200, 0x7FFF, 0,     0x4800, 0, 0x4000,      0, 0, 0, 0 },
    /* 0xC  */ { 32000, 1, 28, 3, 0, 0, 1, &D_80133420[33], 0x300, 0x200, 0x7FFF, 0    ,     0,  0, 0x4000, 0x4800, 0, 0, 0 },
    /* 0xD  */ { 32000, 1, 22, 4, 0, 0, 2, &D_80133420[0],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00,  0, 0x3800, 0x2880, 0, 0, 0 },
    /* 0xE  */ { 32000, 1, 22, 4, 0, 0, 2, &D_80133420[24], 0x300, 0x200, 0x7FFF, 0x7F0, 0xE00,  0, 0x3800, 0x2880, 0, 0, 0 },
    /* 0xF  */ { 32000, 1, 16, 4, 0, 0, 2, &D_80133420[0],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00,  0, 0x3800, 0x2880, 0, 0, 0 },
    /* 0x10 */ { 22050, 1, 24, 4, 0, 0, 2, &D_80133420[0],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00,  0, 0x3800, 0x2880, 0, 0, 0 },
    /* 0x11 */ { 32000, 1, 24, 4, 0, 0, 2, &D_80133420[6],  0x300, 0x200, 0x7FFF, 0x7F0, 0xE00,  0, 0x3600, 0x2600, 0, 0, 0 },
};
