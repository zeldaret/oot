...
void Gameplay_Init(GlobalContext* globalCtx) {
    ...
    func_8005D3BC(globalCtx, &globalCtx->collisionCheckCtx);
        ...
        if (1 && (D_80161490 != 3)) {
            ...
            if ((sp80 == 0) && (IREG(72) == 0)) {
                ...
                if ((globalCtx->actorCtx.unk_00 != 0) && (globalCtx->actorCtx.unk_00-- < 5)) {
                    ...
                    func_8006139C(globalCtx, &globalCtx->collisionCheckCtx);
                    ...
                    func_800622E4(globalCtx, &globalCtx->collisionCheckCtx);
