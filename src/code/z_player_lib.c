...
void Player_DrawHookshotReticle(PlayState* play, Player* this, f32 arg2) {
    ...
    if (BgCheck_AnyLineTest3(&play->colCtx, &sp8C, &sp80, &sp74, &sp9C, 1, 1, 1, 1, &bgId)) {
        ...
        gSPMATRIX_SET_NEW(OVERLAY_DISP++, play->state.gfxCtx, "../z_player_lib.c", 2587);
...
void Player_PostLimbDrawGameplay(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == PLAYER_LIMB_L_HAND) {
        ...
        if (this->itemAction == PLAYER_IA_DEKU_STICK) {
            ...
            gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_player_lib.c", 2653);
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_player_lib.c", 2712);
        ...
        if (this->rightHandType == PLAYER_MODELTYPE_RH_FF) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_player_lib.c", 2804);
