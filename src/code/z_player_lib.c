...
void Player_UpdateShieldCollider(GlobalContext* globalCtx, Player* this, ColliderQuad* collider, Vec3f* quadSrc) {
...
void Player_PostLimbDrawGameplay(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == PLAYER_LIMB_L_HAND) {
        ...
        if (this->rightHandType == PLAYER_MODELTYPE_RH_FF) {
            ...
            Matrix_Get(&this->shieldMf);
            Player_UpdateShieldCollider(globalCtx, this, &this->shieldQuad, sRightHandLimbModelShieldQuadVertices);
        }
        ...
        if (limbIndex == PLAYER_LIMB_SHEATH) {
            if ((this->rightHandType != PLAYER_MODELTYPE_RH_SHIELD) &&
                ...
                if (Player_IsChildWithHylianShield(this)) {
                    Player_UpdateShieldCollider(globalCtx, this, &this->shieldQuad, sSheathLimbModelShieldQuadVertices);
                }
