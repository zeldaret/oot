...
s16 sBootData[PLAYER_BOOTS_MAX][17] = {
    ...
    {
        200,                              // REG(19)
        FRAME_RATE_DEPENDENT(1000, 1200), // REG(30)
        FRAME_RATE_DEPENDENT(300, 360),   // REG(32)
        700,                              // REG(34)
        FRAME_RATE_DEPENDENT(550, 660),   // REG(35)
        FRAME_RATE_DEPENDENT(270, 324),   // REG(36)
        600,                              // REG(37)
        FRAME_RATE_DEPENDENT(350, 420),   // REG(38)
        800,                              // REG(43)
        600,                              // REG(45)
        -100,                             // REG(68)
        600,                              // REG(69)
        ...
        125,                              // IREG(68)
        200,                              // IREG(69)
        FRAME_RATE_DEPENDENT(130, 156),   // MREG(95)
    },
    // PLAYER_BOOTS_IRON
    {
        200,                              // REG(19)
        ...
        FRAME_RATE_DEPENDENT(270, 324),   // REG(36)
        1000,                             // REG(37)
        FRAME_RATE_DEPENDENT(0, 0),       // REG(38)
        800,                              // REG(43)
        300,                              // REG(45)
        -160,                             // REG(68)
        600,                              // REG(69)
    ...
    // PLAYER_BOOTS_HOVER
    {
        ...
        FRAME_RATE_DEPENDENT(270, 324),   // REG(36)
        600,                              // REG(37)
        FRAME_RATE_DEPENDENT(600, 720),   // REG(38)
        800,                              // REG(43)
        550,                              // REG(45)
        -100,                             // REG(68)
        600,                              // REG(69)
    ...
    // PLAYER_BOOTS_INDOOR
    {
        ...
        FRAME_RATE_DEPENDENT(300, 360),   // REG(32)
        700,                              // REG(34)
        FRAME_RATE_DEPENDENT(380, 456),   // REG(35)
        FRAME_RATE_DEPENDENT(400, 480),   // REG(36)
        0,                                // REG(37)
        FRAME_RATE_DEPENDENT(300, 360),   // REG(38)
        800,                              // REG(43)
        500,                              // REG(45)
        -100,                             // REG(68)
        600,                              // REG(69)
    ...
    {
        80,                             // REG(19)
        FRAME_RATE_DEPENDENT(800, 960), // REG(30)
        FRAME_RATE_DEPENDENT(150, 180), // REG(32)
        700,                            // REG(34)
        FRAME_RATE_DEPENDENT(480, 576), // REG(35)
        FRAME_RATE_DEPENDENT(270, 324), // REG(36)
        600,                            // REG(37)
        FRAME_RATE_DEPENDENT(50, 60),   // REG(38)
        800,                            // REG(43)
        550,                            // REG(45)
        -40,                            // REG(68)
        400,                            // REG(69)
        ...
        25,                             // IREG(68)
        0,                              // IREG(69)
        FRAME_RATE_DEPENDENT(80, 96),   // MREG(95)
    },
    // PLAYER_BOOTS_KOKIRI_CHILD
    {
        ...
        FRAME_RATE_DEPENDENT(300, 360),   // REG(32)
        800,                              // REG(34)
        FRAME_RATE_DEPENDENT(500, 600),   // REG(35)
        FRAME_RATE_DEPENDENT(400, 480),   // REG(36)
        800,                              // REG(37)
        FRAME_RATE_DEPENDENT(400, 480),   // REG(38)
        800,                              // REG(43)
        550,                              // REG(45)
        -100,                             // REG(68)
        600,                              // REG(69)
        ...
        125,                              // IREG(68)
        400,                              // IREG(69)
        FRAME_RATE_DEPENDENT(200, 240),   // MREG(95)
    },
};
