...
u32 func_80091738(PlayState* play, u8* segment, SkelAnime* skelAnime) {
    ...
    DmaMgr_SyncDmaRequestDebug(ptr, gObjectTable[OBJECT_GAMEPLAY_KEEP].vromStart, size, "../z_player_lib.c", 2982);
    ...
    DmaMgr_SyncDmaRequestDebug(ptr, gObjectTable[linkObjectId].vromStart, size, "../z_player_lib.c", 2988);
