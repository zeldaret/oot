...
s32 func_8006CFC0(s32 scene) {
    s32 validScenes[] = { SCENE_SPOT00, SCENE_SPOT06, SCENE_SPOT09, SCENE_SPOT12, SCENE_SPOT20, SCENE_ENRUI, SCENE_MARKET_RUINS, SCENE_GANON_TOU, SCENE_SPOT03 };
    s32 i;
