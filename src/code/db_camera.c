...
void DbCamera_Update(DbCamera* dbCamera, Camera* cam) {
    ...
    *sp90 = temp_s6->pos;
    ...
    if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].cur.button, BTN_R)) {
        ...
        pitch = DEG_TO_BINANG((SQ(temp_f0_5) / 600.0f) * 0.8f);
        yaw = DEG_TO_BINANG((SQ(temp_f2_2) / 600.0f) * 0.8f);
        if (!D_80161144) {
        ...
        DbCamera_CalcUpFromPitchYawRoll(&dbCamera->unk_1C, spF4.pitch, spF4.yaw, DEG_TO_BINANG(dbCamera->rollDegrees));
            ...
            switch (dbCamera->sub.unk_08) {
                ...
                case 0:
                    ...
                    if (dbCamera->sub.mode != 1) {
                        ...
                        DbCamera_SetTextValue(BINANG_TO_DEG(sp104.pitch), &D_8012D0E4[11], 4);
                        func_8006376C(0xF, 0x17, 3, D_8012D0E4);
                        DbCamera_SetTextValue(BINANG_TO_DEG(sp104.yaw), &D_8012D0F8[11], 4);
            ...
            if (dbCamera->sub.mode != 1) {
                ...
                func_8006376C(3, 0x16,
                              ...
                              : !D_80161144                                                               ? 4
                                                                                                          : 3,
                              D_8012CF30);
                DbCamera_SetTextValue(BINANG_TO_DEG(spFC.pitch), &D_8012D0E4[10], 4);
                func_8006376C(3, 0x17, 3, D_8012D0E4);
                DbCamera_SetTextValue(BINANG_TO_DEG(spFC.yaw), &D_8012D0F8[10], 4);
        ...
        default: {
            ...
            if (sDbCamAnim.unk_0A != 0) {
                ...
                DbCamera_CalcUpFromPitchYawRoll(&dbCamera->unk_1C, sp5C.pitch, sp5C.yaw,
                                                DEG_TO_BINANG(dbCamera->rollDegrees));
                return 2;
            }
