...
void DbCamera_Update(DbCamera* dbCamera, Camera* cam) {
    ...
    *sp90 = temp_s6->pos;
    ...
    if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].press.button, BTN_Z)) {
        ...
        sDbCamAnim.unk_0A = 0;
        Audio_PlaySfxGeneral(NA_SE_SY_LOCK_ON, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
        ...
        if (dbCamera->unk_00 == 0) {
            ...
            *sp80 = cam->eye;
            ...
            if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].press.button, BTN_R) &&
                ...
                Audio_PlaySfxGeneral(NA_SE_SY_CANCEL, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
                ...
                if (dbCamera->sub.unkIdx == 0x80) {
                    ...
                    Audio_PlaySfxGeneral(NA_SE_IT_SWORD_PUTAWAY, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                         &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    ...
    if (dbCamera->unk_00 == 1) {
        ...
        if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].cur.button, BTN_CRIGHT) &&
            ...
            if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].press.button, BTN_CUP) &&
                CHECK_BTN_ALL(sGlobalCtx->state.input[2].cur.button, BTN_L)) {
                Audio_PlaySfxGeneral(NA_SE_IT_SWORD_IMPACT, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
            ...
            switch (dbCamera->sub.unk_08) {
                ...
                case 1:
                    ...
                    if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].press.button, BTN_DUP)) {
                        Audio_PlaySfxGeneral(NA_SE_SY_ATTENTION_ON, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
...
void DbCamera_PrintAllCuts(Camera* cam) {
    ...
    Audio_PlaySfxGeneral(NA_SE_SY_GET_RUPY, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal, &gSfxFreqOrVolDefaultVal,
                         &gSfxReverbAddNone);
    osSyncPrintf("@@@\n@@@\n@@@/* ****** spline point data ** start here ***** */\n@@@\n");
