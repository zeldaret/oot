...
AudioAsyncLoad* AudioLoad_StartAsyncLoadUnkMedium(s32 unkMediumParam, u32 devAddr, void* ramAddr, ssize_t size, s32 medium,
...
void AudioLoad_DmaSlowCopyUnkMedium(s32 devAddr, u8* ramAddr, ssize_t size, s32 arg3);
