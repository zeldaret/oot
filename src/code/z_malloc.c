...
void* ZeldaArena_Malloc(u32 size) {
    ...
    // "Secure"
    ZeldaArena_CheckPointer(ptr, size, "zelda_malloc", "確保");
    return ptr;
}
...
void* ZeldaArena_MallocDebug(u32 size, const char* file, s32 line) {
    ...
    // "Secure"
    ZeldaArena_CheckPointer(ptr, size, "zelda_malloc_DEBUG", "確保");
    return ptr;
}
...
void* ZeldaArena_MallocR(u32 size) {
    ...
    // "Secure"
    ZeldaArena_CheckPointer(ptr, size, "zelda_malloc_r", "確保");
    return ptr;
}
...
void* ZeldaArena_MallocRDebug(u32 size, const char* file, s32 line) {
    ...
    // "Secure"
    ZeldaArena_CheckPointer(ptr, size, "zelda_malloc_r_DEBUG", "確保");
    return ptr;
}
...
void* ZeldaArena_Realloc(void* ptr, u32 newSize) {
    ...
    // "Re-securing"
    ZeldaArena_CheckPointer(ptr, newSize, "zelda_realloc", "再確保");
    return ptr;
}
...
void* ZeldaArena_ReallocDebug(void* ptr, u32 newSize, const char* file, s32 line) {
    ...
    // "Re-securing"
    ZeldaArena_CheckPointer(ptr, newSize, "zelda_realloc_DEBUG", "再確保");
    return ptr;
}
