...
static OnePointCsFull D_801208EC[3] = {
    {
        ...
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_8),
        0x0101,
        1,
        0,
        60.0f,
...
static OnePointCsFull D_801209B4[4] = {
    ...
    },
    {
        ...
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_1),
        0x0100,
        29,
        0,
        45.0f,
...
static OnePointCsFull D_8012110C[3] = {
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, true, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_5),
        0x2142,
        1,
        0,
        50.0f,
...
static OnePointCsFull D_80121224[6] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_4, false, true),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_52),
        0x4104,
        80,
        0,
        70.0f,
...
static OnePointCsFull D_801213B4[5] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, false, true),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_83),
        0xC2C2,
        30,
        0,
        50.0f,
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_4, false, true),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_69),
        0x4222,
        30,
        0,
        60.0f,
...
static OnePointCsFull D_8012156C[2] = {
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, false, true),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_77),
        0x4242,
        1,
        0,
        65.0f,
...
static OnePointCsFull D_801215E4[10] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_9),
        0x0101,
        40,
        -5,
        70.0f,
...
static OnePointCsFull D_80121814[4] = {
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_76),
        0x0101,
        5,
        0,
        40.0f,
...
static OnePointCsFull D_80121DB4[9] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_57),
        0x2121,
        1,
        8,
        75.0f,
    ...
    },
    {
        ...
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_56),
        0x2121,
        149,
        -20,
        70.0f,
...
static OnePointCsFull D_80121F1C[4] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_1, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_2),
        0x2121,
        23,
        0,
        50.0f,
...
static OnePointCsFull D_801222B4[5] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_11, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_ACTORCAT, ACTORCAT_BG),
        0x0101,
        20,
        10,
        45.0f,
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_11, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_ACTORCAT, ACTORCAT_DOOR),
        0x0101,
        5,
        10,
        45.0f,
...
static OnePointCsFull D_801225D4[5] = {
    ...
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_1, false, false),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_PLAYER_CS, PLAYER_CSMODE_59),
        0x0101,
        60,
        4,
        50.0f,
...
static OnePointCsFull D_801231B4[4] = {
    {
        ONEPOINT_CS_ACTION(ONEPOINT_CS_ACTION_ID_15, false, true),
        ONEPOINT_CS_FIELD(ONEPOINT_CS_FIELD_TYPE_HUD_VISIBILITY, HUD_VISIBILITY_A_HEARTS_MAGIC_FORCE),
        0x4343,
        1,
        0,
        50.0f,
