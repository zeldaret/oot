...
void Audio_InitNoteSub(Note* note, NoteSubEu* sub, NoteSubAttributes* attrs) {
    ...
    if (stereoHeadsetEffects && (gAudioContext.soundMode == AUDIO_FS_HEADSET)) {
        smallPanIndex = pan >> 1;
    ...
    } else if (stereoHeadsetEffects && (gAudioContext.soundMode == AUDIO_FS_STEREO)) {
    ...
    } else if (gAudioContext.soundMode == AUDIO_FS_MONO) {
