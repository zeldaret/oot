 ...
 * @return s32 harmonicIndex, the log of the harmonic for the synthetic wave generated by gWaveSamples
 */
s32 Audio_BuildSyntheticWave(Note* note, SequenceLayer* layer, s32 waveId) {
    ...
    note->noteSubEu.sound.waveSampleAddr = &gWaveSamples[waveId - 128][harmonicIndex * 64];
