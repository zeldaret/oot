    ...
    switch (cmd->type) {
        ...
        case CS_MISC_DEKU_TREE_DEATH:
            ...
            if (csCtx->curFrame == 783) {
                Audio_PlaySfxGeneralWithDefaultSettings1(NA_SE_EV_DEKU_DEATH);
        ...
        case CS_MISC_SANDSTORM_FILL:
            ...
            Audio_PlaySfxGeneralWithDefaultSettings2(NA_SE_EV_SAND_STORM - SFX_FLAG);
            break;
            ...
            case CS_TRANS_GRAY_FILL_OUT:
                ...
                if (cmd->type == CS_TRANS_GRAY_FILL_IN) {
                    ...
                    if ((lerp == 0.0f) && (gSaveContext.entranceIndex == ENTR_CHAMBER_OF_THE_SAGES_0)) {
                        ...
                        Audio_PlaySfxGeneralWithDefaultSettings2(NA_SE_EV_WHITE_OUT);
                    }
                } else {
