...
void func_80083108(GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.cutsceneIndex < 0xFFF0) ||
        ...
        if ((player->stateFlags1 & 0x00800000) || (globalCtx->shootingGalleryAmmo > 1) ||
            ...
            if (gSaveContext.equips.buttonItems[0] != ITEM_NONE) {
                ...
                } else if (globalCtx->shootingGalleryAmmo > 1) {
                    Interface_ChangeAlpha(8);
...
void Interface_DrawAmmoCount(GlobalContext* globalCtx, s16 button, s16 alpha) {
    ...
    if ((i == ITEM_STICK) || (i == ITEM_NUT) || (i == ITEM_BOMB) || (i == ITEM_BOW) ||
        ...
        } else if ((button == 0) && (globalCtx->shootingGalleryAmmo > 1)) {
...
void Interface_Draw(GlobalContext* globalCtx) {
    ...
    if (pauseCtx->flag == 0) {
        ...
        if ((globalCtx->pauseCtx.state == 0) && (globalCtx->pauseCtx.flag == 0) && (globalCtx->unk_10A20 == 0) &&
            ...
            (globalCtx->shootingGalleryAmmo <= 1) &&
            !((globalCtx->sceneNum == SCENE_BOWLING) && Flags_GetSwitch(globalCtx, 0x38))) {
            sp274 = 0;
