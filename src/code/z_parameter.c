...
void func_80083108(GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.cutsceneIndex < 0xFFF0) ||
        ...
        if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_23) || (globalCtx->shootingGalleryStatus > 1) ||
            ...
            if (gSaveContext.equips.buttonItems[0] != ITEM_NONE) {
                ...
                if (globalCtx->transitionMode != 0) {
                    ...
                    Interface_ChangeAlpha(8);
                } else if (player->stateFlags1 & PLAYER_STATE_FLAG_1_23) {
                    Interface_ChangeAlpha(12);
                }
            } else {
                if (player->stateFlags1 & PLAYER_STATE_FLAG_1_23) {
                    Interface_ChangeAlpha(12);
                }
            }
    ...
    if (interfaceCtx->naviCalling && (globalCtx->pauseCtx.state == 0) && (globalCtx->pauseCtx.debugState == 0) &&
        ...
        if (!sCUpInvisible) {
            ...
            if ((gSaveContext.unk_13EA == 1) || (gSaveContext.unk_13EA == 2) || (gSaveContext.unk_13EA == 5)) {
                temp = 0;
            } else if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_21) || (func_8008F2F8(globalCtx) == 4) ||
                       (player->stateFlags2 & PLAYER_STATE_FLAG_2_18)) {
                temp = 70;
            } else {
...
void Interface_Draw(GlobalContext* globalCtx) {
    ...
    if (pauseCtx->debugState == 0) {
        ...
        if ((globalCtx->pauseCtx.state == 0) && (globalCtx->pauseCtx.debugState == 0) &&
            ...
            !(player->stateFlags2 & PLAYER_STATE_FLAG_2_24) && (globalCtx->sceneLoadFlag == 0) &&
