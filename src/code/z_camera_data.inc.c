...
typedef enum {
    /* 0 */ CAM_VERTICAL_PLATFORM_FIRE_LOWER_FLOOR,
    /* 1 */ CAM_VERTICAL_PLATFORM_FIRE_EAST_TOWER,
    /* 2 */ CAM_VERTICAL_PLATFORM_FIRE_WEST_TOWER,
    /* 3 */ CAM_VERTICAL_PLATFORM_SPIRIT_ENTRANCE
} CamVerticalPlatform;

Vec3f sCamVerticalPlatformLowerEyePoints[] = {
    { 3050.0f, 700.0f, 0.0f },     // CAM_VERTICAL_PLATFORM_FIRE_LOWER_FLOOR
    { 1755.0f, 3415.0f, -380.0f }, // CAM_VERTICAL_PLATFORM_FIRE_EAST_TOWER
    { -3120.0f, 3160.0f, 245.0f }, // CAM_VERTICAL_PLATFORM_FIRE_WEST_TOWER
    { 0.0f, -10.0f, 240.0f },      // CAM_VERTICAL_PLATFORM_SPIRIT_ENTRANCE
};

Vec3f sCamVerticalPlatformUpperEyePoints[] = {
    { 3160.0f, 2150.0f, 0.0f },    // CAM_VERTICAL_PLATFORM_FIRE_LOWER_FLOOR
    { 1515.0f, 4130.0f, -835.0f }, // CAM_VERTICAL_PLATFORM_FIRE_EAST_TOWER
    { -3040.0f, 4135.0f, 230.0f }, // CAM_VERTICAL_PLATFORM_FIRE_WEST_TOWER
    { -50.0f, 600.0f, -75.0f },    // CAM_VERTICAL_PLATFORM_SPIRIT_ENTRANCE
};

// Trigger player y position to swap eye points
f32 sCamVerticalPlatformTogglePosY[] = {
    1570.0f, // CAM_VERTICAL_PLATFORM_FIRE_LOWER_FLOOR
    3680.0f, // CAM_VERTICAL_PLATFORM_FIRE_EAST_TOWER
    3700.0f, // CAM_VERTICAL_PLATFORM_FIRE_WEST_TOWER
    395.0f,  // CAM_VERTICAL_PLATFORM_SPIRIT_ENTRANCE
};

f32 sCamVerticalPlatformFovRollParam[] = {
    320.0f, // CAM_VERTICAL_PLATFORM_FIRE_LOWER_FLOOR
    320.0f, // CAM_VERTICAL_PLATFORM_FIRE_EAST_TOWER
    320.0f, // CAM_VERTICAL_PLATFORM_FIRE_WEST_TOWER
    0.0f,   // CAM_VERTICAL_PLATFORM_SPIRIT_ENTRANCE
};

s16 sCamVerticalPlatformRolls[] = {
    -2000, // CAM_VERTICAL_PLATFORM_FIRE_LOWER_FLOOR
    -1000, // CAM_VERTICAL_PLATFORM_FIRE_EAST_TOWER
    0,     // CAM_VERTICAL_PLATFORM_FIRE_WEST_TOWER
    0      // CAM_VERTICAL_PLATFORM_SPIRIT_ENTRANCE
};
