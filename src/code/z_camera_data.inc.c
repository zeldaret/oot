...
typedef enum {
    /* 0 */ CAM_ELEVATOR_PLATFORM_FIRE_TEMPLELOWER_FLOOR, // ACTOR_BG_HIDAN_ROCK
    /* 1 */ CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEEAST_TOWER,  // ACTOR_BG_HIDAN_FSLIFT
    /* 2 */ CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEWEST_TOWER,  // ACTOR_BG_HIDAN_SYOKU
    /* 3 */ CAM_ELEVATOR_PLATFORM_SPIRIT_TEMPLE_ENTRANCE  // ACTOR_BG_JYA_1FLIFT
} CamElevatorPlatform;

Vec3f sCamElevatorPlatformLowerEyePoints[] = {
    { 3050.0f, 700.0f, 0.0f },     // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLELOWER_FLOOR
    { 1755.0f, 3415.0f, -380.0f }, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEEAST_TOWER
    { -3120.0f, 3160.0f, 245.0f }, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEWEST_TOWER
    { 0.0f, -10.0f, 240.0f },      // CAM_ELEVATOR_PLATFORM_SPIRIT_TEMPLE_ENTRANCE
};

Vec3f sCamElevatorPlatformUpperEyePoints[] = {
    { 3160.0f, 2150.0f, 0.0f },    // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLELOWER_FLOOR
    { 1515.0f, 4130.0f, -835.0f }, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEEAST_TOWER
    { -3040.0f, 4135.0f, 230.0f }, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEWEST_TOWER
...
f32 sCamElevatorPlatformTogglePosY[] = {
    1570.0f, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLELOWER_FLOOR
    3680.0f, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEEAST_TOWER
    3700.0f, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEWEST_TOWER
    395.0f,  // CAM_ELEVATOR_PLATFORM_SPIRIT_TEMPLE_ENTRANCE
};

f32 sCamElevatorPlatformFovRollParam[] = {
    320.0f, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLELOWER_FLOOR
    320.0f, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEEAST_TOWER
    320.0f, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEWEST_TOWER
    0.0f,   // CAM_ELEVATOR_PLATFORM_SPIRIT_TEMPLE_ENTRANCE
};

s16 sCamElevatorPlatformRolls[] = {
    -2000, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLELOWER_FLOOR
    -1000, // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEEAST_TOWER
    0,     // CAM_ELEVATOR_PLATFORM_FIRE_TEMPLEWEST_TOWER
