            ...
            if (sDisplayedNoteValue != sPlaybackSong[sPlaybackNotePos].noteIdx) {
                ...
                if (sDisplayedNoteValue != 0xFF) {
                    ...
                    Audio_PlaySfxGeneral(NA_SE_OC_OCARINA, &gSfxPosScreenCenter, 4, &sNormalizedNotePlaybackTone,
                                         &sNormalizedNotePlaybackVolume, &gSfxReverbAddNone);
                } else {
                    Audio_StopSfxById(NA_SE_OC_OCARINA);
                }
            }
        ...
        switch (sAudioSndContSel) {
            ...
            case 3:
                Audio_PlaySfxGeneral(((sAudioSndContWork[2] << 12) & 0xFFFF) + sAudioSndContWork[3] + SFX_FLAG,
                                     &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal, &gSfxFreqOrVolDefaultVal,
                                     &gSfxReverbAddNone);
                break;
            case 4:
...
void AudioDebug_ProcessInput_SfxParamChg(void) {
    ...
    if (CHECK_BTN_ANY(sDebugPadPress, BTN_A)) {
        ...
        Audio_PlaySfxGeneral(sfx, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal, &gSfxFreqOrVolDefaultVal,
                             &gSfxReverbAddNone);
    }
...
void func_800F4010(Vec3f* pos, u16 sfxId, f32 arg2) {
    ...
    Audio_PlaySfxGeneral(sfxId, pos, 4, &D_8016B7B0, &D_8016B7A8, &gSfxReverbAddNone);
    ...
    if ((phi_f0 < arg2) && (phi_v0 != 0)) {
        ...
        Audio_PlaySfxGeneral(sfxId2, pos, 4, &D_8016B7B0, &D_8016B7AC, &gSfxReverbAddNone);
    }
}
...
void func_800F4190(Vec3f* pos, u16 sfxId) {
    Audio_PlaySfxGeneral(sfxId, pos, 4, &D_801305B0, &gSfxFreqOrVolDefaultVal, &D_801305B4);
}
void Audio_PlaySoundRandom(Vec3f* pos, u16 baseSfxId, u8 randLim) {
    u8 offset = Audio_NextRandom() % randLim;

    Audio_PlaySfxGeneral(baseSfxId + offset, pos, 4, &gSfxFreqOrVolDefaultVal, &gSfxFreqOrVolDefaultVal,
                         &gSfxReverbAddNone);
}
...
void func_800F4254(Vec3f* pos, u8 level) {
    ...
    if (level != sPrevChargeLevel) {
        ...
        switch (level) {
            case 1:
                Audio_PlaySfxGeneral(NA_SE_PL_SWORD_CHARGE, pos, 4, &D_801305F4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxReverbAddNone);
                break;
            case 2:
                Audio_PlaySfxGeneral(NA_SE_PL_SWORD_CHARGE, pos, 4, &D_801305F4, &gSfxFreqOrVolDefaultVal,
    ...
    if (level != 0) {
        Audio_PlaySfxGeneral(NA_SE_IT_SWORD_CHARGE - SFX_FLAG, pos, 4, &D_801305F4, &gSfxFreqOrVolDefaultVal,
                             &gSfxReverbAddNone);
    }
}
...
void func_800F436C(Vec3f* pos, u16 sfxId, f32 arg2) {
    ...
    if (D_8016B7D8 > 0.5f) {
        Audio_PlaySfxGeneral(sfxId, pos, 4, &D_8016B7D8, &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
...
void func_800F4524(Vec3f* pos, u16 sfxId, s8 arg2) {
    D_8016B7DC = arg2;
    Audio_PlaySfxGeneral(sfxId, pos, 4, &gSfxFreqOrVolDefaultVal, &gSfxFreqOrVolDefaultVal, &D_8016B7DC);
}

void func_800F4578(Vec3f* pos, u16 sfxId, f32 arg2) {
    D_8016B7E0 = arg2;
    Audio_PlaySfxGeneral(sfxId, pos, 4, &gSfxFreqOrVolDefaultVal, &D_8016B7E0, &gSfxReverbAddNone);
}
...
void Audio_PlaySoundRiver(Vec3f* pos, f32 freqScale) {
    ...
    Audio_PlaySfxGeneral(NA_SE_EV_RIVER_STREAM - SFX_FLAG, pos, 4, &sRiverFreqScaleLerp.value, &gSfxFreqOrVolDefaultVal,
                         &gSfxReverbAddNone);
}
...
void Audio_PlaySoundTransposed(Vec3f* pos, u16 sfxId, s8 semitone) {
    Audio_PlaySfxGeneral(sfxId, pos, 4, &gNoteFrequencies[semitone + 39], &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
}
...
void func_800F4C58(Vec3f* pos, u16 sfxId, u8 arg2) {
    ...
    Audio_PlaySfxGeneral(sfxId, pos, 4, &gSfxFreqOrVolDefaultVal, &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
}
...
void func_800F64E0(u8 arg0) {
    D_80130608 = arg0;
    if (arg0 != 0) {
        Audio_PlaySfxGeneral(NA_SE_SY_WIN_OPEN, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
        Audio_QueueCmdS32(0xF1000000, 0);
    } else {
        Audio_PlaySfxGeneral(NA_SE_SY_WIN_CLOSE, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
...
void Audio_SetBaseFilter(u8 filter) {
    if (sAudioBaseFilter != filter) {
        if (filter == 0) {
            ...
            Audio_PlaySfxGeneral(NA_SE_PL_IN_BUBBLE, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                 &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
        }
    }
...
void Audio_PlaySoundIfNotInCutscene(u16 sfxId) {
    Audio_PlaySfxGeneralIfNotInCutscene(sfxId, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                        &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
}
