...
void func_801109B0(GlobalContext* globalCtx) {
    ...
    DmaMgr_SendRequest1(interfaceCtx->do_actionSegment + 0x300, (u32)_do_action_staticSegmentRomStart + do_actionOffset,
