...
void Regs_InitDataImpl(void) {
    ...
    YREG(46) = 36;
    YREG(47) = 0;
    YREG(48) = -45; // R_KALEIDO_UNK1(0) for NTSC
    YREG(49) = -48; // R_KALEIDO_UNK1(1) for NTSC
    YREG(50) = 16;  // R_KALEIDO_UNK2(0) for NTSC
    YREG(51) = 22;  // R_KALEIDO_UNK2(1) for NTSC
    YREG(52) = -55; // R_KALEIDO_UNK3(0) for NTSC
    YREG(53) = -53; // R_KALEIDO_UNK3(1) for NTSC
    YREG(54) = 43;  // R_KALEIDO_UNK4(0) for NTSC
    YREG(55) = 47;  // R_KALEIDO_UNK4(1) for NTSC
    YREG(56) = -33; // R_KALEIDO_UNK5(0) for NTSC
    YREG(57) = -42; // R_KALEIDO_UNK5(1) for NTSC
    YREG(58) = -33; // R_KALEIDO_UNK6(0) for NTSC
    YREG(59) = -37; // R_KALEIDO_UNK6(1) for NTSC
    YREG(60) = 14;
    YREG(61) = -2;
    YREG(62) = -2;
    YREG(63) = -18;
