...
void func_801109B0(GlobalContext* globalCtx) {
    ...
    R_ITEM_BTN_X(HUD_ITEM_BTN_B) = B_BUTTON_X;
    R_B_BTN_COLOR(0) = B_BUTTON_R;
    R_B_BTN_COLOR(1) = B_BUTTON_G;
    R_B_BTN_COLOR(2) = B_BUTTON_B;
    R_ITEM_ICON_X(HUD_ITEM_BTN_B) = B_BUTTON_X;
    R_ITEM_AMMO_X(HUD_ITEM_BTN_B) = B_BUTTON_X + 2;
...
void func_80111070(void) {
    ...
    ZREG(65) = 21;
    ZREG(66) = 122;
    R_ITEM_BTN_X(HUD_ITEM_BTN_C_LEFT) = C_LEFT_BUTTON_X;
    R_ITEM_BTN_X(HUD_ITEM_BTN_C_DOWN) = C_DOWN_BUTTON_X;
    R_ITEM_BTN_X(HUD_ITEM_BTN_C_RIGHT) = C_RIGHT_BUTTON_X;
    R_ITEM_BTN_Y(HUD_ITEM_BTN_B) = B_BUTTON_Y;
    R_ITEM_BTN_Y(HUD_ITEM_BTN_C_LEFT) = C_LEFT_BUTTON_Y;
    R_ITEM_BTN_Y(HUD_ITEM_BTN_C_DOWN) = C_DOWN_BUTTON_Y;
    R_ITEM_BTN_Y(HUD_ITEM_BTN_C_RIGHT) = C_RIGHT_BUTTON_Y;
    R_ITEM_BTN_DD(HUD_ITEM_BTN_B) = 575;
    R_ITEM_BTN_DD(HUD_ITEM_BTN_C_LEFT) = 620;
    R_ITEM_BTN_DD(HUD_ITEM_BTN_C_DOWN) = 620;
    R_ITEM_BTN_DD(HUD_ITEM_BTN_C_RIGHT) = 620;
    R_ITEM_ICON_X(HUD_ITEM_BTN_C_LEFT) = C_LEFT_BUTTON_X;
    R_ITEM_ICON_X(HUD_ITEM_BTN_C_DOWN) = C_DOWN_BUTTON_X;
    R_ITEM_ICON_X(HUD_ITEM_BTN_C_RIGHT) = C_RIGHT_BUTTON_X;
    R_ITEM_ICON_Y(HUD_ITEM_BTN_B) = B_BUTTON_Y;
    R_ITEM_ICON_Y(HUD_ITEM_BTN_C_LEFT) = C_LEFT_BUTTON_Y;
    R_ITEM_ICON_Y(HUD_ITEM_BTN_C_DOWN) = C_DOWN_BUTTON_Y;
    R_ITEM_ICON_Y(HUD_ITEM_BTN_C_RIGHT) = C_RIGHT_BUTTON_Y;
    R_ITEM_ICON_DD(HUD_ITEM_BTN_B) = 550;
    R_ITEM_ICON_DD(HUD_ITEM_BTN_C_LEFT) = 680;
    R_ITEM_ICON_DD(HUD_ITEM_BTN_C_DOWN) = 680;
    R_ITEM_ICON_DD(HUD_ITEM_BTN_C_RIGHT) = 680;
    ZREG(94) = 1;
    ZREG(95) = 0;
    XREG(0) = 26;
    XREG(1) = 22;
    ...
    VREG(62) = 0;
    VREG(63) = 10;
    R_ITEM_AMMO_X(HUD_ITEM_BTN_C_LEFT) = C_LEFT_BUTTON_X + 1;
    R_ITEM_AMMO_X(HUD_ITEM_BTN_C_DOWN) = C_DOWN_BUTTON_X + 1;
    R_ITEM_AMMO_X(HUD_ITEM_BTN_C_RIGHT) = C_RIGHT_BUTTON_X + 1;
    R_ITEM_AMMO_Y(HUD_ITEM_BTN_B) = B_BUTTON_Y + 18;
    R_ITEM_AMMO_Y(HUD_ITEM_BTN_C_LEFT) = C_LEFT_BUTTON_Y + 17;
    R_ITEM_AMMO_Y(HUD_ITEM_BTN_C_DOWN) = C_DOWN_BUTTON_Y + 17;
    R_ITEM_AMMO_Y(HUD_ITEM_BTN_C_RIGHT) = C_RIGHT_BUTTON_Y + 17;
    VREG(72) = 0;
    VREG(73) = 0;
    VREG(74) = 0;
    VREG(75) = 0;
    R_ITEM_ICON_WIDTH(HUD_ITEM_BTN_B) = 30;
    R_ITEM_ICON_WIDTH(HUD_ITEM_BTN_C_LEFT) = 24;
    R_ITEM_ICON_WIDTH(HUD_ITEM_BTN_C_DOWN) = 24;
    R_ITEM_ICON_WIDTH(HUD_ITEM_BTN_C_RIGHT) = 24;
    R_ITEM_BTN_WIDTH(HUD_ITEM_BTN_B) = 29;
    R_ITEM_BTN_WIDTH(HUD_ITEM_BTN_C_LEFT) = 27;
    R_ITEM_BTN_WIDTH(HUD_ITEM_BTN_C_DOWN) = 27;
    R_ITEM_BTN_WIDTH(HUD_ITEM_BTN_C_RIGHT) = 27;
    VREG(84) = 0;
    VREG(85) = 50;
    VREG(86) = 0;
    VREG(87) = 64;
