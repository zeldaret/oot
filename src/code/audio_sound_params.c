...
SoundParams* gSoundParams[7] = {
    sPlayerBankData, sItemBankData, sEnvBankData, sEnemyBankData, sSystemBankData, sOcarinaBankData, sVoiceBankData,
};
