...
SoundParams sEnemyBankParams[] = {
    ...
    SFX_PARAMS(0x30, 3, 0, SFX_PARAM_10), // NA_SE_EN_FANTOM_VOICE
...
SoundParams sPlayerBankParams[] = {
    SFX_PARAMS(0x20, 0, 2, SFX_PARAM_10),               // NA_SE_PL_WALK_GROUND
    SFX_PARAMS(0x20, 0, 2, SFX_PARAM_10),               // NA_SE_PL_WALK_SAND
    SFX_PARAMS(0x20, 0, 2, SFX_PARAM_10),               // NA_SE_PL_WALK_CONCRETE
    SFX_PARAMS(0x20, 0, 2, SFX_PARAM_10),               // NA_SE_PL_WALK_DIRT
    SFX_PARAMS(0x20, 0, 1, SFX_PARAM_10),               // NA_SE_PL_WALK_WATER0
    SFX_PARAMS(0x20, 0, 1, SFX_PARAM_10),               // NA_SE_PL_WALK_WATER1
    SFX_PARAMS(0x20, 0, 1, SFX_PARAM_10),               // NA_SE_PL_WALK_WATER2
    SFX_PARAMS(0x20, 0, 1, SFX_PARAM_10),               // NA_SE_PL_WALK_MAGMA
    SFX_PARAMS(0x20, 0, 2, SFX_PARAM_10),               // NA_SE_PL_WALK_GRASS
    SFX_PARAMS(0x20, 0, 1, SFX_PARAM_10),               // NA_SE_PL_WALK_IRON
    SFX_PARAMS(0x20, 0, 2, SFX_PARAM_10),               // NA_SE_PL_WALK_LADDER
    SFX_PARAMS(0x20, 0, 0, SFX_PARAM_10),               // NA_SE_PL_WALK_GLASS
    SFX_PARAMS(0x20, 0, 0, SFX_PARAM_10),               // NA_SE_PL_WALK_WALL
    SFX_PARAMS(0x20, 0, 0, SFX_PARAM_10),               // NA_SE_PL_WALK_HEAVYBOOTS
    SFX_PARAMS(0x20, 0, 0, SFX_PARAM_10),               // NA_SE_PL_DUMMY_14
    SFX_PARAMS(0x20, 0, 0, SFX_PARAM_10),               // NA_SE_PL_WALK_ICE
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_SAND
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_CONCRETE
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_DIRT
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_WATER0
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_WATER1
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_WATER2
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_MAGMA
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_GRASS
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_IRON
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_LADDER
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_GLASS
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_DUMMY28
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_HEAVYBOOTS
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_DUMMY30
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_JUMP_ICE
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_SAND
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_CONCRETE
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_DIRT
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_WATER0
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_WATER1
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_WATER2
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_MAGMA
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_GRASS
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_IRON
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_LADDER
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_GLASS
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_44
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_HEAVYBOOTS
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_46
    SFX_PARAMS(0x40, 0, 1, SFX_PARAM_10),               // NA_SE_PL_LAND_ICE
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_TAKE_OUT_SHIELD
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_CHANGE_ARMS
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_CATCH_BOOMERANG
    SFX_PARAMS(0x30, 0, 1, 0),                          // NA_SE_PL_DUMMY_55
    SFX_PARAMS(0x30, 0, 1, 0),                          // NA_SE_PL_DUMMY_56
    SFX_PARAMS(0x30, 0, 2, 0),                          // NA_SE_PL_SWIM
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_THROW
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_BODY_BOUND
    SFX_PARAMS(0x40, 0, 0, SFX_PARAM_10),               // NA_SE_PL_ROLL
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_SKIP
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10),               // NA_SE_PL_BODY_HIT
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_DAMAGE
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_METALEFFECT_KID
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_METALEFFECT_ADULT
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_11 | SFX_PARAM_10), // NA_SE_PL_MAGIC_SOUL_NORMAL
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_ARROW_CHARGE_FIRE
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_ARROW_CHARGE_ICE
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),               // NA_SE_PL_ARROW_CHARGE_LIGHT
    ...
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL_SAND
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL_CONCRETE
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL_DIRT
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL_WATER0
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_181
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_182
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_183
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_184
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_185
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_186
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL_WOOD
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_CRAWL_ICE
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_189
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_190
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10),               // NA_SE_PL_DUMMY_191
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_11 | SFX_PARAM_10), // NA_SE_PL_MAGIC_SOUL_FLASH
...
SoundParams sItemBankParams[] = {
    ...
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10), // NA_SE_IT_ARROW_SHOT
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10), // NA_SE_IT_BOOMERANG_THROW
    SFX_PARAMS(0x60, 3, 2, 0),            // NA_SE_IT_SHIELD_BOUND
    SFX_PARAMS(0x30, 0, 1, SFX_PARAM_10), // NA_SE_IT_BOW_DRAW
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_HOOKSHOT_CHAIN
    SFX_PARAMS(0x30, 1, 0, SFX_PARAM_10), // NA_SE_IT_SHIELD_REFLECT_MG
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_BOOMERANG_FLY
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_SLING_SHOT
    SFX_PARAMS(0x20, 0, 0, SFX_PARAM_10), // NA_SE_IT_SLING_DRAW
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_HOOKSHOT_READY
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_HOOKSHOT_RECEIVE
    SFX_PARAMS(0x60, 3, 1, 0),            // NA_SE_IT_HOOKSHOT_STICK_OBJ
    SFX_PARAMS(0x30, 1, 0, 0),            // NA_SE_IT_SWORD_REFLECT_MG
    SFX_PARAMS(0x30, 1, 0, SFX_PARAM_10), // NA_SE_IT_DEKU
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_BOW_FLICK
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10), // NA_SE_IT_SLING_FLICK
...
SoundParams sEnvBankParams[] = {
    SFX_PARAMS(0x70, 0, 1, SFX_PARAM_10 | SFX_FLAG_9),               // NA_SE_EV_DOOR_OPEN
    ...
    SFX_PARAMS(0x30, 0, 2, SFX_PARAM_10),                            // NA_SE_EV_RIVER_STREAM
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),                            // NA_SE_EV_HORSE_SANDDUST
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),                            // NA_SE_EV_GANON_HORSE_NEIGH
    SFX_PARAMS(0x30, 0, 0, SFX_PARAM_10),                            // NA_SE_EV_GANON_HORSE_GROAN
...
SoundParams sOcarinaBankParams[] = {
    ...
    SFX_PARAMS(0x30, 2, 1, SFX_PARAM_10 | SFX_FLAG_9), // NA_SE_OC_DOOR_OPEN
...
SoundParams sVoiceBankParams[] = {
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWORD_N
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWORD_L
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_LASH
    SFX_PARAMS(0x20, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_HANG
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_CLIMB_END
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DAMAGE_S
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_FREEZE
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_FALL_S
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_FALL_L
    SFX_PARAMS(0x30, 2, 1, SFX_PARAM_10), // NA_SE_VO_LI_BREATH_REST
    SFX_PARAMS(0x30, 2, 1, SFX_PARAM_10), // NA_SE_VO_LI_BREATH_DRINK
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DOWN
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_TAKEN_AWAY
    SFX_PARAMS(0x50, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_HELD
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SNEEZE
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWEAT
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DRINK
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_RELAX
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWORD_PUTAWAY
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_GROAN
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_AUTO_JUMP
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_MAGIC_NALE
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SURPRISE
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_MAGIC_FROL
    SFX_PARAMS(0x30, 2, 2, SFX_PARAM_10), // NA_SE_VO_LI_PUSH
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_HOOKSHOT_HANG
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_LAND_DAMAGE_S
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_NULL_0x1b
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_MAGIC_ATTACK
    SFX_PARAMS(0x80, 2, 0, SFX_PARAM_10), // NA_SE_VO_BL_DOWN
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DEMO_DAMAGE
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_ELECTRIC_SHOCK_LV
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWORD_N_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_ROLLING_CUT_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_LASH_KID
    SFX_PARAMS(0x20, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_HANG_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_CLIMB_END_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DAMAGE_S_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_FREEZE_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_FALL_S_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_FALL_L_KID
    SFX_PARAMS(0x30, 2, 1, SFX_PARAM_10), // NA_SE_VO_LI_BREATH_REST_KID
    SFX_PARAMS(0x30, 2, 1, SFX_PARAM_10), // NA_SE_VO_LI_BREATH_DRINK_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DOWN_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_TAKEN_AWAY_KID
    SFX_PARAMS(0x50, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_HELD_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SNEEZE_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWEAT_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DRINK_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_RELAX_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SWORD_PUTAWAY_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_GROAN_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_AUTO_JUMP_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_MAGIC_NALE_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_SURPRISE_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_MAGIC_FROL_KID
    SFX_PARAMS(0x30, 1, 2, SFX_PARAM_10), // NA_SE_VO_LI_PUSH_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_HOOKSHOT_HANG_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_LAND_DAMAGE_S_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_NULL_0x1b_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_MAGIC_ATTACK_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_BL_DOWN_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_DEMO_DAMAGE_KID
    SFX_PARAMS(0x30, 2, 0, SFX_PARAM_10), // NA_SE_VO_LI_ELECTRIC_SHOCK_LV_KID
