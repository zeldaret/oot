...
s32 Camera_Normal1(Camera *camera) {
    ...
    if(RELOAD_PARAMS){
        ...
        phi_f16 = 1.0f + PCT(OREG(46)) - PCT(OREG(46)) * (68.0f / temp_f0);
        temp_f2 = PCT(temp_f0) * phi_f16;
    ...
    temp_f2 = (camera->unk_D8 - unk24->unk_20) * (1.0f / 3.0f);
    sp94 = temp_f2;
    if(sp94 > 1.0f){
        sp94 = 1.0f;
    }
    ...
    if ((unk24->unk_18 != 0) && (norm1->unk_00 > -40.0f)) {
        ...
        phi_f16 = LERP(norm1->unk_00, -40.0f, temp_f0_5);
    } else {
...
s32 Camera_Normal2(Camera *camera) {
    ...
    } else if (playerPosRot->pos.y == camera->playerGroundY) {
    ...
    camera->phiUpdateRateInv = Camera_LERPCeilF(R_CAM_DEFA_PHI_UPDRATE, camera->phiUpdateRateInv, spA0, 0.1f);
...
block_58:
    ...
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
    camera->atLERPStepScale = Camera_ClampLERPScale(camera, camera->params.normal2.unk_18);
    return 1;
}
#else
...
s32 Camera_Normal3(Camera* camera) {
    ...
    */
    ...
    if (temp_v0_3 != 0) {
        ...
        camera->phiUpdateRateInv = Camera_LERPCeilF((f32)R_CAM_DEFA_PHI_UPDRATE + (unk20->unk_1A * 2), camera->phiUpdateRateInv, sp94, 0.1f);
        unk20->unk_1A--;
    } else {
        camera->thetaUpdateRateInv = Camera_LERPCeilF(normal3->unk_0C, camera->thetaUpdateRateInv, temp_f16, 0.1f);
        camera->phiUpdateRateInv = Camera_LERPCeilF(R_CAM_DEFA_PHI_UPDRATE, camera->phiUpdateRateInv, sp94, 0.1f);
    }
    ...
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
    camera->atLERPStepScale = Camera_ClampLERPScale(camera, normal3->unk_18);
    return 1;
}
#else
...
s32 Camera_Jump3(Camera *camera) {  
    ...
    if (camera->animState == 0 || camera->animState == 0xA || camera->animState == 0x14 || sp54 || R_RELOAD_CAM_PARAMS) {
        ...
        temp_f0_2 = ((1.0f + PCT(OREG(46))) - (PCT(OREG(46)) * (68.0f / sp74)));
...
s32 Camera_Fixed2(Camera *camera) {
    ...
    if (RELOAD_PARAMS) {
        values = sCameraSettings[camera->setting].cameraModes[camera->mode].values;
        t = (1.0f + PCT(OREG(46))) - (PCT(OREG(46)) * (68.0f / yOffset));
        fixd2->yOffset = (NEXTPCT * yOffset) * t;
...
s32 Camera_Unique1(Camera *camera) {
    ...
    if (RELOAD_PARAMS) {
        ...
        uniq1->unk_00 = NEXTPCT * temp_f0 * temp_f2;
        uniq1->unk_04 = NEXTPCT * temp_f0 * temp_f2;
        uniq1->unk_08 = NEXTPCT * temp_f0 * temp_f2;
        uniq1->unk_18 = DEGF_TO_BINANG(NEXTSETTING);
        uniq1->unk_10 = NEXTSETTING;
        uniq1->unk_14 = NEXTPCT;
        uniq1->unk_1A = NEXTSETTING;
    }
    ...
    OLib_Vec3fDiffToVecSphRot90(&sp7C, &camera->at, &camera->eye);
    OLib_Vec3fDiffToVecSphRot90(&sp74, &camera->at, &camera->eyeNext);
    ...
    if (camera->animState == 0) {
        ...
        unk1C->unk_06 = ABS(BINANG_SUB(sp84.theta, sp7C.theta)) < 0x3A98 ? 0 :
            ((BINANG_SUB(sp84.theta, sp7C.theta) / unk1C->unk_08) / 4) * 3;
        camera->animState++;
    }
    ...
    pad2 = uniq1->unk_18;
    sp8C.phi = Camera_LERPCeilS(pad2, sp74.phi, 1.0f / camera->phiUpdateRateInv, 0xA);
    ...
    *sp38 = *sp30;
    ...
    camera->roll = 0;
    camera->atLERPStepScale = Camera_ClampLERPScale(camera, uniq1->unk_14);
    return 1;
}
...
s32 Camera_Unique3(Camera *camera) {
    ...
    sp5C = Player_GetCameraYOffset(camera->player);
    camera->unk_14C &= ~0x10;
    if(RELOAD_PARAMS){
        values = sCameraSettings[camera->setting].cameraModes[camera->mode].values;
        t = (1.0f + PCT(OREG(46))) - (PCT(OREG(46)) * (68.0f / sp5C));
        unkC->unk_00 = (NEXTPCT * sp5C) * t;
...
s32 Camera_Special5(Camera *camera) {
    ...
    if (RELOAD_PARAMS) {
        values = sCameraSettings[camera->setting].cameraModes[camera->mode].values;
        temp_f2 = ((1.0f + (OREG(46) * 0.01f)) - ((OREG(46) * 0.01f) * (68.0f / temp_f0)));
        spec5->unk_00 = (f32) ((((f32) NEXTSETTING * 0.01f) * temp_f0) * temp_f2);
        spec5->unk_04 = NEXTSETTING;
        spec5->unk_08 = NEXTSETTING;
        spec5->unk_14 = NEXTSETTING;
        spec5->unk_16 = DEGF_TO_BINANG(NEXTSETTING);
    ...
    if (unk1C->unk_00 > 0) {
        ...
        unk1C->unk_00--;
        if (spec5->unk_08 < OLib_Vec3fDist(&spA8.pos, &playerPosRot->pos)) {
    ...
    camera->fov = Camera_LERPCeilF(spec5->unk_0C, camera->fov, camera->atLERPStepScale * PCT(OREG(4)), 1.0f);
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
...
s32 Camera_Special9(Camera *camera) {
    ...
    camera->unk_14C &= ~0x10;
    sp78 = (1.0f + PCT(OREG(46))) - (PCT(OREG(46)) * (68.0f / sp98));
