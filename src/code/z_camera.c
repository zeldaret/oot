...
void Camera_KeepOn4(Camera* camera);
...
//temporarily creating a struct for this data;
typedef struct {
    Vec3s unk_00;
    char pad;
}t_struct;
extern t_struct D_8015CE46;
...
s32 func_800457A8(Camera* camera, VecSph* arg1, f32 arg2, s16 arg3) {
    ...
    Camera_LERPCeilVec3f(&sp50, &camera->posOffset, camera->unk_CC.y, camera->unk_CC.x, 0.1f);
...
s32 func_80045B08(Camera* camera, VecSph* arg1, f32 arg2, s16 arg3) {
    ...
    Camera_LERPCeilVec3f(&sp48, &camera->posOffset, camera->unk_CC.y, camera->unk_CC.x, 0.1f);
...
s32 func_800466F8(Camera* camera, VecSph* arg1, f32 arg2, f32* arg3, s16 arg4) {
    ...
    Camera_LERPCeilVec3f(&sp60, &camera->posOffset, camera->unk_CC.y, camera->unk_CC.x, 0.1f);
...
f32 func_800468CC(Camera* camera, f32 arg1, f32 arg2, f32 arg3) {
    ...
    camera->unk_C0.x = Camera_LERPCeilF(phi_f12, camera->unk_C0.x, OREG(25) * 0.01f, 0.1f);
    return Camera_LERPCeilF(sp1C, camera->dist, 1.f / camera->unk_C0.x, 0.2f);
}
...
s16 func_80046B44(Camera* camera, s16 arg1, s16 arg2, s16 arg3) {
    ...
    if (ABS(sp1C) < phi_v1) {
        ...
        phi_a2 = (1.0f / camera->unk_C0.y) * func_800437F0(0.8f, 1.0f - phi_v0 * (1.0f / R_CAM_MAX_PHI));
    }
...
s32 Camera_Normal1(Camera *camera) {
    ...
    if(RELOAD_PARAMS){
        ...
        norm1->unk_20 = (s16) (s32) (((f32) NEXTSETTING * 182.0416717529297f) + 0.5f);
    ...
    switch(camera->animState){
        case 0x14:
            camera->unk_C0.z = (f32) OREG(27);
            camera->unk_C0.y = (f32) OREG(27);
        case 0:
        case 0xA:
        case 0x19:
            unk24->unk_18 = 0;
    ...
    if (unk24->unk_1A != 0) {
        spA0 = temp_f16;
        sp94 = phi_f2_2;
        camera->unk_C0.z = Camera_LERPCeilF(unk24->unk_10 + (f32) (unk24->unk_1A * 2), camera->unk_C0.z, sp98, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF((f32) OREG(7) + (f32) (unk24->unk_1A * 2), camera->unk_C0.y, sp9C, 0.1f);
        unk24->unk_1A--;
    } else {
        temp_f0_2 = unk24->unk_10;
        spA0 = temp_f16;
        sp94 = phi_f2_2;
        camera->unk_C0.z = Camera_LERPCeilF(temp_f0_2 - ((((f32) OREG(49) * 0.01f) * temp_f0_2) * phi_f2_2), camera->unk_C0.z, sp98, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF(OREG(7), camera->unk_C0.y, sp9C, 0.1f);
    }
    spA0 = temp_f2_2 * camera->unk_E0;
    camera->unk_C0.y = Camera_LERPCeilF(OREG(7), camera->unk_C0.y, sp9C, 0.1f);
    camera->unk_CC.x = Camera_LERPCeilF(OREG(2) * 0.01f, camera->unk_CC.x, temp_f2_2 * camera->unk_E0, 0.1f);
    camera->unk_CC.y = Camera_LERPCeilF(OREG(2) * 0.01f, camera->unk_CC.y, sp9C, 0.1f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(3) * 0.01f, camera->unk_CC.y, camera->unk_E0 * 0.05f, 0.1f);
    if (norm1->unk_22 & 1) {
    ...
    if (unk24->unk_2A <= 0) {
        sp7C.phi = sp6C.phi;
        sp7C.theta = Camera_LERPCeilS(unk24->unk_26, sp6C.theta, 1.0f / camera->unk_C0.z, 0xA);
    } else if (unk24->unk_18 != 0) {
        sp7C.theta = Camera_LERPCeilS(unk24->unk_16, sp6C.theta, 1.0f / camera->unk_C0.z, 0xA);
        sp7C.phi = Camera_LERPCeilS(unk24->unk_14, sp6C.phi, 1.0f / camera->unk_C0.z, 0xA);
    } else {
    ...
    camera->fov = Camera_LERPCeilF(norm1->unk_18 * (gSaveContext.health <= 0x10 ? 0.8f : 1.0f), camera->fov, camera->unk_CC.z, 1.0f);
...
s32 Camera_Normal2(Camera *camera) {
    ...
    camera->unk_C0.z = Camera_LERPCeilF(camera->params.normal2.unk_0C, camera->unk_C0.z * camera->unk_E0, OREG(25), 0.1f);
    camera->unk_C0.y = Camera_LERPCeilF(OREG(7), camera->unk_C0.y, spA0, 0.1f);
    camera->unk_CC.x = Camera_LERPCeilF(OREG(2) * 0.1f, camera->unk_CC.x, spA4, 0.1f);
    camera->unk_CC.y = Camera_LERPCeilF(OREG(3) * 0.01f, camera->unk_CC.y, spA0, 0.1f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(4) * 0.01f, camera->unk_CC.y, camera->unk_E0 * 0.05f, 0.1f);
...
block_43:
                    ...
                    sp98.theta = Camera_LERPCeilS(phi_a0 + sp88.theta, sp80.theta, (1.0f / camera->unk_C0.z) * camera->unk_E0, 0xA);
                    if (temp_s1->unk_28 & 1) {
...
block_58:
    ...
    camera->fov = Camera_LERPCeilF(temp_s1->unk_1C, camera->fov, camera->unk_CC.z, 1.0f);
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
...
s32 Camera_Normal3(Camera* camera) {
    ...
    */
    ...
    if (temp_v0_3 != 0) {
        camera->unk_C0.z = Camera_LERPCeilF(normal3->unk_0C + (temp_v0_3 * 2), camera->unk_C0.z, temp_f16, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF((f32)OREG(7) + (unk20->unk_1A * 2), camera->unk_C0.y, sp94, 0.1f);
        unk20->unk_1A--;
    } else {
        camera->unk_C0.z = Camera_LERPCeilF(normal3->unk_0C, camera->unk_C0.z, temp_f16, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF(OREG(7), camera->unk_C0.y, sp94, 0.1f);
    }
    camera->unk_CC.x = Camera_LERPCeilF(OREG(2) * 0.01f, camera->unk_CC.x, temp_f16, 0.1f);
    camera->unk_CC.y = Camera_LERPCeilF(OREG(3) * 0.01f, camera->unk_CC.y, sp94, 0.1f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(4) * 0.01f, camera->unk_CC.z, sp94, 0.1f);
    ...
    sp84.phi = Camera_LERPCeilS(normal3->unk_1C - unk20->unk_24, sp74.phi, 1.0f / camera->unk_C0.y, 0xA);
    ...
    camera->fov = Camera_LERPCeilF(normal3->unk_14, camera->fov, camera->unk_CC.z, 1.0f);
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
...
void Camera_Parallel1(Camera *camera) {
    ...
    spB8 = temp_f2_2;
    camera->unk_C0.x =  Camera_LERPCeilF(OREG(6), camera->unk_C0.x, temp_f2_2, 0.1f);
    camera->unk_C0.z = Camera_LERPCeilF(para1->unk_08, camera->unk_C0.z, temp_f2_2, 0.1f);
    camera->unk_C0.y = Camera_LERPCeilF(2.0f, camera->unk_C0.y, spB4, 0.1f);
    camera->unk_CC.x = Camera_LERPCeilF(OREG(2) * 0.01f, camera->unk_CC.x, temp_f2_2, 0.1f);
    camera->unk_CC.y = Camera_LERPCeilF(OREG(3) * 0.01f, camera->unk_CC.y, spB4, 0.1f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(4) * 0.01f, camera->unk_CC.z, camera->unk_E0 * 0.05f, 0.1f);
    ...
    if (para1Anim->animTimer != 0) {
        ...
        para1Anim->unk_16 = 0;
        camera->dist = Camera_LERPCeilF(para1->distTarget, camera->dist, 1.0f / camera->unk_C0.x, 2.0f);
        ...
        spA8.phi = Camera_LERPCeilS(para1->interfaceFlags & 1 ? para1Anim->phiTarget - para1Anim->unk_10 : para1Anim->phiTarget, sp98.phi, 1.0f / camera->unk_C0.y, 4);
    ...
    camera->fov = Camera_LERPCeilF(para1->fovTarget, camera->fov, camera->unk_CC.z, 1.0f);
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
...
s32 Camera_Jump1(Camera *camera) {
    ...
    if (RELOAD_PARAMS) {
        ...
        jump1->unk_00 = (f32) ((((f32) NEXTSETTING * 0.01f) * temp_f0) * temp_f2);
        jump1->unk_04 = (f32) ((((f32) NEXTSETTING * 0.01f) * temp_f0) * temp_f2);
        jump1->unk_08 = (f32) ((((f32) NEXTSETTING * 0.01f) * temp_f0) * temp_f2);
        jump1->unk_0C = (f32) NEXTSETTING;
        jump1->unk_10 = (f32) (NEXTSETTING * 0.01f);
        jump1->unk_14 = (f32) NEXTSETTING;
        jump1->unk_18 = (f32) (NEXTSETTING * 0.01f);
        jump1->unk_1C = (s16) NEXTSETTING;
    }
    if (R_RELOAD_CAM_PARAMS) {
        Camera_CopyPREGToModeValues(camera);
    }
    ...
    sp40 = &camera->eye;
    sp3C = &camera->at;
    OLib_Vec3fDiffToVecSphRot90(&sp90, &camera->at, &camera->eye);
    sp38 = &camera->eyeNext;
    OLib_Vec3fDiffToVecSphRot90(&sp88, &camera->at, &camera->eyeNext);
    ...
    if (camera->animState == 0 || camera->animState == 0xA || camera->animState == 0x14) {
        ...
        camera->unk_CC.x = 9.999999747378752e-05f;
        camera->animState++;
    }
    if (unk20->unk_1A != 0) {
        camera->unk_C0.z = Camera_LERPCeilF(jump1->unk_0C + unk20->unk_1A, camera->unk_C0.z, OREG(26) * 0.01f, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF((f32)OREG(7) + unk20->unk_1A, camera->unk_C0.y, OREG(26) * 0.01f, 0.1f);
        unk20->unk_1A--;
    } else {
        camera->unk_C0.z = Camera_LERPCeilF(jump1->unk_0C, camera->unk_C0.z, OREG(26) * 0.01f, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF((f32)OREG(7), camera->unk_C0.y, OREG(26) * 0.01f, 0.1f);
    }
    camera->unk_CC.x = Camera_LERPCeilF(OREG(2) * 0.01f, camera->unk_CC.x, OREG(25) * 0.01f, 0.1f);
    camera->unk_CC.y = Camera_LERPCeilF(OREG(3) * 0.01f, camera->unk_CC.y, OREG(26) * 0.01f, 0.1f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(4) * 0.01f, camera->unk_CC.y, 0.05f, 0.1f);
    ...
    if (unk20->unk_18 != 0) {
        sp80.theta = Camera_LERPCeilS(unk20->unk_16, sp88.theta, 1.0f / camera->unk_C0.z, 0xA);
        sp80.phi = Camera_LERPCeilS(unk20->unk_14, sp88.phi, 1.0f / camera->unk_C0.z, 0xA);
    } else {
    ...
    if(sp80.phi < R_CAM_MAX_PHI){
        sp80.phi = R_CAM_MAX_PHI;
    } else if(sp80.phi > OREG(35)){
        sp80.phi = OREG(35);
    }
    ...
    if ((camera->status == 7) && ((jump1->unk_1C & 0x10) == 0)) {
        ...
        if (unk20->unk_18 != 0) {
            camera->direction.y = Camera_LERPCeilS(((unk20->unk_16 - 0x7FFF) - camera->direction.y) + camera->direction.y, camera->direction.y, 1.0f - (0.9900000095367432f * spA4), 0xA);
        }
    } else {
        unk20->unk_10 = jump1->unk_0C;
        unk20->unk_18 = 0;
...
s32 Camera_Jump2(Camera *camera) {
    ...
    camera->unk_C0.z = Camera_LERPCeilF(jump2->unk_10, camera->unk_C0.z, (OREG(25) * 0.01f) * camera->unk_E0, 0.1f);
    camera->unk_CC.x = Camera_LERPCeilF(jump2->unk_14, camera->unk_CC.x, (OREG(25) * 0.01f) * camera->unk_E0, 0.1f);
    camera->unk_CC.y = Camera_LERPCeilF(OREG(3) * 0.01f, camera->unk_CC.y, (OREG(26) * 0.01f) * camera->unk_E0, 0.1f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(4) * 0.01f, camera->unk_CC.y, camera->unk_E0 * 0.05f, 0.1f);
    camera->unk_C0.x = OREG(27);
    ...
    if ((temp_f0_4 != -32000.0f) && (camera->playerPosRot.pos.y < temp_f0_4)) {
        camera->unk_C0.y = Camera_LERPCeilF(20.0f, camera->unk_C0.y, OREG(26) * 0.01f, 0.1f);
        camera->unk_C0.x = Camera_LERPCeilF(20.0f, camera->unk_C0.x, OREG(26) * 0.01f, 0.1f);
        spB4.phi = Camera_LERPCeilS(0x1F4, spA4.phi, 1.0f / camera->unk_C0.y, 0xA);
    } else if ((camera->playerPosRot.pos.y - unk24->unk_00) < sp48) {
        camera->unk_C0.y = Camera_LERPCeilF(20.0f, camera->unk_C0.y, OREG(26) * 0.01f, 0.1f);
        camera->unk_C0.x = Camera_LERPCeilF(20.0f, camera->unk_C0.x, OREG(26) * 0.01f, 0.1f);
        spB4.theta = Camera_LERPCeilS(0x1F4, spA4.phi, 1.0f / camera->unk_C0.y, 0xA);
    } else {
        camera->unk_C0.y = 100.0f;
        camera->unk_C0.x = 100.0f;
    }
    phi_v1_5 = spB4.phi;
    if (phi_v1_4 >= 0x2AF9) {
        phi_v1_5 = 0x2AF8;
    ...
    camera->dist = spB4.r;
    camera->fov = Camera_LERPCeilF(jump2->unk_18, camera->fov, camera->unk_CC.z, 1.0f);
    camera->roll = Camera_LERPCeilS(0, camera->roll, 0.5f, 0xA);
    return 1;
}
#else
...
s32 Camera_Jump3(Camera *camera) {
    ...
    if (unk24->unk_1A != 0) {
        spC4 = temp_f18;
        camera->unk_C0.z = Camera_LERPCeilF(unk24->unk_10 + (f32) (unk24->unk_1A * 2), camera->unk_C0.z, temp_f18, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF((f32) (unk24->unk_1A * 2) + 40.0f, camera->unk_C0.y, spC0, 0.1f);
        unk24->unk_1A = (s16) (unk24->unk_1A - 1);
    } else {
        spC4 = temp_f18;
        camera->unk_C0.z = Camera_LERPCeilF(unk24->unk_10, camera->unk_C0.z, spBC, 0.1f);
        camera->unk_C0.y = Camera_LERPCeilF(40.0f, camera->unk_C0.y, spC0, 0.1f);
    }
    camera->unk_CC.x = Camera_LERPCeilF((f32) OREG(2) * 0.01f, camera->unk_CC.x, spC4, 0.1f);
    temp_f0_3 = Camera_LERPCeilF((f32) OREG(3) * 0.01f, camera->unk_CC.y, spC0, 0.1f);
    camera->unk_CC.y = temp_f0_3;
    camera->unk_CC.z = Camera_LERPCeilF((f32) OREG(4) * 0.01f, temp_f0_3, camera->unk_E0 * 0.05f, 0.1f);
    ...
    if (unk24->unk_18 != 0) {
        spA8.theta = Camera_LERPCeilS(unk24->unk_16, sp90.theta, 1.0f / camera->unk_C0.z, 0xA);
        spA8.phi = Camera_LERPCeilS(unk24->unk_14, sp90.phi, 1.0f / camera->unk_C0.z, 0xA);
    } else {
    ...
    camera->fov = Camera_LERPCeilF(jump3->unk_18, camera->fov, camera->unk_CC.z, 1.0f);
...
s32 Camera_KeepOn0(Camera *camera) {
    ...
    sp2C = &camera->eyeNext;
    Camera_Vec3sToVec3f(&camera->eyeNext, &sp44->pos);
    ...
    sp28 = &camera->targetPosRot.pos;
    sp30 = &camera->eye;
    func_8002EEE4(sp28, camera->target);
    sp2C = &camera->at;
    OLib_Vec3fDiffToVecSphRot90(&sp54, sp30, &camera->at);
    OLib_Vec3fDiffToVecSphRot90(&sp5C, sp30, sp28);
...
s32 Camera_Fixed2(Camera *camera) {
    ...
    s32 pad;
    Fixed2 *fixd2;
    Fixed2_InitParams *initParams;
    f32 yOffset;
    f32 t;
    CameraModeValue* values;

    yOffset = Player_GetCameraYOffset(camera->player);
    fixd2 = &camera->params.fixd2;
    initParams = &fixd2->initParams;
    playerPosRot = &camera->playerPosRot;
    eyeNext = &camera->eyeNext;
    eye = &camera->eye;
    at = &camera->at;
...
s32 Camera_Subj3(Camera *camera) {
    ...
    void *temp_v1;
    CameraModeValue* values;
    Subj3_Unk24* unk24 = &camera->params.subj3.unk_24;
    ...
    Camera_CopyPREGToModeValues(camera);
    values = sCameraSettings[camera->setting].cameraModes[camera->mode].values;
    camera->params.subj3.unk_00 = (f32) ((NEXTSETTING * 0.009999999776482582f) * sp3C);
    camera->params.subj3.unk_04 = (f32) NEXTSETTING;
    camera->params.subj3.unk_08 = (f32) NEXTSETTING;
    camera->params.subj3.unk_0C = (f32) NEXTSETTING;
    camera->params.subj3.unk_10 = (f32) ((f32) NEXTSETTING * 0.10000000149011612f);
    camera->params.subj3.unk_14 = (f32) ((f32) NEXTSETTING * 0.10000000149011612f);
    camera->params.subj3.unk_18 = (f32) ((f32) NEXTSETTING * 0.10000000149011612f);
    camera->params.subj3.unk_1C = (f32) NEXTSETTING;
    camera->params.subj3.unk_20 = (s16) NEXTSETTING;
    sp84.r = camera->params.subj3.unk_08;
    sp84.phi = sp60.rot.x;
    sp84.theta = sp60.rot.y - 0x7FFF;
    sp98 = sp60.pos;
    sp98.y += camera->params.subj3.unk_00;
    Camera_Vec3fVecSphAdd(&sp8C, &sp98, &sp84);
    temp_s1 = &camera->at;
    sp38 = &camera->eye;
    OLib_Vec3fDiffToVecSphRot90(&sp7C, temp_s1, &camera->eye);
    sCameraInterfaceFlags = camera->params.subj3.unk_20;
    if(camera->animState == 0 || camera->animState == 0xA || camera->animState == 0x14){
        unk24->unk_00 = sp7C.r;
        unk24->unk_04 = sp7C.theta;
        unk24->unk_06 = sp7C.phi;
        camera->dist = unk24->unk_08 = OREG(23);
        camera->unk_C0.x = 1.0f;
        camera->dist = camera->params.subj3.unk_08;
        camera->animState++;
    }
    if (unk24->unk_08 != 0) {
        temp_f0 = 1.0f / (f32) unk24->unk_08;
        temp_s1->x += (sp98.x - temp_s1->x) * temp_f0;
        temp_s1->y += (sp98.y - temp_s1->y) * temp_f0;
        temp_s1->z += (sp98.z - temp_s1->z) * temp_f0;
        sp50 = (unk24->unk_06 - sp84.phi) * (1.0f / OREG(23));
        sp52 = (unk24->unk_04 - sp84.theta) * (1.0f / OREG(23));
        sp7C.r = Camera_LERPCeilF(sp84.r + (unk24->unk_08 * ((unk24->unk_00 - sp84.r) * (1.0f / OREG(23)))), sp7C.r, OREG(28) * 0.0f, 1.0f);
        sp7C.theta = Camera_LERPCeilS(sp84.theta + (sp52 * unk24->unk_08), sp7C.theta, OREG(28) * 0.01f, 0xA);
        sp7C.phi = Camera_LERPCeilS(sp84.phi + (sp50 * unk24->unk_08), sp7C.phi, OREG(28) * 0.01f, 0xA);
        sp30 = &camera->eyeNext;
        Camera_Vec3fVecSphAdd(&camera->eyeNext, temp_s1, &sp7C);
        *sp38 = camera->eyeNext;
        unk24->unk_08--;
        if (camera->globalCtx->envCtx.skyDisabled == 0) {
        ...
        sp98.x = camera->params.subj3.unk_10;
        sp98.y = (camera->params.subj3.unk_14 * temp_f0_3) - (camera->params.subj3.unk_18 * sp58);
        sp98.z = (camera->params.subj3.unk_14 * sp58) + (camera->params.subj3.unk_18 * temp_f0_3);
        sp58 = Math_Sins(sp60.rot.y - 0x7FFF);
        temp_f0_4 = Math_Coss(sp60.rot.y - 0x7FFF);
        camera->params.subj3.unk_10 = (sp98.z * sp58) + (sp98.x * temp_f0_4);
        camera->params.subj3.unk_14 = temp_f8;
        camera->params.subj3.unk_18 = (sp98.z * temp_f0_4) - (camera->params.subj3.unk_10 * sp58);
        temp_s1->x = camera->params.subj3.unk_10 + sp60.pos.x;
        temp_s1->y = camera->params.subj3.unk_14 + sp60.pos.y;
        temp_s1->z = camera->params.subj3.unk_18 + sp60.pos.z;
        sp7C.r = camera->params.subj3.unk_08;
        sp7C.phi = sp60.rot.x;
        sp7C.theta = sp60.rot.y - 0x7FFF;
        Camera_Vec3fVecSphAdd(&camera->eyeNext, temp_s1, &sp7C);
        sp7C.r = camera->params.subj3.unk_04;
    ...
    camera->fov = Camera_LERPCeilF(camera->params.subj3.unk_1C, camera->fov, 0.25f, 1.0f);
    camera->roll = 0;
    camera->atLERPStepScale = 0.0f;
    return 1;
}
...
s32 Camera_Unique1(Camera *camera) {
    ...
    camera->unk_C0.z = Camera_LERPCeilF(100.0f, camera->unk_C0.z, OREG(25) * 0.01f, 0.1f);
    camera->unk_C0.y = Camera_LERPCeilF(100.0f, camera->unk_C0.y, OREG(25) * 0.01f, 0.1f);
    camera->unk_CC.x = Camera_LERPCeilF(0.005f, camera->unk_CC.x, OREG(25) * 0.01f, 0.01f);
    camera->unk_CC.y = Camera_LERPCeilF(0.01f, camera->unk_CC.y, OREG(26) * 0.01f, 0.01f);
    camera->unk_CC.z = Camera_LERPCeilF(OREG(4) * 0.01f, camera->unk_CC.z, 0.05f, 0.1f);
    ...
    sp8C.phi = Camera_LERPCeilS(uniq1->unk_18, sp74.phi, 1.0f / camera->unk_C0.y, 0xA);
    if (OREG(5) < sp8C.phi) {
        sp8C.phi = OREG(5);
    }
    if (sp8C.phi < -OREG(5)) {
    ...
    *sp38 = *sp30;
    func_80043F34(camera, sp34, sp38);
    camera->fov = Camera_LERPCeilF(uniq1->unk_10, camera->fov, camera->unk_CC.z, 1.0f);
    camera->roll = 0;
...
// Some pretty confusing jump table logic.
#if 0
s32 Camera_Unique3(Camera *camera) {
    VecSph sp60;
    f32 sp5C;
    ...
    temp_f0 = Player_GetCameraYOffset(camera->player);
    sp5C = temp_f0;
    camera->unk_14C = (s16) (camera->unk_14C & 0xFFEF);
    if(RELOAD_PARAMS){
        values = sCameraSettings[camera->setting].cameraModes[camera->mode].values;
        camera->params.uniq3.unk_0C.unk_00 = (f32) ((((f32) NEXTSETTING * 0.01f) * temp_f0) * ((1.0f + (OREG(46) * 0.01f)) - ((OREG(46) * 0.01f) * (68.0f / temp_f0))));
        camera->params.uniq3.unk_0C.unk_04 = (f32) NEXTSETTING;
        camera->params.uniq3.unk_0C.unk_08 = (s16) NEXTSETTING;

    }
    sp28 = &camera->params.uniq3.unk_0C;
    if (R_RELOAD_CAM_PARAMS != 0) {
        Camera_CopyPREGToModeValues(camera);
    }
    sCameraInterfaceFlags =sp28->unk_08;
    switch(camera->animState){
        case 0:
            func_80043B60(camera);
            camera->unk_14C &= ~(8 | 4);
            camera->params.uniq3.unk_18.unk_00 = camera->fov;
            sp2C = &camera->params.uniq3.unk_18;
            camera->params.uniq3.unk_18.unk_04 = OLib_Vec3fDist(&camera->at, &camera->eye);
            camera->animState++;
            break;
        case 1:
            camera->params.uniq3.unk_06--;
            if (camera->params.uniq3.unk_06 <= 0) {
                sp24 = &camera->eye;
                sp2C = (Unique3_Unk18 *) &camera->at;
                temp_v0_2 = func_8004476C(camera);
                sp54 = temp_v0_2;
                sp20 = &camera->eyeNext;
                Camera_Vec3sToVec3f(&camera->eyeNext, (Vec3s *) temp_v0_2);
                *sp24 = *sp20;
                temp_a2 = &sp60;
                sp4C = sp54->rot;
                sp60.r = 100.0f;
                sp60.phi = -sp4C.x;
                sp60.theta = sp4C.y;
                Camera_Vec3fVecSphAdd(sp2C, sp24, &sp60);
                camera->animState++;
            }
            break;
        case 2:
            if (sp28->unk_08 & 4) {
                ...
                camera->at.y += (sp5C + sp28->unk_00);
            }
            camera->params.uniq3.unk_08--;
            if (camera->params.uniq3.unk_08 <= 0) {
                camera->animState++;
            }
            break;
        case 3:
        ...
        case 4:
            if (sp28->unk_08 & 2) {
                ...
                camera->params.uniq3.unk_0A = 5;
            }
            break;
        case 5:
            if (0.001f < camera->unk_D8 || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x8000) || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x4000) || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x2) || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x4) || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x8) || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x1) || CHECK_PAD(D_8015BD7C->state.input[0].press, 0x2000)) {
                sp20 = &camera->eyeNext;
                sp24 = &camera->eye;
                sp2C = (Unique3_Unk18 *) &camera->at;
                camera->fov = Camera_LERPCeilF(camera->params.uniq3.unk_18.unk_00, camera->fov, 0.4f, 0.1f);
                OLib_Vec3fDiffToVecSphRot90(&sp60, sp2C, sp24);
                sp60.r = Camera_LERPCeilF(100.0f, sp60.r, 0.4f, 0.1f);
                Camera_Vec3fVecSphAdd(sp20, sp2C, &sp60);
                *sp24 = *sp20;
                camera->params.uniq3.unk_0A--;
                if (camera->params.uniq3.unk_0A <= 0) {
                    camera->animState++;
                }
            } else {
                camera->animState++;
...
s32 Camera_Unique7(Camera *camera) {
    ...
    OLib_Vec3fDiffToVecSphRot90(&sp4C, &camera->eye, &camera->playerPosRot.pos);
    phi_v1_2 = sp44->fov;
    if (phi_v1_2 == -1) {
    ...
    Camera_Vec3fVecSphAdd(&camera->at, &camera->eye, &sp4C);
    camera->unk_14C |= 0x400;
    }
    return 1;
}
...
s32 Camera_Demo1(Camera* camera) {
    ...
    if (RELOAD_PARAMS) {
        values = sCameraSettings[camera->setting].cameraModes[camera->mode].values;
        camera->params.demo1.unk_00 = values->val;
    }
    sCameraInterfaceFlags = camera->params.demo1.unk_00;
    unk_04 = &camera->params.demo1.unk_04;
...
s32 Camera_Special4(Camera* camera) {
    ...
    if (camera->animState == 0) {
        ...
        camera->animState++;
        camera->fov = 40.0f;
        camera->params.spec4.unk_00 = *unk_160;
    }
...
Vec3s *Camera_Update(Vec3s *outVec, Camera *camera) {
    ...
    if (camera->status == 0) {
        ...
        *outVec = camera->direction;
        ...
        if (gDbgCamEnabled) {
            camera->globalCtx->view.fovy = D_8015BDC8;
            func_800B4E7C(&D_8015BD80, camera);
            func_800AA358(&camera->globalCtx->view, &D_8015BD90, &D_8015BD84, &D_8015BD9C);
            if (R_DBG_CAM_UPDATE) {
                osSyncPrintf("camera: debug out\n");
            }
            *outVec = D_8015CE46.unk_00;
            return outVec;
        }
        OREG(0) &= ~8;
        if (camera->status == 3) {
...
s32 func_8005AE64(Camera* camera, Camera* otherCamera) {
    ...
    camera->posOffset.x = 0.0f;
    camera->posOffset.y = 0.0f;
    camera->posOffset.z = 0.0f;
    camera->atLERPStepScale = 0.1f;
    camera->at = otherCamera->at;

    eyeTemp = otherCamera->eye;
    camera->eyeNext = eyeTemp;
    camera->eye = eyeTemp;
