 ...
 */
WaterBox sZdWaterBox = { -348, 877, -1746, 553, 780, 0x2104 };

/**
 * WaterBox's effective bounding box
 */
f32 sZdWaterBoxMinX = -348.0f;
f32 sZdWaterBoxMinY = 777.0f;
f32 sZdWaterBoxMinZ = -1746.0f;
f32 sZdWaterBoxMaxX = 205.0f;
f32 sZdWaterBoxMaxY = 977.0f;
f32 sZdWaterBoxMaxZ = -967.0f;
...
s32 WaterBox_GetSurface1(PlayState* play, CollisionContext* colCtx, f32 x, f32 z, f32* ySurface,
    ...
    if (play->sceneNum == SCENE_SPOT07) {
        if (sZdWaterBoxMinX < x && x < sZdWaterBoxMaxX && sZdWaterBoxMinY < *ySurface && *ySurface < sZdWaterBoxMaxY &&
            sZdWaterBoxMinZ < z && z < sZdWaterBoxMaxZ) {
            *outWaterBox = &sZdWaterBox;
            *ySurface = sZdWaterBox.ySurface;
            return true;
        }
    }
