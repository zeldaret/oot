...
void EffectBlure_DrawElemHermiteInterpolation(EffectBlure* this, EffectBlureElement* elem, s32 index,
    ...
    if (vtx == NULL) {
        ...
        vtx[0].v.ob[0] = MathF_NearbyIntF(sp158.x);
        vtx[0].v.ob[1] = MathF_NearbyIntF(sp158.y);
        vtx[0].v.ob[2] = MathF_NearbyIntF(sp158.z);
        vtx[0].v.cn[0] = sp148.r;
        vtx[0].v.cn[1] = sp148.g;
        vtx[0].v.cn[2] = sp148.b;
        vtx[0].v.cn[3] = sp148.a;
        vtx[1].v.ob[0] = MathF_NearbyIntF(sp14C.x);
        vtx[1].v.ob[1] = MathF_NearbyIntF(sp14C.y);
        vtx[1].v.ob[2] = MathF_NearbyIntF(sp14C.z);
        ...
        for (i = 1, j1 = 2, j2 = 3; i < 8; i++, j1 += 2, j2 += 2) {
            ...
            vtx[j1].v.ob[0] = MathF_NearbyIntF(sp158.x);
            vtx[j1].v.ob[1] = MathF_NearbyIntF(sp158.y);
            vtx[j1].v.ob[2] = MathF_NearbyIntF(sp158.z);
            ...
            vtx[j2].v.ob[0] = MathF_NearbyIntF(sp14C.x);
            vtx[j2].v.ob[1] = MathF_NearbyIntF(sp14C.y);
            vtx[j2].v.ob[2] = MathF_NearbyIntF(sp14C.z);
