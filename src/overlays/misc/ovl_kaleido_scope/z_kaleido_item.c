...
void KaleidoScope_DrawItemSelect(PlayState* play) {
    ...
    if ((pauseCtx->state == PAUSE_STATE_MAIN) && (pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_ITEM)) {
        moveCursorResult = 0;
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if (cursorItem != PAUSE_ITEM_NONE) {
                ...
                if ((pauseCtx->debugState == 0) && (pauseCtx->state == PAUSE_STATE_MAIN) && (pauseCtx->unk_1E4 == 0)) {
