...
void KaleidoScope_DrawPlayerWork(GlobalContext* globalCtx) {
    ...
    if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
        ...
        pos.z = -150.0f;
        scale = 0.046f;
    } else if (CUR_EQUIP_VALUE(EQUIP_SWORD) != EQUIP_EQUIP_SWORD_MASTER) {
        pos.x = 25.0f;
        pos.y = -228.0f;
        pos.z = 60.0f;
        scale = 0.056f;
    ...
    rot.x = rot.z = 0;
    func_8009214C(
        globalCtx, pauseCtx->playerSegment, &pauseCtx->playerSkelAnime, &pos, &rot, scale,
        SWORD_EQUIP_TO_PLAYER(CUR_EQUIP_VALUE(EQUIP_SWORD)), TUNIC_EQUIP_TO_PLAYER(CUR_EQUIP_VALUE(EQUIP_TUNIC)),
        SHIELD_EQUIP_TO_PLAYER(CUR_EQUIP_VALUE(EQUIP_SHIELD)), BOOTS_EQUIP_TO_PLAYER(CUR_EQUIP_VALUE(EQUIP_BOOTS)));
}
...
void KaleidoScope_DrawEquipment(GlobalContext* globalCtx) {
    ...
    if ((pauseCtx->state == 6) && (pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_EQUIP)) {
        ...
        if ((pauseCtx->cursorY[PAUSE_EQUIP] == 0) && (pauseCtx->cursorX[PAUSE_EQUIP] == 3)) {
            ...
            } else if (gBitFlags[INV_EQUIP_SWORD_GIANTKNIFE + (EQUIP_SWORD * 4)] & gSaveContext.inventory.equipment) {
                ...
                if (pauseCtx->cursorY[PAUSE_EQUIP] == 0) {
                    ...
                    if ((pauseCtx->cursorX[PAUSE_EQUIP] == 3) && (gSaveContext.bgsFlag != 0)) {
                        ...
                        if ((gSaveContext.equips.buttonItems[0] == ITEM_SWORD_BGS) && (gSaveContext.bgsFlag == 0) &&
                            (gBitFlags[INV_EQUIP_SWORD_GIANTKNIFE + (EQUIP_SWORD * 4)] &
                             gSaveContext.inventory.equipment)) {
