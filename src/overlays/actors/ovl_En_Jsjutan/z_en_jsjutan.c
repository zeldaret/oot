...
void func_80A89A6C(EnJsjutan* this, GlobalContext* globalCtx) {
    ...
    for (j = 0; j < 0x90; j++) {
        ...
        if (j >= 0x84) {
            index = j - 0xC;
            aux_f20 = (f32) (phi_s0_3->n.ob[0] - vtx_phi_s0_2[index].n.ob[0]);
        } else {
            index = j + 0xC;
            aux_f20 = (f32) (vtx_phi_s0_2[index].n.ob[0] - phi_s0_3->n.ob[0]);
        }
...
loop_16:
    ...
    while (phi_s1_3 < 0x90) {
        ...
        while (i < 3) {
            if (spE0[i] != 0) {
                ...
                temp_f14_2 = (spC8[i] * phi_f2) + ((phi_f16 - (phi_f16 * phi_f2)) - 200.0f);
                //distance_f0_2 = distance_f0_2;
                if (distance_f0_2 < 0.0f) {
                    distance_f0_2 = 0.0f;
                }

                phi_f2_3 = 100.0f * distance_f0_2 * 0.01f;
                if (phi_f2_3 > 100.0f) {
                    phi_f2_3 = 100.0f;
                }
    ...
    while (j < 0x90) {
        ...
        temp_f24 = (f32) ((temp_s4[(phi_v1_5)]).n.ob[1] - phi_s0_3->n.ob[1]);
        temp_f22_4 = Math_Atan2F(phi_f22, temp_f24);
        if (j >= 0x84) {
            phi_f20 = (f32) (phi_s0_3->n.ob[0] - (temp_s4[((s16) (j - 0xC))].n.ob[0]));
        } else {
            phi_f20 = (f32) ((temp_s4[((s16) (j + 0xC))].n.ob[0]) - phi_s0_3->n.ob[0]);
        }
