...
void func_8097E454(GlobalContext* globalCtx, Vec3f* spawnerPos, Vec3f* velocity, Vec3f* accel, f32 arg4, f32 scale,
    ...
    if ((FrameAdvance_IsEnabled(globalCtx) == 0) && (arg7 > 0) && (arg6 > 0)) {
...
void func_8097E744(DemoGt* this, GlobalContext* globalCtx, u32 actionIdx) {
    ...
    if (npcAction != NULL) {
        someFloat =
            Kankyo_LerpWeightAccelDecel(npcAction->endFrame, npcAction->startFrame, globalCtx->csCtx.frames, 8, 0);
...
void func_8097F280(DemoGt* this, GlobalContext* globalCtx) {
    ...
    if (globalCtx->csCtx.frames < 160) {
        ...
        temp_f0 = Kankyo_LerpWeightAccelDecel(170, 160, globalCtx->csCtx.frames, 0, 0);
...
void func_8097FDDC(DemoGt* this, GlobalContext* globalCtx) {
    ...
    if (globalCtx->csCtx.frames < 610) {
        ...
        f32 temp_f0 = Kankyo_LerpWeightAccelDecel(620, 610, globalCtx->csCtx.frames, 0, 0);
...
void DemoGt_Draw4(DemoGt* this, GlobalContext* globalCtx) {
    ...
    if (frames < 301) {
        ...
        if (FrameAdvance_IsEnabled(globalCtx2) == 0) {
