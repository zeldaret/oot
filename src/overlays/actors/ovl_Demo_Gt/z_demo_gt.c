...
void DemoGt_PlayExplosion1Sfx(GlobalContext* globalCtx, Vec3f* pos) {
    SoundSource_PlaySfxAtStationaryPosition(globalCtx, pos, 60, NA_SE_IT_BOMB_EXPLOSION);
}

void DemoGt_PlayExplosion2Sfx(GlobalContext* globalCtx, Vec3f* pos) {
    SoundSource_PlaySfxAtStationaryPosition(globalCtx, pos, 60, NA_SE_EV_GRAVE_EXPLOSION);
}
