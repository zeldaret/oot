...
void func_809BD524(EnBigokuta* this) {
    ...
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 255, COLORFILTER_XLUFLAG_OPA, this->unk_196);
...
void func_809BD5E0(EnBigokuta* this) {
    ...
    this->unk_19A = 0;
    this->cylinder[0].base.atFlags &= ~AT_ON;
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_R, 255, COLORFILTER_XLUFLAG_OPA, 24);
