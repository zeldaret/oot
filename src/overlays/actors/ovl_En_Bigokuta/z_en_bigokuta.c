...
void func_809BE568(EnBigokuta* this) {
    ...
    this->collider.elements[0].dim.worldSphere.center.x =
        this->actor.world.pos.x + (this->collider.elements[0].dim.modelSphere.center.x * cos) +
        (this->collider.elements[0].dim.modelSphere.center.z * sin);
    this->collider.elements[0].dim.worldSphere.center.z =
        this->actor.world.pos.z + (this->collider.elements[0].dim.modelSphere.center.z * cos) -
