...
static ColliderCylinderInit D_8092603C = {
    ...
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x00, 0x10 }, { 0xFFDFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_HOOKABLE | BUMP_ON,
OCELEM_ON }, { 20, 40, -20, { 0, 0, 0 } },
};

static ColliderJntSphItemInit  D_80925D80[19] = {
    {
        { ELEMTYPE_UNK4, { 0xFFCFFFFF, 0x00, 0x10 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
}, { 0, { { 0, 0, 0 }, 0 }, 100 },
    },
    {
        { ELEMTYPE_UNK4, { 0xFFCFFFFF, 0x00, 0x10 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
...
static ColliderJntSphInit D_8092602C = {
    { COLTYPE_UNK10, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_TYPE1, COLSHAPE_JNTSPH },
    19, D_80925D80,
};
*/
