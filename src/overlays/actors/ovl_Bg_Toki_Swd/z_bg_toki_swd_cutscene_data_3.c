...
CutsceneData D_808BBD90[] = {
    ...
    CS_CAM_LOOK_AT_LIST(0, 280),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 43, 52, 716, 0x0222),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 43, 52, 716, 0x00FA),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 10, 60.0f, 43, 52, 716, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 10, 60.0f, 43, 52, 716, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 10, 60.0f, 43, 52, 716, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 10, 60.0f, 63, 86, 722, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 63, 86, 722, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 63, 86, 722, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 63, 86, 722, 0x2D70),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 63, 85, 721, 0x0085),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 63, 85, 721, 0x01E6),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 60.0f, 62, 85, 721, 0x0000),
    CS_CAM_LOOK_AT_LIST(90, 360),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -105, 83, 366, 0x0222),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -104, 83, 364, 0x00FA),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -63, 83, 339, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -16, 99, 255, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -30, 111, 177, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -80, 112, 121, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -80, 112, 121, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.0f, -80, 112, 121, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 60.0f, -80, 112, 121, 0x2D70),
    CS_CAM_LOOK_AT_LIST(220, 520),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 137, -55, 0x0222),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 137, -55, 0x00FA),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 117, -55, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 105, -55, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 98, -31, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 98, -31, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 98, -31, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 98, -31, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.000004f, 0, 98, -31, 0x2D70),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 60.000004f, 0, 98, -31, 0x0085),
    CS_END(),
};
// clang-format on
