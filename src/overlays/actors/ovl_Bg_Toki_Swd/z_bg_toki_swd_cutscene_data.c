...
static CutsceneData D_808BB2F0[] = {
    ...
    CS_ACTOR_ACTION_LIST(10, 1),
        CS_ACTOR_ACTION(0x000C, 0, 256, 0x0000, 0x0000, 0x0000, 0, 54, 52, 0, 54, 52, 0.0f, 0.0f, 0.0f),
    CS_LIGHTING_LIST(1),
...
static CutsceneData D_808BB7A0[] = {
    ...
    CS_ACTOR_ACTION_LIST(10, 1),
        CS_ACTOR_ACTION(0x000C, 0, 180, 0x0000, 0x0000, 0x0000, 0, 28, -10, 0, -14, 9, 0.0f, -0.23333333f, 0.0f),
    CS_LIGHTING_LIST(1),
...
static CutsceneData D_808BBD90[] = {
    ...
    CS_ACTOR_ACTION_LIST(10, 3),
        CS_ACTOR_ACTION(0x0005, 0, 1, 0x0000, 0x8000, 0x0000, 0, 0, 820, 0, 0, 820, 0.0f, 0.0f, 1.4E-45f),
        CS_ACTOR_ACTION(0x0002, 1, 16, 0x0000, 0x8000, 0x0000, 0, 0, 820, 0, 0, 720, 0.0f, 0.0f, 1.4E-45f),
        CS_ACTOR_ACTION(0x0005, 16, 176, 0x0000, 0x8000, 0x0000, 0, 0, 720, 0, 0, 720, 0.0f, 0.0f, 1.4E-45f),
    CS_ACTOR_ACTION_LIST(62, 3),
        CS_ACTOR_ACTION(0x0004, 40, 70, 0x7D74, 0x0000, 0x0000, -1, 49, 719, 1, 47, 687, 0.06666667f, -0.06666667f, -0.06666667f),
        CS_ACTOR_ACTION(0x0004, 70, 220, 0x8010, 0x0000, 0x0000, 1, 47, 687, 0, 134, 21, -0.006666667f, 0.58f, 0.006666667f),
        CS_ACTOR_ACTION(0x0002, 220, 272, 0x8000, 0x0000, 0x0000, 0, 134, 21, 0, 101, 2, 0.0f, -0.63461536f, 0.0f),
    CS_MISC_LIST(1),
