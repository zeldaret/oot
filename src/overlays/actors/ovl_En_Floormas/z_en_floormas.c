...
static SubActor98Init D_80A1A49C = { 0x04, 0x001E, 0x0028, 0x96 };

static ActorDamageChart damageChart = {
    {
        DMG_ENTRY(0, DMG_EFF_STUN), DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(1, DMG_EFF_UNK0), DMG_ENTRY(2, DMG_EFF_UNK0),
        DMG_ENTRY(0, DMG_EFF_STUN), DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(0, DMG_EFF_STUN),
        DMG_ENTRY(1, DMG_EFF_UNK0), DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_BURN),
        DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_UNK4), DMG_ENTRY(4, DMG_EFF_UNK0), DMG_ENTRY(2, DMG_EFF_UNK0),
        DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_BURN), DMG_ENTRY(0, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_UNK4),
        DMG_ENTRY(0, DMG_EFF_UNK0), DMG_ENTRY(0, DMG_EFF_UNK0), DMG_ENTRY(1, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_UNK0),
        DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(2, DMG_EFF_UNK0), DMG_ENTRY(8, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_UNK0),
        DMG_ENTRY(0, DMG_EFF_UNK0), DMG_ENTRY(0, DMG_EFF_UNK0), DMG_ENTRY(4, DMG_EFF_UNK0), DMG_ENTRY(0, DMG_EFF_UNK0),
    },
};
...
Vec3f D_80A1A4E8 = { 0.0f, 0.0f, 0.0f };

s16 D_80A1A470[22] = {
    0x0011, 0x0939, 0x1001, 0x0000, 0x0000, 0x0000, 0xFFCF, 0xFFFF, 0x0410, 0x0000, 0xFFCF,
    0xFFFF, 0x0000, 0x0000, 0x0905, 0x0100, 0x0019, 0x0028, 0x0000, 0x0000, 0x0000, 0x0000,
};
...
void EnFloormas_Init(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_06008FB0, &D_06009DB0, &this->unk_19C, &this->unk_232, 0x19);
    ...
    if (this->actor.params == 0x10) {
        ...
        this->actor.attachedA =
            Actor_Spawn(&gctx->actorCtx, gctx, 0x8E, this->actor.posRot.pos.x, this->actor.posRot.pos.y,
                        this->actor.posRot.pos.z, 0, 0, 0, temp_v1 + 0x10);
...
void func_80A17808(EnFloormas* this) {
    if (this->actionFunc != (ActorFunc)&func_80A187E4) {
        SkelAnime_ChangeAnimationPlaybackSpeed(&this->skelAnime, &D_060041F4, 1.5f);
    } else {
...
void func_80A17908(EnFloormas* this) {
    ...
    if (temp_v1 > 0) {
        ...
        SkelAnime_ChangeAnimation(&this->skelAnime, &D_06002158, -1.0f, (f32)SkelAnime_GetFrameCount(&D_06002158), 0.0f,
                                  2, -3.0f);
    }
    if (0.004f < this->actor.scale.x) {
        this->unk_196 = ((f32)temp_v1 * (2.0f / 3.0f));
    } else {
        this->skelAnime.animPlaybackSpeed = this->skelAnime.animPlaybackSpeed + this->skelAnime.animPlaybackSpeed;
        this->unk_196 = (s32)((f32)temp_v1 * (2.0f / 15.0f));
    }
...
void func_80A17A38(EnFloormas* this, GlobalContext* globalCtx) {
    SkelAnime_ChangeAnimation(&this->skelAnime, &D_06009520, 3.0f, 0, (f32)SkelAnime_GetFrameCount(&D_06009520), 2,
                              -3.0f);
    this->actor.speedXZ = 0.0f;
...
void func_80A181D4(EnFloormas* this) {
    ...
    if ((attachedA->actionFunc == (ActorFunc)&func_80A19B9C) && (attachedB->actionFunc == (ActorFunc)&func_80A19B9C)) {
...
void func_80A18650(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    if ((((temp_ret != 0) || (func_800A56C8(&this->skelAnime, 12.0f) != 0)) ||
...
void func_80A18C78(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    Math_ApproxF(&this->actor.speedXZ, 15.0f, SQ(this->actor.speedXZ) * 0.3333333f);
...
void func_80A193C4(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    if (((player->stateFlags2 & 0x80) == 0) || (player->unk_A78 < 0)) {
        if ((((EnFloormas*)this->actor.attachedA)->actionFunc == (ActorFunc)&func_80A193C4) ||
            ((EnFloormas*)this->actor.attachedA)->actionFunc == (ActorFunc)&func_80A19B9C) {
            if (((EnFloormas*)this->actor.attachedB)->actionFunc == (ActorFunc)&func_80A193C4 ||
                ((EnFloormas*)this->actor.attachedB)->actionFunc == (ActorFunc)&func_80A19B9C) {
...
void func_80A198EC(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    if (((sp30 == 0.007f) || (sp30 == 0.004f)) && (sp30 != this->actor.scale.x)) {
            ...
            if (this->colCylinder.base.unk_14 != 0xC) {
                ...
                if ((this->actor.sub_98.damageEffect == 4) || (this->actor.sub_98.damageEffect == 1)) {
                    ...
                    if (this->actor.sub_98.damageEffect == 2) {
                        func_8002A65C(globalCtx, &this->actor, &this->actor.posRot.pos,
                                      (s16)(this->actor.scale.x * 4000.f), (s16)(this->actor.scale.x * 4000.f));
                    }
                    func_80A18254(this);
                }
            }
...
#endif
s32 func_80A1A128(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor* actor,
                  Gfx** gfx) {
...
void func_80A1A160(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* actor, Gfx** gfx) {
    if (limbIndex == 2) {
        Matrix_Push();
...
void EnFloormas_Draw(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    // Gfx* func_800A273C(GlobalContext* globalCtx, u32 limbIndex, u32 adt, u8 limbDListCnt, void* internal0, void*
    // internal1, Actor* actor, Gfx* gfx);
    gfxCtx->polyOpa.p =
        SkelAnime_DrawSV2(globalCtx, this->skelAnime.skeleton, this->skelAnime.actorDrawTbl, this->skelAnime.dListCount,
                          (void*)&func_80A1A128, (void*)&func_80A1A160, &this->actor, gfxCtx->polyOpa.p);
    // sp48->unk2C0 = func_800A273C(arg1, arg0->unk150, arg0->unk16C, arg0->unk14E, &func_80A1A128, &func_80A1A160,
    // arg0, (s32) sp48->unk2C0);
    if (this->colCylinder.base.unk_14 == 0xC) {
...
void func_80A1A350(EnFloormas* this, GlobalContext* globalCtx) {
    ...
    gfxCtx->polyXlu.p =
        SkelAnime_DrawSV2(globalCtx, this->skelAnime.skeleton, this->skelAnime.actorDrawTbl, this->skelAnime.dListCount,
                          (void*)&func_80A1A128, (void*)&func_80A1A160, &this->actor, gfxCtx->polyXlu.p);
    if (this->colCylinder.base.unk_14 == 0xC) {
