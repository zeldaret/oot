...
void BgSpot08Iceblock_Init(Actor* thisx, PlayState* play) {
    ...
    switch (this->dyna.actor.params & 0xF) {
        case 2:
        case 3:
            BgSpot08Iceblock_InitDynaPoly(this, play, colHeader, DYNAPOLYMOVE_UPD_POS_AND_ROT_Y);
            break;
        default:
            BgSpot08Iceblock_InitDynaPoly(this, play, colHeader, DYNAPOLYMOVE_UPD_NONE);
            break;
    }
