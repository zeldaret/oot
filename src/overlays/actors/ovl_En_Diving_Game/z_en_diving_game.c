...
void func_809EDCB0(EnDivingGame* this, GlobalContext* globalCtx) {
    ...
    Animation_Change(&this->skelAnime, &D_06002FE8, 1.0f, 0.0f, (s16)frameCount, ANIMMODE_LOOP, -10.0f);
...
void func_809EE0FC(EnDivingGame* this, GlobalContext* globalCtx) {
    ...
    Animation_Change(&this->skelAnime, &D_0600219C, 1.0f, 0.0f, (s16)frameCount, ANIMMODE_ONCE, -10.0f);
