...
void OceffSpot_Destroy(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Lights_Remove(globalCtx, &globalCtx->lightCtx, this->lightNode1);
    Lights_Remove(globalCtx, &globalCtx->lightCtx, this->lightNode2);
...
void OceffSpot_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Lights_PointNoGlowSetInfo(&this->lightInfo1, (s16)this->actor.posRot.pos.x,
