...
void OceffSpot_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Lights_PointNoGlowSetData(&this->lightInfo1, this->actor.posRot.pos.x, this->actor.posRot.pos.y,
                                    this->actor.posRot.pos.z, 0, 0, 0, 0);
    this->lightNode1 = Lights_Insert(globalCtx, &globalCtx->lightCtx, &this->lightInfo1);

    Lights_PointNoGlowSetData(&this->lightInfo2, this->actor.posRot.pos.x, this->actor.posRot.pos.y,
                                    this->actor.posRot.pos.z, 0, 0, 0, 0);
    this->lightNode2 = Lights_Insert(globalCtx, &globalCtx->lightCtx, &this->lightInfo2);
    if (YREG(15)) {
...
void OceffSpot_Destroy(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Lights_Free(globalCtx, &globalCtx->lightCtx, this->lightNode1);
    Lights_Free(globalCtx, &globalCtx->lightCtx, this->lightNode2);
