...
static ColliderCylinderInit D_80BA1B94 = {
    { COLTYPE_UNK12, AT_PLAYER | AT_ON, AC_PLAYER | AC_ON, OC_ALL | OC_ON, OT_TYPE2, COLSHAPE_CYLINDER },
    { ELEMTYPE_UNK0, { 0x00000002, 0x00, 0x01 }, { 0x4FC1FFFE, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON },
    { 9, 26, 0, { 0, 0, 0 } },
};
*/
