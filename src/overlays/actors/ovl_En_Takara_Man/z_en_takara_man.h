...
typedef struct EnTakaraMan {
    ...
    /* 0x020C */ s16 messageEndCode;
    /* 0x020E */ s16 eyeCont;
    /* 0x0210 */ s16 eyeTimer;
    /* 0x0212 */ s16 unk_212; // "parts_time"
    /* 0x0214 */ s16 unk_214; // "next_frag"
    /* 0x0216 */ s16 unk_216; // "romm_BAK"
    /* 0x0218 */ s16 unk_218; // "once_mode_frag"
    /* 0x021A */ s16 unk_21A; // "message_change_frag"
    /* 0x022C */ f32 eyePos;
    /* 0x0220 */ Vec3f pos;
    /* 0x022C */ char unk_22C[0xC];
