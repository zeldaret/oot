...
s32 func_80B0BE20(EnSw* this, CollisionPoly* poly) {
    ...
    this->unk_3D8.now_21 = this->unk_370.y;
    this->unk_3D8.now_31 = this->unk_370.z;
    this->unk_3D8.now_41 = 0.0f;
    this->unk_3D8.now_12 = this->unk_364.x;
    this->unk_3D8.yy = this->unk_364.y;
    this->unk_3D8.now_32 = this->unk_364.z;
    this->unk_3D8.now_42 = 0.0f;
    this->unk_3D8.now_13 = this->unk_37C.x;
    this->unk_3D8.now_23 = this->unk_37C.y;
    this->unk_3D8.zz = this->unk_37C.z;
    this->unk_3D8.now_43 = 0.0f;
    this->unk_3D8.now_14 = 0.0f;
    this->unk_3D8.now_24 = 0.0f;
    this->unk_3D8.now_34 = 0.0f;
...
s32 func_80B0CCF4(EnSw* this, f32* arg1) {
    ...
    sp2C.now_21 = this->unk_370.y;
    sp2C.now_31 = this->unk_370.z;
    sp2C.now_41 = 0.0f;
    sp2C.now_12 = this->unk_364.x;
    sp2C.yy = this->unk_364.y;
    sp2C.now_32 = this->unk_364.z;
    sp2C.now_42 = 0.0f;
    sp2C.now_13 = this->unk_37C.x;
    sp2C.now_23 = this->unk_37C.y;
