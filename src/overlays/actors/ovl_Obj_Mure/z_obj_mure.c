...
s32 D_80B99A64[] = { 0x0000000C, 0x00000009, 0x00000008, 0x00000000 };

// used to set actorID and params (?) in spawn child
s16 D_80B99A74[] = { 293, 0, 33, 32, 30, 0 };

s16 D_80B99A80[] = { 0, 2, -1, 0, -1, 0 };
...
ObjMureActionFunc D_80B99A98[] = { 0x00000000, 0x00000000, 0x80B995A4, 0x80B995A4, 0x80B997CC, 0x00000000 };
...
void func_80B98F38(ObjMure* this, GlobalContext* globalCtx) {
    ...
    for (i = 0; i < temp_v0; i++) {
        ...
        this->actorSpawnPtrList[i] =
            Actor_Spawn(&globalCtx->actorCtx, globalCtx, D_80B99A74[this->type], sp7C.pos.x, sp7C.pos.y, sp7C.pos.z,
