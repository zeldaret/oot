...
void func_80B11E78(EnSyatekiNiw* this, GlobalContext* globalCtx) {
    ...
    if ((this->unk_29C != 0) && (this->unk_29E == 0) && (this->actor.bgCheckFlags & BGCHECKFLAG_0)) {
        this->unk_29C = 0;
...
void func_80B12460(EnSyatekiNiw* this, GlobalContext* globalCtx) {
    ...
    switch (this->unk_29A) {
        ...
        case 2:
            ...
            if ((this->actor.bgCheckFlags & BGCHECKFLAG_0) && (this->actor.world.pos.z > 110.0f)) {
...
void func_80B129EC(EnSyatekiNiw* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_25C == 0) {
        ...
        if ((Rand_ZeroFloat(5.0f) < 1.0f) && (this->actor.bgCheckFlags & BGCHECKFLAG_0)) {
