    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->objectIdx)) {
        ...
        switch (this->type) {
            ...
            case EXITEM_14:
                ...
                switch (this->type) {
                    case EXITEM_GREEN_RUPEE_CHEST:
                        this->drawId = DI_RUPEE_GREEN;
                        break;
                    case EXITEM_BLUE_RUPEE_CHEST:
                        this->drawId = DI_RUPEE_BLUE;
                        break;
                    case EXITEM_RED_RUPEE_CHEST:
                        this->drawId = DI_RUPEE_RED;
                        break;
                    case EXITEM_14:
                        this->drawId = DI_RUPEE_PURPLE;
                        break;
