...
void func_80999EE0(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    if (this->rutoWarpState == WARP_BLUE_RUTO_STATE_3) {
        ...
        Gameplay_ChangeCameraStatus(globalCtx, sRutoWarpSubCamId, CAM_STATUS_ACTIVE);
...
void func_80999FE4(DoorWarp1* this, GlobalContext* globalCtx) {
    if (func_8010BDBC(&globalCtx->msgCtx) == 0) {
        ...
        Gameplay_CopyCamera(globalCtx, CAM_ID_ACTIVE, sRutoWarpSubCamId);
        Gameplay_ChangeCameraStatus(globalCtx, sRutoWarpSubCamId, CAM_STATUS_WAIT);
