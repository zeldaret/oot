...
void EnKarebaba_DrawBaseShadow(EnKarebaba* this, PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_en_karebaba.c", 1029);
...
void EnKarebaba_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->actionFunc == EnKarebaba_DeadItemDrop) {
        ...
        for (i = 0; i < stemSections; i++) {
            ...
            gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_karebaba.c", 1116);
    ...
    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_karebaba.c", 1144);
    ...
    if (this->actionFunc == EnKarebaba_Dying) {
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_karebaba.c", 1155);
