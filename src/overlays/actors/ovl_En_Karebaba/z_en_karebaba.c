...
void EnKarebaba_SetupAwaken(EnKarebaba* this) {
    SkelAnime_ChangeAnim(&this->skelAnime, &D_060002B8, 4.0f, 0.0f, SkelAnime_GetLastFrame(&D_060002B8), 0, -3.0f);
...
void EnKarebaba_SetupRetract(EnKarebaba* this) {
    SkelAnime_ChangeAnim(&this->skelAnime, &D_060002B8, -3.0f, SkelAnime_GetLastFrame(&D_060002B8), 0.0f, 2, -3.0f);
