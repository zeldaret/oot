...
void EnKarebaba_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Skeleton_Init(globalCtx, &this->skelAnime, &D_06002A40, &D_060002B8, this->jointTbl, this->morphTbl, 8);
...
void EnKarebaba_Upright(EnKarebaba* this, GlobalContext* globalCtx) {
    ...
    if (Animation_IsOnFrame(&this->skelAnime, 0.0f) || Animation_IsOnFrame(&this->skelAnime, 12.0f)) {
