...
void func_80AAA250(EnMd* this) {
    ...
    firstFrame = this->skelAnime.firstFrame;
    this->skelAnime.firstFrame = this->skelAnime.lastFrame;
    this->skelAnime.curFrame = this->skelAnime.lastFrame;
    this->skelAnime.lastFrame = firstFrame;
...
void func_80AAA274(EnMd* this) {
    switch (this->unk_20A) {
        case 0:
            ...
            this->unk_20A++;
        case 1:
            if (SkelAnime_StopAtFrame(&this->skelAnime, this->skelAnime.lastFrame)) {
...
void EnMd_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06007FB8, NULL, this->jointTbl, this->morphTbl, 17);
