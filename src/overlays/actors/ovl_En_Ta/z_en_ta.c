...
void func_80B14F20(EnTa* this, EnTaActionFunc arg1) {
    ...
    this->unk_2B4 = 2;
    Animation_Change(&this->skelAnime, &D_060017E8, 1.0f, 0.0f, Animation_LastFrame(&D_060017E8), 2, -5.0f);
    this->unk_2E2 = 0;
    this->unk_2E4 = &D_060017E8;
}
...
void func_80B14FAC(EnTa* this, EnTaActionFunc arg1) {
    ...
    this->unk_2E0 &= ~0x10;
    Animation_Change(&this->skelAnime, &D_0600C48C, 1.0f, 0.0f, Animation_LastFrame(&D_0600C48C), 2, -5.0f);
}
...
void func_80B15AD4(EnTa* this, GlobalContext* globalCtx) {
    if (this->unk_2CC == 0 && this->unk_2E0 & 0x20) {
        ...
        this->unk_2E0 &= ~0x10;
        Animation_Change(&this->skelAnime, &D_0600BF38, 1.0f, 1.0f, Animation_LastFrame(&D_0600BF38), 2, 0.0f);
        this->unk_2CC = 50;
        func_80088B34(0x1E);
        func_800F5ACC(0x6C);
        this->unk_2E0 |= 0x200;
