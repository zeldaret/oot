...
void EnTrap_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (thisx->params & SPIKETRAP_MODE_LINEAR) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, thisx, 10.0f, 20.0f, 20.0f, UPDBGCHECKINFOFLAG_0 | UPDBGCHECKINFOFLAG_2 | UPDBGCHECKINFOFLAG_3 | UPDBGCHECKINFOFLAG_4);
...
void EnTrap_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (thisx->colorFilterTimer == 0) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, thisx, 25.0f, 20.0f, 20.0f, UPDBGCHECKINFOFLAG_0 | UPDBGCHECKINFOFLAG_2 | UPDBGCHECKINFOFLAG_3 | UPDBGCHECKINFOFLAG_4);
        if (thisx->params & SPIKETRAP_MODE_LINEAR) {
