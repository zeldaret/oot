...
void EnVali_SetupRetaliate(EnVali* this) {
    ...
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_R, 150, COLORFILTER_XLUFLAG_XLU, 30);
    this->actor.params = BARI_TYPE_NORMAL;
    this->bodyCollider.base.acFlags &= ~AC_ON;
...
void EnVali_SetupFrozen(EnVali* this) {
    this->actor.velocity.y = 0.0f;
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 255, COLORFILTER_XLUFLAG_XLU, 36);
    this->bodyCollider.base.acFlags &= ~AC_ON;
    this->timer = 36;
