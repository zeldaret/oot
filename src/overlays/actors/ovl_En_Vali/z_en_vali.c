...
static ColliderQuadInit D_80B288A0 = {
    { COLTYPE_UNK10, AT_ENEMY | AT_ON, AC_OFF, OC_OFF, OT_TYPE1, COLSHAPE_QUAD },
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x07, 0x08 }, { 0x00000000, 0x00, 0x00 }, TOUCH_SFX2 | TOUCH_SFX1 | TOUCH_ON,
...
static ColliderCylinderInit D_80B288F0 = {
    ...
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x07, 0x08 }, { 0xFFCFFFFF, 0x01, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON },
    { 17, 35, -15, { 0, 0, 0 } },
};
*/
