...
void EnHs_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &object_hs_Skel_006260, &object_hs_Anim_0005C0, this->jointTable, this->morphTable, 16);
...
void func_80A6E7BC(EnHs* this, GlobalContext* globalCtx) {
    if ((func_8010BDBC(&globalCtx->msgCtx) == 4) && func_80106BC8(globalCtx)) {
        ...
        Animation_Change(&this->skelAnime, &object_hs_Anim_0005C0, 1.0f, 0.0f, Animation_GetLastFrame(&object_hs_Anim_0005C0), ANIMMODE_LOOP,
                         8.0f);
    }
...
void func_80A6E8CC(EnHs* this, GlobalContext* globalCtx) {
    ...
    if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
        ...
        Animation_Change(&this->skelAnime, &object_hs_Anim_000528, 1.0f, 0.0f, Animation_GetLastFrame(&object_hs_Anim_000528), ANIMMODE_LOOP,
                         8.0f);
    }
...
void func_80A6E9AC(EnHs* this, GlobalContext* globalCtx) {
    ...
    if (func_8002F194(&this->actor, globalCtx)) {
        if (func_8002F368(globalCtx) == 7) {
            ...
            Animation_Change(&this->skelAnime, &object_hs_Anim_000304, 1.0f, 0.0f, Animation_GetLastFrame(&object_hs_Anim_000304),
                             ANIMMODE_LOOP, 8.0f);
            this->unk_2AA = 40;
