...
void EnHs_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06006260, &D_060005C0, this->jointTbl, this->morphTbl, 16);
...
void func_80A6E7BC(EnHs* this, GlobalContext* globalCtx) {
    if ((func_8010BDBC(&globalCtx->msgCtx) == 4) && func_80106BC8(globalCtx)) {
        ...
        SkelAnime_ChangeAnim(&this->skelAnime, &D_060005C0, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_060005C0), 0, 8.0f);
    }
...
void func_80A6E8CC(EnHs* this, GlobalContext* globalCtx) {
    ...
    if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
        ...
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06000528, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06000528), 0, 8.0f);
    }
...
void func_80A6E9AC(EnHs* this, GlobalContext* globalCtx) {
    ...
    if (func_8002F194(&this->actor, globalCtx)) {
        if (func_8002F368(globalCtx) == 7) {
            ...
            SkelAnime_ChangeAnim(&this->skelAnime, &D_06000304, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06000304), 0,
                                 8.0f);
            this->unk_2AA = 40;
