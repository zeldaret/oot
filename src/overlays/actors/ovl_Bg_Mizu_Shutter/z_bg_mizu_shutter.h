...
#define BGMIZUSHUTTER_SIZE_PARAM(thisx)   PARAMS_GET((u16)(thisx)->params, 12, 4)
#define BGMIZUSHUTTER_TIMER_PARAM(thisx)  PARAMS_GET((u16)(thisx)->params,  6, 6)
#define BGMIZUSHUTTER_SWITCH_PARAM(thisx) PARAMS_GET((u16)(thisx)->params,  0, 6)
