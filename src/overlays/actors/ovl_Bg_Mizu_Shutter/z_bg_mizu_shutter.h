...
#define BGMIZUSHUTTER_SIZE_PARAM(thisx)   PARAMS_GET((u16)(thisx)->params, 0xC, 0xF)
#define BGMIZUSHUTTER_TIMER_PARAM(thisx)  PARAMS_GET((u16)(thisx)->params, 0x6, 0x3F)
#define BGMIZUSHUTTER_SWITCH_PARAM(thisx) PARAMS_GET((u16)(thisx)->params, 0x0, 0x3F)
