...
void func_80A7510C(EnIk* this, GlobalContext* globalCtx) {
    ...
    if (Animation_Update(&this->skelAnime) || (--this->unk_2F9 == 0)) {
        if (this->unk_2F8 == 8) {
            func_80A7489C(this);
        } else {
...
void func_80A7735C(EnIk* this, GlobalContext* globalCtx) {
    ...
    Skeleton_InitFlex(globalCtx, &this->skelAnime, &D_060205C0, NULL, this->jointTbl, this->morphTbl, 30);
...
void EnIk_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (((this->actor.params & 0xFF) == 0 && (gSaveContext.eventChkInf[3] & 0x1000)) ||
        ...
        Skeleton_InitFlex(globalCtx, &this->skelAnime, &D_0601E178, &D_0600C114, this->jointTbl, this->morphTbl, 30);
