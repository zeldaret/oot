...
void func_80A74714(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_0600CD70);
    f32 frame;
...
void func_80A7489C(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_0600DD50);
...
void func_80A74AAC(EnIk* this) {
    this->unk_2F8 = 5;
    if (this->unk_2FB == 0) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_0600ED24, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_0600ED24), 0, -4.0f);
        this->actor.speedXZ = 0.9f;
    } else {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06006734, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06006734), 0, -4.0f);
...
void func_80A74E2C(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_06001C28);
...
void func_80A7506C(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_060029FC);
...
void func_80A7510C(EnIk* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelAnime) || (--this->unk_2F9 == 0)) {
        if (this->unk_2F8 == 8) {
            ...
            frames = SkelAnime_GetLastFrame(&D_06002538);
            this->unk_2F8 = 8;
...
void func_80A751C8(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_060033C4);
...
void func_80A753D0(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_06003DBC);
...
void func_80A755F0(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_0600485C);
...
void func_80A75790(EnIk* this) {
    ...
    if (ABS(yawDiff) <= 0x4000) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06006194, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06006194), 2, -4.0f);
        this->actor.speedXZ = -6.0f;
    } else {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_060045BC, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_060045BC), 2, -4.0f);
        this->actor.speedXZ = 6.0f;
    }
    this->unk_2FE = 0;
...
void func_80A7598C(EnIk* this) {
    f32 frames = SkelAnime_GetLastFrame(&D_06005944);
...
void func_80A75C38(EnIk* this, GlobalContext* globalCtx) {
    ...
    if (this->shieldCollider.base.acFlags & 0x80) {
        temp_f0 = SkelAnime_GetLastFrame(&D_0600485C) - 2.0f;
...
void func_80A77158(EnIk* this, GlobalContext* globalCtx) {
    SkelAnime_ChangeAnim(&this->skelAnime, &D_0600C114, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_0600C114), 2, 0.0f);
...
void func_80A7735C(EnIk* this, GlobalContext* globalCtx) {
    s32 pad[3];
    f32 frames = SkelAnime_GetLastFrame(&D_060203D8);
