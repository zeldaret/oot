...
OCELEM_ON }, { 25, 80, 0, { 0, 0, 0 } },
};

static ColliderTrisItemInit  D_80A7836C[2] = {
    {
        { ELEMTYPE_UNK2, { 0x00000000, 0x00, 0x00 }, { 0xFFC3FFFF, 0x00, 0x00 }, TOUCH_OFF, BUMP_NO_AT_INFO |
BUMP_ON, OCELEM_OFF }, { { { -10.0f, 14.0f, 2.0f }, { -10.0f, -6.0f, 2.0f }, { 9.0f, 14.0f, 2.0f } } },
    },
    {
        { ELEMTYPE_UNK2, { 0x00000000, 0x00, 0x00 }, { 0xFFC3FFFF, 0x00, 0x00 }, TOUCH_OFF, BUMP_NO_AT_INFO |
BUMP_ON, OCELEM_OFF }, { { { -10.0f, -6.0f, 2.0f }, { 9.0f, -6.0f, 2.0f }, { 9.0f, 14.0f, 2.0f } } },
    },
};
...
static ColliderQuadInit D_80A783F4 = {
    ...
    { ELEMTYPE_UNK0, { 0x20000000, 0x00, 0x40 }, { 0x00000000, 0x00, 0x00 }, TOUCH_UNK7 | TOUCH_ON, BUMP_OFF,
