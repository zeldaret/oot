...
void EnBird_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->skelAnime, &object_bird_Skel_002190, &object_bird_Anim_00006C, NULL, NULL, 0);
...
void func_809C1CAC(EnBird* this, s16 params) {
    f32 frameCount = Animation_GetLastFrame(&object_bird_Anim_00006C);
    f32 playbackSpeed = this->unk_19C ? 0.0f : 1.0f;
    AnimationHeader* anim = &object_bird_Anim_00006C;
