...
void func_809973E8(DoorShutter* this, GlobalContext* globalCtx) {
    ...
    if (Math_StepToF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y, this->dyna.actor.velocity.y)) {
        if (this->dyna.actor.velocity.y > 20.0f) {
            ...
            Actor_SpawnFloorDust(globalCtx, &this->dyna.actor, &this->dyna.actor.world.pos, 45.0f, 0xA, 8.0f, 0x1F4, 0xA, 0);
        }
...
void func_809975C0(DoorShutter* this, GlobalContext* globalCtx) {
    ...
    if (this->dyna.actor.bgCheckFlags & 1) {
        ...
        if (!(gSaveContext.eventChkInf[7] & 1)) {
            ...
            Actor_SpawnFloorDust(globalCtx, &this->dyna.actor, &this->dyna.actor.world.pos, 70.0f, 20, 8.0f, 500, 10, 1);
        }
    }
}
