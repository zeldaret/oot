...
void func_80997220(DoorShutter* this, GlobalContext* globalCtx) {
    ...
    this->unk_164 = 0;
    this->dyna.actor.velocity.y = 0.0f;
    if (DoorShutter_SetupDoor(this, globalCtx) && !(player->stateFlags1 & PLAYER_STATE_FLAG_1_11)) {
...
void DoorShutter_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(player->stateFlags1 & (PLAYER_STATE_FLAG_1_6 | PLAYER_STATE_FLAG_1_7 | PLAYER_STATE_FLAG_1_10 | PLAYER_STATE_FLAG_1_28)) || (this->actionFunc == DoorShutter_SetupType)) {
