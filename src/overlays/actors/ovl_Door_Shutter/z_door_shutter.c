...
static ShutterInfo D_80998134[] = {
    { 0x060067A0, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06006910, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    ...
    { gDoorMetalBarsDL, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06010CB0, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06011F20, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x060000C0, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06005D90, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06007000, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06002620, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06003890, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x06001D10, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x060010D0, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x060020D0, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
    { 0x060000C0, gSlidingDungeonDoorDL, 130, 12, 20, 15 },
};
