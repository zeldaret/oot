...
void DoorShutter_RequestQuakeAndRumble(PlayState* play, s16 quakeYOffset, s16 quakeDuration, s16 camId);
...
void DoorShutter_RequestQuakeAndRumble(PlayState* play, s16 quakeYOffset, s16 quakeDuration, s16 camId) {
    ...
    Quake_SetPerturbations(quakeIndex, quakeYOffset, 0, 0, 0);
