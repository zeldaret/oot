...
void EnBox_Fall(EnBox* this, GlobalContext* globalCtx) {
    ...
    if (this->dyna.actor.bgCheckFlags & BGCHECKFLAG_GROUND) {
        ...
        Audio_PlaySfxGeneral(NA_SE_EV_COFFIN_CAP_BOUND, &this->dyna.actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
...
void EnBox_AppearInit(EnBox* this, GlobalContext* globalCtx) {
    if (func_8005B198() == this->dyna.actor.category || this->unk_1A8 != 0) {
        ...
        Audio_PlaySfxGeneral(NA_SE_EV_TRE_BOX_APPEAR, &this->dyna.actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
...
void EnBox_Open(EnBox* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelanime)) {
        ...
        if (sfxId != 0) {
            Audio_PlaySfxGeneral(sfxId, &this->dyna.actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                                 &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
        }
