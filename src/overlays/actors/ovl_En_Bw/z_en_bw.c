...
void func_809CEA24(EnBw* this, GlobalContext* globalCtx) {
    ...
    } else if ((this->actor.speedXZ != 0.0f) && (this->actor.bgCheckFlags & BGCHECKFLAG_3)) {
    ...
    switch (this->unk_221) {
        ...
        case 0:
            ...
            break;
        case 1:
            if (((sp64 == 0) && !(this->actor.bgCheckFlags & BGCHECKFLAG_3)) || Actor_IsFacingPlayer(&this->actor, 0x1C70)) {
...
void func_809D0584(EnBw* this, GlobalContext* globalCtx) {
    if ((this->actor.bgCheckFlags & BGCHECKFLAG_4) && (this->actor.bgCheckFlags & BGCHECKFLAG_0)) {
        this->unk_230 = 0;
        this->actor.scale.y -= 0.009f;
        Actor_SpawnFloorDustRing(globalCtx, &this->actor, &this->actor.world.pos, 30.0f, 11, 4.0f, 0, 0, false);
        func_809D00F4(this);
