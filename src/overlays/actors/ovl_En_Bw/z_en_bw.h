...
typedef enum {
    ...
    /*  2 */ TORCH_SLUG_LIMB_LEFT_EYESTALK_ROOT,
    /*  3 */ TORCH_SLUG_LIMB_LEFT_EYESTALK_WRAPPER,
    /*  4 */ TORCH_SLUG_LIMB_LEFT_UPPER_EYESTALK_ROOT,
    /*  5 */ TORCH_SLUG_LIMB_LEFT_UPPER_EYESTALK,
    /*  6 */ TORCH_SLUG_LIMB_LEFT_LOWER_EYESTALK,
    /*  7 */ TORCH_SLUG_LIMB_RIGHT_EYESTALK_ROOT,
    /*  8 */ TORCH_SLUG_LIMB_RIGHT_EYESTALK_WRAPPER,
