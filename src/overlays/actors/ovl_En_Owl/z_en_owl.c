...
void EnOwl_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    EnOwl_ChangeMode(this, EnOwl_WaitDefault, func_80ACC540, &this->skelAnime2, &gObjOwlAnim4, 0.0f);
...
void func_80ACA5C8(EnOwl* this) {
    EnOwl_ChangeMode(this, func_80ACBEA0, func_80ACC540, &this->skelAnime, &gObjOwlAnim3, 0.0f);
    this->eyeTexIndex = 0;
...
void func_80ACBAB8(EnOwl* this, GlobalContext* globalCtx) {
    switch (globalCtx->csCtx.npcActions[7]->action - 1) {
        case 0:
            EnOwl_ChangeMode(this, func_80ACB904, func_80ACC540, &this->skelAnime, &gObjOwlAnim1, 0.0f);
            break;
        case 1:
            this->actor.draw = EnOwl_Draw;
            EnOwl_ChangeMode(this, EnOwl_WaitDefault, func_80ACC540, &this->skelAnime, &gObjOwlAnim4, 0.0f);
            break;
        case 2:
            this->actor.draw = EnOwl_Draw;
            EnOwl_ChangeMode(this, func_80ACB994, func_80ACC540, &this->skelAnime, &gObjOwlAnim1, 0.0f);
            break;
        case 3:
...
void func_80ACBD4C(EnOwl* this, GlobalContext* globalCtx) {
    ...
    if (this->actionFlags & 1) {
        EnOwl_ChangeMode(this, func_80ACBC0C, func_80ACC460, &this->skelAnime, &gObjOwlAnim1, 0.0f);
        this->unk_3FE = 6;
...
void func_80ACBEA0(EnOwl* this, GlobalContext* GlobalContext) {
    if (this->actionFlags & 1) {
        this->unk_3FE = 3;
        EnOwl_ChangeMode(this, func_80ACBD4C, func_80ACC540, &this->skelAnime, &gObjOwlAnim0, 0.0f);
...
void func_80ACC30C(EnOwl* this, GlobalContext* globalCtx) {
    if (this->actionFlags & 1) {
        this->unk_3FE = 3;
        EnOwl_ChangeMode(this, func_80ACC23C, func_80ACC540, &this->skelAnime, &gObjOwlAnim0, 0.0f);
        this->unk_3F8 = this->actor.world.pos.y;
        this->actor.velocity.y = 0.2f;
    }
...
void func_80ACC460(EnOwl* this) {
    if (SkelAnime_Update(this->curSkelAnime) != 0) {
        if (this->unk_3FE > 0) {
            ...
            Animation_Change(this->curSkelAnime, &gObjOwlAnim2, 1.0f, 0.0f, Animation_GetLastFrame(&gObjOwlAnim2), 0, 5.0f);
        }
    }
}
...
void EnOwl_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(this->actionFlags & 0x80) && func_80ACC624(this, globalCtx)) {
        if ((this->skelAnime.animation == &gObjOwlAnim0 &&
            ...
            (this->skelAnime.animation == &gObjOwlAnim1 && this->skelAnime.curFrame == 4.0f)) {
...
void EnOwl_Draw(Actor* thisx, GlobalContext* globalCtx) {
    static u64* eyeTextures[] = { gObjOwlEyeOpenTex, gObjOwlEyeHalfOpenTex, gObjOwlEyeClosedTex };
    EnOwl* this = THIS;
    s32 pad;
