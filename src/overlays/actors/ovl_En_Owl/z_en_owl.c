...
void EnOwl_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &gDefaultOwlSkeleton, &gOwlFlyAnim_15CC, this->jointTable, this->morphTable, 21);
    SkelAnime_InitFlex(globalCtx, &this->skelAnime2, &gObjOwlSkel1, &gOwlWaitAnim, this->jointTable2, this->morphTable2,
                       16);
    ...
    EnOwl_ChangeMode(this, EnOwl_WaitDefault, func_80ACC540, &this->skelAnime2, &gOwlWaitAnim, 0.0f);
...
void func_80ACA5C8(EnOwl* this) {
    EnOwl_ChangeMode(this, func_80ACBEA0, func_80ACC540, &this->skelAnime, &gOwlFlyAnim_C684, 0.0f);
    this->eyeTexIndex = 0;
...
void func_80ACBAB8(EnOwl* this, GlobalContext* globalCtx) {
    switch (globalCtx->csCtx.npcActions[7]->action - 1) {
        case 0:
            EnOwl_ChangeMode(this, func_80ACB904, func_80ACC540, &this->skelAnime, &gOwlFlyAnim_15CC, 0.0f);
            break;
        case 1:
            this->actor.draw = EnOwl_Draw;
            EnOwl_ChangeMode(this, EnOwl_WaitDefault, func_80ACC540, &this->skelAnime, &gOwlWaitAnim, 0.0f);
            break;
        case 2:
            this->actor.draw = EnOwl_Draw;
            EnOwl_ChangeMode(this, func_80ACB994, func_80ACC540, &this->skelAnime, &gOwlFlyAnim_15CC, 0.0f);
            break;
        case 3:
...
void func_80ACBD4C(EnOwl* this, GlobalContext* globalCtx) {
    ...
    if (this->actionFlags & 1) {
        EnOwl_ChangeMode(this, func_80ACBC0C, func_80ACC460, &this->skelAnime, &gOwlFlyAnim_15CC, 0.0f);
        this->unk_3FE = 6;
...
void func_80ACC390(EnOwl* this) {
    ...
    if (this->unk_3FE > 0) {
        ...
        this->unk_3FE = 6;
        Animation_Change(this->curSkelAnime, &gOwlFlyAnim_15CC, 1.0f, 0.0f, Animation_GetLastFrame(&gOwlFlyAnim_15CC), 2, 5.0f);
    }
}
...
void func_80ACC460(EnOwl* this) {
    if (SkelAnime_Update(this->curSkelAnime)) {
        if (this->unk_3FE > 0) {
            ...
            Animation_Change(this->curSkelAnime, &gOwlFlyingInDistanceAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gOwlFlyingInDistanceAnim), 0, 5.0f);
        }
    }
}
...
void EnOwl_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(this->actionFlags & 0x80) && func_80ACC624(this, globalCtx)) {
        if ((this->skelAnime.animation == &gOwlTakeoffAnim &&
            ...
            (this->skelAnime.animation == &gOwlFlyAnim_15CC && this->skelAnime.curFrame == 4.0f)) {
