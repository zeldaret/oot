...
static ColliderJntSphItemInit  D_80906D7C[16] = {
    {
        { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x00, 0x10 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
}, { 0, { { 0, 0, 0 }, 30 }, 100 },
    },
    {
        { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x00, 0x10 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
...
static ColliderJntSphInit D_80906FBC = {
    { COLTYPE_METAL_SHIELD, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_FIRST_ONLY |
OT_TYPE1, COLSHAPE_JNTSPH }, 16, D_80906D7C,
};

static ColliderJntSphItemInit  D_80906FCC[2] = {
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x40 }, { 0xFFDFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
}, { 15, { { 0, 0, 0 }, 45 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x40 }, { 0xFFDFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
...
static ColliderJntSphInit D_80907014 = {
    { COLTYPE_METAL_SHIELD, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_TYPE1,
