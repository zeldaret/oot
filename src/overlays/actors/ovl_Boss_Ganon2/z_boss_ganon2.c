    ...
    if (this->unk_313) {
        if (this->actionFunc != func_808FFFE0) {
            if (this->unk_424.elements[0].base.acElemFlags & ACELEM_HIT) {
                ...
                if ((acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & DMG_ARROW_LIGHT) && (this->actionFunc != func_80900890)) {
                    func_809000A0(this, play);
                    Actor_PlaySfx(&this->actor, NA_SE_EN_FANTOM_HIT_THUNDER);
                    Actor_PlaySfx(&this->actor, NA_SE_EN_MGANON_DAMAGE);
                    Audio_StopSfxById(NA_SE_EN_MGANON_UNARI);
                } else if ((this->actionFunc == func_80900890) &&
                           (acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & (DMG_JUMP_MASTER | DMG_SPIN_MASTER | DMG_SLASH_MASTER))) {
                    this->unk_316 = 60;
                    this->unk_342 = 5;
                    Actor_PlaySfx(&this->actor, NA_SE_EN_MGANON_DAMAGE);
                    Audio_StopSfxById(NA_SE_EN_MGANON_UNARI);
        ...
        if (this->unk_424.elements[15].base.acElemFlags & ACELEM_HIT) {
            ...
            Audio_StopSfxById(NA_SE_EN_MGANON_UNARI);
            phi_v1_2 = 1;
            if (acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & (DMG_JUMP_MASTER | DMG_SPIN_MASTER | DMG_SLASH_MASTER)) {
                if (acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & DMG_JUMP_MASTER) {
                    phi_v1_2 = 4;
                } else {
                    phi_v1_2 = 2;
                }
