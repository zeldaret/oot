...
static ColliderJntSphInit D_80906FBC = {
    { COLTYPE_METAL, AT_ON | AT_ENEMY, AC_ON | AC_PLAYER, OC_ON | OC_PLAYER, OT_FIRST_ONLY | OT_TYPE1,
      COLSHAPE_JNTSPH },
    16,
    D_80906D7C,
};
...
static ColliderJntSphInit D_80907014 = {
    { COLTYPE_METAL, AT_ON | AT_ENEMY, AC_ON | AC_PLAYER, OC_ON | OC_PLAYER, OT_TYPE1, COLSHAPE_JNTSPH },
    2,
    D_80906FCC,
};
*/
