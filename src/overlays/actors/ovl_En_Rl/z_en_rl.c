...
void func_80AE7358(EnRl* this) {
    Animation_Change(&this->skelAnime, &D_06000A3C, 1.0f, 0.0f, Animation_LastFrame(&D_06000A3C), 0, 0.0f);
    this->action = 4;
    this->drawConfig = 0;
    this->alpha = 0;
...
void func_80AE7698(EnRl* this, GlobalContext* globalCtx) {
    ...
    if (globalCtx->csCtx.state != 0) {
        ...
        if (csCmdActorAction != NULL && csCmdActorAction->action == 3) {
            Animation_Change(&this->skelAnime, &D_0600040C, 1.0f, 0.0f, Animation_LastFrame(&D_0600040C), 2, 0.0f);
            this->action = 2;
        }
    }
}
...
void func_80AE772C(EnRl* this, s32 arg1) {
    if (arg1) {
        Animation_Change(&this->skelAnime, &D_06000830, 1.0f, 0.0f, Animation_LastFrame(&D_06000830), 0, 0.0f);
        this->action = 3;
    }
}
...
void func_80AE7AF8(EnRl* this, GlobalContext* globalCtx) {
    if (func_80AE74B4(this, globalCtx, 3, 0)) {
        Animation_Change(&this->skelAnime, &D_0600040C, 1.0f, 0.0f, Animation_LastFrame(&D_0600040C), 2, -8.0f);
        this->action = 6;
