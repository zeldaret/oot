...
static ColliderCylinderInit D_8095BF60 = {
    ...
    { ELEMTYPE_UNK0, { 0xFFCFFFEF, 0x03, 0x08 }, { 0x00000010, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_ON,
OCELEM_ON }, { 85, 120, 0, { 0, 0, 0 } },
};
...
static ColliderQuadInit D_8095BFF4 = {
    { COLTYPE_METAL, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_OFF, OT_NONE, COLSHAPE_QUAD },
    { ELEMTYPE_UNK0, { 0x20000000, 0x03, 0x04 }, { 0x00000010, 0x00, 0x00 }, TOUCH_UNK7 | TOUCH_SFX_NORMAL | TOUCH_ON,
...
static ColliderJntSphElementInit  D_8095BFC0[1] = {
    {
        { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x03, 0x04 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_ON,
OCELEM_OFF }, { 0, { { 0, 0, 0 }, 30 }, 100 },
    },
};

static ColliderJntSphInit D_8095BFE4 = {
    { COLTYPE_NONE, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_OFF, OT_TYPE1, COLSHAPE_JNTSPH },
    1, D_8095BFC0,
};
