...
void BossVa_BodyPhase4(BossVa* this, GlobalContext* globalCtx) {
    ...
    if (this->timer == 0) {
        ...
        if (this->timer > 0) {
            if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_26) && (this->timer > 35)) {
                this->timer = 35;
            }
            ...
            if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_26) && (this->timer < -60)) {
                this->timer = -59;
            }
            if ((globalCtx->gameplayFrames % 4) == 0) {
...
void BossVa_ZapperAttack(BossVa* this, GlobalContext* globalCtx) {
    ...
    if ((sp8E >= ABS(tmp17) || this->burst) && !(sBodyState & 0x80) && !(player->stateFlags1 & PLAYER_STATE_FLAG_1_26)) {
        ...
        if (this->burst || (this->timer2 < 0)) {
            ...
            if ((this->timer2 < 0) && (player->stateFlags1 & PLAYER_STATE_FLAG_1_26)) {
