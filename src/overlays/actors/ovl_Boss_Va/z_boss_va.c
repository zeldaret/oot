...
void BossVa_BodyPhase1(BossVa* this, PlayState* play) {
    ...
    if (sBodyState & 0x7F) {
        ...
        Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 255, COLORFILTER_XLUFLAG_OPA, 12);
...
void BossVa_BodyPhase2(BossVa* this, PlayState* play) {
    ...
    if (this->actor.colorFilterTimer == 0) {
        ...
        if ((this->invincibilityTimer != 0) && (this->actor.colorFilterParams & 0x4000)) {
            Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 255, COLORFILTER_XLUFLAG_OPA, 160);
        ...
        if (this->timer >= 0) {
            if (this->invincibilityTimer == 0) {
                ...
                if (this->actor.colChkInfo.damageEffect != 1) {
                    ...
                    this->actor.speedXZ = 0.0f;
                    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 125, COLORFILTER_XLUFLAG_OPA, 255);
                    Audio_PlayActorSfx2(&this->actor, NA_SE_EN_BALINADE_FAINT);
                }
            }
