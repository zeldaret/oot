...
void DemoEffect_Init(Actor* thisx, PlayState* play2) {
    ...
    effectType = PARAMS_GET2(this->actor.params, 0, 8);
    lightEffect = PARAMS_GET2(this->actor.params, 12, 4);
...
void DemoEffect_Destroy(Actor* thisx, PlayState* play) {
    DemoEffect* this = (DemoEffect*)thisx;
    s32 effectType = PARAMS_GET2(this->actor.params, 0, 8);
...
void DemoEffect_UpdateLightEffect(DemoEffect* this, PlayState* play) {
    ...
    isLargeSize = PARAMS_GET2(this->actor.params, 8, 4);
...
void DemoEffect_DrawTimeWarp(Actor* thisx, PlayState* play) {
    ...
    u8 effectType = PARAMS_GET2(this->actor.params, 0, 8);
