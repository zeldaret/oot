...
static ColliderJntSphElementInit  D_808D5FD0[9] = {
    {
        { ELEMTYPE_UNK3, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_OFF, BUMP_HOOKABLE | BUMP_ON,
OCELEM_ON }, { 35, { { 6000, 0, 0 }, 21 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 18, { { 4000, 0, 0 }, 13 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 19, { { 3000, 0, 0 }, 13 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 20, { { 4000, 0, 0 }, 15 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 24, { { 4000, 0, 0 }, 13 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 25, { { 3000, 0, 0 }, 13 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 26, { { 3500, 1500, 0 }, 15 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 17, { { 0, 0, 0 }, 26 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 30, { { 0, 0, 0 }, 17 }, 100 },
    },
};

static ColliderJntSphInit D_808D6114 = {
    { COLTYPE_METAL, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_TYPE1,
COLSHAPE_JNTSPH }, 9, D_808D5FD0,
};
*/
