...
void BossFd2_UpdateCamera(BossFd2* this, GlobalContext* globalCtx) {
    if (this->subCamId != CAM_ID_MAIN) {
        ...
        Math_ApproachF(&this->subCamData.eye.y, this->subCamData.nextEye.y, this->subCamData.eyeMaxVel.y,
                       this->subCamData.eyeVel.y * this->subCamData.speedMod);
        Math_ApproachF(&this->subCamData.eye.z, this->subCamData.nextEye.z, this->subCamData.eyeMaxVel.z,
                       this->subCamData.eyeVel.z * this->subCamData.speedMod);
        Math_ApproachF(&this->subCamData.at.x, this->subCamData.nextAt.x, this->subCamData.atMaxVel.x,
                       this->subCamData.atVel.x * this->subCamData.speedMod);
        Math_ApproachF(&this->subCamData.at.y, this->subCamData.nextAt.y, this->subCamData.atMaxVel.y,
                       this->subCamData.atVel.y * this->subCamData.speedMod);
        Math_ApproachF(&this->subCamData.at.z, this->subCamData.nextAt.z, this->subCamData.atMaxVel.z,
                       this->subCamData.atVel.z * this->subCamData.speedMod);
        Math_ApproachF(&this->subCamData.speedMod, 1.0f, 1.0f, this->subCamData.accel);
        this->subCamData.at.y += this->subCamData.yMod;
        Gameplay_CameraSetAtEye(globalCtx, this->subCamId, &this->subCamData.at, &this->subCamData.eye);
        Math_ApproachF(&this->subCamData.yMod, 0.0f, 1.0f, 0.1f);
    }
}
...
void BossFd2_Death(BossFd2* this, GlobalContext* globalCtx) {
    ...
    switch (this->deathState) {
        case DEATH_START:
            ...
            this->subCamData.eyeVel.x = 100.0f;
            this->subCamData.eyeVel.y = 100.0f;
            this->subCamData.eyeVel.z = 100.0f;
            this->subCamData.atVel.x = 100.0f;
            this->subCamData.atVel.y = 100.0f;
            this->subCamData.atVel.z = 100.0f;
            this->subCamData.accel = 0.02f;
            this->timers[0] = 0;
            this->work[FD2_HOLE_COUNTER] = 0;
            this->subCamData.eyeMaxVel.x = 0.1f;
            this->subCamData.eyeMaxVel.y = 0.1f;
            this->subCamData.eyeMaxVel.z = 0.1f;
            this->subCamData.atMaxVel.x = 0.1f;
            this->subCamData.atMaxVel.y = 0.1f;
            this->subCamData.atMaxVel.z = 0.1f;
        case DEATH_RETREAT:
            this->work[FD2_HOLE_COUNTER]++;
            ...
            this->subCamData.nextEye.x = this->actor.world.pos.x + sp64.x;
            this->subCamData.nextEye.y = 140.0f;
            this->subCamData.nextEye.z = this->actor.world.pos.z + sp64.z;
            if (this->actor.focus.pos.y >= 90.0f) {
                this->subCamData.nextAt.y = this->actor.focus.pos.y;
                this->subCamData.nextAt.x = this->actor.focus.pos.x;
                this->subCamData.nextAt.z = this->actor.focus.pos.z;
            }
            if (this->timers[0] == 0) {
        ...
        case DEATH_FD_BODY:
            if (bossFd->actor.world.pos.y < 80.0f) {
                if (bossFd->actor.world.rot.x > 0x3000) {
                    this->subCamData.nextAt = bossFd->actor.world.pos;
                    this->subCamData.nextAt.y = 80.0f;
                    this->subCamData.nextEye.x = bossFd->actor.world.pos.x;
                    this->subCamData.nextEye.y = 150.0f;
                    this->subCamData.nextEye.z = bossFd->actor.world.pos.z + 300.0f;
                }
            } else {
                this->subCamData.nextAt = bossFd->actor.world.pos;
                this->subCamData.nextEye.x = this->actor.world.pos.x;
                Math_ApproachF(&this->subCamData.nextEye.y, 200.0f, 1.0f, 2.0f);
                Math_ApproachF(&this->subCamData.nextEye.z, bossFd->actor.world.pos.z + 200.0f, 1.0f, 3.0f);
                if (this->work[FD2_ACTION_STATE] == 0) {
                    this->work[FD2_ACTION_STATE]++;
                    this->subCamData.speedMod = 0.0f;
                    this->subCamData.accel = 0.02f;
            ...
            break;
        case DEATH_FD_SKULL:
            Math_ApproachF(&this->subCamData.nextAt.y, 100.0, 1.0f, 100.0f);
            this->subCamData.nextAt.x = 0.0f;
            this->subCamData.nextAt.z = 0.0f;
            this->subCamData.nextEye.x = 0.0f;
            this->subCamData.nextEye.y = 140.0f;
            Math_ApproachF(&this->subCamData.nextEye.z, 220.0f, 0.5f, 1.15f);
            if (bossFd->work[BFD_CAM_SHAKE_TIMER] != 0) {
                ...
                this->subCamData.yMod = (bossFd->work[BFD_CAM_SHAKE_TIMER] & 1) ? cameraShake : -cameraShake;
            }
