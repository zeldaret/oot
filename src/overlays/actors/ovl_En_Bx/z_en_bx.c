...
Vec3f D_809D250C = {
    0.0149999996647f, 0.0149999996647f, 0.0149999996647f
 };
...
Vec3f D_809D2528 = {
    8000.0f, 15000.0f, 2500.0f
};

Vec3f D_809D2534 = {
    8000.0f, 10000.0f, 2500.0f
};
...
u32 D_809D2560[] = {
    0x060024F0, 0x060027F0, 0x060029F0, 0x00000000
};
...
void EnBx_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((thisx->xzDistFromLink <= 70.0f) || (this->collider.base.atFlags & 2) || (this->collider.base.acFlags & 2) || (this->colliderQuad.base.atFlags & 2)) {
        if ((thisx->xzDistFromLink <= 70.0f) || (&player->actor == this->collider.base.at) || (&player->actor == this->collider.base.ac) || (&player->actor == this->colliderQuad.base.at)) {
    ...
    if (this->unk_14C != 0) {
        ...
        for (i = 0; i < 4; i++) {
            if (!((this->unk_14C + (i << 1)) % 4)) {
                ...
                func_800295A0(globalCtx, &sp58, &D_809D2558, &D_809D255C, 0xE6, 
                    tmp16, 6, 0);
            }
        }
...
void EnBx_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    
    {
        ...
        gSPSegment(gfxCtx->polyOpa.p++, 0x08, 
            SEGMENTED_TO_VIRTUAL(D_809D2560[this->actor.params & 0x7F]));
