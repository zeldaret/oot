...
s32 EnAm_CanMove(EnAm* this, GlobalContext* globalCtx, f32 distance, s16 yaw) {
    ...
    ret = this->dyna.actor.bgCheckFlags & BGCHECKFLAG_0;
...
void EnAm_MoveToHome(EnAm* this, GlobalContext* globalCtx) {
    ...
    if ((this->dyna.actor.speedXZ != 0.0f) && (this->dyna.actor.bgCheckFlags & BGCHECKFLAG_3)) {
...
void EnAm_Lunge(EnAm* this, GlobalContext* globalCtx) {
    if (this->deathTimer < 52) {
        ...
        if ((this->dyna.actor.speedXZ != 0.0f) && (this->dyna.actor.bgCheckFlags & BGCHECKFLAG_3)) {
            ...
            Actor_MoveForward(&this->dyna.actor);
            this->dyna.actor.bgCheckFlags &= ~BGCHECKFLAG_3;
        }
...
void EnAm_Statue(EnAm* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_258 == 0) {
        ...
        if ((this->dyna.unk_150 == 0.0f) || (this->unk_258 == 0) || !(this->dyna.actor.bgCheckFlags & BGCHECKFLAG_0) ||
