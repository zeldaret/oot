...
typedef enum {
    EN_WEATHER_TAG_TYPE_0,
    EN_WEATHER_TAG_TYPE_1,
    EN_WEATHER_TAG_TYPE_2,
    EN_WEATHER_TAG_TYPE_3,
    EN_WEATHER_TAG_TYPE_4,
    EN_WEATHER_TAG_TYPE_5,
    EN_WEATHER_TAG_TYPE_6,
    EN_WEATHER_TAG_TYPE_7
} EnWeatherTagType;
