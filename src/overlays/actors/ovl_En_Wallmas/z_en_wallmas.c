...
void EnWallmas_WaitToDrop(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    if ((player->stateFlags1 & PLAYER_STATE_FLAG_1_20) || (player->stateFlags1 & PLAYER_STATE_FLAG_1_27) || !(player->actor.bgCheckFlags & 1) ||
...
void EnWallmas_Drop(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    if (!Player_InCsMode(globalCtx) && !(player->stateFlags2 & PLAYER_STATE_FLAG_2_4) && (player->invincibilityTimer >= 0) &&
