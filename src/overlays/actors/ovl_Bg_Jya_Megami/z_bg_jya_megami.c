...
void BgJyaMegami_DetectLight(BgJyaMegami* this, GlobalContext* globalCtx) {
    ...
    if (this->lightTimer > 40) {
        ...
        SoundSource_PlaySfxAtStationaryPosition(globalCtx, &this->dyna.actor.world.pos, 100, NA_SE_EV_FACE_EXPLOSION);
...
void BgJyaMegami_Explode(BgJyaMegami* this, GlobalContext* globalCtx) {
    ...
    if (this->explosionTimer == 30) {
        SoundSource_PlaySfxAtStationaryPosition(globalCtx, &this->dyna.actor.world.pos, 100, NA_SE_EV_FACE_BREAKDOWN);
    }
