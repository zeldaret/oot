...
void BgJyaMegami_DrawFace(BgJyaMegami* this, PlayState* play) {
    ...
    gSPMatrix(POLY_OPA_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_bg_jya_megami.c", 716), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void BgJyaMegami_DrawExplode(BgJyaMegami* this, PlayState* play) {
    ...
    for (i = 0; i < ARRAY_COUNT(this->pieces); i++) {
        ...
        gSPMatrix(POLY_OPA_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_bg_jya_megami.c", 778), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
