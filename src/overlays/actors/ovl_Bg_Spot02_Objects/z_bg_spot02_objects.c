...
void func_808ACCB8(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (globalCtx->csCtx.state != 0 && globalCtx->csCtx.npcActions[0] != NULL &&
        ...
        Matrix_RotateX(BINANG_TO_RAD_ALT(globalCtx->csCtx.npcActions[0]->urot.x), MTXMODE_APPLY);
        Matrix_RotateY(BINANG_TO_RAD_ALT(globalCtx->csCtx.npcActions[0]->urot.y), MTXMODE_APPLY);
        Matrix_RotateZ(BINANG_TO_RAD_ALT(globalCtx->csCtx.npcActions[0]->urot.z), MTXMODE_APPLY);
...
void func_808AD450(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (globalCtx->csCtx.state != 0 && globalCtx->csCtx.npcActions[2] != NULL) {
        ...
        if ((globalCtx->csCtx.npcActions[2]->action & 0xFFFF) == 2) {
            ...
            Matrix_RotateX(BINANG_TO_RAD_ALT(globalCtx->csCtx.npcActions[2]->urot.x), MTXMODE_APPLY);
            Matrix_RotateY(BINANG_TO_RAD_ALT(globalCtx->csCtx.npcActions[2]->urot.y), MTXMODE_APPLY);
