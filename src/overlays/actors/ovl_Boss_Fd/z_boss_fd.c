...
void BossFd_SetCameraSpeed(BossFd* this, f32 speedMod) {
    this->subCamData.eyeVel.x = fabsf(this->subCamData.eye.x - this->subCamData.nextEye.x) * speedMod;
    this->subCamData.eyeVel.y = fabsf(this->subCamData.eye.y - this->subCamData.nextEye.y) * speedMod;
    this->subCamData.eyeVel.z = fabsf(this->subCamData.eye.z - this->subCamData.nextEye.z) * speedMod;
    this->subCamData.atVel.x = fabsf(this->subCamData.at.x - this->subCamData.nextAt.x) * speedMod;
    this->subCamData.atVel.y = fabsf(this->subCamData.at.y - this->subCamData.nextAt.y) * speedMod;
    this->subCamData.atVel.z = fabsf(this->subCamData.at.z - this->subCamData.nextAt.z) * speedMod;
}
...
void BossFd_UpdateCamera(BossFd* this, GlobalContext* globalCtx) {
    if (this->subCamId != CAM_ID_MAIN) {
        ...
        Math_ApproachZeroF(&this->subCamData.yMod, 1.0f, 0.1f);
    }
}
        ...
        switch (this->introState) {
            case BFD_CS_WAIT:
                ...
                if ((fabsf(player2->actor.world.pos.z) < 80.0f) &&
                    ...
                    this->subCamData.nextEye.x = player2->actor.world.pos.x - 50.0f + 18.0f;
                    this->subCamData.nextEye.y = player2->actor.world.pos.y + 40;
                    this->subCamData.nextEye.z = player2->actor.world.pos.z + 50.0f - 18.0f;
                    this->subCamData.nextAt.x = player2->actor.world.pos.x;
                    this->subCamData.nextAt.y = player2->actor.world.pos.y + 50.0f;
                    this->subCamData.nextAt.z = player2->actor.world.pos.z;
                    BossFd_SetCameraSpeed(this, 1.0f);
                    this->subCamData.atMaxVel.x = this->subCamData.atMaxVel.y = this->subCamData.atMaxVel.z = 0.05f;
                    this->subCamData.eyeMaxVel.x = this->subCamData.eyeMaxVel.y = this->subCamData.eyeMaxVel.z = 0.05f;
                    this->timers[0] = 0;
                    this->subCamData.speedMod = 0.0f;
                    this->subCamData.accel = 0.0f;
                    if (gSaveContext.eventChkInf[7] & 8) {
                        this->introState = BFD_CS_EMERGE;
                        this->subCamData.nextEye.x = player2->actor.world.pos.x + 100.0f + 300.0f - 600.0f;
                        this->subCamData.nextEye.y = player2->actor.world.pos.y + 100.0f - 50.0f;
                        this->subCamData.nextEye.z = player2->actor.world.pos.z + 200.0f - 150.0f;
            ...
            case BFD_CS_LOOK_LINK:
                ...
                if (this->timers[0] < 50) {
                    ...
                    this->subCamData.yMod = Math_CosS(this->work[BFD_MOVE_TIMER] * 0x8000) * this->subCamData.shake;
                ...
                if (this->timers[0] == 0) {
                    ...
                    this->subCamData.nextAt.y = player2->actor.world.pos.y + 10.0f;
                    this->subCamData.atMaxVel.y = 0.2f;
                    this->subCamData.speedMod = 0.0f;
            ...
            case BFD_CS_LOOK_GROUND:
                ...
                if (this->timers[0] == 0) {
                    ...
                    this->subCamData.nextEye.x = player2->actor.world.pos.x + 100.0f + 300.0f;
                    this->subCamData.nextEye.y = player2->actor.world.pos.y + 100.0f;
                    this->subCamData.nextEye.z = player2->actor.world.pos.z + 200.0f;
                    this->subCamData.nextAt.x = player2->actor.world.pos.x;
                    this->subCamData.nextAt.y = player2->actor.world.pos.y - 150.0f;
                    this->subCamData.nextAt.z = player2->actor.world.pos.z - 50.0f;
            ...
            case BFD_CS_EMERGE:
                ...
                if (this->actor.world.pos.y > 120.0f) {
                    this->subCamData.nextAt = this->actor.world.pos;
                ...
                if (this->timers[3] <= 100) {
                    ...
                    this->subCamData.nextEye.x = player2->actor.world.pos.x + 50.0f;
                    this->subCamData.nextEye.y = player2->actor.world.pos.y + 50.0f;
                    this->subCamData.nextEye.z = player2->actor.world.pos.z + 50.0f;
                }
