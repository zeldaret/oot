...
void EnHeishi4_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->type == HEISHI4_AT_MARKET_DYING) {
        ...
        Skeleton_Init(globalCtx, &this->skelAnime, &D_0600BAC8, &D_0600C444, &this->jointTbl, &this->morphTbl, 17);
    } else {
        this->height = 60.0f;
...
void EnHeishi4_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Skeleton_DrawOpa(globalCtx, this->skelAnime.skeleton, this->skelAnime.jointTbl, EnHeishi_OverrideLimbDraw, NULL,
                     this);
}
