...
static ColliderCylinderInit D_80AD2740 = {
    { COLTYPE_WOOD, AT_OFF, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_TYPE1, COLSHAPE_CYLINDER },
...
static ColliderQuadInit D_80AD27A0 = {
    { COLTYPE_METAL, AT_ENEMY | AT_ON, AC_PLAYER | AC_HARD | AC_ON, OC_OFF, OT_NONE, COLSHAPE_QUAD },
