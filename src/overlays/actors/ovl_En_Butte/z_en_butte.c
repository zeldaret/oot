...
void EnButte_FlyAround(EnButte* this, PlayState* play) {
    ...
    if ((PARAMS_GET(this->actor.params, 0, 1) == 1) && (player->heldItemAction == PLAYER_IA_DEKU_STICK) &&
...
void EnButte_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((PARAMS_GET(this->actor.params, 0, 1) == 1) && (this->actionFunc == EnButte_TransformIntoFairy)) {
