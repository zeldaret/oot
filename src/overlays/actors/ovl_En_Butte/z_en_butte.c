...
void EnButte_DrawTransformationEffect(EnButte* this, GlobalContext* globalCtx) {
    ...
    Matrix_RotateY(BINANG_TO_RAD_ALT(camDir.y), MTXMODE_NEW);
    Matrix_RotateX(BINANG_TO_RAD_ALT(camDir.x), MTXMODE_APPLY);
    Matrix_RotateZ(BINANG_TO_RAD_ALT(camDir.z), MTXMODE_APPLY);
