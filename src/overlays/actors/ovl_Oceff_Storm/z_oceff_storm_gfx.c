...
static Gfx sCylinderTexDl[] = {
    ...
    gsDPLoadTextureBlock(gEffectUnknown10Tex, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_NOMIRROR,
                         G_TX_NOMIRROR | G_TX_NOMIRROR, 5, 5, 2, 13),
    gsDPLoadMultiBlock(gEffectUnknown11Tex, 0x100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_NOMIRROR,
