...
void OceffStorm_Draw2(Actor* thisx, GlobalContext* globalCtx) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, sSongOfStormsTextureDL);
...
void OceffStorm_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, sSongOfStormsCylinderTextureDL);
    ...
    gSPDisplayList(POLY_XLU_DISP++, sSongOfStormsCylinderVtxDL);
