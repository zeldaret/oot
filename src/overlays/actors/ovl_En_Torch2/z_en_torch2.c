        ...
        case ENTORCH2_ATTACK:
            ...
            if (sDodgeRollState != 0) {
                ...
                if (((player->meleeWeaponState != 0) || (player->actor.velocity.y > -3.0f)) &&
                    (player->meleeWeaponAnimation == PMWA_JUMPSLASH_START)) {
                    ...
                    if (func_800354B4(globalCtx, &this->actor, 120.0f, 0x7FFF, 0x7FFF, this->actor.world.rot.y)) {
                        if ((player->meleeWeaponAnimation == PMWA_STAB_1H) && (this->actor.xzDistToPlayer < 90.0f)) {
                            ...
                            if ((this->meleeWeaponState == 0) && (sCounterState == 0) &&
                                (player->invincibilityTimer == 0) && (player->meleeWeaponAnimation == PMWA_STAB_1H) &&
                            ...
                            if (player->meleeWeaponAnimation <= PMWA_FORWARD_COMBO_2H) {
                                sStickTilt = 0.0f;
                            } else if (player->meleeWeaponAnimation <= PMWA_RIGHT_COMBO_2H) {
                                sStickTilt = 127.0f;
                                sStickAngle += 0x4000;
                            } else if (player->meleeWeaponAnimation <= PMWA_LEFT_COMBO_2H) {
                                sStickTilt = 127.0f;
                                sStickAngle -= 0x4000;
                            } else if (player->meleeWeaponAnimation <= PMWA_HAMMER_SIDE) {
                                input->cur.button = BTN_R;
                            } else if (player->meleeWeaponAnimation <= PMWA_BIG_SPIN_2H) {
                                EnTorch2_Backflip(this, input, &this->actor);
                            } else {
                                EnTorch2_Backflip(this, input, &this->actor);
                            }
