    ...
    if (gSaveContext.sceneSetupIndex == 4) {
        ...
        if (sceneNum == SCENE_SPOT11) {
            ...
            if (frameCount == 119) {
                ...
                SkinMatrix_Vec3fMtxFMultXYZW(&globalCtx->projectionMatrix, &pos, &sXyzDist, wDest);
...
void EnXc_PlayDiveSFX(Vec3f* src, GlobalContext* globalCtx) {
    ...
    SkinMatrix_Vec3fMtxFMultXYZW(&globalCtx->projectionMatrix, src, &D_80B42DA0, wDest);
...
void EnXc_PlayTriforceSFX(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->unk_2A8) {
        ...
        SkinMatrix_Vec3fMtxFMultXYZW(&globalCtx->projectionMatrix, &src, &pos, &wDest);
