...
void func_80B96678(ObjLift* this, GlobalContext* globalCtx) {
    ...
    if ((this->timer & 3) == 3) {
        SoundSource_PlaySfxByPosAndId(globalCtx, &this->dyna.actor.world.pos, 16, NA_SE_EV_BLOCK_SHAKE);
    }
}
...
void func_80B96840(ObjLift* this, GlobalContext* globalCtx) {
    ...
    if ((this->dyna.actor.floorHeight - this->dyna.actor.world.pos.y) >=
        ...
        SoundSource_PlaySfxByPosAndId(globalCtx, &this->dyna.actor.world.pos, 20, NA_SE_EV_BOX_BREAK);
