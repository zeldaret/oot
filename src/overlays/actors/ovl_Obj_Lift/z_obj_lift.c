...
void func_80B96160(ObjLift* this, GlobalContext* globalCtx) {
    ...
    if (((this->dyna.actor.params >> 1) & 1) == 0) {
        Actor_SpawnFlyingDust(globalCtx, &this->dyna.actor.world.pos, 120.0f, 12, 120, 100, 1);
    } else if (((this->dyna.actor.params >> 1) & 1) == 1) {
        Actor_SpawnFlyingDust(globalCtx, &this->dyna.actor.world.pos, 60.0f, 8, 60, 100, 1);
    }
}
