...
static ColliderCylinderInit D_80B94B30 = {
    ...
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x02, 0x00 }, { 0x00020800, 0x00, 0x00 }, TOUCH_SFX_NONE | TOUCH_ON,
BUMP_ON, OCELEM_ON }, { 50, 120, 0, { 0, 0, 0 } },
};

static ColliderCylinderInit D_80B94B5C = {
    { COLTYPE_HARD, AT_OFF, AC_PLAYER | AC_HARD | AC_ON, OC_OFF, OT_TYPE2, COLSHAPE_CYLINDER },
