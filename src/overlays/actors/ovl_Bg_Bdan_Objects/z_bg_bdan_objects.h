...
typedef enum {
    BDAN_OBJECTS_TYPE_BIG_OCTO_PLATFORM = 0,
    BDAN_OBJECTS_TYPE_SMALL_AUTO_ELEVATOR = 1,
    BDAN_OBJECTS_TYPE_WATERBOX_HEIGHT_CHANGER = 2,
    BDAN_OBJECTS_TYPE_FALLING_PLATFORM = 3
} BgBdanObjectsType;
