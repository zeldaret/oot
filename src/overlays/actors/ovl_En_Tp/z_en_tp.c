            ...
            if (this->actor.colChkInfo.health == 0) {
                ...
                for (now = (EnTp*)this->actor.parent; now != NULL; now = (EnTp*)now->actor.parent) {
                    ...
                    if (phi_s4 != 0) {
                        ...
                        if (phi_s2 != 0) {
                            Actor_SetColorFilter(&now->actor, COLORFILTER_COLORFLAG_B, 255, COLORFILTER_XLUFLAG_OPA, 80);
                        } else {
                            Actor_SetColorFilter(&now->actor, COLORFILTER_COLORFLAG_B, 255, COLORFILTER_XLUFLAG_XLU, 80);
                        }
                    }
                }
