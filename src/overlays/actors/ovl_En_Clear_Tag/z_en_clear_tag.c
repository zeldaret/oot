...
void EnClearTag_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->drawMode != CLEAR_TAG_DRAW_MODE_EFFECT) {
        ...
        if (this->state >= CLEAR_TAG_STATE_LASER) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_en_clear_tag.c", 1004);
            gSPDisplayList(POLY_XLU_DISP++, gArwingLaserDL);

            Matrix_Translate(-50.0f, 0.0f, 0.0f, MTXMODE_APPLY);
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_en_clear_tag.c", 1011);
            gSPDisplayList(POLY_XLU_DISP++, gArwingLaserDL);
        } else {
            ...
            gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_clear_tag.c", 1030);
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_en_clear_tag.c", 1067);
            ...
            Matrix_RotateZ(this->roll, MTXMODE_APPLY);
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_en_clear_tag.c", 1104);
...
void EnClearTag_DrawEffects(PlayState* play) {
    ...
    for (i = 0; i < CLEAR_TAG_EFFECT_COUNT; i++, effect++) {
        if (effect->type == CLEAR_TAG_EFFECT_DEBRIS) {
            ...
            gSPMATRIX_SET_NEW(POLY_OPA_DISP++, gfxCtx, "../z_en_clear_tag.c", 1307);
    ...
    for (i = 0; i < CLEAR_TAG_EFFECT_COUNT; i++, effect++) {
        if (effect->type == CLEAR_TAG_EFFECT_FLASH) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, gfxCtx, "../z_en_clear_tag.c", 1342);
    ...
    for (i = 0; i < CLEAR_TAG_EFFECT_COUNT; i++, effect++) {
        if (effect->type == CLEAR_TAG_EFFECT_SMOKE) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, gfxCtx, "../z_en_clear_tag.c", 1392);
    ...
    for (i = 0; i < CLEAR_TAG_EFFECT_COUNT; i++, effect++) {
        if (effect->type == CLEAR_TAG_EFFECT_FIRE) {
            ...
            Matrix_ReplaceRotation(&play->billboardMtxF);
            Matrix_Scale(effect->scale, effect->scale, 1.0f, MTXMODE_APPLY);
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, gfxCtx, "../z_en_clear_tag.c", 1439);
            gSPDisplayList(POLY_XLU_DISP++, gArwingFireEffectDL);
        }
    }
    ...
    for (i = 0; i < CLEAR_TAG_EFFECT_COUNT; i++, effect++) {
        if (effect->type == CLEAR_TAG_EFFECT_FLASH) {
            ...
            Matrix_ReplaceRotation(&play->billboardMtxF);
            Matrix_Scale(effect->scale, effect->scale, 1.0f, MTXMODE_APPLY);
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, gfxCtx, "../z_en_clear_tag.c", 1470);
