        ...
        switch (this->state) {
            ...
            state_crashing:
                ...
                if (this->timers[CLEAR_TAG_TIMER_ARWING_UPDATE_BG_INFO] == 0) {
                    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 50.0f, 30.0f, 100.0f, UPDBGCHECKINFOFLAG_0 | UPDBGCHECKINFOFLAG_2);
            ...
            case CLEAR_TAG_STATE_LASER:
                ...
                Collider_UpdateCylinder(&this->actor, &this->collider);
                CollisionCheck_SetAT(globalCtx, &globalCtx->colChkCtx, &this->collider.base);
                Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 50.0f, 80.0f, 100.0f, UPDBGCHECKINFOFLAG_0 | UPDBGCHECKINFOFLAG_2);
