...
typedef enum BgMizuMovebgType {
    /* 0 */ MIZUMOVEBG_TYPE_FLOATING_PLATFORM_OUTSIDE_CENTRE_PILLAR,
    /* 1 */ MIZUMOVEBG_TYPE_FLOATING_PLATFORM_WEST,
    /* 2 */ MIZUMOVEBG_TYPE_FLOATING_PLATFORM_INSIDE_CENTRE_PILLAR,
    /* 3 */ MIZUMOVEBG_TYPE_DRAGON_STATUE_BOSS_ROOM, // Dragon Statue leading to the Water Temple boss room
    /* 4 */ MIZUMOVEBG_TYPE_DRAGON_STATUE_2,         // Same behaviour as ``MIZUMOVEBG_TYPE_DRAGON_STATUE_3``
    /* 5 */ MIZUMOVEBG_TYPE_DRAGON_STATUE_3,         // Dragon Statues used in Water Temple puzzles
    /* 6 */ MIZUMOVEBG_TYPE_DRAGON_STATUE_4,         // Same behaviour as ``MIZUMOVEBG_TYPE_DRAGON_STATUE_3``
