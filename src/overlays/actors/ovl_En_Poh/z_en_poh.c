...
void EnPoh_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->colliderSph.list[0].dim.worldSphere.center.x = this->actor.world.pos.x;
    this->colliderSph.list[0].dim.worldSphere.center.y = this->actor.world.pos.y;
    this->colliderSph.list[0].dim.worldSphere.center.z = this->actor.world.pos.z;
