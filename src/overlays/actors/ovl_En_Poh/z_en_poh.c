...
UnkEnPohStruct D_80AE1AFC[2] = {
    { 255, 170, 255, 0x64, 0x00, 0x96, 0x12, 0x05, 0xF8, 0x060015B0, 0x06000A60, 0x060004EC, 0x060006E0, 0x06002D28, 0x06002608, 0x06003850 },
    { 255, 255, 170, 0x00, 0x96, 0x00, 0x09, 0x01, 0xF4, 0x06001440, 0x060009DC, 0x06000570, 0x06000708, 0x060045A0, 0x06005220, 0x06001C90 },
};
...
void EnPoh_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->unk_194 = 0;
    this->unk_195 = 32;
    this->unk_19A = Math_Rand_S16Offset(700, 300);
...
void func_80ADEF38(EnPoh* this, GlobalContext* globalCtx) {
    if (SkelAnime_FrameUpdateMatrix(&this->skelAnime) != 0) {
        ...
        this->unk_29D = ((this->skelAnime.animCurrentFrame - 10.0f) * 0.05f) * 255.0f;
    }
...
void func_80ADF0B8(EnPoh* this, GlobalContext* globalCtx) {
    if (SkelAnime_FrameUpdateMatrix(&this->skelAnime) != 0) {
        ...
        this->unk_29D = CLAMP_MAX((s32)(this->skelAnime.animCurrentFrame * 25.5f), 255);
    }
}
...
void func_80ADF660(EnPoh* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_194 == 0) {
        this->unk_19A = Math_Rand_S16Offset(100, 50);
        func_80ADE16C(this);
    }
}
...
void func_80ADF994(EnPoh* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.bgCheckFlags & 1) {
        phi_v0 = (this->unk_197 == 1) ? 110 : 9;
        func_800297A4(globalCtx, &this->actor.posRot.pos, 6.0f, 0, 1, 1, 15, phi_v0, 10, this->unk_2A4->unk_1C);
        func_80ADE6D4(this);
    } else if (this->unk_198 == 0) {
        Actor_Kill(&this->actor);
        return;
...
void func_80ADFA90(EnPoh* this, s32 arg1) {
    ...
    this->unk_29D = CLAMP(this->unk_29D + arg1, 0, 255);
    if (arg1 < 0) {
        multiplier = this->unk_29D * 0.003921569f;
        ...
        multiplier = 1.0f;
        this->actor.scale.z = this->unk_29D * 2.7450982e-05f;
        this->actor.scale.y = this->unk_29D * 2.7450982e-05f;
        this->actor.scale.x = this->unk_29D * 2.7450982e-05f;
        this->actor.posRot.pos.y = this->actor.initPosRot.pos.y + 0.05882353f * this->unk_29D;
    }
    ...
    Lights_InitType0PositionalLight(&this->lightInfo, 
                    ...
                    this->unk_2A4->unk_3, this->unk_2A4->unk_4, this->unk_2A4->unk_5, this->unk_29D * 0.78431373f);
}
...
void func_80AE03C4(EnPoh* this) {
    if (this->actionFunc != func_80ADF77C && this->actionFunc != func_80ADF660 && 
        ...
        if (this->unk_29D == 255) {
            ...
            if ((this->unk_194 == 20 || this->unk_19A == 0) && (this->actionFunc == func_80ADEAC4 || 
...
void func_80AE067C(EnPoh* this) {
    ...
    if (this->actionFunc == func_80ADEDFC) {
        this->unk_29A = CLAMP_MAX((s16)(this->unk_29A + 5), 255);
        this->unk_29B = CLAMP_MIN((s16)(this->unk_29B - 5), 50);
        temp_var = this->unk_29C - 5;
        this->unk_29C = CLAMP_MIN(temp_var, 0);
    } else if (this->actionFunc == func_80ADF894) {
        this->unk_29A = CLAMP_MAX((s16)(this->unk_29A + 5), 80);
        this->unk_29B = CLAMP_MAX((s16)(this->unk_29B + 5), 255);
        temp_var = this->unk_29C + 5;
        this->unk_29C = CLAMP_MAX(temp_var, 225);
        ...
        if (this->unk_29C >= 211) {
            temp_var = this->unk_29C - 5;
            this->unk_29C = CLAMP_MIN(temp_var, 210);
        } else {
            temp_var = this->unk_29C + 5;
            this->unk_29C = CLAMP_MAX(temp_var, 210);
        }
    }
}
...
void func_80AE089C(EnPoh* this) {
    ...
    if ((this->actionFunc == func_80ADEF38 || this->actionFunc == func_80ADF0B8) && this->skelAnime.animCurrentFrame < 12.0f) {
        this->unk_2A0 = (s16)(this->skelAnime.animCurrentFrame * 16.66f) + 55;
        this->unk_29F = (s16)(this->skelAnime.animCurrentFrame * 16.66f) + 55;
        this->unk_29E = (s16)(this->skelAnime.animCurrentFrame * 16.66f) + 55;
        this->unk_2A1 = this->skelAnime.animCurrentFrame * 16.666666f;
    } else {
        rand = Math_Rand_ZeroOne();
        this->unk_29E = (s16)(rand * 30.0f) + 225;
        this->unk_29F = (s16)(rand * 100.0f) + 155;
        this->unk_2A0 = (s16)(rand * 160.0f) + 95;
        this->unk_2A1 = 200;
    }
}
...
void func_80AE0A1C(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Actor_MoveForward(&this->actor);
    if (this->actionFunc == func_80ADEDFC && this->unk_198 < 10) {
    ...
    if ((this->colliderCyl.base.acFlags & 1) && this->unk_29D == 255) {
...
void func_80AE0EE4(Actor* thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_29D == 255 || this->unk_29D == 0) {
        gDPSetEnvColor(oGfxCtx->polyOpa.p++, this->unk_29A, this->unk_29B, this->unk_29C, this->unk_29D);
        ...
        gDPSetEnvColor(oGfxCtx->polyXlu.p++, 255, 255, 255, this->unk_29D);
    ...
    gDPSetEnvColor(oGfxCtx->polyOpa.p++, this->unk_29E, this->unk_29F, this->unk_2A0, 255);
    Matrix_Put(&this->unk_368);
    gSPMatrix(oGfxCtx->polyOpa.p++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_poh.c", 2676), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(oGfxCtx->polyOpa.p++, this->unk_2A4->unk_1C);
...
void func_80AE1148(Actor* thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk_29D == 255 || this->unk_29D == 0) {
        func_80093D18(globalCtx->state.gfxCtx);
        gSPSegment(oGfxCtx->polyOpa.p++, 0x08, Gfx_EnvColor(globalCtx->state.gfxCtx, this->unk_29A, this->unk_29B, this->unk_29C, this->unk_29D));
        gSPSegment(oGfxCtx->polyOpa.p++, 0x0A, Gfx_EnvColor(globalCtx->state.gfxCtx, sp90->r, sp90->g, sp90->b, this->unk_29D));
        gSPSegment(oGfxCtx->polyOpa.p++, 0x0B, Gfx_EnvColor(globalCtx->state.gfxCtx, phi_t0->r, phi_t0->g, phi_t0->b, this->unk_29D));
        ...
        func_80093D18(globalCtx->state.gfxCtx);
        func_80093D84(globalCtx->state.gfxCtx);
        gSPSegment(oGfxCtx->polyXlu.p++, 0x08, Gfx_EnvColor(globalCtx->state.gfxCtx, this->unk_29A, this->unk_29B, this->unk_29C, this->unk_29D));
        gSPSegment(oGfxCtx->polyXlu.p++, 0x0A, Gfx_EnvColor(globalCtx->state.gfxCtx, sp90->r, sp90->g, sp90->b, this->unk_29D));
        gSPSegment(oGfxCtx->polyXlu.p++, 0x0B, Gfx_EnvColor(globalCtx->state.gfxCtx, phi_t0->r, phi_t0->g, phi_t0->b, this->unk_29D));
    ...
    gDPSetEnvColor(oGfxCtx->polyOpa.p++, this->unk_29E, this->unk_29F, this->unk_2A0, 255);
    Matrix_Put(&this->unk_368);
    gSPMatrix(oGfxCtx->polyOpa.p++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_poh.c", 2787), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(oGfxCtx->polyOpa.p++, this->unk_2A4->unk_1C);
    gSPDisplayList(oGfxCtx->polyOpa.p++, D_06004498);
    gDPPipeSync(oGfxCtx->polyOpa.p++);
    gDPSetEnvColor(oGfxCtx->polyOpa.p++, sp90->r, sp90->g, sp90->b, 255);
    gSPDisplayList(oGfxCtx->polyOpa.p++, D_06004530);
...
void func_80AE1654(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actionFunc == func_80ADF994) {
        ...
        Lights_InitType2PositionalLight(&this->lightInfo, this->actor.posRot.pos.x, this->actor.posRot.pos.y, this->actor.posRot.pos.z, 
                                        this->unk_29E, this->unk_29F, this->unk_2A0, 200);
        ...
        if (this->unk_197 == 1) {
            ...
            gSPDisplayList(oGfxCtx->polyOpa.p++, D_06004498);
            gDPPipeSync(oGfxCtx->polyOpa.p++);
            gDPSetEnvColor(oGfxCtx->polyOpa.p++, envColor->r, envColor->g, envColor->b, 255);
            gSPDisplayList(oGfxCtx->polyOpa.p++, D_06004530);
        }
    } else {
        func_80093D84(globalCtx->state.gfxCtx);
        gSPSegment(oGfxCtx->polyXlu.p++, 0x08, 
                    Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0, 0, 0x20, 0x40, 1, 0, (this->unk_19A * this->unk_2A4->unk_8) % 512U, 0x20, 0x80));
        gDPSetPrimColor(oGfxCtx->polyXlu.p++, 0x80, 0x80, this->unk_2A4->unk_0, this->unk_2A4->unk_1, this->unk_2A4->unk_2, this->unk_29D);
        gDPSetEnvColor(oGfxCtx->polyXlu.p++, this->unk_29A, this->unk_29B, this->unk_29C, 255);
        Matrix_RotateY((s16)(func_8005A9F4(ACTIVE_CAM) + 0x8000) * 9.58738e-05f, 1);
        gSPMatrix(oGfxCtx->polyXlu.p++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_poh.c", 2910), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
        gSPDisplayList(oGfxCtx->polyXlu.p++, this->unk_2A4->unk_24);
    }
