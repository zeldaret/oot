...
void EnIshi_Wait(EnIshi* this, GlobalContext* globalCtx) {
    ...
    if (Actor_HasParent(&this->actor, globalCtx)) {
        ...
        SoundSource_PlaySfxAtStationaryPosition(globalCtx, &this->actor.world.pos, 20, liftSounds[type]);
        ...
        SoundSource_PlaySfxAtStationaryPosition(globalCtx, &this->actor.world.pos, sBreakSoundDurations[type],
                                      sBreakSounds[type]);
