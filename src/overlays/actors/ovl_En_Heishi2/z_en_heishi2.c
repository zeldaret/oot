...
void func_80A53DF8(EnHeishi2* this, GlobalContext* globalCtx) {
    ...
    Gameplay_ChangeCameraStatus(globalCtx, CAM_ID_MAIN, CAM_STATUS_WAIT);
    Gameplay_ChangeCameraStatus(globalCtx, this->subCamId, CAM_STATUS_ACTIVE);
    this->subCamEyeCopy.x = this->subCamEye.x = -71.0f;
    this->subCamEyeCopy.y = this->subCamEye.y = 571.0f;
    this->subCamEyeCopy.z = this->subCamEye.z = -1487.0f;
    this->subCamAtCopy.x = this->subCamAt.x = 181.0f;
    this->subCamAtCopy.y = this->subCamAt.y = 417.0f;
    this->subCamAt.z = this->subCamAtCopy.z = -1079.0f;
    Gameplay_CameraSetAtEye(globalCtx, this->subCamId, &this->subCamEye, &this->subCamAt);
