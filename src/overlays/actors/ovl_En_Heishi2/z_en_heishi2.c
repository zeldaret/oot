...
void func_80A53DF8(EnHeishi2* this, GlobalContext* globalCtx) {
    ...
    Gameplay_ChangeCameraStatus(globalCtx, CAM_ID_MAIN, CAM_STAT_WAIT);
    Gameplay_ChangeCameraStatus(globalCtx, this->subCamId, CAM_STAT_ACTIVE);
    this->subCamEyeCopy.x = -71.0f;
    this->subCamEye.x = -71.0f;
    this->subCamEyeCopy.y = 571.0f;
    this->subCamEye.y = 571.0f;
    this->subCamEyeCopy.z = -1487.0f;
    this->subCamEye.z = -1487.0f;
    this->subCamAtCopy.x = 181.0f;
    this->subCamAt.x = 181.0f;
    this->subCamAtCopy.y = 417.0f;
    this->subCamAt.y = 417.0f;
    this->subCamAtCopy.z = -1079.0f;
