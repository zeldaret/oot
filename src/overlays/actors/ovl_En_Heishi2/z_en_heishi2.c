...
void func_80A535BC(EnHeishi2* this, GlobalContext* globalCtx) {
    f32 frameCount = SkelAnime_GetLastFrame(&D_06005500);
...
void EnHeishi2_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_DrawOpa(globalCtx, this->skelAnime.skeleton, this->skelAnime.jointTbl, EnHeishi2_OverrideLimbDraw,
