...
void EnBrob_Update(Actor* thisx, PlayState* play2) {
    ...
    if ((acHits[0] && (this->colliders[0].elem.acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & DMG_BOOMERANG)) ||
        (acHits[1] && (this->colliders[1].elem.acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & DMG_BOOMERANG))) {
        ...
        EnBrob_SetupStunned(this);
               ...
               (acHits[0] && (this->colliders[0].elem.acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & DMG_SLASH_KOKIRI)) ||
               (acHits[1] && (this->colliders[1].elem.acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT & DMG_SLASH_KOKIRI))) {
