...
void EnWonderItem_Init(Actor* thisx, PlayState* play) {
    ...
    switch (this->wonderMode) {
        ...
        case WONDERITEM_INTERACT_SWITCH:
            ...
            this->collider.elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC = damageFlags[colTypeIndex];
        ...
        case WONDERITEM_BOMB_SOLDIER:
            Collider_InitCylinder(play, &this->collider);
            Collider_SetCylinder(play, &this->collider, &this->actor, &sCylinderInit);
            this->collider.elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC = DMG_SLINGSHOT;
