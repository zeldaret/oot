...
//     temp_s0 = temp_a0 - this->actor.colChkInfo.damage;
...
//     goto block_22;
// block_10:
//     if (this->actionFunc == func_809E7458) {
//         goto block_14;
//     }
//     phi_s0 = temp_s0;
//     if (temp_s0 > 0) {
...
//     goto block_25;
// block_24:
//     this->actor.colChkInfo.health = (u8) phi_s0;
// block_25:
//     if (this->actor.colChkInfo.damageEffect != 2) {
//         goto block_35;
//     }
//     // sp38 = &this->actor.world.pos;
//     // sp34 = (?32) (s16) (s32) (this->unk_230 * 70.0f);

//     for (phi_s0_2 = 0; phi_s0_2 < 4; phi_s0_2++) {
//         EffectSsEnFire_SpawnVec3f(globalCtx, &this->actor, &this->actor.world.pos, (s16) this->unk_230 * 70.0f, 0, 0,
//         phi_s0_2);
//     }
// //     phi_s0_2 = 0;
// // loop_27:
...
//         goto block_42;
//     }
//     if (this->actionFunc == func_809E78DC) {
//         goto block_42;
//     }
