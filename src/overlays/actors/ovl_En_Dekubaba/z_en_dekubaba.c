...
void EnDekubaba_DrawStemRetracted(EnDekubaba* this, PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_dekubaba.c", 2461);
...
void EnDekubaba_DrawStemExtended(EnDekubaba* this, PlayState* play) {
    ...
    for (i = 0; i < stemSections; i++) {
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_dekubaba.c", 2533);
...
void EnDekubaba_DrawStemBasePruned(EnDekubaba* this, PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_dekubaba.c", 2586);
...
void EnDekubaba_DrawBaseShadow(EnDekubaba* this, PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_en_dekubaba.c", 2710);
...
void EnDekubaba_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->actionFunc != EnDekubaba_DeadStickDrop) {
        ...
        Matrix_Scale(scale, scale, scale, MTXMODE_APPLY);
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_dekubaba.c", 2780);
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_en_dekubaba.c", 2797);
