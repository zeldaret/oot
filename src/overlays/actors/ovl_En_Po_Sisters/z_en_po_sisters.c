...
void func_80AD99D4(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    OnePointDemo_Init(globalCtx, 3190, 999, &this->actor, MAIN_CAM);
}
...
void func_80AD9DF0(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    OnePointDemo_Init(globalCtx, 3180, 156, &this->actor, MAIN_CAM);
}
...
void func_80ADBC88(EnPoSisters* this, GlobalContext* globalCtx) {
    if (D_80ADD784 != 0 || !Player_InCsMode(globalCtx)) {
        ...
        if (this->unk_19A == 30) {
            if (this->unk_194 == 0) {
                OnePointDemo_Init(globalCtx, 3140, 999, NULL, MAIN_CAM);
            }
            D_80ADD784 = 1;
        }
        if (this->unk_19A == 0) {
