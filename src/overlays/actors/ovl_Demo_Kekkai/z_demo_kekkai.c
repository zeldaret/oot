...
void DemoKekkai_DrawTrialBarrier(Actor* thisx, PlayState* play2) {
    ...
    Matrix_Translate(0.0f, -1200.0f, 0.0f, MTXMODE_APPLY);
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_demo_kekkai.c", 639);
    ...
    Matrix_Pop();
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_demo_kekkai.c", 656);
...
void DemoKekkai_DrawTowerBarrier(Actor* thisx, PlayState* play) {
    ...
    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_demo_kekkai.c", 707);
