...
Gfx* BgHidanRsekizou_DrawFireball(GlobalContext* globalCtx, BgHidanRsekizou* this, s16 frame, MtxF* mf, s32 a,
    ...
    mf->now_14 = (tmpf7 * sins) + this->dyna.actor.world.pos.x;
    mf->now_24 = (this->dyna.actor.world.pos.y + 30.0f) + ((7.0f / 10.0f) * fVar6);
    mf->now_34 = (tmpf7 * coss) + this->dyna.actor.world.pos.z;
