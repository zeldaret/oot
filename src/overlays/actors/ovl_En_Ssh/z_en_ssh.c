...
void EnSsh_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Skeleton_Init(globalCtx, &this->skelAnime, &D_060052E0, NULL, this->jointTbl, this->morphTbl, 30);
...
void EnSsh_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Skeleton_DrawOpa(globalCtx, this->skelAnime.skeleton, this->skelAnime.jointTbl, EnSsh_OverrideLimbDraw,
