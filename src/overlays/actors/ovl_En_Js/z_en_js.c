...
void func_80A89008(EnJs* this) {
    En_Js_SetupAction(this, func_80A89304);
    SkelAnime_ChangeAnim(&this->skelAnime, &D_0600045C, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_0600045C), 2, -4.0f);
}
...
void func_80A89294(EnJs* this) {
    ...
    SkelAnime_ChangeAnim(&this->skelAnime, &D_0600018C, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_0600018C), 2, -4.0f);
}
