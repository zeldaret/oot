...
void EnZl1_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    frameCount = SkelAnime_GetLastFrame(&D_06012118);
    ...
    if (gSaveContext.sceneSetupIndex >= 4) {
        frameCount = SkelAnime_GetLastFrame(&D_06000438);
...
void func_80B4B010(EnZl1* this, GlobalContext* globalCtx) {
    ...
    if (func_8002F194(&this->actor, globalCtx)) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06010B38, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06010B38), 3, -10.0f);
...
void func_80B4B240(EnZl1* this, GlobalContext* globalCtx) {
    ...
    switch (this->unk_1E2) {
        ...
        case 2:
            ...
            break;
        case 3:
            frameCount = SkelAnime_GetLastFrame(&D_06013F10);
        ...
        case 5:
            ...
            break;
        case 6:
            frameCount = SkelAnime_GetLastFrame(&D_060116E4);
            if (this->skelAnime.curFrame == frameCount) {
        ...
        case 8:
            ...
            break;
        case 9:
            frameCount = SkelAnime_GetLastFrame(&D_060132D8);
            if (this->skelAnime.curFrame == frameCount) {
    ...
    if (sp3C != 0) {
        frameCount = SkelAnime_GetLastFrame(animHeaderSeg);
...
void func_80B4B8B4(EnZl1* this, GlobalContext* globalCtx) {
    ...
    if (npcAction != NULL) {
        ...
        if (this->unk_1E6 != npcAction->action) {
            frameCount = SkelAnime_GetLastFrame(spB0[npcAction->action]);
...
void func_80B4BBC4(EnZl1* this, GlobalContext* globalCtx) {
    s32 pad;
    f32 frameCount = SkelAnime_GetLastFrame(&D_06000438);
    Player* player = PLAYER;
...
void func_80B4BC78(EnZl1* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelAnime) && (this->skelAnime.animation == &D_06010B38)) {
        frameCount = SkelAnime_GetLastFrame(&D_06011348);
    ...
    if (npcAction != NULL) {
        ...
        if (this->unk_1E6 != npcAction->action) {
            frameCount = SkelAnime_GetLastFrame(sp90[npcAction->action]);
