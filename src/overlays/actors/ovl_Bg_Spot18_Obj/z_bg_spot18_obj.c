...
s32 func_808B8A5C(BgSpot18Obj* this, PlayState* play) {
    Actor_SetScale(&this->dyna.actor, D_808B90F4[PARAMS_GET(this->dyna.actor.params, 0, 4)]);
    return 1;
}
...
s32 func_808B8B08(BgSpot18Obj* this, PlayState* play) {
    this->dyna.actor.flags |= D_808B9104[PARAMS_GET(this->dyna.actor.params, 0, 4)];
    return 1;
}
...
s32 func_808B8BB4(BgSpot18Obj* this, PlayState* play) {
    ...
    if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
        func_808B9030(this);
    } else if (Flags_GetSwitch(play, PARAMS_GET(this->dyna.actor.params, 8, 6))) {
        func_808B9030(this);
...
s32 func_808B8CC8(BgSpot18Obj* this, PlayState* play) {
    if ((D_808B913C[PARAMS_GET(this->dyna.actor.params, 0, 4)] != NULL) &&
        (!D_808B913C[PARAMS_GET(this->dyna.actor.params, 0, 4)](this, play))) {
        return 0;
    }
    return 1;
}
...
void BgSpot18Obj_Draw(Actor* thisx, PlayState* play) {
    Gfx_DrawDListOpa(play, sDlists[PARAMS_GET(thisx->params, 0, 4)]);
}
