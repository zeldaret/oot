...
void EnHeishi1_SetupWalk(EnHeishi1* this, GlobalContext* globalCtx) {
    f32 frameCount = SkelAnime_GetLastFrame(&D_06005880);
...
void EnHeishi1_Walk(EnHeishi1* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_StopAtFrame(&this->skelAnime, 1.0f) || SkelAnime_StopAtFrame(&this->skelAnime, 17.0f)) {
...
void EnHeishi1_SetupWait(EnHeishi1* this, GlobalContext* globalCtx) {
    s16 rand;
    f32 frameCount = SkelAnime_GetLastFrame(&D_06005C30);
