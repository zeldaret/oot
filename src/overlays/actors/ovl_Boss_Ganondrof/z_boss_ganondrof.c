...
static UNK_PTR D_80915028[] = { 0x0600A800, 0x0600AE80, 0x0600AF00, 0x0600C180, 0x0600C400 };
static UNK_PTR D_8091503C[] = { 0x0600B980, 0x0600C480, 0x0600BC80, 0x0600BD80, 0x0600C080 };
...
void BossGanondrof_InitialAction(BossGanondrof* this, GlobalContext* globalCtx) {
    ...
    static Vec3f D_809150A0 = { 0.0f, 0.0f, 0.0f };
    static Vec3f D_809150AC = { 0.0f, 0.0f, 0.0f };
...
void BossGanondrof_StartReturnAction(BossGanondrof* this, GlobalContext* globalCtx) {
    static AnimationHeader* D_809150D0[] = { 0x06010FD4, 0x06011800 };
