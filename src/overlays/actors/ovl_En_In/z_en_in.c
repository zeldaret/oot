...
u16 func_80A79010(GlobalContext* globalCtx) {
    ...
    switch (GET_EVENTINF_wth_0t3) {
        case VAL_EVENTINF_wth_0t3_1:
        ...
        case VAL_EVENTINF_wth_0t3_3:
            if (GET_EVENTINF(EVENTINF_06) || GET_EVENTINF(EVENTINF_05)) {
                return 0x203E;
            } else {
                return 0x203D;
            }
        case VAL_EVENTINF_wth_0t3_4:
            return 0x203A;
        case VAL_EVENTINF_wth_0t3_5:
        case VAL_EVENTINF_wth_0t3_6:
            return 0x203C;
        case VAL_EVENTINF_wth_0t3_7:
            return 0x205B;
        case VAL_EVENTINF_wth_0t3_2:
        default:
    ...
    switch (this->actor.textId) {
        ...
        case 0x205B:
            if (globalCtx->msgCtx.choiceIndex == 0 && gSaveContext.rupees >= 50) {
                ...
                SET_EVENTINF_wth_0t3(VAL_EVENTINF_wth_0t3_0);
...
void EnIn_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (D_80A7B998 == 0 && respawnPos.x == 1107.0f && respawnPos.y == 0.0f && respawnPos.z == -3740.0f) {
        gSaveContext.eventInf[EVENTINF_wth_0X_INDEX] = 0;
        D_80A7B998 = 1;
    }
...
void func_80A7A4C8(EnIn* this, GlobalContext* globalCtx) {
    if (this->unk_308.unk_00 == 2) {
        ...
        SET_EVENTINF_wth_0t3(VAL_EVENTINF_wth_0t3_1);
...
void func_80A7A568(EnIn* this, GlobalContext* globalCtx) {
    ...
    if (gSaveContext.timer1State == 10) {
        ...
        if (globalCtx->msgCtx.choiceIndex == 0) {
            ...
            SET_EVENTINF_wth_04(((EnHorse*)GET_PLAYER(globalCtx)->rideActor)->type);
            SET_EVENTINF_wth_0t3(VAL_EVENTINF_wth_0t3_2);
            phi_a2 = 2;
...
void func_80A7A770(EnIn* this, GlobalContext* globalCtx) {
    if (this->unk_308.unk_00 == 0) {
        ...
        this->actionFunc = func_80A7A848;
        SET_EVENTINF_wth_0t3(VAL_EVENTINF_wth_0t3_7);
        this->unk_308.unk_00 = 0;
        gSaveContext.eventInf[EVENTINF_wth_0X_INDEX] =
            (gSaveContext.eventInf[EVENTINF_wth_0X_INDEX] & 0xFFFF) | EVENTINF_05_MASK;
...
void func_80A7A940(EnIn* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_308.unk_00 == 2) {
        ...
        this->unk_308.unk_00 = 0;
        gSaveContext.eventInf[EVENTINF_wth_0X_INDEX] =
            (gSaveContext.eventInf[EVENTINF_wth_0X_INDEX] & 0xFFFF) | EVENTINF_06_MASK;
    }
}
...
void EnIn_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actionFunc != func_80A7A304) {
        ...
        if (this->skelAnime.animation == &object_in_Anim_001BE0 && GET_EVENTINF_wth_0t3 != VAL_EVENTINF_wth_0t3_6) {
