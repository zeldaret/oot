...
void EnGo_CurledUp(EnGo* this, GlobalContext* globalCtx) {
    if ((DECR(this->unk_210) == 0) && EnGo_IsCameraModified(this, globalCtx)) {
        Audio_PlaySfxGeneral(NA_SE_EN_GOLON_WAKE_UP, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
...
void EnGo_WakeUp(EnGo* this, GlobalContext* globalCtx) {
    ...
    if (DECR(this->unk_212) == 0) {
        Audio_PlaySfxGeneral(NA_SE_EN_GOLON_SIT_DOWN, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
...
void func_80A40494(EnGo* this, GlobalContext* globalCtx) {
    ...
    if (!(frame >= 0.0f)) {
        Audio_PlaySfxGeneral(NA_SE_EN_DODO_M_GND, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
