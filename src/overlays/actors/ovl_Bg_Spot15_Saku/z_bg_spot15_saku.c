...
extern Gfx gSpot15ObjDL1[];
extern CollisionHeader gSpot15ObjCol1;
...
void BgSpot15Saku_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    CollisionHeader_GetVirtual(&gSpot15ObjCol1, &colHeader);
...
void BgSpot15Saku_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, gSpot15ObjDL1);
