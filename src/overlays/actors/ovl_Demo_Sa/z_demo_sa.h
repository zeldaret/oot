...
typedef enum DemoSaAction {
    ...
    /*  3 */ DEMOSA_ACTION_SAGE_OF_FOREST_DIALOG,
    /*  4 */ DEMOSA_ACTION_RAISE_ARMS_FOR_MEDALLION,
    /*  5 */ DEMOSA_ACTION_AWAIT_FOREST_MEDALLION,
    /*  6 */ DEMOSA_ACTION_FINISH_FOREST_MEDALLION_CS,
    /*  7 */ DEMOSA_ACTION_FOREST_TRIAL_INVISIBLE,
    /*  8 */ DEMOSA_ACTION_FOREST_TRIAL_FADE,
    /*  9 */ DEMOSA_ACTION_AWAIT_SPAWN_LIGHT_BALL,
