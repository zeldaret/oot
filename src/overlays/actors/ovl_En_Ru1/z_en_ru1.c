...
void func_80AEBC30(GlobalContext* globalCtx) {
    ...
    if (globalCtx->csCtx.frames == 0xCD) {
        ...
        Audio_PlaySfxGeneral(NA_SE_EV_DIVE_INTO_WATER, &player->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
...
void func_80AED520(EnRu1* this, GlobalContext* globalCtx) {
    ...
    Audio_PlaySfxGeneral(NA_SE_PL_PULL_UP_RUTO, &player->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                         &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
