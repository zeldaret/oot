...
static EnRu1ActionFunc sActionFuncs[] = {
    ...
    EnRu1_Speakable_PreSpawn,
    EnRu1_Speakable_Spawn,
    EnRu1_Speakable_Idle,
    EnRu1_Speakable_JabuTalk,
    EnRu1_Speakable_TakingSeat,
    ...
    EnRu1_ThroneRoom_Idle,
    EnRu1_ThroneRoom_Talk,
};
