...
void func_80AEB264(EnRu1* this, AnimationHeader* animation, u8 arg2, f32 transitionRate, s32 arg4) {
    ...
    f32 frameCount = SkelAnime_GetLastFrame(animHeader);
    f32 playbackSpeed;
    f32 unk0;
    f32 fc;
...
void func_80AEB738(EnRu1* this, GlobalContext* globalCtx) {
    ...
    skelAnime->unk_3E = *skelAnime->jointTbl;
...
void func_80AEBCB8(EnRu1* this, UNK_TYPE arg1) {
    if (arg1 != 0) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06012E94, 1.0f, 0, SkelAnime_GetLastFrame(&D_06012E94), 0, -8.0f);
    }
}
...
void func_80AEBD94(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (func_80AEB480(globalCtx, 3)) {
        frameCount = SkelAnime_GetLastFrame(&D_06009060);
...
void func_80AEBE3C(EnRu1* this, GlobalContext* globalCtx, s32 arg2) {
    ...
    if (arg2 != 0) {
        frameCount = SkelAnime_GetLastFrame(&D_06013A64);
        func_80AEB7D0(this);
...
void func_80AEBEC8(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (func_80AEB458(globalCtx, 6)) {
        frameCount = SkelAnime_GetLastFrame(&D_06008AA8);
        func_80AEB738(this, globalCtx);
...
void func_80AEBFD8(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (csCmdNPCAction != NULL) {
        ...
        if (csCtxFrames >= endFrame - 2) {
            frameCount = SkelAnime_GetLastFrame(&D_06008100);
...
void func_80AEC6E4(EnRu1* this, GlobalContext* globalCtx) {
    if ((func_80AEAFA0(globalCtx, 4, 3)) && (this->unk_280 == 0)) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06003784, 1.0f, 0, SkelAnime_GetLastFrame(&D_06003784), 2, -8.0f);
        this->unk_280 = 1;
        func_80AEC6B0(this);
    }
}
...
void func_80AEC8B8(EnRu1* this, GlobalContext* globalCtx) {
    if (func_80AEAFA0(globalCtx, 3, 3)) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06004074, 1.0f, 0, SkelAnime_GetLastFrame(&D_06004074), 2, -8.0f);
        this->action = 10;
    }
}
...
void func_80AEC93C(EnRu1* this, UNK_TYPE arg1) {
    if (arg1 != 0) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_060078E4, 1.0f, 0, SkelAnime_GetLastFrame(&D_060078E4), 0, -8.0f);
...
void func_80AED19C(EnRu1* this, s32 cond) {
    if (cond) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06001488, 1.0f, 0, SkelAnime_GetLastFrame(&D_06001488), 2, -8.0f);
        this->action = 20;
...
void func_80AED218(EnRu1* this, UNK_TYPE arg1) {
    if (func_80AED084(this, 4)) {
        if (arg1 != 0) {
            SkelAnime_ChangeAnim(&this->skelAnime, &D_06002058, 1.0f, 0, SkelAnime_GetLastFrame(&D_06002058), 0, -8.0f);
        }
    } else if (func_80AED084(this, 5)) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06002990, 1.0f, 0, SkelAnime_GetLastFrame(&D_06002990), 2, -8.0f);
        this->action = 21;
...
void func_80AEE628(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (func_80AEAF38(globalCtx)) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06006B9C, 1.0f, 0, SkelAnime_GetLastFrame(&D_06006B9C), 0, -8.0f);
...
s32 func_80AEE6D0(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((!(gSaveContext.infTable[20] & 0x10)) && (func_80AEB124(globalCtx) != 0)) {
        if (!Player_InCsMode(globalCtx)) {
            SkelAnime_ChangeAnim(&this->skelAnime, &D_06004648, 1.0f, 0, SkelAnime_GetLastFrame(&D_06004350), 0, -8.0f);
            func_80AED600(this);
            this->action = 34;
            this->unk_26C = 0.0f;
...
void func_80AEE7C4(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (Actor_HasNoParent(this, globalCtx)) {
        frameCount = SkelAnime_GetLastFrame(&D_06006B9C);
        ...
        if (this->action != 32) {
            if (*unk_370 > 30.0f) {
                if (Math_Rand_S16Offset(0, 3) == 0) {
                    frameCount = SkelAnime_GetLastFrame(&D_06004350);
...
s32 func_80AEF0BC(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (gSaveContext.infTable[20] & 4) {
        frameCount = SkelAnime_GetLastFrame(&D_06007534);
...
void func_80AEF1F0(EnRu1* this, GlobalContext* globalCtx, UNK_TYPE arg2) {
    if (arg2 != 0) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06006B9C, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06006B9C), 0, 0.0f);
        func_80106CCC(globalCtx);
...
void func_80AEF624(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (func_80AEAFE0(globalCtx, 1, 3)) {
        frameCount = SkelAnime_GetLastFrame(&D_060063F4);
...
void func_80AEF728(EnRu1* this, UNK_TYPE arg1) {
    if (arg1 != 0) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06003608, 1.0f, 0.0f, SkelAnime_GetLastFrame(&D_06003608), 0, 0.0f);
        func_80AEB3CC(this);
        this->action = 38;
    }
}
...
void func_80AEF79C(EnRu1* this, GlobalContext* globalCtx) {
    if (func_80AEAFE0(globalCtx, 2, 3)) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_06002EC0, 1.0f, 0, SkelAnime_GetLastFrame(&D_06002EC0), 2, -8.0f);
        this->action = 39;
    }
}
...
void func_80AEF820(EnRu1* this, UNK_TYPE arg1) {
    if (arg1 != 0) {
        SkelAnime_ChangeAnim(&this->skelAnime, &D_060097B8, 1.0f, 0, SkelAnime_GetLastFrame(&D_060097B8), 0, -8.0f);
        this->action = 40;
    }
}
