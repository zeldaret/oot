...
void EnRu1_DoNothing(EnRu1* this, GlobalContext* globalCtx);
...
static EnRu1ActionFunc sActionFuncs[] = {
    ...
    EnRu1_DoNothing, func_80AEF9D8, func_80AEFA2C, func_80AEFAAC, func_80AEFB04, func_80AEFB68, func_80AEFCE8,
