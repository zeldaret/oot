...
void func_80AEDAE0(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if (dynaPolyActor == NULL || dynaPolyActor->actor.id == ACTOR_EN_BOX) {
        this->actor.bgCheckFlags &= ~(BGCHECKFLAG_0 | BGCHECKFLAG_3 | BGCHECKFLAG_4);
    }
}
...
void func_80AEE2F8(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & BGCHECKFLAG_0) && (this->actor.floorBgId != BGCHECK_SCENE)) {
...
void func_80AEE488(EnRu1* this, GlobalContext* globalCtx) {
    ...
    } else if ((!func_80AEE394(this, globalCtx)) && (!(this->actor.bgCheckFlags & BGCHECKFLAG_0))) {
...
void func_80AEE568(EnRu1* this, GlobalContext* globalCtx) {
    if (!func_80AEE394(this, globalCtx)) {
        if ((this->actor.bgCheckFlags & BGCHECKFLAG_0) && (this->actor.speedXZ == 0.0f) && (this->actor.minVelocityY == 0.0f)) {
            func_80AEE02C(this);
