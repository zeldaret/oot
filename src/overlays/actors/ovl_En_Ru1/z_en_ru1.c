...
void func_80AED8DC(EnRu1* this) {
    ...
    s16* someY = &this->interactInfo.rotHead.y;
...
void func_80AEEF68(EnRu1* this, PlayState* play) {
    ...
    Npc_TrackPlayer(&this->actor, &this->interactInfo, something, NPC_PLAYER_TRACKING_HEAD_AND_TORSO);
}
...
void func_80AEEFEC(EnRu1* this, PlayState* play) {
    ...
    this->interactInfo.yPosOffset = kREG(16) - 3.0f;
    something = kREG(17) + 0xC;
    Npc_TrackPlayer(&this->actor, &this->interactInfo, something, NPC_PLAYER_TRACKING_FULL_BODY);
...
void func_80AF0278(EnRu1* this, PlayState* play, s32 limbIndex, Vec3s* rot) {
    Vec3s* vec1 = &this->interactInfo.rotTorso;
    Vec3s* vec2 = &this->interactInfo.rotHead;
