    ...
    if (this->timers[1] != 0) {
        ...
        switch (this->beamShootState) {
            ...
            case 0:
                ...
                SkinMatrix_Vec3fMtxFMultXYZW(&globalCtx->projectionMatrix, &this->beamReflectionOrigin, &this->unk_54C,
            ...
            case 1:
                ...
                SkinMatrix_Vec3fMtxFMultXYZW(&globalCtx->projectionMatrix, &this->unk_530, &this->unk_558,
                                             &this->actor.projectedW);
