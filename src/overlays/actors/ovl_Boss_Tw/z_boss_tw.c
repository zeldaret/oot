...
static ColliderCylinderInit D_8094A7E8 = {
    { COLTYPE_UNK10, AT_ALL | AT_ON, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_TYPE1, COLSHAPE_CYLINDER },
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x00, 0x30 }, { 0x00100000, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON },
    { 25, 35, -17, { 0, 0, 0 } },
};

static ColliderCylinderInit D_8094A814 = {
    { COLTYPE_UNK3, AT_ENEMY | AT_ON, AC_PLAYER | AC_ON, OC_PLAYER | OC_ON, OT_TYPE1, COLSHAPE_CYLINDER },
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON },
    { 45, 120, -30, { 0, 0, 0 } },
};
...
static ColliderCylinderInit D_8094A840 = {
    ...
    { ELEMTYPE_UNK0, { 0xFFCFFFFF, 0x00, 0x20 }, { 0xFFCDFFFE, 0x00, 0x00 }, TOUCH_ON, BUMP_HOOKABLE | BUMP_ON,
