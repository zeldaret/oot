            ...
            case 0:
                if (this->timers[0] != 0) {
                    ...
                    if (beamReflection == 1) {
                        ...
                        Matrix_MtxFToRotS(&player->shieldMf, &sp128, 0);
                        sp128.y += 0x8000;
                        sp128.x = -sp128.x;
            ...
            switch (this->csState1) {
                ...
                case 10:
                    ...
                    if (this->timers[0] == 0) {
                        ...
                        this->actor.world.pos.y = -2000.0f;
                        Matrix_MtxFToRotS(&player2->shieldMf, &blastDir, MTXMODE_NEW);
            ...
            switch (this->csState1) {
                ...
                case 10:
                    ...
                    if (this->timers[0] == 0) {
                        ...
                        this->actor.world.pos = player2->bodyPartsPos[15];
                        this->actor.world.pos.y = -2000.0f;
                        Matrix_MtxFToRotS(&player2->shieldMf, &reflDir, 0);
                        reflDir.x = -reflDir.x;
                        reflDir.y += 0x8000;
            ...
            if (info->toucher.dmgFlags & DMG_SHIELD) {
                ...
                if (Player_HasMirrorShieldEquipped(globalCtx)) {
                    ...
                    if ((sShieldIceCharge >= 3) || (sShieldFireCharge >= 3)) {
                        this->timers[0] = 80;
                        this->csState1 = 10;
                        Matrix_MtxFToRotS(&player->shieldMf, &this->magicDir, 0);
