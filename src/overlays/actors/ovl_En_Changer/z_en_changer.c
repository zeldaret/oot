...
// s32 D_809D3130[] = { 0x00000000, 0x00000072, 0x00000072, 0x00000073, 0x00000073, 0x00000074 };
...
/* void EnChanger_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((s32)globalCtx->roomCtx.curRoom.num >= 6) {
        if ((gSaveContext.itemGetInf[1] & 0x800) != 0) {
            phi_v0 = 0x4EA0;
        } else {
            sp6A = 0x4EC0;
            phi_v0 = 0x4EC0;
        ...
        sp6A = temp_v0_2;
        // sp68 = temp_v1_3;
        this->unk_158 = Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_EN_BOX, 20.0f, 20.0f,
-2500.0f, 0, 0x7FFF, 0, temp_v0_2); if (this->unk_158 != 0) { if ((s16)this->unk_168 != 0) {
            ...
            return;
                ...
                Actor_Spawn(sp4C, globalCtx, ACTOR_ITEM_ETCETERA, 20.0f, 20.0f, -2500.0f, 0, 0, 0,
                            ((*D_809D3174 & 0x1F) << 8) + (phi_v0_2 & 0xFF));
    ...
    this->unk_150 =
        Actor_SpawnAsChild(sp4C, &this->actor, globalCtx, ACTOR_EN_BOX, D_809D30A0[globalCtx->roomCtx.curRoom.num].x,
                           D_809D30A0[globalCtx->roomCtx.curRoom.num].y, D_809D30A0[globalCtx->roomCtx.curRoom.num].z,
                           0, -0x3FFF, 0, sp6E);
    if (this->unk_150 != 0) {
        ...
        if ((s16)this->unk_168 != 0) {
            ...
            Actor_Spawn(sp4C, globalCtx, ACTOR_ITEM_ETCETERA, D_809D30A0[globalCtx->roomCtx.curRoom.num].x,
                        D_809D30A0[globalCtx->roomCtx.curRoom.num].y, D_809D30A0[globalCtx->roomCtx.curRoom.num].z, 0,
                        0, 0, ((this->unk_15C & 0x1F) << 8) + (sp64 & 0xFF));
        }
    }
    // temp_v0_7 = D_809D30E8[globalCtx->roomCtx.curRoom.num];
    this->unk_154 = Actor_SpawnAsChild(
        sp4C, &this->actor, globalCtx, ACTOR_EN_BOX, D_809D30E8[globalCtx->roomCtx.curRoom.num].x,
    ...
    if (this->unk_166 == 0) {
        ...
        if (temp_a0 != 0) {
            if (temp_a0 == 1) {
                ...
                if (temp_v1_2 == GI_DOOR_KEY) {
                    Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_EX_ITEM, temp_f0, temp_f2, temp_f12, 0, 0, 0,
0xF); Flags_SetSwitch(globalCtx, 0x32); } else { temp_s0 = (s16) (temp_v1_2 - 0x72) + 0xA; osSyncPrintf((const char *)
"\x1b[32m☆☆☆☆☆ 左宝開く ☆☆☆☆☆ %d\n\x1b[m", temp_s0); Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_EX_ITEM,
temp_f0, temp_f2, temp_f12, 0, 0, 0, temp_s0);
                }
            }
        } else {
            temp_v0_2 = this->unk_162;
            temp_f0_2 = temp_v1->dyna.actor.posRot.pos.x;
            temp_f2_2 = temp_v1->dyna.actor.posRot.pos.y;
            temp_f12_2 = temp_v1->dyna.actor.posRot.pos.z;
            if (temp_v0_2 == GI_DOOR_KEY) {
                Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_EX_ITEM, temp_f0_2, temp_f2_2, temp_f12_2, 0, 0,
0, 0xF); Flags_SetSwitch(globalCtx, 0x32); } else { temp_s0_2 = (s16) (temp_v0_2 - 0x72) + 0xA; osSyncPrintf((const char
*) "\x1b[32m☆☆☆☆☆ 右宝開く ☆☆☆☆☆ %d\n\x1b[m", temp_s0_2); Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_EX_ITEM,
temp_f0_2, temp_f2_2, temp_f12_2, 0, 0, 0, temp_s0_2);
            }
        }
        Actor_Kill(&this->actor);
    }
        ...
        if (temp_a0 != 0) {
            if (temp_a0 == 1) {
                ...
                if (temp_v1_2 == GI_DOOR_KEY) {
                    ...
                    temp_s0 = (s16)(temp_v1_2 - 0x72) + 0xA;
            ...
            if (temp_v0_2 == GI_DOOR_KEY) {
                ...
                temp_s0_2 = (s16)(temp_v0_2 - 0x72) + 0xA;
