...
void Fishing_DrawEffects(FishingEffect* effect, PlayState* play) {
    ...
    for (i = 0; i < 100; i++) {
        if (effect->type == FS_EFF_RIPPLE) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2305);
    ...
    for (i = 0; i < 100; i++) {
        if (effect->type == FS_EFF_DUST_SPLASH) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2346);
    ...
    for (i = 0; i < 100; i++) {
        if (effect->type == FS_EFF_WATER_DUST) {
            ...
            gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 2394);
    ...
    for (i = 0; i < 100; i++) {
        if (effect->type == FS_EFF_BUBBLE) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2423);
    ...
    for (i = 30; i < FISHING_EFFECT_COUNT; i++) {
        if (effect->type == FS_EFF_RAIN_DROP) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2467);
    ...
    for (i = 30; i < FISHING_EFFECT_COUNT; i++) {
        if (effect->type == FS_EFF_RAIN_RIPPLE) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2504);
    ...
    for (i = 30; i < FISHING_EFFECT_COUNT; i++) {
        if (effect->type == FS_EFF_RAIN_SPLASH) {
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2541);
    ...
    if (effect->type == FS_EFF_OWNER_HAT) {
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 2560);
...
void Fishing_DrawStreamSplash(PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 2598);
...
void Fishing_DrawLureHook(PlayState* play, Vec3f* pos, Vec3f* refPos, u8 hookIndex) {
    ...
    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 3029);
    gSPDisplayList(POLY_OPA_DISP++, gFishingLureHookDL);

    Matrix_RotateZ(M_PI / 2, MTXMODE_APPLY);

    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 3034);
    gSPDisplayList(POLY_OPA_DISP++, gFishingLureHookDL);
    ...
    if ((hookIndex == 1) && (sIsOwnersHatHooked)) {
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 3085);
        gSPDisplayList(POLY_OPA_DISP++, gFishingOwnerHatDL);
    }
    ...
    if (sLurePos.y < WATER_SURFACE_Y(play)) {
        ...
        for (i = SINKING_LURE_SEG_COUNT - 1; i >= 0; i--) {
            if ((i + sSinkingLureSegmentIndex) < SINKING_LURE_SEG_COUNT) {
                ...
                gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 3239);
        ...
        for (i = SINKING_LURE_SEG_COUNT - 1; i >= 0; i--) {
            if ((i + sSinkingLureSegmentIndex) < SINKING_LURE_SEG_COUNT) {
                ...
                gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 3265);
...
void Fishing_DrawLureAndLine(PlayState* play, Vec3f* linePos, Vec3f* lineRot) {
    ...
    if (sLureEquipped != FS_LURE_SINKING) {
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 3369);
    ...
    if ((sRodCastState == 4) && ((sLineHooked != 0) || (sLureEquipped != FS_LURE_SINKING))) {
        ...
        gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 3444);
        ...
        for (i = spooled; i < LINE_SEG_COUNT - 1; i++) {
            if ((i == LINE_SEG_COUNT - 3) && (sLureEquipped == FS_LURE_STOCK) && (sRodCastState == 3)) {
                ...
                gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 3475);
                gSPDisplayList(POLY_XLU_DISP++, gFishingLineModelDL);
                break;
            }
            ...
            gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 3492);
            gSPDisplayList(POLY_XLU_DISP++, gFishingLineModelDL);
        }
    }
...
void Fishing_DrawRod(PlayState* play) {
    ...
    for (i = 0; i < 22; i++) {
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 3809);
    ...
    for (i = 0; i < POND_PROP_COUNT; i++) {
        if (prop->type == FS_PROP_REED) {
            ...
            if (prop->shouldDraw) {
                ...
                gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 7726);
    ...
    for (i = 0; i < POND_PROP_COUNT; i++) {
        if (prop->type == FS_PROP_WOOD_POST) {
            ...
            if (prop->shouldDraw) {
                ...
                gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 7748);
    ...
    for (i = 0; i < POND_PROP_COUNT; i++) {
        if (prop->type == FS_PROP_LILY_PAD) {
            ...
            if (prop->shouldDraw) {
                ...
                gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 7774);
    ...
    for (i = 0; i < POND_PROP_COUNT; i++) {
        if (prop->type == FS_PROP_ROCK) {
            ...
            if (prop->shouldDraw) {
                ...
                gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 7798);
...
void Fishing_DrawGroupFishes(PlayState* play) {
    ...
    for (i = 0; i < GROUP_FISH_COUNT; i++, fish++) {
        ...
        if (fish->shouldDraw) {
            ...
            gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 8093);
...
void Fishing_DrawOwner(Actor* thisx, PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_fishing.c", 9297);
    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_fishing.c", 9298);
