    ...
    switch (this->unk_158) {
        ...
        case 5:
            ...
            if ((D_80B7A694 < 3) || ((D_80B7E074 != 0) && (D_80B7E080 > 50)) || (D_80B7E080 >= 6000) ||
                ...
                if ((D_80B7E122 == 0) && (D_80B7E124 == 0)) {
                    ...
                    AudioSeqCmd_StopSequence(SEQ_PLAYER_BGM_MAIN, 10);
                }
        ...
        case 6:
            ...
            if (this->unk_17A[0] == 90) {
                AudioSeqCmd_PlaySequence(SEQ_PLAYER_BGM_MAIN, 0, 9, NA_BGM_HEART_GET);
                D_80B7A67C = 40;
...
void Fishing_UpdateOwner(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    switch (D_80B7A6CC) {
        ...
        case 22:
            if (D_80B7A6D0 == 30) {
                AudioSeqCmd_PlaySequence(SEQ_PLAYER_BGM_MAIN, 0, 9, NA_BGM_ITEM_GET);
            }
