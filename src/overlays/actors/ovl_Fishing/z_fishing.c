...
void Fishing_DrawRod(PlayState* play) {
    ...
    if ((D_80B7A694 == 3) || (D_80B7A694 == 4)) {
        ...
        spC4 = player->actionCharge;
        Math_SmoothStepToF(&player->actionCharge, input->rel.stick_x * 0.02f, 0.3f, 5.0f, 0.0f);
        spC4 = player->actionCharge - spC4;

        if (player->actionCharge > 1.0f) {
            player->actionCharge = 1.0f;
        }
        ...
        Math_ApproachZeroF(&player->actionCharge, 1.0f, 0.1f);
    ...
    Matrix_RotateZ((player->actionCharge * 0.5f) + 3.0f * M_PI / 20.0f, MTXMODE_APPLY);
    ...
    switch (D_80B7A694) {
        case 0:
            ...
            if (D_80B7E0B4 == 0) {
                ...
                if (D_80B7E0B4 == 18) {
                    ...
                    Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&D_80B7AF94, NA_SE_IT_SWORD_SWING_HARD);
                }
            }
            break;
        ...
        case 1:
            ...
            if (CHECK_BTN_ALL(input->cur.button, BTN_A) || (D_80B7A68C != 0)) {
                ...
                D_80B7E0E8.z *= 0.9f;
                if (D_80B7A68C == 0) {
                    Audio_PlaySfxGeneralWithDefaultSettings1(NA_SE_IT_FISHING_REEL_HIGH - SFX_FLAG);
                }
            }
            ...
            if (spC8 > SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&D_80B7AF94, NA_SE_EN_FANTOM_FLOAT - SFX_FLAG);
                }
            } else {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if ((sLurePos.y <= spE4) && (spE4 < spE0) && (spE4 == WATER_SURFACE_Y(play))) {
                        D_80B7E114 = 10;
                        Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&D_80B7AF94, NA_SE_EV_BOMB_DROP_WATER);
                        D_80B7E0F8.y = 0.0f;
                        D_80B7E0E8.y *= 0.2f;
        ...
        case 3:
            ...
            if (spC8 < SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if (CHECK_BTN_ALL(input->press.button, BTN_B)) {
                        D_80B7E144 += 6.0f;
                        Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&D_80B7AF94, NA_SE_PL_WALK_GROUND + SURFACE_SFX_OFFSET_SAND);
                    }
                } else {
                    if (D_80B7E144 > 150.0f) {
                        sLureRot.x = sReelLineRot[LINE_SEG_COUNT - 2].x + M_PI;
            ...
            if (CHECK_BTN_ALL(input->cur.button, BTN_A)) {
                if (CHECK_BTN_ALL(input->cur.button, BTN_R)) {
                    ...
                    Audio_PlaySfxGeneralWithDefaultSettings1(NA_SE_IT_FISHING_REEL_SLOW - SFX_FLAG);
        ...
        case -3:
            ...
            if ((D_80B7A694 != 3) || (this->unk_17A[0] == 0) || (sLurePos.y > (WATER_SURFACE_Y(play) + 5.0f)) ||
                ...
                if (sLurePos.y > (WATER_SURFACE_Y(play) - 10.0f)) {
                    ...
                    Audio_PlaySfxGeneralWithDefaultSettings1(NA_SE_PL_CATCH_BOOMERANG);
                }
        ...
        case 5:
            ...
            if ((D_80B7E122 != 0) && (D_80B7E124 == 0)) {
                if (((input->rel.stick_y < -50) && (D_80B7A6C8 > -40)) || CHECK_BTN_ALL(input->press.button, BTN_A)) {
                    ...
                    D_80B7E0A4 = 40;
                    D_80B7FDA8 = 10;
                    Audio_PlaySfxGeneralWithDefaultSettings1(NA_SE_IT_FISHING_HIT);
                }
            }
...
void Fishing_UpdateOwner(Actor* thisx, PlayState* play2) {
            ...
            if (CHECK_BTN_ALL(input->press.button, BTN_Z)) {
                if ((D_80B7E088 >= 0) && (D_80B7E122 == 0)) {
                    ...
                    if ((D_80B7E088 == 0) || (D_80B7E088 == 3)) {
                        Audio_PlaySfxGeneralWithDefaultSettings1(NA_SE_SY_CAMERA_ZOOM_DOWN);
                    } else {
    ...
    Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&sStreamSfxProjectedPos, NA_SE_EV_WATER_WALL - SFX_FLAG);
