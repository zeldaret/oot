...
void func_80985EF4(DemoIm* this) {
    if (!Animation_IsOnFrame(&this->skelAnime, Animation_GetLastFrame(&D_0601182C) - 1.0f)) {
        func_80985060(this);
    }
}
...
void func_80986570(DemoIm* this, GlobalContext* globalCtx) {
    if ((Animation_IsOnFrame(&this->skelAnime, 7.0f)) && (this->actor.bgCheckFlags & 1)) {
        u32 sfxId = SFX_FLAG;
...
void DemoIm_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Skeleton_InitFlex(globalCtx, &this->skelAnime, &D_0600F788, NULL, this->jointTbl, this->morphTbl, 17);
    thisx->flags &= ~1;
...
void func_80987658(DemoIm* this, GlobalContext* globalCtx) {
    ...
    Skeleton_DrawFlexOpa(globalCtx, skelAnime->skeleton, skelAnime->jointTbl, skelAnime->dListCount, func_80987514,
                         func_809875C0, this);
