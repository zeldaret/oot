...
void func_80985280(DemoIm* this, AnimationHeader* animHeaderSeg, u8 arg2, f32 transitionRate, s32 arg4) {
    f32 frameCount = Animation_LastFrame(animHeaderSeg);
    f32 playbackSpeed;
    f32 unk0;
    f32 fc;
...
void func_809854DC(DemoIm* this, GlobalContext* globalCtx) {
    if ((globalCtx->csCtx.state != 0) && (globalCtx->csCtx.npcActions[5] != NULL) &&
        ...
        Animation_Change(&this->skelAnime, &D_06001868, 1.0f, 0.0f, Animation_LastFrame(&D_06001868), 0, 0.0f);
        this->action = 2;
        this->drawConfig = 1;
...
void func_809855A8(DemoIm* this, GlobalContext* globalCtx) {
    if ((globalCtx->csCtx.state != 0) && (globalCtx->csCtx.npcActions[5] != NULL) &&
        ...
        Animation_Change(&this->skelAnime, &D_06000710, 1.0f, 0.0f, Animation_LastFrame(&D_06000710), 2, 4.0f);
        this->action = 4;
    }
}
...
void func_80985640(DemoIm* this, s32 arg1) {
    if (arg1 != 0) {
        Animation_Change(&this->skelAnime, &D_06000AFC, 1.0f, 0.0f, Animation_LastFrame(&D_06000AFC), 0, 0.0f);
        this->action = 5;
    }
}
...
void func_80985948(DemoIm* this, GlobalContext* globalCtx) {
    if (func_809850E8(this, globalCtx, 4, 5)) {
        Animation_Change(&this->skelAnime, &D_06011C08, 1.0f, 0.0f, Animation_LastFrame(&D_06011C08), 2, 0.0f);
        this->action = 8;
        this->drawConfig = 2;
        this->unk_26C = 0;
        this->actor.shape.unk_14 = 0;
...
void func_80985B34(DemoIm* this, GlobalContext* globalCtx) {
    if (func_80985134(this, globalCtx, 4, 5)) {
        Animation_Change(&this->skelAnime, &D_06012218, 1.0f, 0.0f, Animation_LastFrame(&D_06012218), 2, -8.0f);
        this->action = 8;
        this->drawConfig = 2;
...
void func_80985EF4(DemoIm* this) {
    if (!Animation_OnFrame(&this->skelAnime, Animation_LastFrame(&D_0601182C) - 1.0f)) {
        func_80985060(this);
    }
}
...
void func_80985FE8(DemoIm* this, s32 arg1) {
    if (arg1 != 0) {
        Animation_Change(&this->skelAnime, &D_0601182C, 1.0f, 0.0f, Animation_LastFrame(&D_0601182C), 0, -8.0f);
    }
}

void func_8098604C(DemoIm* this) {
    f32 frameCount = Animation_LastFrame(&D_06010EE0);
...
void func_809860DC(DemoIm* this, s32 arg1) {
    if (arg1 != 0) {
        Animation_Change(&this->skelAnime, &D_06001868, 1.0f, 0.0f, Animation_LastFrame(&D_06001868), 0, -8.0f);
        this->unk_2D0 = 0;
    }
}

void func_80986148(DemoIm* this) {
    Animation_Change(&this->skelAnime, &D_06010EE0, -1.0f, Animation_LastFrame(&D_06010EE0), 0.0f, 2, -8.0f);
    this->action = 14;
    this->drawConfig = 1;
}
        ...
        if (action != unk_274) {
            switch (action) {
                case 9:
                    ...
                    break;
                case 7:
                    Animation_Change(&this->skelAnime, &D_0601182C, 1.0f, 0.0f, Animation_LastFrame(&D_0601182C), 0,
                                     -8.0f);
                    this->action = 12;
                    break;
                default:
...
void func_80986794(DemoIm* this) {
    Animation_Change(&this->skelAnime, &D_060014E4, 1.0f, 0.0f, Animation_LastFrame(&D_060014E4), 2, -8.0f);
    this->action = 17;
    this->drawConfig = 1;
}
