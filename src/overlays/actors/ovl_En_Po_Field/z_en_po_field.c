...
void EnPoField_SoulIdle(EnPoField* this, GlobalContext* globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 10.0f, 10.0f, 10.0f, UPDBGCHECKINFOFLAG_2);
}
...
void EnPoField_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actionFunc != EnPoField_WaitForSpawn) {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &this->actor, 0.0f, 27.0f, 60.0f, UPDBGCHECKINFOFLAG_2);
        func_80AD619C(this);
        func_80AD6330(this);
