...
s32 EnHy_FindSkelAndHeadObjects(EnHy* this, PlayState* play) {
    u8 headInfoIndex = sModelInfo[PARAMS_GET2(this->actor.params, 0, 7)].headInfoIndex;
    u8 skelInfoIndex2 = sModelInfo[PARAMS_GET2(this->actor.params, 0, 7)].skelInfoIndex2;
    u8 skelInfoIndex1 = sModelInfo[PARAMS_GET2(this->actor.params, 0, 7)].skelInfoIndex1;
...
u16 EnHy_GetTextId(PlayState* play, Actor* thisx) {
    ...
    switch (PARAMS_GET2(this->actor.params, 0, 7)) {
        case ENHY_TYPE_AOB:
...
void EnHy_InitCollider(EnHy* this) {
    u8 type = PARAMS_GET2(this->actor.params, 0, 7);
...
void EnHy_UpdateCollider(EnHy* this, PlayState* play) {
    ...
    pos.x += sColliderInfo[PARAMS_GET2(this->actor.params, 0, 7)].offset.x;
    pos.y += sColliderInfo[PARAMS_GET2(this->actor.params, 0, 7)].offset.y;
    pos.z += sColliderInfo[PARAMS_GET2(this->actor.params, 0, 7)].offset.z;
    ...
    switch (play->sceneId) {
        case SCENE_KAKARIKO_VILLAGE:
            if (!(PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_BOJ_9 || PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_BOJ_10 ||
                ...
                return true;
            } else if (PARAMS_GET2(this->actor.params, 0, 7) != ENHY_TYPE_BOJ_12 && IS_NIGHT) {
                return false;
            } else {
                return true;
            }
        case SCENE_IMPAS_HOUSE:
            if (PARAMS_GET2(this->actor.params, 0, 7) != ENHY_TYPE_BOJ_10) {
                ...
                return false;
            } else if (PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_BOJ_10 && IS_DAY) {
                return false;
            } else {
                return true;
            }
...
void EnHy_Init(Actor* thisx, PlayState* play) {
    ...
    if (PARAMS_GET2(this->actor.params, 0, 7) >= ENHY_TYPE_MAX || !EnHy_FindOsAnimeObject(this, play) ||
...
void EnHy_InitImpl(EnHy* this, PlayState* play) {
    if (EnHy_IsOsAnimeObjectLoaded(this, play) && EnHy_AreSkelAndHeadObjectsLoaded(this, play)) {
        ...
        this->path = Path_GetByIndex(play, PARAMS_GET2(this->actor.params, 7, 4), 15);
...
void EnHy_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_BOJ_3 && limbIndex == 8) {
...
void EnHy_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->actionFunc != EnHy_InitImpl) {
        ...
        envColorSeg8 = sModelInfo[PARAMS_GET2(this->actor.params, 0, 7)].envColorSeg8;
        envColorSeg9 = sModelInfo[PARAMS_GET2(this->actor.params, 0, 7)].envColorSeg9;
        ...
        switch (PARAMS_GET2(this->actor.params, 0, 7)) {
            ...
            case ENHY_TYPE_AHG_20:
                ...
                if (PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_CNE_8 || PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_CNE_11) {
                    ...
                    if (PARAMS_GET2(this->actor.params, 0, 7) == ENHY_TYPE_CNE_11) {
