...
void ArmsHook_Shoot(ArmsHook* this, GlobalContext* globalCtx) {
    ...
    if ((this->timer != 0) && (this->collider.base.atFlags & AT_HIT) &&
        ...
        this->timer = 0;
        Audio_PlaySfxGeneral(NA_SE_IT_ARROW_STICK_CRE, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
        ...
        if (BgCheck_EntityLineTest1(&globalCtx->colCtx, &sp60, &this->unk_1E8, &intersectPos, &poly, true, true, true,
            ...
            if (SurfaceType_IsHookshotSurface(&globalCtx->colCtx, poly, bgId)) {
                ...
                Audio_PlaySfxGeneral(NA_SE_IT_HOOKSHOT_REFLECT, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
            }
