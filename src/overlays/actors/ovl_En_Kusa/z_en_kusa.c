...
//     temp_s4 = &spC4;
//     phi_s1 = D_80A9C23C;
//     for (int i = 0; i < ARRAY_COUNT(D_80A9C26C); i++) {
...
//                              *(D_80A9C26C + (((Math_Rand_ZeroOne() * 111.1f) & 7) * 2)), 0, 0, 0x50, -1, 1,
//                              0x40355E0);
...
//     // Set scale factors
//     func_80A9B1FC(this);
//     this->actor.shape.rot.x = this->actor.initPosRot.rot.z;
//     this->actor.shape.rot.z = this->actor.initPosRot.rot.x;
