...
typedef struct EnDns {
    ...
    /* 0x0190 */ Vec3s limbDrawTable[0x12];
    /* 0x01FC */ Vec3s transitionDrawTable[0x12];
    /* 0x0268 */  EnDnsActionFunc actionFunc;
    /* 0x026C */ ColliderCylinder collider;
    /* 0x02B8 */ s16 dustTimer;
    /* 0x02BA */ u8 unk_2BA;
    /* 0x02BB */ u8 maintainCollider;
    /* 0x02BC */ u8 standOnGround; // Falls for Burrow when unset
    /* 0x02BD */ u8 dropCollectible;
    /* 0x02C0 */ DnsItemEntry* dnsItemEntry; // word-aligned
    /* 0x02C4 */ f32 yInitPos;
} EnDns; // size = 0x02C8
