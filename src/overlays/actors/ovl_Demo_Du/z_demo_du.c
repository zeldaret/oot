...
void DemoDu_CsPlaySfx_DaruniaHitsLink(GlobalContext* globalCtx) {
    ...
    Audio_PlaySfxGeneral(NA_SE_VO_LI_DAMAGE_S_KID, &player->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
...
void DemoDu_CsPlaySfx_LinkEscapeFromGorons(GlobalContext* globalCtx) {
    if (globalCtx->csCtx.frames == 1400) {
        ...
        Audio_PlaySfxGeneral(NA_SE_VO_LI_FALL_L_KID, &player->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
...
void DemoDu_CsPlaySfx_LinkSurprised(GlobalContext* globalCtx) {
    if (globalCtx->csCtx.frames == 174) {
        ...
        Audio_PlaySfxGeneral(NA_SE_VO_LI_SURPRISE_KID, &player->actor.projectedPos, 4U, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
