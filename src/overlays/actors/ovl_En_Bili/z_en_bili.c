...
void EnBili_SetupBurnt(EnBili* this) {
    ...
    this->actor.speedXZ = 0.0f;
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_R, 200, COLORFILTER_XLUFLAG_XLU, 20);
...
void EnBili_SetupStunned(EnBili* this) {
    ...
    this->actor.speedXZ = 0.0f;
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 150, COLORFILTER_XLUFLAG_XLU, 80);
...
void EnBili_SetupFrozen(EnBili* this, PlayState* play) {
    ...
    this->actor.speedXZ = 0.0f;
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 150, COLORFILTER_XLUFLAG_XLU, 10);
    this->collider.base.atFlags &= ~AT_ON;
    this->collider.base.acFlags &= ~AC_ON;
    this->timer = 300;
    ...
    if ((this->actor.colChkInfo.health != 0) && (this->collider.base.acFlags & AC_HIT)) {
        ...
        if ((this->actor.colChkInfo.damageEffect != 0) || (this->actor.colChkInfo.damage != 0)) {
            ...
            if (damageEffect == BIRI_DMGEFF_DEKUNUT) {
                ...
                if (this->actionFunc != EnBili_Stunned) {
                    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_R, 200, COLORFILTER_XLUFLAG_XLU, 10);
