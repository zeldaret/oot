...
void EnBili_SetupFloatIdle(EnBili* this) {
    ...
    this->collider.elem.acDmgInfo.playerATHitReaction = PLAYER_AT_HIT_REACTION_1; // Shock?
    this->timer = 32;
...
void EnBili_SetupStunned(EnBili* this) {
    this->timer = 80;
    this->collider.elem.acDmgInfo.playerATHitReaction = PLAYER_AT_HIT_REACTION_0;
