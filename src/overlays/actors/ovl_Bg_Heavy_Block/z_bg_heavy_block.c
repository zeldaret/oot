...
static InitChainEntry sInitChain[] = {
    ...
    ICHAIN_F32(cullingVolumeDepth, 4000, ICHAIN_CONTINUE),
...
void BgHeavyBlock_SetupDynapoly(BgHeavyBlock* this, PlayState* play) {
    ...
    this->dyna.actor.flags |= ACTOR_FLAG_DISABLE_UPDATE_CULLING | ACTOR_FLAG_DISABLE_DRAW_CULLING | ACTOR_FLAG_CARRY_X_ROT_INFLUENCE;
...
void BgHeavyBlock_Init(Actor* thisx, PlayState* play) {
    ...
    switch (PARAMS_GET_U(thisx->params, 0, 8)) {
        case HEAVYBLOCK_BIG_PIECE:
            ...
            this->timer = 120;
            thisx->flags |= ACTOR_FLAG_DISABLE_UPDATE_CULLING;
