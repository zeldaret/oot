...
void BgHeavyBlock_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (BgHeavyBlock_LiftedUp == this->actionFunc) {
        Matrix_TranslateRotateYXZ(player->leftHandPos.x, player->leftHandPos.y, player->leftHandPos.z, &thisx->shape.rot);
        ...
        Matrix_TranslateRotateYXZ(thisx->home.pos.x, thisx->home.pos.y, thisx->home.pos.z, &thisx->shape.rot);
