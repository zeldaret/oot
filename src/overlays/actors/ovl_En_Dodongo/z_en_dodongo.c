...
BUMP_HOOKABLE | BUMP_ON, OCELEM_OFF }, { { { -10.0f, 14.0f, 2.0f }, { -10.0f, -6.0f, 2.0f }, { 9.0f, 14.0f, 2.0f }
    ...
    {
        { ELEMTYPE_UNK2, { 0x00000000, 0x00, 0x00 }, { 0xFFCBF96E, 0x00, 0x00 }, TOUCH_OFF, BUMP_NO_AT_INFO |
...
static ColliderJntSphItemInit  D_809FA7E0[6] = {
    ...
    {
        { ELEMTYPE_UNK0, { 0x00000000, 0x00, 0x00 }, { 0x0D800691, 0x00, 0x00 }, TOUCH_OFF, BUMP_ON, OCELEM_UNK3 |
OCELEM_ON }, { 6, { { 0, 0, 0 }, 35 }, 100 },
    },
};
