...
static u8 sCutTypes[PMWA_MAX] = {
    CUT_VERT_L, // PMWA_FORWARD_SLASH_1H
    CUT_VERT_L, // PMWA_FORWARD_SLASH_2H
    CUT_DIAG_R, // PMWA_FORWARD_COMBO_1H
    CUT_DIAG_R, // PMWA_FORWARD_COMBO_2H
    CUT_HORIZ,  // PMWA_RIGHT_SLASH_1H
    CUT_HORIZ,  // PMWA_RIGHT_SLASH_2H
    CUT_HORIZ,  // PMWA_RIGHT_COMBO_1H
    CUT_HORIZ,  // PMWA_RIGHT_COMBO_2H
    CUT_HORIZ,  // PMWA_LEFT_SLASH_1H
    CUT_HORIZ,  // PMWA_LEFT_SLASH_2H
    CUT_HORIZ,  // PMWA_LEFT_COMBO_1H
    CUT_HORIZ,  // PMWA_LEFT_COMBO_2H
    CUT_POST,   // PMWA_STAB_1H
    CUT_POST,   // PMWA_STAB_2H
    CUT_POST,   // PMWA_STAB_COMBO_1H
    CUT_POST,   // PMWA_STAB_COMBO_2H
    CUT_VERT_L, // PMWA_FLIPSLASH_START
    CUT_VERT_L, // PMWA_JUMPSLASH_START
    CUT_VERT_L, // PMWA_FLIPSLASH_FINISH
    CUT_VERT_L, // PMWA_JUMPSLASH_FINISH
    CUT_HORIZ,  // PMWA_BACKSLASH_RIGHT
    CUT_HORIZ,  // PMWA_BACKSLASH_LEFT
    CUT_POST,   // PMWA_HAMMER_FORWARD
    CUT_POST,   // PMWA_HAMMER_SIDE
    CUT_POST,   // PMWA_SPIN_ATTACK_1H
    CUT_POST,   // PMWA_SPIN_ATTACK_2H
    CUT_POST,   // PMWA_BIG_SPIN_1H
    CUT_POST,   // PMWA_BIG_SPIN_2H
};
