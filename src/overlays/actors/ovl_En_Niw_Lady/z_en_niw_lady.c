    ...
    if (arg2 != this->unk_270) {
        ...
        switch (arg2) {
            case 10:
                this->unk_275 = 1;
            case 9:
                frames = SkelAnime_GetLastFrame(&D_060007D0);
            ...
            case 24:
            case 29:
                frames = SkelAnime_GetLastFrame(&D_06009F94);
            ...
            case 27:
            case 28:
                frames = SkelAnime_GetLastFrame(&D_06000718);
                SkelAnime_ChangeAnim(&this->skelAnime, &D_06000718, 1.0f, 0.0f, frames, 0, -10.0f);
                break;
            case 100:
                frames = SkelAnime_GetLastFrame(&D_0600A630);
...
void func_80AB9F24(EnNiwLady* this, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->objectAneIndex) &&
        ...
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_060000F0, NULL, this->jointTbl, this->morphTbl, 16);
