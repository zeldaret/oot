...
void EnNiwLady_Init(Actor* thisx, PlayState* play) {
    ...
    osSyncPrintf(T_FGCOL(GREEN) "☆☆☆☆☆ ねぇちゃんうっふん ☆☆☆☆☆ %d\n" T_RST, this->unk_278);
    osSyncPrintf("\n\n");
...
void func_80ABA244(EnNiwLady* this, PlayState* play) {
    ...
    if (Actor_ProcessTalkRequest(&this->actor, play)) {
        osSyncPrintf("\n\n");
        osSyncPrintf(T_FGCOL(YELLOW) "☆☆☆☆☆ ねぇちゃん選択\t ☆☆☆☆ %d\n" T_RST, phi_s1);
        osSyncPrintf(T_FGCOL(YELLOW) "☆☆☆☆☆ ねぇちゃんハート     ☆☆☆☆ %d\n" T_RST, this->unk_26C);
        osSyncPrintf(T_FGCOL(YELLOW) "☆☆☆☆☆ ねぇちゃん保存       ☆☆☆☆ %d\n" T_RST, this->unk_26A);
        osSyncPrintf(T_FGCOL(YELLOW) "☆☆☆☆☆ ねぇちゃん今\t ☆☆☆☆ %d\n" T_RST, this->cuccosInPen);
        osSyncPrintf(T_FGCOL(GREEN) "☆☆☆☆☆ this->actor.talk_message ☆☆ %x\n" T_RST, this->actor.textId);
        osSyncPrintf(T_FGCOL(GREEN) "☆☆☆☆☆ this->message_end_code   ☆☆ %d\n" T_RST, this->unk_262);
        osSyncPrintf("\n\n");
        if (Text_GetFaceReaction(play, 8) == 0) {
...
void func_80ABA654(EnNiwLady* this, PlayState* play) {
    if (this->unk_262 == Message_GetState(&play->msgCtx) && Message_ShouldAdvance(play)) {
        ...
        osSyncPrintf(T_FGCOL(GREEN) "☆☆☆☆☆ ハート ☆☆☆☆☆ %d\n" T_RST, this->unk_26C);
        osSyncPrintf(T_FGCOL(YELLOW) "☆☆☆☆☆ 爆弾   ☆☆☆☆☆ %d\n" T_RST, this->unk_272);
        osSyncPrintf("\n\n");
        this->unk_26E = 0xB;
...
void func_80ABA778(EnNiwLady* this, PlayState* play) {
    // "☆☆☆☆☆ Adult message check ☆☆☆☆☆"
    osSyncPrintf(T_FGCOL(GREEN) "☆☆☆☆☆ アダルトメッセージチェック ☆☆☆☆☆ \n" T_RST);
    this->unk_262 = TEXT_STATE_DONE;
    this->unk_273 = 0;
...
void func_80ABAD38(EnNiwLady* this, PlayState* play) {
    osSyncPrintf(T_FGCOL(GREEN) "☆☆☆☆☆ 通常メッセージチェック ☆☆☆☆☆ \n" T_RST);
    this->unk_262 = TEXT_STATE_DONE;
