...
void EnFish_Dropped_Fall(EnFish* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.bgCheckFlags & BGCHECKFLAG_0) { // On floor
        this->timer = 400;
        EnFish_Dropped_SetupFlopOnGround(this);
    } else if (this->actor.bgCheckFlags & BGCHECKFLAG_5) { // In water
...
void EnFish_Dropped_FlopOnGround(EnFish* this, GlobalContext* globalCtx) {
    ...
    if (this->timer <= 60) {
        ...
        EnFish_Dropped_SetupSwimAway(this);
    } else if (this->actor.bgCheckFlags & BGCHECKFLAG_0) { // On floor
        EnFish_Dropped_SetupFlopOnGround(this);
    }
}
...
void EnFish_Dropped_SwimAway(EnFish* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & BGCHECKFLAG_3) || !(this->actor.bgCheckFlags & BGCHECKFLAG_5)) {
