    ...
    if (this->onFire || (this->actor.params == KEESE_ICE_FLY) ||
        ...
        if (skelanimeUpdated) {
            ...
            if (this->actor.bgCheckFlags & BGCHECKFLAG_0) {
                this->targetPitch = 0x954;
            } else if ((this->actor.bgCheckFlags & BGCHECKFLAG_4) || (this->maxAltitude < this->actor.world.pos.y)) {
                this->targetPitch = 0x2154;
            }
        }
...
void EnFirefly_Fall(EnFirefly* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.flags & ACTOR_FLAG_15) {
        ...
        if ((this->actor.bgCheckFlags & BGCHECKFLAG_0) || (this->timer == 0)) {
...
void EnFirefly_DiveAttack(EnFirefly* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.bgCheckFlags & BGCHECKFLAG_3) {
        ...
        if ((this->actor.bgCheckFlags & BGCHECKFLAG_4) || (this->maxAltitude < this->actor.world.pos.y)) {
            this->targetPitch = 0x2154;
        } else {
            this->targetPitch = 0x954;
        }
