...
CutsceneData gAdultWarpOutToTCS[] = {
    ...
    CS_CAM_EYE_SPLINE_REL_TO_PLAYER(0, 1091),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 0x42714CA8, 42, 89, 50, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 0x42714CA8, 42, 89, 50, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 0x42714CA8, 42, 89, 50, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 0x42714CA8, 42, 89, 50, 0x0000),
        CS_CAM_POINT(CS_CAM_STOP, 0x00, 0, 0x42714CA8, 42, 89, 50, 0x29D0),
    CS_CAM_AT_SPLINE_REL_TO_PLAYER(0, 1120),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 0x42714CA8, 24, 66, 29, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 0x42714CA8, 24, 66, 29, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 1000, 0x42714CA8, 24, 66, 29, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 0x42714CA8, 24, 66, 29, 0x0000),
        CS_CAM_POINT(CS_CAM_STOP, 0x00, 30, 0x42714CA8, 24, 66, 29, 0x29D0),
    CS_MISC_LIST(1),
