...
void DemoKankyo_DrawRain(Actor* thisx, PlayState* play) {
    ...
    for (i = 0; i < 30; i++) {
        ...
        for (j = 0; j < 5; j++) {
            ...
            gSPMatrix(POLY_XLU_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 1344), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoKankyo_DrawRock(Actor* thisx, PlayState* play) {
    ...
    gSPMatrix(POLY_OPA_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 1404), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoKankyo_DrawClouds(Actor* thisx, PlayState* play) {
    ...
    for (i = 0; i < 30; i++) {
        ...
        gSPMatrix(POLY_XLU_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 1461), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoKankyo_DrawDoorOfTime(Actor* thisx, PlayState* play) {
    ...
    gSPMatrix(POLY_OPA_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 1492), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    ...
    gSPMatrix(POLY_OPA_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 1497), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoKankyo_DrawLightPlane(Actor* thisx, PlayState* play) {
    ...
    if (play->csCtx.state == CS_STATE_IDLE || IS_CUTSCENE_LAYER) {
        ...
        gSPMatrix(POLY_XLU_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 1529), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoKankyo_DrawWarpSparkles(Actor* thisx, PlayState* play) {
    ...
    for (i = this->sparkleCounter - 1; i >= 0; i--) {
        ...
        if (this->unk_150[i].unk_22 < 2) {
            ...
            gSPMatrix(POLY_XLU_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 2011), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoKankyo_DrawSparkles(Actor* thisx, PlayState* play) {
    ...
    for (i = this->sparkleCounter - 1; i >= 0; i--) {
        ...
        if (this->unk_150[i].unk_22 < 2) {
            ...
            Matrix_Mult(&play->billboardMtxF, MTXMODE_APPLY);
            Matrix_RotateZ(DEG_TO_RAD(this->unk_150[i].unk_24), MTXMODE_APPLY);
            gSPMatrix(POLY_XLU_DISP++, MATRIX_NEW(play->state.gfxCtx, "../z_demo_kankyo.c", 2572), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
