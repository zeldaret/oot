...
void OceffWipe2_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    gSPMatrix(gfxCtx->polyXlu.p++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_oceff_wipe2.c", 400), G_MTX_NOPUSH|G_MTX_LOAD|G_MTX_MODELVIEW);
    ...
    gSPDisplayList(gfxCtx->polyXlu.p++, Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, scroll*6, scroll*(-6), 64, 64, 1, scroll*(-6), 0, 64, 64));
