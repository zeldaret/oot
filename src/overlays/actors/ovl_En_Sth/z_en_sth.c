...
static u16 sEventFlags[6] = {
    0,
    GET_EVENTCHKINF_MASK(EVENTCHKINF_DA),
    GET_EVENTCHKINF_MASK(EVENTCHKINF_DB),
    GET_EVENTCHKINF_MASK(EVENTCHKINF_DC),
    GET_EVENTCHKINF_MASK(EVENTCHKINF_DD),
    GET_EVENTCHKINF_MASK(EVENTCHKINF_DE),
};
