...
static ColliderCylinderInit D_80B8AF50 = {
    ...
    { ELEMTYPE_UNK0, { 0x00020000, 0x00, 0x01 }, { 0x00000000, 0x00, 0x00 }, TOUCH_ON | TOUCH_SFX_NONE, BUMP_NONE, OCELEM_NONE, },
    { 9, 9, 0, { 0, 0, 0 } },
};
...
0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x10, 0x11, 0x12, 0x13, 0x19, 0x1A, 0x1B, 0x20, 0x23, 0x24, 0x25, 0x26, 0x27, 0x2D, 0x2E, 0x2F, 0x34, 0x35, 0x36, 0x3B, 0x3C, 0x3D, 0x43, 0x44,
};
static u8 D_80B8AFA0[] = {
0x45, 0x46, 0x47, 0x48, 0x00, 0x01, 0x0B, 0x0C, 0x0E, 0x14, 0x15, 0x17, 0x1C, 0x1E, 0x21, 0x22, 0x28, 0x29, 0x2B, 0x30, 0x32, 0x37, 0x39, 0x3E, 0x40, 0x41, 0x49, 0x4A, 0x00, 0x00, 0x00, 0x00,
};
...
void MagicFire_Draw(Actor *thisx, GlobalContext *globalCtx) {
    ...
    if (this->unk1A4 > 0) {
        ...
        gDPSetPrimColor(POLY_XLU_DISP++, 0, 0, (u8)(s32)(this->unk19C * 60.0f), (u8)(s32)(this->unk19C * 20.0f), (u8)(s32)(this->unk19C * 0.0f), (u8)(s32)(this->unk19C * 120.0f));
        ...
        gDPLoadTextureBlock(POLY_XLU_DISP++, D_80B89900, G_IM_FMT_I, G_IM_SIZ_8b, 64, 64, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 6, 6, 15, G_TX_NOLOD);
        ...
        temp_v1 = (s32)(this->unk198 * (f32)0xFF);
        for (i = 0; i < 0x20; i++){
            D_80B8A900[D_80B8AF80[i]].n.a = temp_v1;
        }
        temp_v2 = (s32)(this->unk198 * (f32)0x4C);
        for (j = 0; j < 0x20; j++){
            D_80B8AB00[D_80B8AFA0[j]].n.a = temp_v2;
        }
    }
}
