...
static ColliderQuadInit D_80870760 = {
    { COLTYPE_UNK10, AT_OFF, AC_BOMB | AC_PLAYER | AC_ON, OC_OFF, OT_TYPE2, COLSHAPE_QUAD },
    { ELEMTYPE_UNK0, { 0x00000048, 0x00, 0x00 }, { 0x00000048, 0x00, 0x00 }, TOUCH_OFF, BUMP_ON, OCELEM_OFF },
