...
void BgHakaShip_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->dyna.actor.params == 0) {
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_bg_haka_ship.c", 534);
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_bg_haka_ship.c", 547);
        ...
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_bg_haka_ship.c", 556);
        gSPDisplayList(POLY_OPA_DISP++, object_haka_objects_DL_005A70);
    } else {
        gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_bg_haka_ship.c", 562);
