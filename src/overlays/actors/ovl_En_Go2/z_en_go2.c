...
EnGo
pathIndex: PARAMS_GET2(this->actor.params, 0, 0xF)
Goron: PARAMS_GET2(this->actor.params, 0, 0xF0)

EnGo2
PARAMS_GET2(this->actor.params, 5, 0x3E0)
PARAMS_GET2(this->actor.params, 0xA, 0xFC00) - Gorons in Fire Temple
PARAMS_GET2(this->actor.params, 0, 0x1F)
...
u16 EnGo2_GoronFireGenericGetTextId(EnGo2* this) {
    switch (PARAMS_GET2(this->actor.params, 0xA, 0xFC00)) {
        case 3:
            return 0x3069;
        case 5:
            return 0x306A;
...
u16 EnGo2_GetTextIdGoronFireGeneric(PlayState* play, EnGo2* this) {
    if (Flags_GetSwitch(play, PARAMS_GET2(this->actor.params, 0xA, 0xFC00))) {
        return 0x3071;
    } else {
        return 0x3051;
    }
...
u16 EnGo2_GetTextId(PlayState* play, Actor* thisx) {
    ...
    if (faceReaction != 0) {
        ...
        switch (PARAMS_GET2(this->actor.params, 0, 0x1F)) {
...
s32 func_80A44790(EnGo2* this, PlayState* play) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_DMT_BIGGORON && PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_CITY_ROLLING_BIG) {
...
void EnGo2_SetColliderDim(EnGo2* this) {
    u8 index = PARAMS_GET2(this->actor.params, 0, 0x1F);
...
void EnGo2_CheckCollision(EnGo2* this, PlayState* play) {
    ...
    xzDist = D_80A4816C[PARAMS_GET2(this->actor.params, 0, 0x1F)].xzDist;
    pos.x += (s16)(xzDist * Math_SinS(this->actor.shape.rot.y));
    pos.z += (s16)(xzDist * Math_CosS(this->actor.shape.rot.y));
    pos.y += D_80A4816C[PARAMS_GET2(this->actor.params, 0, 0x1F)].yDist;
...
s32 EnGo2_IsWakingUp(EnGo2* this) {
    s16 yawDiff;
    f32 xyzDist = PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_DMT_BIGGORON ? 800.0f : 200.0f;
    f32 yDist = PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_DMT_BIGGORON ? 400.0f : 60.0f;
    s16 yawDiffAbs;
...
s32 EnGo2_IsRollingOnGround(EnGo2* this, s16 arg1, f32 arg2, s16 arg3) {
    ...
    if (this->unk_59C >= 2) {
        Audio_PlayActorSound2(&this->actor, PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_ROLLING_BIG
...
void func_80A45288(EnGo2* this, PlayState* play) {
    ...
    if (this->actionFunc != EnGo2_GoronFireGenericAction) {
        ...
        this->unk_194.unk_14 = D_80A482D8[PARAMS_GET2(this->actor.params, 0, 0x1F)][((void)0, gSaveContext.linkAge)];
...
f32 EnGo2_GetTargetXZSpeed(EnGo2* this) {
    f32 yDist = PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_DMT_BIGGORON ? 400.0f : 60.0f;
    s32 index = PARAMS_GET2(this->actor.params, 0, 0x1F);
...
s32 EnGo2_IsCameraModified(EnGo2* this, PlayState* play) {
    ...
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_FIRE_GENERIC || PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_ROLLING_BIG ||
        PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_STAIRWELL || PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_DMT_BIGGORON ||
        PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_MARKET_BAZAAR) {
        return true;
...
void EnGo2_GetDustData(EnGo2* this, s32 index2) {
    s32 index1 = PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_ROLLING_BIG ? 1 : 0;
...
void EnGo2_SetupRolling(EnGo2* this, PlayState* play) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_ROLLING_BIG || PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_LINK) {
...
void EnGo2_StopRolling(EnGo2* this, PlayState* play) {
    ...
    if ((PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_CITY_ROLLING_BIG) && (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_CITY_LINK)) {
        if (PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_DMT_ROLLING_SMALL) {
...
s32 EnGo2_IsFreeingGoronInFire(EnGo2* this, PlayState* play) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_FIRE_GENERIC) {
        return false;
    }
...
s32 EnGo2_IsGoronDmtBombFlower(EnGo2* this) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_DMT_BOMB_FLOWER || this->unk_194.unk_00 != 2) {
        return false;
    }
...
s32 EnGo2_IsGoronRollingBig(EnGo2* this, PlayState* play) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_CITY_ROLLING_BIG || (this->unk_194.unk_00 != 2)) {
        return false;
    }
    this->unk_194.unk_00 = 0;
...
s32 EnGo2_IsGoronFireGeneric(EnGo2* this) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_FIRE_GENERIC || this->unk_194.unk_00 == 0) {
        return false;
    }
...
s32 EnGo2_IsGoronLinkReversing(EnGo2* this) {
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_CITY_LINK || (this->waypoint >= this->unk_216) ||
...
void EnGo2_GoronLinkAnimation(EnGo2* this, PlayState* play) {
    ...
    if (PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_CITY_LINK) {
...
void EnGo2_BiggoronAnimation(EnGo2* this) {
    if (INV_CONTENT(ITEM_TRADE_ADULT) >= ITEM_SWORD_BROKEN && INV_CONTENT(ITEM_TRADE_ADULT) <= ITEM_EYEDROPS &&
        PARAMS_GET2(this->actor.params, 0, 0x1F) == GORON_DMT_BIGGORON && this->unk_194.unk_00 == 0) {
...
void EnGo2_Init(Actor* thisx, PlayState* play) {
    ...
    this->unk_26E = 1;
    this->path = Path_GetByIndex(play, PARAMS_GET2(this->actor.params, 5, 0x3E0), 0x1F);
    switch (PARAMS_GET2(this->actor.params, 0, 0x1F)) {
        case GORON_CITY_ENTRANCE:
        case GORON_CITY_ISLAND:
        case GORON_CITY_LOWEST_FLOOR:
        ...
        case GORON_CITY_LINK:
            if (GET_INFTABLE(INFTABLE_109)) {
                ...
                this->collider.dim.height = (D_80A4816C[PARAMS_GET2(this->actor.params, 0, 0x1F)].height * 0.6f);
...
void EnGo2_CurledUp(EnGo2* this, PlayState* play) {
    ...
    if ((PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_FIRE_GENERIC) && EnGo2_IsWakingUp(this)) {
        EnGo2_WakeUp(this, play);
    }
}
...
void EnGo2_ContinueRolling(EnGo2* this, PlayState* play) {
    ...
    if ((PARAMS_GET2(this->actor.params, 0, 0x1F) != GORON_DMT_ROLLING_SMALL || !(this->actor.xyzDistToPlayerSq > SQ(float1))) &&
...
void EnGo2_SlowRolling(EnGo2* this, PlayState* play) {
    ...
    if (!EnGo2_IsRolling(this)) {
        ...
        index = PARAMS_GET2(this->actor.params, 0, 0x1F);
    ...
    switch (this->goronState) {
        ...
        case 2: // Walking away
            if (DECR(this->animTimer)) {
                ...
                this->animTimer = 0;
                this->actor.speedXZ = 0.0f;
                if ((PARAMS_GET2(this->actor.params, 0xA, 0xFC00) != 1) && (PARAMS_GET2(this->actor.params, 0xA, 0xFC00) != 2) &&
                    (PARAMS_GET2(this->actor.params, 0xA, 0xFC00) != 4) && (PARAMS_GET2(this->actor.params, 0xA, 0xFC00) != 5) &&
                    (PARAMS_GET2(this->actor.params, 0xA, 0xFC00) != 9) && (PARAMS_GET2(this->actor.params, 0xA, 0xFC00) != 11)) {
                    this->goronState++;
                }
                this->goronState++;
            }
