...
void func_80A693D0(EnHorseLinkChild* this) {
    ...
    if ((this->skin.skelAnime.curFrame > D_80A6AF5C[this->unk_1F0]) &&
        ...
        Audio_PlaySfxGeneral(NA_SE_EV_KID_HORSE_WALK, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
...
void func_80A6948C(EnHorseLinkChild* this) {
    if (this->animationIdx == 2) {
        ...
        if ((this->animationIdx == 3) || (this->animationIdx == 4)) {
            Audio_PlaySfxGeneral(NA_SE_EV_KID_HORSE_RUN, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                                 &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
        } else if (this->animationIdx == 1) {
            if (Rand_ZeroOne() > 0.5f) {
                Audio_PlaySfxGeneral(NA_SE_EV_KID_HORSE_GROAN, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
            } else {
                Audio_PlaySfxGeneral(NA_SE_EV_KID_HORSE_NEIGH, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
            }
        }
    }
