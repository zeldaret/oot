...
static CutsceneData D_80AF411C[] = {
    ...
    CS_CAM_EYE_PLAYER_LIST(899, 2080),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 33, -27, 0x0000),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 33, -27, 0x1FBC),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 68, -26, 0xD5E0),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 103, -26, 0x0000),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 103, -26, 0x1F98),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 103, -26, 0x0000),
        CS_CAM_EYE_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 68.599945f, 0, 103, -26, 0x0000),
        CS_CAM_EYE_PLAYER(CS_CMD_STOP, 0x00, 0, 68.599945f, 0, 103, -26, 0x0164),
    CS_CAM_LOOK_AT_LIST(0, 330),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x1E, 20, 175.39832f, -649, -75, 101, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0xE2, 20, 175.39832f, -652, -75, 98, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x1E, 20, 175.39832f, -658, -75, 87, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0xE2, 20, 175.39832f, -678, 127, 71, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 20, 175.39832f, -727, 0, 71, 0x1F98),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 20, 145.79877f, -513, 0, 43, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.600002f, -349, 89, 47, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.600002f, 6, 61, 1, 0x0164),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.600002f, 33, 66, 28, 0x2100),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.600002f, 158, 42, 1, 0x0049),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.600002f, 158, 42, 1, 0x204C),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.600002f, 158, 42, 1, 0xE990),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 60.600002f, 158, 42, 1, 0x0000),
    CS_CAM_LOOK_AT_LIST(263, 1513),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 42.22703f, 322, 62, -122, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 42.22703f, 322, 62, -122, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 50, 42.22703f, 322, 62, -122, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 50, 42.22703f, 232, 63, -83, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 42.22703f, 232, 63, -83, 0x1F98),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 1000, 42.22703f, 232, 63, -83, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 42.22703f, 232, 63, -83, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 42.22703f, 232, 63, -83, 0x0164),
    CS_CAM_LOOK_AT_LIST(383, 1503),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.22702f, 51, 62, -105, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.22702f, 51, 62, -105, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 1000, 70.22702f, 51, 62, -105, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.22702f, 51, 62, -105, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 70.22702f, 51, 62, -105, 0x1F98),
    CS_CAM_LOOK_AT_LIST(453, 1573),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 45.027042f, 102, 22, -31, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 45.027042f, 102, 22, -31, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 1000, 45.027042f, 102, 22, -31, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 45.027042f, 102, 22, -31, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 45.027042f, 102, 22, -31, 0x1F98),
    CS_CAM_LOOK_AT_LIST(553, 1673),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.22702f, 51, 62, -105, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.22702f, 51, 62, -105, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 1000, 70.22702f, 51, 62, -105, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.22702f, 51, 62, -105, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 70.22702f, 51, 62, -105, 0x1F98),
    CS_CAM_LOOK_AT_LIST(623, 1743),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 347, 22, 0, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 347, 22, 0, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 1000, 60.4271f, 347, 22, 0, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 347, 22, 0, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 60.4271f, 347, 22, 0, 0x1F98),
    CS_CAM_LOOK_AT_LIST(693, 1813),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 258, -30, -54, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 258, -30, -54, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 1000, 60.4271f, 258, -30, -54, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 258, -30, -54, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 60.4271f, 258, -30, -54, 0x1F98),
    CS_CAM_LOOK_AT_LIST(763, 973),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 60.4271f, 96, 105, -29, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 40, 60.4271f, 96, 105, -29, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 15, 60.4271f, 96, 105, -29, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 15, 60.0271f, 110, 196, -26, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 20, 70.42702f, 185, 399, 6, 0x1F98),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.42702f, 185, 399, 6, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 70.42702f, 185, 399, 6, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 30, 70.42702f, 185, 399, 6, 0x0164),
    CS_CAM_LOOK_AT_LIST(823, 1214),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 50, 60.0f, 3, 6, -6, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 40, 60.0f, 3, 6, -6, 0x1FBC),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 30, 50.999966f, 3, 6, -6, 0xD5E0),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 20, 20.59985f, 3, 6, -6, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 51, 10.799838f, 3, 6, -6, 0x1F98),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 50, 10.399838f, 3, 6, -6, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 50, 10.399838f, 3, 6, -6, 0x0000),
        CS_CAM_LOOK_AT(CS_CMD_CONTINUE, 0x00, 50, 10.199839f, 3, 6, -6, 0x0164),
        CS_CAM_LOOK_AT(CS_CMD_STOP, 0x00, 50, 10.999838f, 3, 6, -6, 0x2100),
    CS_CAM_LOOK_AT_PLAYER_LIST(899, 2109),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 68.599945f, 0, 100, 5, 0x0000),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 68.599945f, 0, 101, 6, 0x1FBC),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 68.599945f, 1, 99, 41, 0xD5E0),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 68.599945f, 0, 42, 16, 0x0000),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 68.599945f, 0, 42, 16, 0x1F98),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 1000, 68.599945f, 0, 42, 16, 0x0000),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 68.599945f, 0, 42, 16, 0x0000),
        CS_CAM_LOOK_AT_PLAYER(CS_CMD_STOP, 0x00, 30, 68.599945f, 0, 42, 16, 0x0164),
