...
void func_80AF29DC(EnRu2* this, GlobalContext* globalCtx) {
    ...
    Actor_SpawnChild(&globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_DOOR_WARP1, posX, posY, posZ, 0, 0, 0, 2);
}
...
void func_80AF2A38(EnRu2* this, GlobalContext* globalCtx) {
    ...
    Actor_SpawnChild(&globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_DEMO_EFFECT, posX, posY, posZ, 0, 0, 0, 10);
...
void func_80AF2E84(EnRu2* this, GlobalContext* globalCtx) {
    Actor_SpawnChild(&globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_DEMO_6K, this->actor.posRot.pos.x,
