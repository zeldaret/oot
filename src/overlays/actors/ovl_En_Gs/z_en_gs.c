...
void EnGs_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(this->unk_19E & 8)) {
        ...
        Matrix_Push();
        if (this->unk_19E & 1) {
            Matrix_RotateY(BINANG_TO_RAD_ALT(this->unk_1A0[0].y), MTXMODE_APPLY);
            Matrix_RotateX(BINANG_TO_RAD_ALT(this->unk_1A0[0].x), MTXMODE_APPLY);
            Matrix_RotateZ(BINANG_TO_RAD_ALT(this->unk_1A0[0].z), MTXMODE_APPLY);
            Matrix_Scale(this->unk_1B4[0].x, this->unk_1B4[0].y, this->unk_1B4[0].z, MTXMODE_APPLY);
            Matrix_RotateY(BINANG_TO_RAD_ALT(this->unk_1A0[1].y), MTXMODE_APPLY);
            Matrix_RotateX(BINANG_TO_RAD_ALT(this->unk_1A0[1].x), MTXMODE_APPLY);
            Matrix_RotateZ(BINANG_TO_RAD_ALT(this->unk_1A0[1].z), MTXMODE_APPLY);
        }
