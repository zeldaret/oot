...
void EnMThunder_Init(Actor* thisx, PlayState* play2) {
    ...
    if (player->stateFlags2 & PLAYER_STATE2_17) {
        ...
        this->unk_1CA = 1;
        this->collider.elem.atDmgInfo.dmgFlags_ColliderElementDamageInfoAT = D_80AA044C[this->unk_1C7];
        this->unk_1C6 = 1;
    ...
    if (player->stateFlags2 & PLAYER_STATE2_17) {
        ...
        if (player->unk_858 <= 0.15f) {
            ...
            if (player->unk_858 < 0.85f) {
                ...
                this->collider.elem.atDmgInfo.dmgFlags_ColliderElementDamageInfoAT = D_80AA0458[this->unk_1C7];
                this->unk_1C6 = 0;
