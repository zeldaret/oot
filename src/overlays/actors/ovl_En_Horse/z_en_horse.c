...
void EnHorse_IdleAnimSounds(EnHorse* this, GlobalContext* globalCtx) {
    if (this->animationIdx == ENHORSE_ANIM_IDLE &&
        ...
        this->stateFlags |= ENHORSE_SANDDUST_SOUND;
        Audio_PlaySfxGeneral(NA_SE_EV_HORSE_SANDDUST, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    } else if (this->animationIdx == ENHORSE_ANIM_REARING && this->curFrame > 25.0f &&
               !(this->stateFlags & ENHORSE_LAND2_SOUND)) {
        this->stateFlags |= ENHORSE_LAND2_SOUND;
        Audio_PlaySfxGeneral(NA_SE_EV_HORSE_LAND2, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
...
void EnHorse_MountedIdleWhinney(EnHorse* this) {
    ...
    if (this->stateFlags & ENHORSE_DRAW) {
        Audio_PlaySfxGeneral(NA_SE_EV_HORSE_GROAN, &this->unk_21C, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
...
void EnHorse_StartRearing(EnHorse* this) {
    ...
    this->unk_21C = this->unk_228;
    if (this->stateFlags & ENHORSE_DRAW) {
        Audio_PlaySfxGeneral(NA_SE_EV_HORSE_NEIGH, &this->unk_21C, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
...
void EnHorse_StartBraking(EnHorse* this, GlobalContext* globalCtx) {
    ...
    Audio_PlaySfxGeneral(NA_SE_EV_HORSE_SLIP, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                         &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
...
void EnHorse_StartLowJump(EnHorse* this, GlobalContext* globalCtx) {
    ...
    Audio_PlaySfxGeneral(NA_SE_EV_HORSE_JUMP, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                         &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
...
void EnHorse_LowJump(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skin.skelAnime) ||
        ...
        Audio_PlaySfxGeneral(NA_SE_EV_HORSE_LAND, &this->actor.projectedPos, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
...
void EnHorse_InitIngoHorse(EnHorse* this) {
    ...
    this->unk_21C = this->unk_228;
    if (this->stateFlags & ENHORSE_DRAW) {
        Audio_PlaySfxGeneral(NA_SE_IT_INGO_HORSE_NEIGH, &this->unk_21C, 4, &gSfxFreqOrVolDefaultVal,
                             &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
    }
}
    ...
    if (this->numBoosts < 6 && this->numBoosts > 0) {
        ...
        if (this->boostRegenTime <= 0) {
            ...
            if (!EN_HORSE_CHECK_4(this)) {
                Audio_PlaySfxGeneral(NA_SE_SY_CARROT_RECOVER, &gSfxPosScreenCenter, 4, &gSfxFreqOrVolDefaultVal,
                                     &gSfxFreqOrVolDefaultVal, &gSfxReverbAddNone);
            }
