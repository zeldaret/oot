...
void EnHorse_Inactive(EnHorse* this, GlobalContext* globalCtx2) {
    ...
    if (DREG(53) != 0 && this->type == HORSE_EPONA) {
        ...
        if (EnHorse_Spawn(this, globalCtx) != 0) {
            ...
            Camera_SetParam(globalCtx->cameraPtrs[MAIN_CAM], 8, this);
            Camera_ChangeSetting(globalCtx->cameraPtrs[MAIN_CAM], CAM_SET_ITEM2);
            Camera_SetCameraData(globalCtx->cameraPtrs[MAIN_CAM], 4, NULL, NULL, 0x51, 0, 0);
        }
    }
