...
static ColliderCylinderInit D_80A65EAC = {
    { COLTYPE_NONE, AT_PLAYER | AT_OFF, AC_OFF, OC_ALL | OC_ON, OT_TYPE1 | OT_UNK1, COLSHAPE_CYLINDER },
    { ELEMTYPE_UNK0, { 0x00000400, 0x00, 0x04 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_SFX_NONE | TOUCH_ON,
