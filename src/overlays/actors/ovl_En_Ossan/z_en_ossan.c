    ...
    if (this->actor.params == 10) {
        ...
        for (i = 0; i < 8; i++) {
            if ((sp24[i].funcIdx >= 0) && (this->unk_200[i] == NULL)) {
                ...
                if (temp_v0 >= 0) {
                    this->unk_200[i] = (EnGirlA*)Actor_Spawn(
                        &globalCtx->actorCtx, globalCtx, ACTOR_EN_GIRLA, sp24[i].pos.x + (*tana)->actor.posRot.pos.x,
                        sp24[i].pos.y + (*tana)->actor.posRot.pos.y, sp24[i].pos.z + (*tana)->actor.posRot.pos.z,
                        (*tana)->actor.shape.rot.x, (*tana)->actor.shape.rot.y + D_80AC88F4[i],
                        (*tana)->actor.shape.rot.z, temp_v0);
                }
            }
        }
    }
...
void func_80AC5014(GlobalContext* globalCtx, EnOssan* this) {
    ...
    switch (girlA->unk_1BC(globalCtx, girlA)) {
        case 0:
            if ((girlA->actor.params == 12) && (gSaveContext.infTable[7] & 0x40)) {
...
void func_80AC5A28(EnOssan* this, GlobalContext* globalCtx, Player* player) {
    ...
    } else if ((msg == 4) && !func_80AC38C8(this, globalCtx, cont1) && func_80106BC8(globalCtx)) {
        switch (globalCtx->msgCtx.choiceIndex) {
            case 0:
                switch (girlA->actor.params) {
                    case 30:
...
void func_80AC5DAC(EnOssan* this, GlobalContext* globalCtx, Player* player) {
    ...
    if ((msg == 6) && func_80106BC8(globalCtx)) {
        if (this->actor.params == 0xA) {
...
void func_80AC5EF0(EnOssan* this, GlobalContext* globalCtx, Player* player) {
    ...
    if (msg == 4) {
        if (func_80106BC8(globalCtx)) {
            func_80AC646C(this);
            this->unk_200[this->unk_252]->unk_1B0(globalCtx, this->unk_200[this->unk_252]);
            if (!func_80AC3884(this, globalCtx, &globalCtx->state.input[0])) {
                switch (globalCtx->msgCtx.choiceIndex) {
                    case 0:
                        // Continuing
...
void func_80AC65B8(EnOssan* this) {
    ...
    for (i = 0; i < 8; i++) {
        actor2 = *actor;
        if (actor2 != NULL) {
            if ((this->unk_1FC != 9) && (this->unk_1FC != 10) && (this->unk_1FC != 11) && (this->unk_1FC != 12) &&
                (this->unk_1FC != 13) && (this->unk_1FC != 0x18) && (this->unk_1FC != 14) && (this->unk_251 == 0)) {
                actor2->unk_1B4 = 0;
            } else if (i == this->unk_252) {
                actor2->unk_1B4 = 1;
            } else {
                actor2->unk_1B4 = 0;
            }
...
void func_80AC67C4(EnOssan* this) {
    ...
    this->unk_2A8 = this->unk_2A4 = this->unk_270 = tmp;

    this->unk_2AC = this->unk_274 = tmp2;

    this->unk_2B0 = this->unk_278 = tmp3;

    this->unk_29C = tmp4;

    this->unk_264 = tmp5;

    this->unk_280 = this->unk_2B8 = 91.0f;

    this->unk_268 = this->unk_2A0 = 95.0f;
    this->unk_27C = 33.0f;
}
#else
...
s32 func_80AC6A44(EnOssan* this, GlobalContext* globalCtx) {
    if (Object_IsLoaded(&globalCtx->objectCtx, this->unk_1E8)) {
        if ((this->unk_1E9 >= 0) && !Object_IsLoaded(&globalCtx->objectCtx, this->unk_1E9)) {
            return 0;
        } else if ((this->unk_1EA >= 0) && !Object_IsLoaded(&globalCtx->objectCtx, this->unk_1EA)) {
            return 0;
        } else {
            return 1;
        }
...
void func_80AC6ADC(EnOssan* this, GlobalContext* globalCtx) {
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_06009B38, &D_06000338, NULL, NULL, 0);
    this->actor.draw = func_80AC7DAC;
    this->unk_194 = NULL;
}

void func_80AC6B3C(EnOssan* this, GlobalContext* globalCtx) {
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_060000F0, NULL, NULL, NULL, 0);
    gSegments[6] = PHYSICAL_TO_VIRTUAL(globalCtx->objectCtx.status[this->unk_1EA].segment);
    SkelAnime_ChangeAnim(&this->skelAnime, &D_060004A8, 1.0f, 0.0f, SkelAnime_GetFrameCount(&D_060004A8.genericHeader),
                         0, 0.0f);
...
void func_80AC6C54(EnOssan* this, GlobalContext* globalCtx) {
    ...
    gSegments[6] = PHYSICAL_TO_VIRTUAL(globalCtx->objectCtx.status[this->unk_1EA].segment);
    SkelAnime_ChangeAnim(&this->skelAnime, &D_060000FC, 1.0f, 0.0f, SkelAnime_GetFrameCount(&D_060000FC.genericHeader),
                         0, 0.0f);
...
void func_80AC6D30(EnOssan* this, GlobalContext* globalCtx) {
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_0600BFA8, NULL, NULL, NULL, 0);
    gSegments[6] = PHYSICAL_TO_VIRTUAL(globalCtx->objectCtx.status[this->unk_1EA].segment);
    SkelAnime_ChangeAnim(&this->skelAnime, &D_0600078C, 1.0f, 0.0f, SkelAnime_GetFrameCount(&D_0600078C.genericHeader),
                         0, 0.0f);
...
void func_80AC6E0C(EnOssan* this, GlobalContext* globalCtx) {
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_06004258, &D_060002E4, NULL, NULL, 0);
    this->actor.draw = func_80AC854C;
    this->unk_194 = NULL;
}

void func_80AC6E6C(EnOssan* this, GlobalContext* globalCtx) {
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_06004658, &D_060002E4, NULL, NULL, 0);
    this->actor.draw = func_80AC8668;
    this->unk_194 = NULL;
}

void func_80AC6ECC(EnOssan* this, GlobalContext* globalCtx) {
    SkelAnime_InitSV(globalCtx, &this->skelAnime, &D_06004868, &D_0600065C, NULL, NULL, 0);
...
u16 func_80AC6F2C(EnOssan* this) {
    this->unk_1EB = 8;
    if (this->actor.params == 10) {
        if (INV_CONTENT(ITEM_WEIRD_EGG) == 44) {
