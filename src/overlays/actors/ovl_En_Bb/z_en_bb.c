...
void EnBb_SetupStunned(EnBb* this) {
    ...
    switch (this->dmgEffect) {
        case 8:
            Actor_SetColorFilter(&this->actor, -COLORFILTER_COLORFLAG_RGB, 200, COLORFILTER_XLUFLAG_OPA, 80);
            break;
        case 9:
        ...
        case 15:
            ...
            Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 180, COLORFILTER_XLUFLAG_OPA, 80);
            break;
    }
    this->actor.bgCheckFlags &= ~BGCHECKFLAG_GROUND;
