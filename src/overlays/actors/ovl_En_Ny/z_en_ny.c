...
void func_80ABCD40(EnNy* this) {
    ...
    temp = (this->actor.yDistUnderWater > 0.0f) ? 0.7f : 1.0f;
...
void EnNy_Move(EnNy* this, PlayState* play) {
    ...
    if (!(this->unk_1F0 < this->actor.yDistUnderWater)) {
...
void func_80ABD3B8(EnNy* this, f32 arg1, f32 arg2) {
    if (this->unk_1E8 == 0.0f) {
        this->actor.gravity = -0.4f;
    } else if (!(arg1 < this->actor.yDistUnderWater)) {
        this->actor.gravity = -0.4f;
    } else if (arg2 < this->actor.yDistUnderWater) {
...
void EnNy_SetupDie(EnNy* this, PlayState* play) {
    ...
    if (this->timer >= 2) {
        if (this->actor.yDistUnderWater > 0.0f) {
            for (i = 0; i < 10; i++) {
