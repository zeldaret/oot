    ...
    if ((play->sceneNum == SCENE_DAIYOUSEI_IZUMI) && (play->csCtx.npcActions[0]->action >= 10) &&
        ...
        switch (actionIndex) {
            case FAIRY_UPGRADE_MAGIC:
                ...
                // magicLevel is already 0, which triggers magicCapacity to step to magicFillTarget
            ...
            case FAIRY_UPGRADE_DOUBLE_MAGIC:
                ...
                // Setting magicLevel to 0 triggers magicCapacity to step to magicFillTarget
