...
static ColliderTrisItemInit  D_8087EE60[4] = {
    {
        { ELEMTYPE_UNK2, { 0x20000000, 0x00, 0x04 }, { 0x00000000, 0x00, 0x00 }, TOUCH_ON, BUMP_OFF, OCELEM_OFF },
...
static ColliderTrisInit D_8087EF50 = {
    { COLTYPE_UNK10, AT_ENEMY | AT_ON, AC_OFF, OC_OFF, OT_TYPE2, COLSHAPE_TRIS },
    4, D_8087EE60,
};
