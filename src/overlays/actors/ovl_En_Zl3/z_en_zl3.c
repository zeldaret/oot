...
void func_80B54EF4(EnZl3* this) {
    Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&this->actor.projectedPos, NA_SE_VO_Z1_PAIN);
}
...
void func_80B56DA4(EnZl3* this) {
    Audio_PlaySfxGeneralWithDefaultSettings2(NA_SE_EV_ZELDA_POWER);
}
...
void func_80B56DEC(EnZl3* this) {
    ...
    if ((skelAnime->mode == 2) && Animation_OnFrame(skelAnime, 9.0f) != 0) {
        Audio_PlaySfxGeneralWithDefaultSettingsAtPosition(&this->actor.projectedPos, NA_SE_VO_Z1_OPENDOOR);
    }
}
