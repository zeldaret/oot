...
void func_80B5764C(EnZl3* this, GlobalContext* globalCtx) {
    ...
    if ((sceneNum == SCENE_GANON_SONOGO) && (func_80B54DB4(this) == 0x26)) {
        ...
        if ((unk_314 == 1) && !Gameplay_InCsMode(globalCtx)) {
            OnePointDemo_Init(globalCtx, 1000, 40, &this->actor, 0);
        }
    }
}
...
void func_80B58014(EnZl3* this, GlobalContext* globalCtx) {
    ...
    if (func_80B57324(this, globalCtx)) {
        ...
        OnePointDemo_Init(globalCtx, 4000, -99, &this->actor, 0);
        this->unk_3D0 = 0;
        ...
        func_80B537E8(this);
        this->unk_3D8 = 1;
        OnePointDemo_Init(globalCtx, 4010, -99, &this->actor, 0);
...
void func_80B584B4(EnZl3* this, GlobalContext* globalCtx) {
    ...
    if (D_80B5A4BC == 0) {
        if ((nearbyEnTest == NULL) && (!Gameplay_InCsMode(globalCtx))) {
            this->action = 33;
            OnePointDemo_Init(globalCtx, 4011, -99, &this->actor, 0);
