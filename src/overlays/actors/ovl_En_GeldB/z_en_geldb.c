...
s32 EnGeldB_ReactToPlayer(GlobalContext* globalCtx, EnGeldB* this, s16 arg2) {
    ...
    if (func_800354B4(globalCtx, thisx, 100.0f, 0x5DC0, 0x2AA8, thisx->shape.rot.y)) {
        ...
        if ((thisx->bgCheckFlags & BGCHECKFLAG_3) && (ABS(angleToWall) < 0x2EE0) && (thisx->xzDistToPlayer < 90.0f)) {
        ...
        thisx->shape.rot.y = thisx->world.rot.y = thisx->yawTowardsPlayer;
        if (((thisx->bgCheckFlags & BGCHECKFLAG_3) && (angleToWall < 0x2EE0)) || (bomb->id == ACTOR_EN_BOM_CHU)) {
...
void EnGeldB_SetupWait(EnGeldB* this) {
    ...
    this->actor.bgCheckFlags &= ~(BGCHECKFLAG_0 | BGCHECKFLAG_1);
...
void EnGeldB_Circle(EnGeldB* this, GlobalContext* globalCtx) {
    ...
    if (!EnGeldB_DodgeRanged(globalCtx, this) && !EnGeldB_ReactToPlayer(globalCtx, this, 0)) {
        ...
        if ((this->actor.bgCheckFlags & BGCHECKFLAG_3) || !Actor_TestFloorInDirection(&this->actor, globalCtx, this->actor.speedXZ,
...
void EnGeldB_Stunned(EnGeldB* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.colorFilterTimer == 0) && (this->actor.bgCheckFlags & BGCHECKFLAG_0)) {
...
void EnGeldB_Damaged(EnGeldB* this, GlobalContext* globalCtx) {
    ...
    if (!EnGeldB_DodgeRanged(globalCtx, this) && !EnGeldB_ReactToPlayer(globalCtx, this, 0) &&
        SkelAnime_Update(&this->skelAnime) && (this->actor.bgCheckFlags & BGCHECKFLAG_0)) {
        angleToWall = this->actor.wallYaw - this->actor.shape.rot.y;
        if ((this->actor.bgCheckFlags & BGCHECKFLAG_3) && (ABS(angleToWall) < 0x2EE0) && (this->actor.xzDistToPlayer < 90.0f)) {
            EnGeldB_SetupJump(this);
...
void EnGeldB_Jump(EnGeldB* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelAnime) && (this->actor.bgCheckFlags & (BGCHECKFLAG_0 | BGCHECKFLAG_1))) {
        this->actor.world.rot.y = this->actor.shape.rot.y = this->actor.yawTowardsPlayer;
