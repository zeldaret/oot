...
void BgSpot00Hanebasi_DrawTorches(Actor* thisx, PlayState* play2) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_bg_spot00_hanebasi.c", 674);
...
void BgSpot00Hanebasi_Draw(Actor* thisx, PlayState* play) {
    ...
    gSPMATRIX_SET_NEW(POLY_OPA_DISP++, play->state.gfxCtx, "../z_bg_spot00_hanebasi.c", 702);
