...
static ColliderJntSphItemInit  D_808C7100[19] = {
    {
        { ELEMTYPE_UNK3, { 0xFFCFFFFF, 0x00, 0x04 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
    ...
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x04 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
}, { 1, { { 0, 0, 0 }, 60 }, 100 },
    },
    {
        { ELEMTYPE_UNK2, { 0xFFCFFFFF, 0x00, 0x04 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_ON, BUMP_ON, OCELEM_ON
