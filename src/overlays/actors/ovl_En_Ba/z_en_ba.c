...
void EnBa_Idle(EnBa* this, GlobalContext* globalCtx) {
    ...
    if (!(player->stateFlags1 & PLAYER_STATE_FLAG_1_26) && (this->actor.xzDistToPlayer <= 175.0f) &&
        (this->actor.world.pos.y == this->actor.home.pos.y + 100.0f)) {
...
void EnBa_SwingAtPlayer(EnBa* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.xzDistToPlayer <= 175.0f) || (this->unk31A != 0)) {
        ...
        if (this->unk318 != 0) {
            ...
            if (this->unk31A != 0) {
                ...
                this->unk31A--;
            } else if ((this->actor.xzDistToPlayer > 175.0f) || (player->stateFlags1 & PLAYER_STATE_FLAG_1_26)) {
                EnBa_SetupIdle(this);
            } else {
                EnBa_SetupSwingAtPlayer(this);
                this->unk318 = 27;
    ...
    if ((this->actor.xzDistToPlayer > 175.0f) || (player->stateFlags1 & PLAYER_STATE_FLAG_1_26)) {
        EnBa_SetupIdle(this);
    } else {
        EnBa_SetupSwingAtPlayer(this);
        this->unk318 = 27;
