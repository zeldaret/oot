...
s32 EnZf_CanAttack(GlobalContext* globalCtx, EnZf* this) {
    ...
    if (this->actor.params >= ENZF_TYPE_LIZALFOS_MINIBOSS_A) { // miniboss
        if (player->stateFlags1 & (PLAYER_STATE_FLAG_1_13 | PLAYER_STATE_FLAG_1_14)) {                    // Hanging or climbing
            return false;
        } else {
            return true;
        }
            ...
            if (Rand_ZeroOne() > 0.7f) {
                ...
                if (rotDiff <= 10000) {
                    ...
                    if (yawDiff > 16000) {
                        this->actor.world.rot.y = this->actor.yawTowardsPlayer;
                        func_80B483E4(this, globalCtx);
                    } else if (player->stateFlags1 & (PLAYER_STATE_FLAG_1_4 | PLAYER_STATE_FLAG_1_13 | PLAYER_STATE_FLAG_1_14)) {
