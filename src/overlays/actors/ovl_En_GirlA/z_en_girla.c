...
s32 func_80A3A758(EnGirlA* this) {
    switch (this->actor.params) {
        case 17:
            if (gSaveContext.save.info.itemGetInf[0] & 0x4) {
                this->actor.params = 16;
                return 1;
            }
            break;
        case 24:
            if (gSaveContext.save.info.itemGetInf[0] & 0x40) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 25:
            if (gSaveContext.save.info.itemGetInf[0] & 0x80) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 26:
            if (gSaveContext.save.info.itemGetInf[0] & 0x100) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 27:
            if (gSaveContext.save.info.itemGetInf[0] & 0x200) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 28:
            if (gSaveContext.save.info.itemGetInf[0] & 0x400) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 21:
            if (gSaveContext.save.info.itemGetInf[0] & 0x8) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 22:
            if (gSaveContext.save.info.itemGetInf[0] & 0x10) {
                this->actor.params = 38;
                return 1;
            }
            break;
        case 23:
            if (gSaveContext.save.info.itemGetInf[0] & 0x20) {
                this->actor.params = 38;
                return 1;
            }
            break;
...
void func_80A3BC6C(GlobalContext* globalCtx, EnGirlA* this) {
    switch (this->actor.params) {
        case 24:
            gSaveContext.save.info.itemGetInf[0] |= 0x40;
            break;
        case 25:
            gSaveContext.save.info.itemGetInf[0] |= 0x80;
            break;
        case 26:
            gSaveContext.save.info.itemGetInf[0] |= 0x100;
            break;
        case 27:
            gSaveContext.save.info.itemGetInf[0] |= 0x200;
            break;
        case 28:
            gSaveContext.save.info.itemGetInf[0] |= 0x400;
            break;
        case 21:
            gSaveContext.save.info.itemGetInf[0] |= 0x8;
            break;
        case 22:
            gSaveContext.save.info.itemGetInf[0] |= 0x10;
            break;
        case 23:
            gSaveContext.save.info.itemGetInf[0] |= 0x20;
            break;
    }
    Rupees_ChangeBy(-this->unk_1C8);
}
...
void func_80A3BD8C(GlobalContext* globalCtx, EnGirlA* this) {
    ...
    if ((this->actor.params >= 30) && (this->actor.params < 35)) {
        ...
        switch (this->actor.params) {
            case 30:
                if (gSaveContext.save.info.itemGetInf[3] & 0x100) {
                    tmp3 = 1;
                }
                break;
            case 31:
                if (gSaveContext.save.info.itemGetInf[3] & 0x400) {
                    tmp3 = 1;
                }
                break;
            case 32:
                if (gSaveContext.save.info.itemGetInf[3] & 0x200) {
                    tmp3 = 1;
                }
                break;
            case 33:
                if (gSaveContext.save.info.itemGetInf[3] & 0x800) {
                    tmp3 = 1;
                }
                break;
            case 34:
