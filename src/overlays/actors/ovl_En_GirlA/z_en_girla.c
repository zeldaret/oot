...
static ShopItemEntry D_80A3C674[] = {
    { OBJECT_GI_NUTS, GID_NUTS, Actor_DrawHiliteReflectionXlu, 0x000F, 0x0005, 0x00B2, 0x007F, GI_NUTS_5_2, func_80A3ABF8,
      func_80A3B714, func_80A3BB6C },
    { OBJECT_GI_ARROW, GID_ARROWS_MEDIUM, Actor_DrawHiliteReflectionOpa, 0x003C, 0x001E, 0x00C1, 0x009B, GI_ARROWS_MEDIUM,
      func_80A3AAA8, func_80A3B634, func_80A3BB6C },
    { OBJECT_GI_ARROW, GID_ARROWS_LARGE, Actor_DrawHiliteReflectionOpa, 0x005A, 0x0032, 0x00B0, 0x007D, GI_ARROWS_LARGE, func_80A3AAA8,
      func_80A3B634, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, GID_BOMB, Actor_DrawHiliteReflectionOpa, 0x0019, 0x0005, 0x00A3, 0x008B, GI_BOMBS_5, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_NUTS, GID_NUTS, Actor_DrawHiliteReflectionXlu, 0x001E, 0x000A, 0x00A2, 0x0087, GI_NUTS_10, func_80A3ABF8, func_80A3B714,
      func_80A3BB6C },
    { OBJECT_GI_STICK, GID_STICK, NULL, 0x000A, 0x0001, 0x00A1, 0x0088, GI_STICKS_1, func_80A3ACAC, func_80A3B780,
      func_80A3BB6C },
    { OBJECT_GI_BOMB_1, GID_BOMB, Actor_DrawHiliteReflectionOpa, 0x0032, 0x000A, 0x00B1, 0x007C, GI_BOMBS_10, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_FISH, GID_FISH, Actor_DrawHiliteReflectionXlu, 0x00C8, 0x0001, 0x00B3, 0x007E, GI_FISH, func_80A3AD60, NULL,
      func_80A3BB6C },
    { OBJECT_GI_LIQUID, GID_POTION_RED, Actor_DrawHiliteReflectionOpa, 0x001E, 0x0001, 0x00A5, 0x008E, GI_POTION_RED, func_80A3ADD4,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LIQUID, GID_POTION_GREEN, Actor_DrawHiliteReflectionOpa, 0x001E, 0x0001, 0x00A6, 0x008F, GI_POTION_GREEN, func_80A3AE48,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LIQUID, GID_POTION_BLUE, Actor_DrawHiliteReflectionOpa, 0x003C, 0x0001, 0x00A7, 0x0090, GI_POTION_BLUE, func_80A3AEBC,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LONGSWORD, GID_SWORD_BGS, Actor_DrawHiliteReflectionOpa, 0x03E8, 0x0001, 0x00A8, 0x0091, GI_SWORD_KNIFE, func_80A3AF30,
      func_80A3B7BC, func_80A3BB6C },
    { OBJECT_GI_SHIELD_2, GID_SHIELD_HYLIAN, Actor_DrawHiliteReflectionOpa, 0x0050, 0x0001, 0x00A9, 0x0092, GI_SHIELD_HYLIAN,
      func_80A3AFC4, func_80A3B800, func_80A3BB6C },
    { OBJECT_GI_SHIELD_1, GID_SHIELD_DEKU, Actor_DrawHiliteReflectionOpa, 0x0028, 0x0001, 0x009F, 0x0089, GI_SHIELD_DEKU, func_80A3B040,
    ...
    { OBJECT_GI_EGG, GID_EGG, Actor_DrawHiliteReflectionOpa, 0x0064, 0x0001, 0x00AE, 0x0099, GI_WEIRD_EGG, func_80A3B2AC, func_80A3B968,
      func_80A3BB6C },
    { OBJECT_GI_MILK, GID_MILK, func_80A3C498, 0x2710, 0x0001, 0x00B4, 0x0085, GI_NONE, func_80A3B308, func_80A3B9A4,
      func_80A3BB6C },
    { OBJECT_GI_EGG, GID_EGG, Actor_DrawHiliteReflectionOpa, 0x2710, 0x0001, 0x00B5, 0x0085, GI_NONE, func_80A3B318, func_80A3B9D4,
      func_80A3BB6C },
    { OBJECT_GI_BOMB_2, GID_BOMBCHU, Actor_DrawHiliteReflectionOpa, 0x0064, 0x000A, 0x00BC, 0x008C, GI_BOMBCHUS_10, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_BOMB_2, GID_BOMBCHU, Actor_DrawHiliteReflectionOpa, 0x00B4, 0x0014, 0x0061, 0x002A, GI_BOMBCHUS_20, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_BOMB_2, GID_BOMBCHU, Actor_DrawHiliteReflectionOpa, 0x00B4, 0x0014, 0x0061, 0x002A, GI_BOMBCHUS_20, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_BOMB_2, GID_BOMBCHU, Actor_DrawHiliteReflectionOpa, 0x0064, 0x000A, 0x00BC, 0x008C, GI_BOMBCHUS_10, func_80A3B328, NULL,
    ...
    { OBJECT_GI_BOMB_2, GID_BOMBCHU, Actor_DrawHiliteReflectionOpa, 0x0064, 0x000A, 0x00BC, 0x008C, GI_BOMBCHUS_10, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_SEED, GID_SEEDS, Actor_DrawHiliteReflectionOpa, 0x001E, 0x001E, 0x00DF, 0x00DE, GI_SEEDS_30, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_KI_TAN_MASK, GID_MASK_KEATON, Actor_DrawHiliteReflectionOpa, 0x0000, 0x0001, 0x70B2, 0x70BE, GI_MASK_KEATON,
      func_80A3B3A8, func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_REDEAD_MASK, GID_MASK_SPOOKY, Actor_DrawHiliteReflectionOpa, 0x0000, 0x0001, 0x70B1, 0x70BD, GI_MASK_SPOOKY,
      func_80A3B3A8, func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_SKJ_MASK, GID_MASK_SKULL, Actor_DrawHiliteReflectionOpa, 0x0000, 0x0001, 0x70B0, 0x70BC, GI_MASK_SKULL, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_RABIT_MASK, GID_MASK_BUNNY, Actor_DrawHiliteReflectionOpa, 0x0000, 0x0001, 0x70B3, 0x70BF, GI_MASK_BUNNY, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    ...
    { OBJECT_GI_GERUDOMASK, GID_MASK_GERUDO, NULL, 0x0000, 0x0001, 0x70BA, 0x70C2, GI_MASK_GERUDO, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_SOLDOUT, GID_SOLDOUT, Actor_DrawHiliteReflectionOpa, 0x0000, 0x0000, 0x00BD, 0x70C2, GI_MASK_GERUDO, func_80A3B454,
      NULL, NULL },
    { OBJECT_GI_FIRE, GID_BLUE_FIRE, Actor_DrawHiliteReflectionOpa, 0x012C, 0x0001, 0x00B9, 0x00B8, GI_BLUE_FIRE, func_80A3B464,
      func_80A3BA40, func_80A3BB6C },
    ...
    { OBJECT_GI_SOUL, GID_FAIRY, func_80A3C498, 0x0032, 0x0001, 0x00B7, 0x00B6, GI_FAIRY, func_80A3B5C0, func_80A3BA40,
      func_80A3BB6C },
    { OBJECT_GI_ARROW, GID_ARROWS_SMALL, Actor_DrawHiliteReflectionOpa, 0x0014, 0x000A, 0x00A0, 0x008A, GI_ARROWS_SMALL, func_80A3AAA8,
      func_80A3B634, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, GID_BOMB, Actor_DrawHiliteReflectionOpa, 0x0050, 0x0014, 0x001C, 0x0006, GI_BOMBS_20, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, GID_BOMB, Actor_DrawHiliteReflectionOpa, 0x0078, 0x001E, 0x001D, 0x001E, GI_BOMBS_30, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, GID_BOMB, Actor_DrawHiliteReflectionOpa, 0x0023, 0x0005, 0x00CB, 0x00CA, GI_BOMBS_5, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_LIQUID, GID_POTION_RED, Actor_DrawHiliteReflectionOpa, 0x0028, 0x0001, 0x0064, 0x0062, GI_POTION_RED, func_80A3ADD4,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LIQUID, GID_POTION_RED, Actor_DrawHiliteReflectionOpa, 0x0032, 0x0001, 0x0065, 0x0063, GI_POTION_RED, func_80A3ADD4,
      func_80A3BA40, func_80A3BB6C },
};
