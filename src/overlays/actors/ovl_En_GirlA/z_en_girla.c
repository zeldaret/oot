...
static ShopItemEntry D_80A3C674[] = {
    { OBJECT_GI_NUTS, DI_NUTS, func_8002ED80, 0x000F, 0x0005, 0x00B2, 0x007F, GI_NUTS_5_2, func_80A3ABF8, func_80A3B714,
      func_80A3BB6C },
    { OBJECT_GI_ARROW, DI_ARROWS_MEDIUM, func_8002EBCC, 0x003C, 0x001E, 0x00C1, 0x009B, GI_ARROWS_MEDIUM, func_80A3AAA8,
      func_80A3B634, func_80A3BB6C },
    { OBJECT_GI_ARROW, DI_ARROWS_LARGE, func_8002EBCC, 0x005A, 0x0032, 0x00B0, 0x007D, GI_ARROWS_LARGE, func_80A3AAA8,
      func_80A3B634, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, DI_BOMB, func_8002EBCC, 0x0019, 0x0005, 0x00A3, 0x008B, GI_BOMBS_5, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_NUTS, DI_NUTS, func_8002ED80, 0x001E, 0x000A, 0x00A2, 0x0087, GI_NUTS_10, func_80A3ABF8, func_80A3B714,
      func_80A3BB6C },
    { OBJECT_GI_STICK, DI_STICK, NULL, 0x000A, 0x0001, 0x00A1, 0x0088, GI_STICKS_1, func_80A3ACAC, func_80A3B780,
      func_80A3BB6C },
    { OBJECT_GI_BOMB_1, DI_BOMB, func_8002EBCC, 0x0032, 0x000A, 0x00B1, 0x007C, GI_BOMBS_10, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_FISH, DI_FISH, func_8002ED80, 0x00C8, 0x0001, 0x00B3, 0x007E, GI_FISH, func_80A3AD60, NULL,
      func_80A3BB6C },
    { OBJECT_GI_LIQUID, DI_POTION_RED, func_8002EBCC, 0x001E, 0x0001, 0x00A5, 0x008E, GI_POTION_RED, func_80A3ADD4,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LIQUID, DI_POTION_GREEN, func_8002EBCC, 0x001E, 0x0001, 0x00A6, 0x008F, GI_POTION_GREEN, func_80A3AE48,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LIQUID, DI_POTION_BLUE, func_8002EBCC, 0x003C, 0x0001, 0x00A7, 0x0090, GI_POTION_BLUE, func_80A3AEBC,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LONGSWORD, DI_SWORD_BGS, func_8002EBCC, 0x03E8, 0x0001, 0x00A8, 0x0091, GI_SWORD_KNIFE, func_80A3AF30,
      func_80A3B7BC, func_80A3BB6C },
    { OBJECT_GI_SHIELD_2, DI_SHIELD_HYLIAN, func_8002EBCC, 0x0050, 0x0001, 0x00A9, 0x0092, GI_SHIELD_HYLIAN,
      func_80A3AFC4, func_80A3B800, func_80A3BB6C },
    { OBJECT_GI_SHIELD_1, DI_SHIELD_DEKU, func_8002EBCC, 0x0028, 0x0001, 0x009F, 0x0089, GI_SHIELD_DEKU, func_80A3B040,
      func_80A3B83C, func_80A3BB6C },
    { OBJECT_GI_CLOTHES, DI_TUNIC_GORON, NULL, 0x00C8, 0x0001, 0x00AA, 0x0093, GI_TUNIC_GORON, func_80A3B0BC,
      func_80A3B878, func_80A3BC0C },
    { OBJECT_GI_CLOTHES, DI_TUNIC_ZORA, NULL, 0x012C, 0x0001, 0x00AB, 0x0094, GI_TUNIC_ZORA, func_80A3B160,
      func_80A3B8B4, func_80A3BC3C },
    { OBJECT_GI_HEART, DI_HEART, NULL, 0x000A, 0x0010, 0x00AC, 0x0095, GI_HEART, func_80A3B204, func_80A3B8F0,
      func_80A3BB6C },
    { OBJECT_GI_MILK, DI_MILK, func_80A3C498, 0x0064, 0x0001, 0x00AD, 0x0097, GI_MILK_BOTTLE, func_80A3B250,
      func_80A3B92C, func_80A3BB6C },
    { OBJECT_GI_EGG, DI_EGG, func_8002EBCC, 0x0064, 0x0001, 0x00AE, 0x0099, GI_WEIRD_EGG, func_80A3B2AC, func_80A3B968,
      func_80A3BB6C },
    { OBJECT_GI_MILK, DI_MILK, func_80A3C498, 0x2710, 0x0001, 0x00B4, 0x0085, GI_NONE, func_80A3B308, func_80A3B9A4,
      func_80A3BB6C },
    { OBJECT_GI_EGG, DI_EGG, func_8002EBCC, 0x2710, 0x0001, 0x00B5, 0x0085, GI_NONE, func_80A3B318, func_80A3B9D4,
      func_80A3BB6C },
    { OBJECT_GI_BOMB_2, DI_BOMBCHU, func_8002EBCC, 0x0064, 0x000A, 0x00BC, 0x008C, GI_BOMBCHUS_10, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_BOMB_2, DI_BOMBCHU, func_8002EBCC, 0x00B4, 0x0014, 0x0061, 0x002A, GI_BOMBCHUS_20, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_BOMB_2, DI_BOMBCHU, func_8002EBCC, 0x00B4, 0x0014, 0x0061, 0x002A, GI_BOMBCHUS_20, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_BOMB_2, DI_BOMBCHU, func_8002EBCC, 0x0064, 0x000A, 0x00BC, 0x008C, GI_BOMBCHUS_10, func_80A3B328, NULL,
    ...
    { OBJECT_GI_BOMB_2, DI_BOMBCHU, func_8002EBCC, 0x0064, 0x000A, 0x00BC, 0x008C, GI_BOMBCHUS_10, func_80A3B328, NULL,
      func_80A3BC6C },
    { OBJECT_GI_SEED, DI_SEEDS, func_8002EBCC, 0x001E, 0x001E, 0x00DF, 0x00DE, GI_SEEDS_30, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_KI_TAN_MASK, DI_MASK_KEATON, func_8002EBCC, 0x0000, 0x0001, 0x70B2, 0x70BE, GI_MASK_KEATON,
      func_80A3B3A8, func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_REDEAD_MASK, DI_MASK_SPOOKY, func_8002EBCC, 0x0000, 0x0001, 0x70B1, 0x70BD, GI_MASK_SPOOKY,
      func_80A3B3A8, func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_SKJ_MASK, DI_MASK_SKULL, func_8002EBCC, 0x0000, 0x0001, 0x70B0, 0x70BC, GI_MASK_SKULL, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_RABIT_MASK, DI_MASK_BUNNY, func_8002EBCC, 0x0000, 0x0001, 0x70B3, 0x70BF, GI_MASK_BUNNY, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_TRUTH_MASK, DI_MASK_TRUTH, func_80A3C498, 0x0000, 0x0001, 0x70AF, 0x70C3, GI_MASK_TRUTH, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_ZORAMASK, DI_MASK_ZORA, NULL, 0x0000, 0x0001, 0x70B9, 0x70C1, GI_MASK_ZORA, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_GOLONMASK, DI_MASK_GORON, NULL, 0x0000, 0x0001, 0x70B8, 0x70C0, GI_MASK_GORON, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_GERUDOMASK, DI_MASK_GERUDO, NULL, 0x0000, 0x0001, 0x70BA, 0x70C2, GI_MASK_GERUDO, func_80A3B3A8,
      func_80A3BA04, func_80A3BB6C },
    { OBJECT_GI_SOLDOUT, DI_SOLDOUT, func_8002EBCC, 0x0000, 0x0000, 0x00BD, 0x70C2, GI_MASK_GERUDO, func_80A3B454, NULL,
      NULL },
    { OBJECT_GI_FIRE, DI_BLUE_FIRE, func_8002EBCC, 0x012C, 0x0001, 0x00B9, 0x00B8, GI_BLUE_FIRE, func_80A3B464,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_INSECT, DI_BUG, func_80A3C498, 0x0032, 0x0001, 0x00BB, 0x00BA, GI_BUGS, func_80A3B4D8, func_80A3BA40,
      func_80A3BB6C },
    { OBJECT_GI_GHOST, DI_BIG_POE, func_80A3C498, 0x0032, 0x0001, 0x506F, 0x5070, GI_BIG_POE, func_80A3B54C,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_GHOST, DI_POE, func_80A3C498, 0x001E, 0x0001, 0x506D, 0x506E, GI_POE, func_80A3B54C, func_80A3BA40,
      func_80A3BB6C },
    { OBJECT_GI_SOUL, DI_FAIRY, func_80A3C498, 0x0032, 0x0001, 0x00B7, 0x00B6, GI_FAIRY, func_80A3B5C0, func_80A3BA40,
      func_80A3BB6C },
    { OBJECT_GI_ARROW, DI_ARROWS_SMALL, func_8002EBCC, 0x0014, 0x000A, 0x00A0, 0x008A, GI_ARROWS_SMALL, func_80A3AAA8,
      func_80A3B634, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, DI_BOMB, func_8002EBCC, 0x0050, 0x0014, 0x001C, 0x0006, GI_BOMBS_20, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, DI_BOMB, func_8002EBCC, 0x0078, 0x001E, 0x001D, 0x001E, GI_BOMBS_30, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_BOMB_1, DI_BOMB, func_8002EBCC, 0x0023, 0x0005, 0x00CB, 0x00CA, GI_BOMBS_5, func_80A3AB58,
      func_80A3B678, func_80A3BB6C },
    { OBJECT_GI_LIQUID, DI_POTION_RED, func_8002EBCC, 0x0028, 0x0001, 0x0064, 0x0062, GI_POTION_RED, func_80A3ADD4,
      func_80A3BA40, func_80A3BB6C },
    { OBJECT_GI_LIQUID, DI_POTION_RED, func_8002EBCC, 0x0032, 0x0001, 0x0065, 0x0063, GI_POTION_RED, func_80A3ADD4,
      func_80A3BA40, func_80A3BB6C },
};
