...
void EnSt_InitColliders(EnSt* this, PlayState* play) {
    ...
    this->colCylinder[0].elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC =
    ...
    this->colCylinder[2].base.colMaterial_Collider = COL_MATERIAL_METAL;
    this->colCylinder[2].elem.acElemFlags = ACELEM_ON | ACELEM_HOOKABLE | ACELEM_NO_AT_INFO;
    this->colCylinder[2].elem.elemMaterial_ColliderElement = ELEM_MATERIAL_UNK2;
...
void EnSt_CheckBodyStickHit(EnSt* this, PlayState* play) {
    ...
    if (player->unk_860 != 0) {
        bodyElem->acDmgInfo.dmgFlags_ColliderElementDamageInfoAC |= DMG_DEKU_STICK;
        this->colCylinder[1].elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC &= ~DMG_DEKU_STICK;
        this->colCylinder[2].elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC &= ~DMG_DEKU_STICK;
    } else {
        bodyElem->acDmgInfo.dmgFlags_ColliderElementDamageInfoAC &= ~DMG_DEKU_STICK;
        this->colCylinder[1].elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC |= DMG_DEKU_STICK;
        this->colCylinder[2].elem.acDmgInfo.dmgFlags_ColliderElementDamageInfoAC |= DMG_DEKU_STICK;
...
s32 EnSt_CheckHitBackside(EnSt* this, PlayState* play) {
    ...
    if (cyl->base.acFlags & AC_HIT) {
        ...
        hit = true;
        flags |= cyl->elem.acHitElem->atDmgInfo.dmgFlags_ColliderElementDamageInfoAT;
    }
