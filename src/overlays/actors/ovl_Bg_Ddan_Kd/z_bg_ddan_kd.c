...
void BgDdanKd_LowerStairs(BgDdanKd* this, GlobalContext* globalCtx) {
    ...
    if (Math_SmoothScaleMaxMinF(&this->dyna.actor.posRot.pos.y, (this->dyna.actor.initPosRot.pos.y - 200.0f) - 20.0f,
        ...
        if (globalCtx->state.frames & 1) {
            ...
            sp5C.y = this->dyna.actor.bgChkInfo.groundY + 20.0f + Math_Rand_ZeroOne();
            sp50.y = this->dyna.actor.bgChkInfo.groundY + 20.0f + Math_Rand_ZeroOne();
            ...
            sp5C.y = Math_Rand_ZeroOne() * 3.0f + (this->dyna.actor.bgChkInfo.groundY + 20.0f);
