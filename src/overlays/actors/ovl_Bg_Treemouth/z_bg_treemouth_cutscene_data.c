...
CutsceneData D_808BCE20[] = {
    ...
    CS_START_SEQ_LIST(1),
        CS_START_SEQ(0x004C, 140, 141, 0x0000, 0x00000000, 0x00000000, 0xFFFFFFBA, 0x00000094, 0x00000000, 0xFFFFFFBA, 0x00000094),
    CS_FADE_SEQ_LIST(1),
...
CutsceneData D_808BD2A0[] = {
    ...
    CS_CAM_EYE_POINTS_REL_TO_PLAYER_LIST(60, 1151),
        CS_CAM_EYE_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 60.0f, -4, 5, 49, 0x7065),
        CS_CAM_EYE_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 60.0f, -4, 5, 49, 0x6167),
        CS_CAM_EYE_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 60.0f, -4, 5, 49, 0x6D5D),
        CS_CAM_EYE_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 0, 60.0f, -4, 5, 49, 0xF348),
        CS_CAM_EYE_POINTS_REL_TO_PLAYER(CS_CMD_STOP, 0x00, 0, 60.0f, -4, 5, 49, 0x9D94),
    CS_CAM_AT_POINTS_LIST(0, 1120),
    ...
    CS_CAM_AT_POINTS_REL_TO_PLAYER_LIST(60, 1180),
        CS_CAM_AT_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 1, 35, -36, 0x7065),
        CS_CAM_AT_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 1, 35, -36, 0x6167),
        CS_CAM_AT_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 1000, 60.0f, 1, 35, -36, 0x6D5D),
        CS_CAM_AT_POINTS_REL_TO_PLAYER(CS_CMD_CONTINUE, 0x00, 30, 60.0f, 1, 35, -36, 0xF348),
        CS_CAM_AT_POINTS_REL_TO_PLAYER(CS_CMD_STOP, 0x00, 30, 60.0f, 1, 35, -36, 0x9D94),
    CS_TEXT_LIST(2),
        CS_TEXT_NONE(0, 20),
        CS_TEXT(0x1016, 20, 80, 0x0000, 0xFFFF, 0xFFFF),
    CS_START_SEQ_LIST(1),
        CS_START_SEQ(0x004C, 0, 1, 0x0000, 0x00000000, 0x00000000, 0xFFFFFFAC, 0x0000007E, 0x00000000, 0xFFFFFFAC, 0x0000007E),
    CS_END(),
};
...
CutsceneData D_808BD520[] = {
    ...
    CS_START_SEQ_LIST(1),
        CS_START_SEQ(0x003D, 99, 100, 0x0000, 0x00000000, 0xFFFFFFD0, 0x00000000, 0x00000041, 0xFFFFFFD0, 0x00000000, 0x00000041),
    CS_END(),
};
...
CutsceneData D_808BD790[] = {
    ...
    CS_START_SEQ_LIST(1),
        CS_START_SEQ(0x003D, 79, 80, 0x0000, 0x00000000, 0xFFFFFFE8, 0x00000000, 0x0000003A, 0xFFFFFFE8, 0x00000000, 0x0000003A),
    CS_END(),
};
// clang-format on
