...
static ColliderJntSphElementInit  D_80937630[11] = {
    {
        { ELEMTYPE_UNK1, { 0x20000000, 0x00, 0x30 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_ON,
OCELEM_ON
}, { 7, { { 1500, 0, 0 }, 70 }, 100 },
    },
    {
...
OCELEM_ON
    ...
    {
        { ELEMTYPE_UNK1, { 0x20000000, 0x00, 0x30 }, { 0x00000080, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_OFF,
OCELEM_ON }, { 8, { { 1500, 0, 0 }, 70 }, 100 },
    },
};

static ColliderJntSphInit D_809377BC = {
    { COLTYPE_HARD, AT_ENEMY | AT_OFF, AC_PLAYER | AC_HARD | AC_ON, OC_ALL | OC_OFF, OT_TYPE1, COLSHAPE_JNTSPH },
    11, D_80937630,
};
...
static ColliderJntSphElementInit  D_80937494[11] = {
    {
        { ELEMTYPE_UNK1, { 0x20000000, 0x00, 0x00 }, { 0xFFCFFFFF, 0x00, 0x00 }, TOUCH_SFX_NORMAL | TOUCH_ON, BUMP_ON,
OCELEM_ON
...
static ColliderCylinderInit D_809377F8 = {
    { COLTYPE_NONE, AT_ENEMY | AT_OFF, AC_OFF, OC_OFF, OT_TYPE1, COLSHAPE_CYLINDER },
    { ELEMTYPE_UNK0, { 0x20000000, 0x04, 0x10 }, { 0x00000000, 0x00, 0x00 }, TOUCH_SFX_NONE | TOUCH_ON,
