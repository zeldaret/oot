...
void BossSst_DrawHead(Actor* thisx, PlayState* play) {
    ...
    if ((this->actionFunc == BossSst_HeadIntro) && (113 >= this->timer) && (this->timer > 20)) {
        ...
        gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_boss_sst.c", 6934);
        ...
        if (this->effectMode == BONGO_ICE) {
            ...
            for (i = 0; i < 18; i++) {
                ...
                if (effect->move) {
                    ...
                    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_boss_sst.c", 7350);
            ...
            for (i = 0; i < 3; i++, scaleY -= 0.001f) {
                ...
                if (effect->move != 0) {
                    ...
                    gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_boss_sst.c", 7396);
            ...
            while (effect->status != -1) {
                ...
                gSPMATRIX_SET_NEW(POLY_XLU_DISP++, play->state.gfxCtx, "../z_boss_sst.c", 7423);
