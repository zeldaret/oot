...
static ColliderCylinderInit D_809377CC = {
    { COLTYPE_HIT0, AT_OFF, AC_PLAYER | AC_OFF, OC_OFF, OT_TYPE1, COLSHAPE_CYLINDER },
...
static ColliderJntSphInit D_80937620 = {
    { COLTYPE_HIT0, AT_ENEMY | AT_OFF, AC_PLAYER | AC_ON, OC_ALL | OC_OFF, OT_TYPE1, COLSHAPE_JNTSPH },
    11, D_80937494,
};
