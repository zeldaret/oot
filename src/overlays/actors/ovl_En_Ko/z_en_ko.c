...
s32 func_80A97D68(EnKo* this, GlobalContext* globalCtx) {
    ...
    Npc_TurnTowardsFocus(&this->actor, &this->unk_1E8, 2, arg3);
...
s32 func_80A97F20(EnKo* this, GlobalContext* globalCtx) {
    func_80034F54(globalCtx, this->unk_2E4, this->unk_304, 16);
    Npc_TurnTowardsFocus(&this->actor, &this->unk_1E8, 2, 4);
    return 1;
}
...
s32 func_80A97F70(EnKo* this, GlobalContext* globalCtx) {
    ...
    Npc_TurnTowardsFocus(&this->actor, &this->unk_1E8, 5, arg3);
    return EnKo_IsWithinTalkAngle(this);
}
...
s32 func_80A98174(EnKo* this, GlobalContext* globalCtx) {
    ...
    Npc_TurnTowardsFocus(&this->actor, &this->unk_1E8, 2, (this->skelAnime.playSpeed == 0.0f) ? 2 : 1);
    return EnKo_IsWithinTalkAngle(this);
}
...
void func_80A9877C(EnKo* this, GlobalContext* globalCtx) {
    ...
    if ((globalCtx->csCtx.state != 0) || (gDbgCamEnabled != 0)) {
        this->unk_1E8.focusPos = globalCtx->view.eye;
        this->unk_1E8.eyeHeight = 40.0f;
        if (ENKO_TYPE != ENKO_TYPE_CHILD_0) {
            Npc_TurnTowardsFocus(&this->actor, &this->unk_1E8, 2, 2);
        }
    } else {
        this->unk_1E8.focusPos = player->actor.world.pos;
        this->unk_1E8.eyeHeight = func_80A97BC0(this);
        if ((func_80A98ECC(this, globalCtx) == 0) && (this->unk_1E8.talkState == 0)) {
            return;
        }
    }
    if (Actor_Talk(globalCtx, &this->actor, &this->unk_1E8.talkState, this->lookDist, func_80A97610, func_80A97738) &&
        ...
        if (Actor_GetItemExchangePlayer(globalCtx) == ENKO_TYPE_CHILD_9) {
...
void func_80A99504(EnKo* this, GlobalContext* globalCtx) {
    if (Actor_HasParent(&this->actor, globalCtx)) {
        ...
        Actor_PickUp(&this->actor, globalCtx, GI_SAW, 120.0f, 10.0f);
    }
}
