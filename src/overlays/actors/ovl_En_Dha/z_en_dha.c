    ...
    if (this->actor.xzDistToPlayer <= 100.0f) {
        ...
        if (Math_Vec3f_DistXYZ(&playerPos, &this->handPos[0]) <= 12.0f) {
            if (this->unk_1CC == 0) {
                ...
                if (!(player->stateFlags2 & PLAYER_STATE_FLAG_2_7)) {
                    this->unk_1CC = 0;
            ...
            if ((player->stateFlags2 & PLAYER_STATE_FLAG_2_7) && (&this->actor == player->actor.parent)) {
                player->stateFlags2 &= ~PLAYER_STATE_FLAG_2_7;
