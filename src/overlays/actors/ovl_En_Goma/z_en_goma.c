...
void EnGoma_SpawnHatchDebris(EnGoma* this, GlobalContext* globalCtx2) {
    ...
    if (this->actor.params < 6) {
        AudioSource_CreateSoundSource(globalCtx, &this->actor.world.pos, 0x28, NA_SE_EN_GOMA_BJR_EGG2);
    } else {
        AudioSource_CreateSoundSource(globalCtx, &this->actor.world.pos, 0x28, NA_SE_EN_GOMA_EGG2);
    }
