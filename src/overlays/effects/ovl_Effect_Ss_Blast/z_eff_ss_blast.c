...
typedef enum {
    /* 0x00 */ SS_BLAST_PRIM_R,
    /* 0x01 */ SS_BLAST_PRIM_G,
    /* 0x02 */ SS_BLAST_PRIM_B,
    /* 0x03 */ SS_BLAST_PRIM_A,
    /* 0x04 */ SS_BLAST_ENV_R,
    /* 0x05 */ SS_BLAST_ENV_G,
    /* 0x06 */ SS_BLAST_ENV_B,
    /* 0x07 */ SS_BLAST_ENV_A,
...
u32 EffectSsBlast_Init(GlobalContext* globalCtx, u32 index, EffectSs* this, void* initParamsx) {
    ...
    this->regs[SS_BLAST_ALPHA_STEP] = initParams->primColor.a / initParams->life;
...
void EffectSsBlast_Draw(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    gDPSetEnvColor(oGfxCtx->polyXlu.p++, this->regs[SS_BLAST_ENV_R], this->regs[SS_BLAST_ENV_G],
                   this->regs[SS_BLAST_ENV_B], this->regs[SS_BLAST_ENV_A]);
    func_800BFCB8(globalCtx, &mtx, &this->pos);
    gDPSetPrimColor(oGfxCtx->polyXlu.p++, 0, 0, this->regs[SS_BLAST_PRIM_R], this->regs[SS_BLAST_PRIM_G],
...
void EffectSsBlast_Update(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    Math_ApproxS(&this->regs[SS_BLAST_PRIM_A], 0, this->regs[SS_BLAST_ALPHA_STEP]);
