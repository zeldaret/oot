 ...
 */
Acmd* AudioSynth_ProcessNote(s32 noteIndex, NoteSampleState* sampleState, NoteSynthesisState* synthState,
                             UNUSED s16* aiBuf, s32 aiBufLen, Acmd* cmd, s32 updateIndex) {
    STACK_PADS(s32, 3);
    Sample* sample;
    AdpcmLoop* loopInfo;
