...
beginseg
    ...
    include "build/src/audio/audio_data.o"
    include "build/src/audio/audio_synthesis.o"
    include "build/src/audio/audio_heap.o"
    include "build/src/audio/audio_load.o"
    include "build/src/audio/audio_thread.o"
    include "build/src/audio/audio_dcache.o"
    include "build/src/libultra/io/aisetnextbuf.o"
    include "build/src/audio/audio_playback.o"
    include "build/src/audio/audio_effects.o"
    include "build/src/audio/audio_seqplayer.o"
