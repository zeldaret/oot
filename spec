...
beginseg
    ...
    include "build/src/audio/internal/data.o"
    include "build/src/audio/internal/synthesis.o"
    include "build/src/audio/internal/heap.o"
    include "build/src/audio/internal/load.o"
    include "build/src/audio/internal/thread.o"
    include "build/src/audio/internal/dcache.o"
    include "build/src/audio/internal/aisetnextbuf.o"
    include "build/src/audio/internal/playback.o"
    include "build/src/audio/internal/effects.o"
    include "build/src/audio/internal/seqplayer.o"
    include "build/src/audio/external/general.o"
    include "build/src/audio/external/sfx_params.o"
    include "build/src/audio/external/sfx.o"
    include "build/src/audio/external/sequence.o"
    include "build/src/audio/external/data.o"
    include "build/src/audio/external/session_config.o"
