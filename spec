...
beginseg
    ...
    include "build/src/libaudio/audio_data.o"
    include "build/src/libaudio/audio_synthesis.o"
    include "build/src/libaudio/audio_heap.o"
    include "build/src/libaudio/audio_load.o"
    include "build/src/libaudio/audio_thread.o"
    include "build/src/libaudio/audio_dcache.o"
    include "build/src/libultra/io/aisetnextbuf.o"
    include "build/src/libaudio/audio_playback.o"
    include "build/src/libaudio/audio_effects.o"
    include "build/src/libaudio/audio_seqplayer.o"
    include "build/src/audio/audio_external_general.o"
    include "build/src/audio/audio_sfx_params.o"
