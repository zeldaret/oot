...
beginseg
    ...
    include "build/assets/soundfonts/8_Kakariko_Village__Child_.o"
    include "build/assets/soundfonts/9_Fairy_Fountain.o"
    include "build/assets/soundfonts/10_Fire_Temple.o"
    include "build/assets/soundfonts/11_Dodongo_s_Cavern.o"
    ...
    include "build/assets/soundfonts/21_Zora_s_Domain.o"
    ...
    include "build/assets/soundfonts/29_Kotake_and_Koume_s_Theme.o"
    include "build/assets/soundfonts/30_Ganon_s_Castle__Organ_.o"
    include "build/assets/soundfonts/31_Ganon_s_Castle.o"
    include "build/assets/soundfonts/32_Ganondorf_s_Battle.o"
    ...
    include "build/assets/soundfonts/36_Kaepora_Gaebora_s_Theme.o"
    include "build/assets/soundfonts/37_Deku_Tree__Unused_.o"
    include "build/data/audio_pad.rodata.o"
endseg

beginseg
    name "Audioseq"
    include "build/src/audio/000_Sound_Effects.o"
    include "build/src/audio/001_Ambient_Effects.o"
    include "build/src/audio/002_Hyrule_Field_Program.o"
