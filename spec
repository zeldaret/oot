...
beginseg
    ...
    include "build/src/libaudio/data.o"
    include "build/src/libaudio/synthesis.o"
    include "build/src/libaudio/heap.o"
    ...
    include "build/src/code/audio/general.o"
    include "build/src/code/audio/sfx_params.o"
    include "build/src/code/audio/sfx.o"
    include "build/src/code/audio/sequence.o"
    include "build/src/code/audio/data.o"
    include "build/src/code/audio/session_config.o"
