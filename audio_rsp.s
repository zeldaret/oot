...
// process SHORT ADPCM
/* 04001294 000294 200A0005 */  addi	$t2, $zero, 5           // t2 = 5
/* 04001298 000298 2009000E */  addi	$t1, $zero, 0xe         // t1 = 14
/* 0400129C 00029C CA191802 */  ldv		$v25[0], 0x10($s0)      // v25[0..7] = *(s0 + 0x10..0x17)
/* 040012A0 0002A0 CA171803 */  ldv		$v23[0], 0x18($s0)      // v23[0..7] = *(s0 + 0x18..0x1F)
/* 040012A4 0002A4 2210FFFF */  addi	$s0, $s0, -1            // s0--
/* 040012A8 0002A8 CA191C02 */  ldv		$v25[8], 0x10($s0)      // v25[8..15] = *(s0 + 0x10..0x17)
/* 040012AC 0002AC 22100002 */  addi	$s0, $s0, 2             // s0 += 2
/* 040012B0 0002B0 090004B4 */  j		.L040012D0              // step over !(flags & 4)
/* 040012B4 0002B4 CA171C03 */   ldv	$v23[8], 0x18($s0)      // v23[8..15] = *(s0 + 0x18..0x1F)
.L040012B8: // process regular ADPCM
/* 040012B8 0002B8 200A0009 */  addi	$t2, $zero, 9           // t2 = 9
/* 040012BC 0002BC 2009000C */  addi	$t1, $zero, 0xc         // t1 = 12
/* 040012C0 0002C0 CA191800 */  ldv		$v25[0], ($s0)          // v25[0..7] = *(s0 + 0..7)
/* 040012C4 0002C4 CA181C00 */  ldv		$v24[8], ($s0)          // v24[8..15] = *(s0 + 0..7)
/* 040012C8 0002C8 CA171801 */  ldv		$v23[0], 0x8($s0)       // v23[0..7] = *(s0 + 8..15)
/* 040012CC 0002CC CA171C01 */  ldv		$v23[8], 0x8($s0)       // v23[8..15] = *(s0 + 8..15)
.L040012D0:
